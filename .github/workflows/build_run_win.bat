...
:mk_DebugMSVC_x86
"C:\Program Files\Microsoft Visual Studio\2022\Enterprise\Common7\IDE\devenv.com" "%~dp0..\..\mk_clib\projects\vs2022\mk_clib.sln" /Build "DebugMSVC|Win32" /Project "%~3" /ProjectConfig "DebugMSVC|Win32" /Out "%~dp0..\..\%~3-DebugMSVC-x86.txt"
...
goto :eof
:mk_ReleaseMSVC_x86
"C:\Program Files\Microsoft Visual Studio\2022\Enterprise\Common7\IDE\devenv.com" "%~dp0..\..\mk_clib\projects\vs2022\mk_clib.sln" /Build "ReleaseMSVC|Win32" /Project "%~3" /ProjectConfig "ReleaseMSVC|Win32" /Out "%~dp0..\..\%~3-ReleaseMSVC-x86.txt"
copy "%~dp0..\..\mk_clib\projects\vs2022\build\out\Win32\ReleaseMSVC\%~3.exe" "%~dp0..\..\%~3-ReleaseMSVC-x86.exe"
"%~dp0..\..\%~3-ReleaseMSVC-x86.exe"
goto :eof
:mk_DebugMSVC_x64
"C:\Program Files\Microsoft Visual Studio\2022\Enterprise\Common7\IDE\devenv.com" "%~dp0..\..\mk_clib\projects\vs2022\mk_clib.sln" /Build "DebugMSVC|x64" /Project "%~3" /ProjectConfig "DebugMSVC|x64" /Out "%~dp0..\..\%~3-DebugMSVC-x64.txt"
...
goto :eof
:mk_ReleaseMSVC_x64
"C:\Program Files\Microsoft Visual Studio\2022\Enterprise\Common7\IDE\devenv.com" "%~dp0..\..\mk_clib\projects\vs2022\mk_clib.sln" /Build "ReleaseMSVC|x64" /Project "%~3" /ProjectConfig "ReleaseMSVC|x64" /Out "%~dp0..\..\%~3-ReleaseMSVC-x64.txt"
