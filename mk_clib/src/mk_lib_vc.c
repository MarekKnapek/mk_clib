...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_vc_xts_decrypt_block(mk_lib_vc_algid_t const algid, mk_lib_vc_alg_schedule_t const schedule_pri, mk_lib_vc_alg_schedule_t const schedule_sec, mk_sl_cui_uint64_pct const block_id, mk_lib_vc_block_pct const in, mk_lib_vc_block_pt const out) mk_lang_noexcept
{
	...
	tweaks = mk_lang_constexpr_is_constant_evaluated_test ? &tweaks_oversized.m_data.m_block : ((mk_lib_vc_block_pt)(mk_lang_roundup_align_ptr(&tweaks_oversized, sizeof(*tweaks))));
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_vc_keys_init(mk_lib_vc_seqid_t const seqid, mk_lib_vc_keys_material_pct const key_material, mk_lib_vc_seq_keys_pt const keys) mk_lang_noexcept
{
	...
	switch(seqid)
	{
		...
		break;
		case mk_lib_vc_seqid_e_aes_twofish:
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_aes_twofish.m_twofish_pri.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(0 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)))) + (0 * mk_lib_crypto_alg_twofish_256_key_len_v)], mk_lib_crypto_alg_twofish_256_key_len_v);
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_aes_twofish.m_aes_pri    .m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(0 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)))) + (1 * mk_lib_crypto_alg_twofish_256_key_len_v)], mk_lib_crypto_alg_aes_256_key_len_v    );
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_aes_twofish.m_twofish_sec.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(1 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)))) + (0 * mk_lib_crypto_alg_twofish_256_key_len_v)], mk_lib_crypto_alg_twofish_256_key_len_v);
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_aes_twofish.m_aes_sec    .m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(1 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)))) + (1 * mk_lib_crypto_alg_twofish_256_key_len_v)], mk_lib_crypto_alg_aes_256_key_len_v    );
		break;
		case mk_lib_vc_seqid_e_aes_twofish_serpent:
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_aes_twofish_serpent.m_serpent_pri.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(0 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_serpent_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)))) + (0 * mk_lib_crypto_alg_twofish_256_key_len_v) + (0 * mk_lib_crypto_alg_serpent_key_len_v)], mk_lib_crypto_alg_serpent_key_len_v    );
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_aes_twofish_serpent.m_twofish_pri.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(0 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_serpent_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)))) + (0 * mk_lib_crypto_alg_twofish_256_key_len_v) + (1 * mk_lib_crypto_alg_serpent_key_len_v)], mk_lib_crypto_alg_twofish_256_key_len_v);
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_aes_twofish_serpent.m_aes_pri    .m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(0 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_serpent_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)))) + (1 * mk_lib_crypto_alg_twofish_256_key_len_v) + (1 * mk_lib_crypto_alg_serpent_key_len_v)], mk_lib_crypto_alg_aes_256_key_len_v    );
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_aes_twofish_serpent.m_serpent_sec.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(1 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_serpent_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)))) + (0 * mk_lib_crypto_alg_twofish_256_key_len_v) + (0 * mk_lib_crypto_alg_serpent_key_len_v)], mk_lib_crypto_alg_serpent_key_len_v    );
		...
		break;
		case mk_lib_vc_seqid_e_serpent_aes:
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_serpent_aes.m_aes_pri    .m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(0 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_serpent_key_len_v)))) + (0 * mk_lib_crypto_alg_aes_256_key_len_v)], mk_lib_crypto_alg_aes_256_key_len_v);
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_serpent_aes.m_serpent_pri.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(0 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_serpent_key_len_v)))) + (1 * mk_lib_crypto_alg_aes_256_key_len_v)], mk_lib_crypto_alg_serpent_key_len_v);
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_serpent_aes.m_aes_sec    .m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(1 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_serpent_key_len_v)))) + (0 * mk_lib_crypto_alg_aes_256_key_len_v)], mk_lib_crypto_alg_aes_256_key_len_v);
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_serpent_aes.m_serpent_sec.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(1 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_serpent_key_len_v)))) + (1 * mk_lib_crypto_alg_aes_256_key_len_v)], mk_lib_crypto_alg_serpent_key_len_v);
		break;
		case mk_lib_vc_seqid_e_serpent_twofish_aes:
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_serpent_twofish_aes.m_aes_pri    .m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(0 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)) + mk_lib_crypto_alg_serpent_key_len_v)) + (0 * mk_lib_crypto_alg_twofish_256_key_len_v) + (0 * mk_lib_crypto_alg_aes_256_key_len_v)], mk_lib_crypto_alg_aes_256_key_len_v    );
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_serpent_twofish_aes.m_twofish_pri.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(0 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)) + mk_lib_crypto_alg_serpent_key_len_v)) + (0 * mk_lib_crypto_alg_twofish_256_key_len_v) + (1 * mk_lib_crypto_alg_aes_256_key_len_v)], mk_lib_crypto_alg_twofish_256_key_len_v);
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_serpent_twofish_aes.m_serpent_pri.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(0 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)) + mk_lib_crypto_alg_serpent_key_len_v)) + (1 * mk_lib_crypto_alg_twofish_256_key_len_v) + (1 * mk_lib_crypto_alg_aes_256_key_len_v)], mk_lib_crypto_alg_serpent_key_len_v    );
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_serpent_twofish_aes.m_aes_sec    .m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(1 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)) + mk_lib_crypto_alg_serpent_key_len_v)) + (0 * mk_lib_crypto_alg_twofish_256_key_len_v) + (0 * mk_lib_crypto_alg_aes_256_key_len_v)], mk_lib_crypto_alg_aes_256_key_len_v    );
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_serpent_twofish_aes.m_twofish_sec.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(1 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)) + mk_lib_crypto_alg_serpent_key_len_v)) + (0 * mk_lib_crypto_alg_twofish_256_key_len_v) + (1 * mk_lib_crypto_alg_aes_256_key_len_v)], mk_lib_crypto_alg_twofish_256_key_len_v);
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_serpent_twofish_aes.m_serpent_sec.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(1 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)) + mk_lib_crypto_alg_serpent_key_len_v)) + (1 * mk_lib_crypto_alg_twofish_256_key_len_v) + (1 * mk_lib_crypto_alg_aes_256_key_len_v)], mk_lib_crypto_alg_serpent_key_len_v    );
		break;
		case mk_lib_vc_seqid_e_twofish_serpent:
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_twofish_serpent.m_serpent_pri.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(0 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_serpent_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)))) + (0 * mk_lib_crypto_alg_serpent_key_len_v)], mk_lib_crypto_alg_serpent_key_len_v    );
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_twofish_serpent.m_twofish_pri.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(0 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_serpent_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)))) + (1 * mk_lib_crypto_alg_serpent_key_len_v)], mk_lib_crypto_alg_twofish_256_key_len_v);
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_twofish_serpent.m_serpent_sec.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(1 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_serpent_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)))) + (0 * mk_lib_crypto_alg_serpent_key_len_v)], mk_lib_crypto_alg_serpent_key_len_v    );
			mk_lib_vc_memcpyu8_fn(&keys->m_data.m_twofish_serpent.m_twofish_sec.m_data.m_uint8s[0], &key_material->m_data.m_uint8s[(1 * (((mk_lang_types_sint_t)(mk_lib_crypto_alg_serpent_key_len_v)) + ((mk_lang_types_sint_t)(mk_lib_crypto_alg_twofish_256_key_len_v)))) + (1 * mk_lib_crypto_alg_serpent_key_len_v)], mk_lib_crypto_alg_twofish_256_key_len_v);
		break;
		case mk_lib_vc_seqid_e_dummy:
			mk_lang_assert(mk_lang_false);
		break;
