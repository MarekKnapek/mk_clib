...
mk_lang_typedef(mk_lib_net_ioctl_request);
#include "mk_lang_warning_msvc_pop.h"

#include "mk_lang_warning_msvc_push_c4820.h"
struct mk_lib_net_accept_request_s
{
	mk_lang_types_void_pct m_fn_ptr_accept_ex;
	mk_lang_types_void_pct m_fn_ptr_get_accept_ex_sock_addrs;
	mk_lib_net_socket_pt m_socket_listen;
	mk_lib_net_socket_pt m_socket_accept;
	mk_sl_cui_uint8_pt m_out_data_buf;
	mk_lang_types_sint_t m_out_data_len;
	mk_lang_types_bool_t m_b;
	mk_lang_types_uint_t m_flags;
...
typedef struct mk_lib_net_accept_request_s mk_lib_net_accept_request_t;
mk_lang_typedef(mk_lib_net_accept_request);
#include "mk_lang_warning_msvc_pop.h"
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_ioctl_request_is_ready(mk_lib_net_ioctl_request_pt const ioctl_request, mk_lang_types_bool_pt const is_ioctly) mk_lang_noexcept;
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_ioctl_request_wait_timeout(mk_lib_net_ioctl_request_pt const ioctl_request, mk_lang_types_sint_t const ms, mk_lang_types_bool_pt const is_ioctly) mk_lang_noexcept;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_accept_request_is_ready(mk_lib_net_accept_request_pt const accept_request, mk_lang_types_bool_pt const is_accepty) mk_lang_noexcept;
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_accept_request_wait_timeout(mk_lib_net_accept_request_pt const accept_request, mk_lang_types_sint_t const ms, mk_lang_types_bool_pt const is_accepty) mk_lang_noexcept;
