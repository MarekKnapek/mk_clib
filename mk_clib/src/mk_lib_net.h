...
union mk_lib_net_ipv4_address_data_u
{
	...
	mk_sl_cui_uint32_t m_u32s[((mk_lang_types_sint_t)(mk_sl_cui_uint32_size_bytes_v)) / ((mk_lang_types_sint_t)(mk_sl_cui_uint32_size_bytes_v))];
	...
	mk_lang_types_pchar_t m_pcs[((mk_lang_types_sint_t)(mk_sl_cui_uint32_size_bytes_v)) / ((mk_lang_types_sint_t)(mk_lang_sizeof_bi_pchar_t))];
};
...
#include "mk_lang_warning_msvc_push_c4820.h"
struct mk_lib_net_connect_request_s
{
	mk_lib_net_socket_pt m_socket;
	mk_win_dll_ws2_event_t m_event;
	mk_lib_net_destination_t m_destination;
};
typedef struct mk_lib_net_connect_request_s mk_lib_net_connect_request_t;
mk_lang_typedef(mk_lib_net_connect_request);
#include "mk_lang_warning_msvc_pop.h"
