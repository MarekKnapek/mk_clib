#ifndef mk_include_guard_mk_lib_crypto_any_piecewise_fuzz_c
#define mk_include_guard_mk_lib_crypto_any_piecewise_fuzz_c
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_crypto_any_piecewise_fuzz_hashers(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
...
#include "mk_lang_warning_msvc_push_c5045.h"
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_crypto_any_piecewise_fuzz_xofers(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	mk_lang_types_uchar_pct d;
	mk_lang_types_usize_t s;
	mk_lang_types_uint_t kind;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_crypto_any_piecewise_fuzz(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size, mk_lang_types_bool_t const allow_all) mk_lang_noexcept
{
	...
	base = __LINE__;
	curr = base + 2 + line;
	if(all || curr == ((mk_lang_types_uint_t)(__LINE__))){ err = mk_lib_crypto_any_piecewise_fuzz_hashers(d, s); mk_lang_check_rereturn(err); }
	if(all || curr == ((mk_lang_types_uint_t)(__LINE__))){ err = mk_lib_crypto_any_piecewise_fuzz_xofers(d, s); mk_lang_check_rereturn(err); }
	return 0;
}
