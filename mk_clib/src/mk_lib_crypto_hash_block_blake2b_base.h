#ifndef mk_include_guard_mk_lib_crypto_hash_block_blake2b_base_h
#define mk_include_guard_mk_lib_crypto_hash_block_blake2b_base_h
...
#define mk_lib_crypto_hash_block_blake2b_base_block_len_d 128
#define mk_lib_crypto_hash_block_blake2b_base_digest_len_d 64
enum mk_lib_crypto_hash_block_blake2b_base_block_len_e{ mk_lib_crypto_hash_block_blake2b_base_block_len_v = mk_lib_crypto_hash_block_blake2b_base_block_len_d }; typedef enum mk_lib_crypto_hash_block_blake2b_base_block_len_e mk_lib_crypto_hash_block_blake2b_base_block_len_t;
enum mk_lib_crypto_hash_block_blake2b_base_digest_len_e{ mk_lib_crypto_hash_block_blake2b_base_digest_len_v = mk_lib_crypto_hash_block_blake2b_base_digest_len_d }; typedef enum mk_lib_crypto_hash_block_blake2b_base_digest_len_e mk_lib_crypto_hash_block_blake2b_base_digest_len_t;


union mk_lib_crypto_hash_block_blake2b_base_block_data_u
{
	mk_lang_alignas(mk_lib_crypto_hash_block_blake2b_base_block_len_v) mk_sl_cui_uint8_t m_uint8s[mk_lib_crypto_hash_block_blake2b_base_block_len_v];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_blake2b_base_block_data_u mk_lib_crypto_hash_block_blake2b_base_block_data_t;
struct mk_lib_crypto_hash_block_blake2b_base_block_s
{
	mk_lib_crypto_hash_block_blake2b_base_block_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_blake2b_base_block_s mk_lib_crypto_hash_block_blake2b_base_block_t;
...
union mk_lib_crypto_hash_block_blake2b_base_digest_data_u
{
	mk_lang_alignas(mk_lib_crypto_hash_block_blake2b_base_digest_len_v) mk_sl_cui_uint8_t m_uint8s[mk_lib_crypto_hash_block_blake2b_base_digest_len_v];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_blake2b_base_digest_data_u mk_lib_crypto_hash_block_blake2b_base_digest_data_t;
struct mk_lib_crypto_hash_block_blake2b_base_digest_s
{
	mk_lib_crypto_hash_block_blake2b_base_digest_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_blake2b_base_digest_s mk_lib_crypto_hash_block_blake2b_base_digest_t;
