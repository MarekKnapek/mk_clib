...
mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall GetMessageA(mk_win_user_message_lpt, mk_win_user_window_t, mk_win_base_uint_t, mk_win_base_uint_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_user_window_lresult_t mk_win_base_stdcall DispatchMessageA(mk_win_user_message_lpct) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_user_window_lresult_t mk_win_base_stdcall SendMessageA(mk_win_user_window_t, mk_win_base_uint_t, mk_win_user_window_wparam_t, mk_win_user_window_lparam_t) mk_lang_noexcept;

mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall GetMessageW(mk_win_user_message_lpt, mk_win_user_window_t, mk_win_base_uint_t, mk_win_base_uint_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_user_window_lresult_t mk_win_base_stdcall DispatchMessageW(mk_win_user_message_lpct) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_user_window_lresult_t mk_win_base_stdcall SendMessageW(mk_win_user_window_t, mk_win_base_uint_t, mk_win_user_window_wparam_t, mk_win_user_window_lparam_t) mk_lang_noexcept;

mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall TranslateMessage(mk_win_user_message_lpct) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import void mk_win_base_stdcall PostQuitMessage(int) mk_lang_noexcept;
