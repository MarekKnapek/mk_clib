...
struct mk_lib_mt_unique_lock_portable_cpp_s
{
	typename std::aligned_storage<sizeof(std::unique_lock<std::mutex>), alignof(std::unique_lock<std::mutex>)>::type m_unique_lock;
};
typedef struct mk_lib_mt_unique_lock_portable_cpp_s mk_lib_mt_unique_lock_portable_cpp_t;
typedef mk_lib_mt_unique_lock_portable_cpp_t const mk_lib_mt_unique_lock_portable_cpp_ct;
typedef mk_lib_mt_unique_lock_portable_cpp_t* mk_lib_mt_unique_lock_portable_cpp_pt;
typedef mk_lib_mt_unique_lock_portable_cpp_t const* mk_lib_mt_unique_lock_portable_cpp_pct;
