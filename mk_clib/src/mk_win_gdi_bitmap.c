...
mk_lang_extern_c mk_win_base_dll_import mk_win_gdi_bitmap_t mk_win_base_stdcall CreateCompatibleBitmap(mk_win_gdi_dc_t, int, int) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall BitBlt(mk_win_gdi_dc_t, int, int, int, int, mk_win_gdi_dc_t, int, int, mk_win_base_dword_t) mk_lang_noexcept;
