...
{
	union mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_to_u8s_be_data_u
	{
		mk_lang_types_uchar_t m_uchars[mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_size_bytes_v];
		mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_t m_pri_single;
	};
	typedef union mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_to_u8s_be_data_u mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_to_u8s_be_data_t;
	struct mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_to_u8s_be_s
	{
		mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_to_u8s_be_data_t m_data;
	};
	typedef struct mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_to_u8s_be_s mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_to_u8s_be_t;

	mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_to_u8s_be_t storage mk_lang_constexpr_init;

	mk_lang_assert(a);
	mk_lang_assert(b);

	mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_to_buis_uchar_be(a, &storage.m_data.m_uchars[0]);
	mk_sl_cui_uint8_from_bi_uchar_many(&b[0], &storage.m_data.m_uchars[0], mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_size_bytes_v);
}
