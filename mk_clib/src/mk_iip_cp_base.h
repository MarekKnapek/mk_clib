...
union mk_iip_cp_base_elgamal_key_pri_data_u
{
	mk_iip_cp_helper_cui_elgamal_single_t m_val;
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_iip_cp_base_elgamal_key_pri_data_u mk_iip_cp_base_elgamal_key_pri_data_t;

struct mk_iip_cp_base_elgamal_key_pri_s
{
	mk_iip_cp_base_elgamal_key_pri_data_t m_data;
};
typedef struct mk_iip_cp_base_elgamal_key_pri_s mk_iip_cp_base_elgamal_key_pri_t;
typedef mk_iip_cp_base_elgamal_key_pri_t const mk_iip_cp_base_elgamal_key_pri_ct;
typedef mk_iip_cp_base_elgamal_key_pri_t* mk_iip_cp_base_elgamal_key_pri_pt;
typedef mk_iip_cp_base_elgamal_key_pri_t const* mk_iip_cp_base_elgamal_key_pri_pct;

union mk_iip_cp_base_elgamal_key_pub_data_u
{
	mk_iip_cp_helper_cui_elgamal_single_t m_val;
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_iip_cp_base_elgamal_key_pub_data_u mk_iip_cp_base_elgamal_key_pub_data_t;

struct mk_iip_cp_base_elgamal_key_pub_s
{
	mk_iip_cp_base_elgamal_key_pub_data_t m_data;
};
typedef struct mk_iip_cp_base_elgamal_key_pub_s mk_iip_cp_base_elgamal_key_pub_t;
typedef mk_iip_cp_base_elgamal_key_pub_t const mk_iip_cp_base_elgamal_key_pub_ct;
typedef mk_iip_cp_base_elgamal_key_pub_t* mk_iip_cp_base_elgamal_key_pub_pt;
typedef mk_iip_cp_base_elgamal_key_pub_t const* mk_iip_cp_base_elgamal_key_pub_pct;

union mk_iip_cp_base_dsa_key_pri_data_u
{
	mk_iip_cp_helper_cui_dsa_pri_single_t m_val;
	mk_lang_types_ulllong_t m_align;
};
...
{
	mk_iip_cp_helper_cui_dsa_pub_single_t m_val;
	mk_lang_types_ulllong_t m_align;
};
...
{
	mk_iip_cp_helper_cui_dsa_pri_single_t m_r;
	mk_iip_cp_helper_cui_dsa_pri_single_t m_s;
};
...
enum mk_iip_cp_base_dsa_signature_len_e { mk_iip_cp_base_dsa_signature_len_v = 2 * mk_iip_cp_helper_cui_dsa_pri_single_sizebytes_v }; typedef enum mk_iip_cp_base_dsa_signature_len_e mk_iip_cp_base_dsa_signature_len_t;
