...
mm_per_bi(`#undef mk_sl_cui_inl_defd_base_from_bi_')
`#'undef mk_sl_cui_inl_defd_base_to_base
mm_per_bi(`#undef mk_sl_cui_inl_defd_base_to_bi_')
mm_per_bui(`#undef mk_sl_cui_inl_defd_base_from_buis_')
mm_per_bui(`#undef mk_sl_cui_inl_defd_base_to_buis_')
mm_per_bui(`#undef mk_sl_cui_inl_defd_base_from_buis_')
mm_per_bui(`#undef mk_sl_cui_inl_defd_base_to_buis_')
...
`#'undef mk_sl_cui_inl_defd_pprt
`#'undef mk_sl_cui_inl_defd_pprct
...
mm_per_bi(`#undef mk_sl_cui_inl_defd_from_bi_')
`#'undef mk_sl_cui_inl_defd_to_base
mm_per_bi(`#undef mk_sl_cui_inl_defd_to_bi_')
mm_per_bui(`#undef mk_sl_cui_inl_defd_from_buis_')
mm_per_bui(`#undef mk_sl_cui_inl_defd_to_buis_')
mm_per_bui(`#undef mk_sl_cui_inl_defd_from_buis_')
mm_per_bui(`#undef mk_sl_cui_inl_defd_to_buis_')
...
`#'undef mk_sl_cui_inl_defd_mul3_wrap_wi_restrict
`#'undef mk_sl_cui_inl_defd_mul3_wrap_wi_alias
