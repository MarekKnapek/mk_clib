...
#else
	mk_lang_assert(x);
	mk_lang_assert(bit_idx >= 0 && bit_idx < ((int)(mk_sl_cui_inl_defd_count * mk_sl_cui_inl_defd_base_bits)));
...
mk_lang_jumbo void mk_sl_cui_inl_defd_set_mask(mk_sl_cui_inl_defd_t* const x, int const bits_count) mk_lang_noexcept
{
	...
	mk_lang_assert(x);
	mk_lang_assert(bits_count >= 1 && bits_count <= ((int)(mk_sl_cui_inl_defd_count * mk_sl_cui_inl_defd_base_bits)));
