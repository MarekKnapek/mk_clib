...
#if defined mk_lib_crypto_hash_block_streebog_base__fastwant
#if (mk_lib_crypto_hash_block_streebog_base__fastwant) == 0
#define mk_lib_crypto_hash_block_streebog_base_fast_have 0
#elif (mk_lib_crypto_hash_block_streebog_base__fastwant) == 1
#define mk_lib_crypto_hash_block_streebog_base_fast_have 1
#else
#error xxxxxxxxxx
#endif
#else
...
#if mk_lib_crypto_hash_block_streebog_base_fast_have
