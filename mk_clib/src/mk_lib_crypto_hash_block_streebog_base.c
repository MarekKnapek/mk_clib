#ifndef mk_include_guard_mk_lib_crypto_hash_block_streebog_base_c
#define mk_include_guard_mk_lib_crypto_hash_block_streebog_base_c
...
#if defined mk_lib_crypto_hash_block_streebog_base_want_fast
#if (mk_lib_crypto_hash_block_streebog_base_want_fast) == 0
#define mk_lib_crypto_hash_block_streebog_base_have_fast 0
#elif (mk_lib_crypto_hash_block_streebog_base_want_fast) == 1
#define mk_lib_crypto_hash_block_streebog_base_have_fast 1
#else
#error xxxxxxxxxx
#endif
#else
...
#define mk_lib_crypto_hash_block_streebog_base_nrounds 12


union mk_lib_crypto_hash_block_streebog_base_table_pi_data_u
{
	mk_sl_cui_uint8_t m_uint8s[0xff + 1];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_streebog_base_table_pi_data_u mk_lib_crypto_hash_block_streebog_base_table_pi_data_t;
struct mk_lib_crypto_hash_block_streebog_base_table_pi_s
{
	mk_lang_alignas(sizeof(mk_lib_crypto_hash_block_streebog_base_table_pi_data_t)) mk_lib_crypto_hash_block_streebog_base_table_pi_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_streebog_base_table_pi_s mk_lib_crypto_hash_block_streebog_base_table_pi_t;

union mk_lib_crypto_hash_block_streebog_base_table_tau_data_u
{
	mk_sl_cui_uint8_t m_uint8s[64];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_streebog_base_table_tau_data_u mk_lib_crypto_hash_block_streebog_base_table_tau_data_t;
struct mk_lib_crypto_hash_block_streebog_base_table_tau_s
{
	mk_lang_alignas(sizeof(mk_lib_crypto_hash_block_streebog_base_table_tau_data_t)) mk_lib_crypto_hash_block_streebog_base_table_tau_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_streebog_base_table_tau_s mk_lib_crypto_hash_block_streebog_base_table_tau_t;

#if mk_lib_crypto_hash_block_streebog_base_have_fast

union mk_lib_crypto_hash_block_streebog_base_table_a_data_u
{
	mk_sl_cui_uint64_t m_uint64s[0xff + 1];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_streebog_base_table_a_data_u mk_lib_crypto_hash_block_streebog_base_table_a_data_t;
struct mk_lib_crypto_hash_block_streebog_base_table_a_s
{
	mk_lang_alignas(sizeof(mk_lib_crypto_hash_block_streebog_base_table_a_data_t)) mk_lib_crypto_hash_block_streebog_base_table_a_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_streebog_base_table_a_s mk_lib_crypto_hash_block_streebog_base_table_a_t;

union mk_lib_crypto_hash_block_streebog_base_tables_a_data_u
{
	mk_lib_crypto_hash_block_streebog_base_table_a_t m_tables[8];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_streebog_base_tables_a_data_u mk_lib_crypto_hash_block_streebog_base_tables_a_data_t;
struct mk_lib_crypto_hash_block_streebog_base_tables_a_s
{
	mk_lang_alignas(sizeof(mk_lib_crypto_hash_block_streebog_base_tables_a_data_t)) mk_lib_crypto_hash_block_streebog_base_tables_a_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_streebog_base_tables_a_s mk_lib_crypto_hash_block_streebog_base_tables_a_t;

#else

union mk_lib_crypto_hash_block_streebog_base_table_a_data_u
{
	mk_sl_cui_uint64_t m_uint64s[64];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_streebog_base_table_a_data_u mk_lib_crypto_hash_block_streebog_base_table_a_data_t;
struct mk_lib_crypto_hash_block_streebog_base_table_a_s
...
union mk_lib_crypto_hash_block_streebog_base_table_fast_data_u
{
	mk_sl_cui_uint64_t m_uint64s[0xff + 1];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_streebog_base_table_fast_data_u mk_lib_crypto_hash_block_streebog_base_table_fast_data_t;
struct mk_lib_crypto_hash_block_streebog_base_table_fast_s
{
	mk_lang_alignas(sizeof(mk_lib_crypto_hash_block_streebog_base_table_fast_data_t)) mk_lib_crypto_hash_block_streebog_base_table_fast_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_streebog_base_table_fast_s mk_lib_crypto_hash_block_streebog_base_table_fast_t;

union mk_lib_crypto_hash_block_streebog_base_tables_fast_data_u
{
	mk_lib_crypto_hash_block_streebog_base_table_fast_t m_tables_fast[8];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_streebog_base_tables_fast_data_u mk_lib_crypto_hash_block_streebog_base_tables_fast_data_t;
struct mk_lib_crypto_hash_block_streebog_base_tables_fast_s
{
	mk_lang_alignas(sizeof(mk_lib_crypto_hash_block_streebog_base_tables_fast_data_t)) mk_lib_crypto_hash_block_streebog_base_tables_fast_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_streebog_base_tables_fast_s mk_lib_crypto_hash_block_streebog_base_tables_fast_t;

union mk_lib_crypto_hash_block_streebog_base_table_c_data_u
{
	mk_lib_crypto_hash_block_streebog_base_block2_t m_block;
	mk_sl_cui_uint64_t m_uint64s[8];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_streebog_base_table_c_data_u mk_lib_crypto_hash_block_streebog_base_table_c_data_t;
struct mk_lib_crypto_hash_block_streebog_base_table_c_s
{
	mk_lang_alignas(sizeof(mk_lib_crypto_hash_block_streebog_base_table_c_data_t)) mk_lib_crypto_hash_block_streebog_base_table_c_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_streebog_base_table_c_s mk_lib_crypto_hash_block_streebog_base_table_c_t;

union mk_lib_crypto_hash_block_streebog_base_tables_c_data_u
{
	mk_lib_crypto_hash_block_streebog_base_table_c_t m_tables[mk_lib_crypto_hash_block_streebog_base_nrounds];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_streebog_base_tables_c_data_u mk_lib_crypto_hash_block_streebog_base_tables_c_data_t;
struct mk_lib_crypto_hash_block_streebog_base_tables_c_s
{
	mk_lang_alignas(sizeof(mk_lib_crypto_hash_block_streebog_base_table_c_t)) mk_lib_crypto_hash_block_streebog_base_tables_c_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_streebog_base_tables_c_s mk_lib_crypto_hash_block_streebog_base_tables_c_t;


mk_lang_constexpr_static_inline mk_lib_crypto_hash_block_streebog_base_table_pi_t const mk_lib_crypto_hash_block_streebog_base_k_pi =
{{{
...
mk_lang_constexpr_static_inline mk_lib_crypto_hash_block_streebog_base_table_tau_t const mk_lib_crypto_hash_block_streebog_base_k_tau =
{{{
...
mk_lang_constexpr_static_inline mk_lib_crypto_hash_block_streebog_base_tables_fast_t const mk_lib_crypto_hash_block_streebog_base_k_pi_fast =
{{{
	{{{
...
mk_lang_constexpr_static_inline mk_lib_crypto_hash_block_streebog_base_tables_a_t const mk_lib_crypto_hash_block_streebog_base_k_a =
{{{
	{{{
		mk_sl_cui_uint64_c(0x00000000ul, 0x00000000ul), mk_sl_cui_uint64_c(0x641c314bul, 0x2b8ee083ul), mk_sl_cui_uint64_c(0xc8386296ul, 0x5601dd1bul), mk_sl_cui_uint64_c(0xac2453ddul, 0x7d8f3d98ul),
		mk_sl_cui_uint64_c(0x8d70c431ul, 0xac02a736ul), mk_sl_cui_uint64_c(0xe96cf57aul, 0x878c47b5ul), mk_sl_cui_uint64_c(0x4548a6a7ul, 0xfa037a2dul), mk_sl_cui_uint64_c(0x215497ecul, 0xd18d9aaeul),
...
mk_lang_constexpr_static_inline mk_lib_crypto_hash_block_streebog_base_table_a_t const mk_lib_crypto_hash_block_streebog_base_k_a =
{{{
...
mk_lang_constexpr_static_inline mk_lib_crypto_hash_block_streebog_base_tables_c_t const mk_lib_crypto_hash_block_streebog_base_k_c =
{{{
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_streebog_base_ss(mk_sl_cui_uint64_pct const a, mk_sl_cui_uint64_pt  const b) mk_lang_noexcept
{
	union mk_lib_crypto_hash_block_streebog_base_ss_convert_data_u
	{
		mk_lang_types_uchar_t m_uchars[mk_sl_cui_uint64_size_bytes_v];
		mk_sl_cui_uint64_t m_align;
	};
	typedef union mk_lib_crypto_hash_block_streebog_base_ss_convert_data_u mk_lib_crypto_hash_block_streebog_base_ss_convert_data_t;
	struct mk_lib_crypto_hash_block_streebog_base_ss_convert_s
	{
		mk_lib_crypto_hash_block_streebog_base_ss_convert_data_t m_data;
	};
	typedef struct mk_lib_crypto_hash_block_streebog_base_ss_convert_s mk_lib_crypto_hash_block_streebog_base_ss_convert_t;

	mk_lib_crypto_hash_block_streebog_base_ss_convert_t convert mk_lang_constexpr_init;
	...
	mk_sl_cui_uint64_to_buis_uchar_le(a, &convert.m_data.m_uchars[0]);
	n = mk_sl_cui_uint64_size_bytes_v;
	for(i = 0; i != n; ++i)
	{
		mk_sl_cui_uint8_to_bi_uchar(&mk_lib_crypto_hash_block_streebog_base_k_pi.m_data.m_uint8s[convert.m_data.m_uchars[i]], &convert.m_data.m_uchars[i]);
	}
	mk_sl_cui_uint64_from_buis_uchar_le(b, &convert.m_data.m_uchars[0]);
}
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_streebog_base_s(mk_lib_crypto_hash_block_streebog_base_block2_pct const a, mk_lib_crypto_hash_block_streebog_base_block2_pt const b) mk_lang_noexcept
{
	...
	n = mk_lang_countof(a->m_data.m_uint64s);
	for(i = 0; i != n; ++i)
	{
		mk_lib_crypto_hash_block_streebog_base_ss(&a->m_data.m_uint64s[i], &b->m_data.m_uint64s[i]);
	}
}
...
{
	union mk_lib_crypto_hash_block_streebog_base_p_convert_data_u
	{
		mk_sl_cui_uint8_t m_uint8s[mk_sl_cui_uint64_size_bytes_v];
		mk_sl_cui_uint64_t m_align;
	};
	typedef union mk_lib_crypto_hash_block_streebog_base_p_convert_data_u mk_lib_crypto_hash_block_streebog_base_p_convert_data_t;
	struct mk_lib_crypto_hash_block_streebog_base_p_convert_s
	{
		mk_lib_crypto_hash_block_streebog_base_p_convert_data_t m_data;
	};
	typedef struct mk_lib_crypto_hash_block_streebog_base_p_convert_s mk_lib_crypto_hash_block_streebog_base_p_convert_t;
	...
	mk_lib_crypto_hash_block_streebog_base_p_convert_t convert mk_lang_constexpr_init;

	mk_lang_assert(a);
	mk_lang_assert(b);

	mk_sl_uint_convert_64_8_le_to_sml_multi(&a->m_data.m_uint64s[0], &t.m_data.m_uint8s[0], mk_lang_countof(a->m_data.m_uint64s));
	n = mk_lang_countof(a->m_data.m_uint64s);
	for(i = 0; i != n; ++i)
	{
		m = mk_sl_cui_uint64_size_bytes_v;
		for(j = 0; j != m; ++j)
		{
			mk_sl_cui_uint8_to_bi_uchar(&mk_lib_crypto_hash_block_streebog_base_k_tau.m_data.m_uint8s[i * n + j], &tuc);
			convert.m_data.m_uint8s[j] = t.m_data.m_uint8s[tuc];
		}
		mk_sl_uint_convert_64_8_le_to_big(&b->m_data.m_uint64s[i], &convert.m_data.m_uint8s[0]);
	}
}
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_streebog_base_l(mk_lib_crypto_hash_block_streebog_base_block2_pct const a, mk_lib_crypto_hash_block_streebog_base_block2_pt const b) mk_lang_noexcept
{
	...
	for(i = 0; i != n; ++i)
	{
		ta = a->m_data.m_uint64s[i];
		mk_sl_cui_uint64_to_bi_uchar(&ta, &tuc);
		b->m_data.m_uint64s[i] = mk_lib_crypto_hash_block_streebog_base_k_a.m_data.m_tables[0].m_data.m_uint64s[tuc];
		m = mk_sl_cui_uint64_size_bytes_v;
		for(j = 1; j != m; ++j)
		{
			mk_sl_cui_uint64_shr2(&ta, mk_lang_charbit);
			mk_sl_cui_uint64_to_bi_uchar(&ta, &tuc);
			mk_sl_cui_uint64_xor2(&b->m_data.m_uint64s[i], &mk_lib_crypto_hash_block_streebog_base_k_a.m_data.m_tables[j].m_data.m_uint64s[tuc]);
		}
	}
#else
	mk_lang_types_sint_t n mk_lang_constexpr_init;
	...
	{
		ta = a->m_data.m_uint64s[i];
		mk_sl_cui_uint64_set_zero(&b->m_data.m_uint64s[i]);
		m = mk_sl_cui_uint64_size_bits_v;
		for(j = 0; j != m; ++j)
		{
			if(mk_sl_cui_uint64_has_lsb(&ta))
			{
				mk_sl_cui_uint64_xor2(&b->m_data.m_uint64s[i], &mk_lib_crypto_hash_block_streebog_base_k_a.m_data.m_uint64s[(mk_sl_cui_uint64_size_bits_v - 1) - j]);
			}
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_streebog_base_block2_xor2(mk_lib_crypto_hash_block_streebog_base_block2_pt const a, mk_lib_crypto_hash_block_streebog_base_block2_pct const b) mk_lang_noexcept
{
	...
	mk_lib_crypto_bitops_bulk_uint64_8_xor2(&a->m_data.m_uint64s[0], &b->m_data.m_uint64s[0]);
}
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_streebog_base_block2_xor3(mk_lib_crypto_hash_block_streebog_base_block2_pct const a, mk_lib_crypto_hash_block_streebog_base_block2_pct const b, mk_lib_crypto_hash_block_streebog_base_block2_pt const c) mk_lang_noexcept
{
	...
	mk_lib_crypto_bitops_bulk_uint64_8_xor3(&a->m_data.m_uint64s[0], &b->m_data.m_uint64s[0], &c->m_data.m_uint64s[0]);
}
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_streebog_base_k(mk_lib_crypto_hash_block_streebog_base_block2_pct const a, mk_lang_types_sint_t const b, mk_lib_crypto_hash_block_streebog_base_block2_pt const c) mk_lang_noexcept
{
	...
	mk_lang_assert(a);
	mk_lang_assert(b >= 0 && b < mk_lib_crypto_hash_block_streebog_base_nrounds);
	mk_lang_assert(c);

	mk_lib_crypto_hash_block_streebog_base_block2_xor3(a, &mk_lib_crypto_hash_block_streebog_base_k_c.m_data.m_tables[b].m_data.m_block, &t);
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_streebog_base_e(mk_lib_crypto_hash_block_streebog_base_block2_pct const k, mk_lib_crypto_hash_block_streebog_base_block2_pct const m, mk_lib_crypto_hash_block_streebog_base_block2_pt const e) mk_lang_noexcept
{
	...
	k_curr = ((mk_lib_crypto_hash_block_streebog_base_block2_pt)(k));
	pta = ((mk_lib_crypto_hash_block_streebog_base_block2_pt)(m));
	ptb = &ta;
	k_next = &tb;
	...
	for(i = 1; i != mk_lib_crypto_hash_block_streebog_base_nrounds - 1; ++i)
	{
		mk_lib_crypto_hash_block_streebog_base_lps(pta, ptb); ptc = pta; pta = ptb; ptb = ptc;
	...
	mk_lib_crypto_hash_block_streebog_base_lps(pta, ptb); ptc = pta; pta = ptb; ptb = ptc;
	mk_lib_crypto_hash_block_streebog_base_k(k_curr, i, k_next); ptc = k_curr; k_curr = k_next; k_next = ptc;
	mk_lib_crypto_hash_block_streebog_base_x(k_curr, pta, e);
}
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_streebog_base_block2_add_sint(mk_lib_crypto_hash_block_streebog_base_block2_pt const a, mk_lang_types_sint_t const nbytes) mk_lang_noexcept
{
	...
	mk_lang_assert(a);
	mk_lang_assert(nbytes >= 0);
	mk_lang_assert(nbytes <= mk_lang_limits_sint_max / mk_lang_charbit);

	nbits = nbytes * mk_lang_charbit;
	mk_sl_cui_uint64_from_bi_sint(&tu64, &nbits);
	mk_sl_cui_uint64_add2_wrap_cid_coe(&a->m_data.m_uint64s[0], &tu64, &cf);
	if(cf)
	{
		mk_sl_cui_uint64_inc1(&a->m_data.m_uint64s[1]);
		for(i = 2; i != mk_lang_countof(a->m_data.m_uint64s) && mk_sl_cui_uint64_is_zero(&a->m_data.m_uint64s[i - 1]); ++i)
		{
			mk_sl_cui_uint64_inc1(&a->m_data.m_uint64s[i]);
		}
	}
}
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_streebog_base_block2_add2(mk_lib_crypto_hash_block_streebog_base_block2_pt const a, mk_lib_crypto_hash_block_streebog_base_block2_pct const b) mk_lang_noexcept
{
	...
	i = 0;
	mk_sl_cui_uint64_add2_wrap_cid_coe(&a->m_data.m_uint64s[i], &b->m_data.m_uint64s[i], &c);
	for(i = 1; i != mk_lang_countof(a->m_data.m_uint64s) - 1; ++i)
	{
		mk_sl_cui_uint64_add2_wrap_cie_coe(&a->m_data.m_uint64s[i], &b->m_data.m_uint64s[i], c, &c);
	}
	mk_sl_cui_uint64_add2_wrap_cie_cod(&a->m_data.m_uint64s[i], &b->m_data.m_uint64s[i], c);
}
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_streebog_base_stage_2(mk_lib_crypto_hash_block_streebog_base_pt const streebog_base, mk_lib_crypto_hash_block_streebog_base_block2_pct const block) mk_lang_noexcept
{
	...
	mk_lib_crypto_hash_block_streebog_base_g(&streebog_base->m_state.m_data.m_n, &streebog_base->m_state.m_data.m_h, block, &streebog_base->m_state.m_data.m_h);
	mk_lib_crypto_hash_block_streebog_base_block2_add_sint(&streebog_base->m_state.m_data.m_n, mk_lib_crypto_hash_block_streebog_base_block_len_v);
	mk_lib_crypto_hash_block_streebog_base_block2_add2(&streebog_base->m_state.m_data.m_s, block);
}
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_streebog_base_erase_block(mk_lib_crypto_hash_block_streebog_base_block2_pt const block) mk_lang_noexcept
{
	...
	mk_lib_crypto_bitops_bulk_uint64_8_memclr(&block->m_data.m_uint64s[0]);
}
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_streebog_base_append_blocks(mk_lib_crypto_hash_block_streebog_base_pt const streebog_base, mk_lib_crypto_hash_block_streebog_base_block_pct const pblocks, mk_lang_types_usize_t const nblocks) mk_lang_noexcept
{
	...
	mk_lang_static_assert(sizeof(mk_lib_crypto_hash_block_streebog_base_block2_t) == sizeof(mk_lib_crypto_hash_block_streebog_base_block_t));
	mk_lang_static_assert(mk_lang_alignof(mk_lib_crypto_hash_block_streebog_base_block2_t) == mk_lang_alignof(mk_lib_crypto_hash_block_streebog_base_block_t));
	...
	mk_lang_assert(nblocks <= mk_lang_limits_usize_max / mk_lib_crypto_hash_block_streebog_base_block_len_v);
	#include "mk_lang_warning_gcc_pop.h"
	#include "mk_lang_warning_msvc_pop.h"

	for(iblock = 0; iblock != nblocks; ++iblock)
	{
		mk_sl_uint_convert_64_8_le_to_big_multi(&block.m_data.m_uint64s[0], &pblocks[iblock].m_data.m_uint8s[0], mk_lang_countof(block.m_data.m_uint64s));
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_streebog_base_stage_3(mk_lib_crypto_hash_block_streebog_base_pt const streebog_base, mk_lib_crypto_hash_block_streebog_base_block_pt const block, mk_lang_types_sint_t const idx) mk_lang_noexcept
{
	...
	mk_lang_assert(streebog_base);
	mk_lang_assert(block);
	mk_lang_assert(idx >= 0 && idx < mk_lib_crypto_hash_block_streebog_base_block_len_v);

	tuc = 0x01; mk_sl_cui_uint8_from_bi_uchar(&block->m_data.m_uint8s[idx], &tuc);
	mk_sl_cui_uint8_memclr_fn(&block->m_data.m_uint8s[idx + 1], ((mk_lang_types_usize_t)(mk_lib_crypto_hash_block_streebog_base_block_len_v - 1 - idx)));
	mk_sl_uint_convert_64_8_le_to_big_multi(&blck.m_data.m_uint64s[0], &block->m_data.m_uint8s[0], mk_lang_countof(blck.m_data.m_uint64s));
	mk_lib_crypto_hash_block_streebog_base_g(&streebog_base->m_state.m_data.m_n, &streebog_base->m_state.m_data.m_h, &blck, &streebog_base->m_state.m_data.m_h);
	mk_lib_crypto_hash_block_streebog_base_block2_add_sint(&streebog_base->m_state.m_data.m_n, idx);
	mk_lib_crypto_hash_block_streebog_base_block2_add2(&streebog_base->m_state.m_data.m_s, &blck);
	mk_lib_crypto_bitops_bulk_uint64_8_memclr(&zero.m_data.m_uint64s[0]);
	mk_lib_crypto_hash_block_streebog_base_g(&zero, &streebog_base->m_state.m_data.m_h, &streebog_base->m_state.m_data.m_n, &streebog_base->m_state.m_data.m_h);
	mk_lib_crypto_hash_block_streebog_base_g(&zero, &streebog_base->m_state.m_data.m_h, &streebog_base->m_state.m_data.m_s, &streebog_base->m_state.m_data.m_h);
}
