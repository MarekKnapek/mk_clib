...
mk_lang_nodiscard static mk_lang_inline mk_win_main_heap_counts_t mk_win_main_heap_get_allocated_blocks(void) mk_lang_noexcept;
mk_lang_nodiscard static mk_lang_inline mk_win_main_heap_counts_t mk_win_main_heap_get_deallocated_blocks(void) mk_lang_noexcept;
mk_lang_nodiscard static mk_lang_inline mk_win_main_heap_counts_t mk_win_main_heap_get_live_blocks(void) mk_lang_noexcept;
mk_lang_nodiscard static mk_lang_inline mk_win_main_heap_countl_t mk_win_main_heap_get_allocated_bytes(void) mk_lang_noexcept;
mk_lang_nodiscard static mk_lang_inline mk_win_main_heap_countl_t mk_win_main_heap_get_deallocated_bytes(void) mk_lang_noexcept;
mk_lang_nodiscard static mk_lang_inline mk_win_main_heap_countl_t mk_win_main_heap_get_live_bytes(void) mk_lang_noexcept;
#endif 
...
mk_lang_jumbo void mk_win_main_heap_destroy(void) mk_lang_noexcept
{
	...
	#if mk_win_main_heap_want_statistics_impl
	mk_lang_assert(mk_win_main_heap_get_live_blocks() == 0);
	mk_lang_assert(mk_win_main_heap_get_live_bytes() == 0);
	#endif
...
mk_lang_jumbo void mk_win_main_heap_reallocate(mk_lang_exception_t* const ex, mk_win_base_void_lpct const old_mem, mk_win_base_size_t const old_size_bytes, mk_win_base_size_t const new_size_bytes, mk_win_base_void_lpt* const new_mem) mk_lang_noexcept
{
	...
	*new_mem = m;
	#if mk_win_main_heap_want_statistics_impl
	g_mk_win_main_heap_allocated_blocks += 1;
	g_mk_win_main_heap_allocated_bytes += new_size_bytes;
	g_mk_win_main_heap_deallocated_blocks += 1;
	g_mk_win_main_heap_deallocated_bytes += old_size_bytes;
	#endif
}

mk_lang_jumbo void mk_win_main_heap_size(mk_win_base_void_lpct const mem, mk_win_base_size_t* const size_bytes) mk_lang_noexcept
{
	mk_win_base_size_t s;

	mk_lang_assert(g_mk_win_main_heap);
	mk_lang_assert(mem);
	mk_lang_assert(size_bytes);

	s = mk_win_kernel_heap_size(g_mk_win_main_heap, mk_win_kernel_heap_size_flags_e_none, mem);
	*size_bytes = s;
}
...
mk_lang_nodiscard static mk_lang_inline mk_win_main_heap_counts_t mk_win_main_heap_get_live_blocks(void) mk_lang_noexcept
{
	mk_lang_assert(mk_win_main_heap_get_allocated_blocks() >= mk_win_main_heap_get_deallocated_blocks());

	return mk_win_main_heap_get_allocated_blocks() - mk_win_main_heap_get_deallocated_blocks();
}
...
mk_lang_nodiscard static mk_lang_inline mk_win_main_heap_countl_t mk_win_main_heap_get_live_bytes(void) mk_lang_noexcept
{
	mk_lang_assert(mk_win_main_heap_get_allocated_bytes() >= mk_win_main_heap_get_deallocated_bytes());

	return mk_win_main_heap_get_allocated_bytes() - mk_win_main_heap_get_deallocated_bytes();
}
