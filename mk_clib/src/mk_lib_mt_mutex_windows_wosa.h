#ifndef mk_include_guard_mk_lib_mt_mutex_windows_wosa
#define mk_include_guard_mk_lib_mt_mutex_windows_wosa
...
struct mk_lib_mt_mutex_windows_wosa_s
{
	mk_win_base_slong_t m_mutex;
};
typedef struct mk_lib_mt_mutex_windows_wosa_s mk_lib_mt_mutex_windows_wosa_t;
typedef mk_lib_mt_mutex_windows_wosa_t const mk_lib_mt_mutex_windows_wosa_ct;
typedef mk_lib_mt_mutex_windows_wosa_t* mk_lib_mt_mutex_windows_wosa_pt;
typedef mk_lib_mt_mutex_windows_wosa_t const* mk_lib_mt_mutex_windows_wosa_pct;
...
#include "mk_lib_mt_mutex_windows_wosa.c"
#endif
#endif
