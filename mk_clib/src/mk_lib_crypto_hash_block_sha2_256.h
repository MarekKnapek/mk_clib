...
typedef mk_lib_crypto_hash_block_sha2_32bit_aligned64_t mk_lib_crypto_hash_block_sha2_256_block_t;
...
typedef mk_lib_crypto_hash_block_sha2_32bit_aligned32_t mk_lib_crypto_hash_block_sha2_256_digest_t;
