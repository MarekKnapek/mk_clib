...
{
	mk_lib_cpp_constexpr_array_t<mk_lang_types_uchar_t, mk_lib_crypto_mode_ofb_aes_128_msg_len_v> iv_bytes mk_lang_constexpr_init;
	mk_lib_cpp_constexpr_array_t<mk_lang_types_uchar_t, mk_lib_crypto_mode_ofb_aes_128_key_len_v> key_bytes mk_lang_constexpr_init;
	...
	mk_lib_crypto_mode_ofb_aes_128_msg_t msg mk_lang_constexpr_init;
	mk_lang_types_usize_t i mk_lang_constexpr_init;
	mk_lib_crypto_mode_ofb_aes_128_t mode mk_lang_constexpr_init;
	...
	for(i = 0; i != mk_lib_crypto_mode_ofb_aes_128_msg_len_v; ++i){ iv.m_data.m_uchars[i] = iv_bytes[i]; }
	mk_lib_crypto_mode_ofb_aes_128_init(&mode, &iv);
	for(i = 0; i != mk_lib_crypto_mode_ofb_aes_128_key_len_v; ++i){ key.m_data.m_uchars[i] = key_bytes[i]; }
	for(j = 0; j != ((msg_lit_len - 1) / 2) / mk_lib_crypto_mode_ofb_aes_128_msg_len_v; ++j)
	{
		for(i = 0; i != mk_lib_crypto_mode_ofb_aes_128_msg_len_v; ++i){ msg.m_data.m_uchars[i] = msg_bytes[j * mk_lib_crypto_mode_ofb_aes_128_msg_len_v + i]; }
		mk_lib_crypto_mode_ofb_aes_128_encrypt(&mode, &key, &msg, &msg);
		for(i = 0; i != mk_lib_crypto_mode_ofb_aes_128_msg_len_v; ++i){ out_bytes[j * mk_lib_crypto_mode_ofb_aes_128_msg_len_v + i] = msg.m_data.m_uchars[i]; }
	}
	return out_bytes;
}

template<mk_lang_types_usize_t iv_lit_len, mk_lang_types_usize_t key_lit_len, mk_lang_types_usize_t msg_bytes_len>
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_mode_ofb_aes_128_test_decrypt_from_str_lit(char const(&iv_lit)[iv_lit_len], char const(&key_lit)[key_lit_len], mk_lib_cpp_constexpr_array_t<mk_lang_types_uchar_t, msg_bytes_len> const& msg_bytes) mk_lang_noexcept
{
	mk_lib_cpp_constexpr_array_t<mk_lang_types_uchar_t, mk_lib_crypto_mode_ofb_aes_128_msg_len_v> iv_bytes mk_lang_constexpr_init;
	mk_lib_cpp_constexpr_array_t<mk_lang_types_uchar_t, mk_lib_crypto_mode_ofb_aes_128_key_len_v> key_bytes mk_lang_constexpr_init;
	mk_lib_crypto_mode_ofb_aes_128_msg_t iv mk_lang_constexpr_init;
	...
	mk_lib_crypto_mode_ofb_aes_128_init(&mode, &iv);
	for(i = 0; i != mk_lib_crypto_mode_ofb_aes_128_key_len_v; ++i){ key.m_data.m_uchars[i] = key_bytes[i]; }
	for(j = 0; j != msg_bytes_len / mk_lib_crypto_mode_ofb_aes_128_msg_len_v; ++j)
	{
		for(i = 0; i != mk_lib_crypto_mode_ofb_aes_128_msg_len_v; ++i){ msg.m_data.m_uchars[i] = msg_bytes[j * mk_lib_crypto_mode_ofb_aes_128_msg_len_v + i]; }
		mk_lib_crypto_mode_ofb_aes_128_decrypt(&mode, &key, &msg, &msg);
		for(i = 0; i != mk_lib_crypto_mode_ofb_aes_128_msg_len_v; ++i){ out_bytes[j * mk_lib_crypto_mode_ofb_aes_128_msg_len_v + i] = msg.m_data.m_uchars[i]; }
	}
	return out_bytes;
}
...
mk_lang_extern_c void mk_lib_crypto_mode_ofb_aes_128_test(void) mk_lang_noexcept
{
	...
	mk_lang_constexpr_static auto const s_out_computed_1 = mk_lib_crypto_mode_ofb_aes_128_test_encrypt_from_str_lit(iv_1, key_1, msg_1);

	mk_lang_constexpr_static auto const s_msg_computed_1 = mk_lib_crypto_mode_ofb_aes_128_test_decrypt_from_str_lit(iv_1, key_1, s_out_computed_1);
	...
	mk_lib_crypto_mode_ofb_aes_128_msg_t iv;
	mk_lib_crypto_mode_ofb_aes_128_key_t key;
	mk_lib_crypto_mode_ofb_aes_128_msg_t msg;
	mk_lib_crypto_mode_ofb_aes_128_t mode;
	...
	for(i = 0; i != n; ++i)
	{
		...
		mk_lang_assert(msg_len >= mk_lib_crypto_mode_ofb_aes_128_msg_len_v * 2 + 1 && ((msg_len - 1) / 2) % mk_lib_crypto_mode_ofb_aes_128_msg_len_v == 0);
		msg_len = (msg_len - 1) / 2;
		for(j = 0; j != mk_lib_crypto_mode_ofb_aes_128_msg_len_v; ++j)
		{
		...
		for(j = 0; j != mk_lib_crypto_mode_ofb_aes_128_key_len_v; ++j)
		{
		...
		mk_lib_crypto_mode_ofb_aes_128_init(&mode, &iv);
		for(k = 0; k != msg_len / mk_lib_crypto_mode_ofb_aes_128_msg_len_v; ++k)
		{
			for(j = 0; j != mk_lib_crypto_mode_ofb_aes_128_msg_len_v; ++j)
			{
				hi = mk_lib_cpp_constexpr_char_to_nibble(s_msgs[i][(k * mk_lib_crypto_mode_ofb_aes_128_msg_len_v + j) * 2 + 0]); mk_lang_assert(hi >= 0x0 && hi <= 0xf);
				lo = mk_lib_cpp_constexpr_char_to_nibble(s_msgs[i][(k * mk_lib_crypto_mode_ofb_aes_128_msg_len_v + j) * 2 + 1]); mk_lang_assert(lo >= 0x0 && lo <= 0xf);
				byte = ((mk_lang_types_uchar_t)(((mk_lang_types_uchar_t)(hi << 4)) | ((mk_lang_types_uchar_t)(lo << 0))));
			...
			for(j = 0; j != mk_lib_crypto_mode_ofb_aes_128_msg_len_v; ++j)
			{
				hi = mk_lib_cpp_constexpr_char_to_nibble(s_outs[i][(k * mk_lib_crypto_mode_ofb_aes_128_msg_len_v + j) * 2 + 0]); mk_lang_assert(hi >= 0x0 && hi <= 0xf);
				lo = mk_lib_cpp_constexpr_char_to_nibble(s_outs[i][(k * mk_lib_crypto_mode_ofb_aes_128_msg_len_v + j) * 2 + 1]); mk_lang_assert(lo >= 0x0 && lo <= 0xf);
				byte = ((mk_lang_types_uchar_t)(((mk_lang_types_uchar_t)(hi << 4)) | ((mk_lang_types_uchar_t)(lo << 0))));
