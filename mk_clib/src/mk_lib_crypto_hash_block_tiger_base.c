#ifndef mk_include_guard_mk_lib_crypto_hash_block_tiger_base_c
#define mk_include_guard_mk_lib_crypto_hash_block_tiger_base_c
...
union mk_lib_crypto_hash_block_tiger_base_block2_data_u
{
	...
	mk_lib_crypto_hash_block_tiger_base_block_t m_align;
};
...
{
	mk_lang_alignas(sizeof(mk_lib_crypto_hash_block_tiger_base_block2_data_t)) mk_lib_crypto_hash_block_tiger_base_block2_data_t m_data;
};
...
union mk_lib_crypto_hash_block_tiger_base_table_data_u
{
	mk_sl_cui_uint64_t m_uint64s[4 * (0xff + 1)];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_tiger_base_table_data_u mk_lib_crypto_hash_block_tiger_base_table_data_t;
struct mk_lib_crypto_hash_block_tiger_base_table_s
{
	mk_lang_alignas(mk_lang_min(4 * 1024, sizeof(mk_lib_crypto_hash_block_tiger_base_table_data_t))) mk_lib_crypto_hash_block_tiger_base_table_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_tiger_base_table_s mk_lib_crypto_hash_block_tiger_base_table_t;


mk_lang_constexpr_static_inline mk_lib_crypto_hash_block_tiger_base_table_t const mk_lib_crypto_hash_block_tiger_base_k_table =
{{{
...
mk_lang_constexpr_static_inline mk_sl_cui_uint64_t const mk_lib_crypto_hash_block_tiger_base_k_key_schedule_constant_a = mk_sl_cui_uint64_c(0xa5a5a5a5ul, 0xa5a5a5a5ul);
mk_lang_constexpr_static_inline mk_sl_cui_uint64_t const mk_lib_crypto_hash_block_tiger_base_k_key_schedule_constant_b = mk_sl_cui_uint64_c(0x01234567ul, 0x89abcdeful);
mk_lang_constexpr_static_inline mk_sl_cui_uint64_t const mk_lib_crypto_hash_block_tiger_base_k_init[3] =
{
	mk_sl_cui_uint64_c(0x01234567ul, 0x89abcdeful),
	mk_sl_cui_uint64_c(0xfedcba98ul, 0x76543210ul),
	mk_sl_cui_uint64_c(0xf096a5b4ul, 0xc3b2e187ul),
};


mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_tiger_base_key_schedule(mk_lib_crypto_hash_block_tiger_base_block2_pt const block) mk_lang_noexcept
{
	mk_sl_cui_uint64_t ta mk_lang_constexpr_init;

	mk_lang_assert(block);

	mk_sl_cui_uint64_xor3(&block->m_data.m_uint64s[7], &mk_lib_crypto_hash_block_tiger_base_k_key_schedule_constant_a, &ta);
	...
	mk_sl_cui_uint64_xor3(&block->m_data.m_uint64s[6], &mk_lib_crypto_hash_block_tiger_base_k_key_schedule_constant_b, &ta);
	mk_sl_cui_uint64_sub2_wrap_cid_cod(&block->m_data.m_uint64s[7], &ta);
}

mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_tiger_base_round(mk_sl_cui_uint64_prt const a, mk_sl_cui_uint64_prt const b, mk_sl_cui_uint64_prt const c, mk_sl_cui_uint64_prct const x, mk_lang_types_sint_t const mul) mk_lang_noexcept
{
	union mk_lib_crypto_hash_block_tiger_base_u64_uc_data_u
	{
		mk_lang_types_uchar_t m_ucs[mk_sl_cui_uint64_size_bytes_v];
		mk_sl_cui_uint64_t m_align;
	};
	typedef union mk_lib_crypto_hash_block_tiger_base_u64_uc_data_u mk_lib_crypto_hash_block_tiger_base_u64_uc_data_t;
	struct mk_lib_crypto_hash_block_tiger_base_u64_uc_s
	{
		mk_lib_crypto_hash_block_tiger_base_u64_uc_data_t m_data;
	};
	typedef struct mk_lib_crypto_hash_block_tiger_base_u64_uc_s mk_lib_crypto_hash_block_tiger_base_u64_uc_t;

	mk_lib_crypto_hash_block_tiger_base_u64_uc_t cc mk_lang_constexpr_init;
	mk_sl_cui_uint64_t ta mk_lang_constexpr_init;
	...
	mk_sl_cui_uint64_to_buis_uchar_le(c, &cc.m_data.m_ucs[0]);
	mk_sl_cui_uint64_xor3(&mk_lib_crypto_hash_block_tiger_base_k_table.m_data.m_uint64s[0 * 256 + cc.m_data.m_ucs[0]], &mk_lib_crypto_hash_block_tiger_base_k_table.m_data.m_uint64s[1 * 256 + cc.m_data.m_ucs[2]], &ta);
	mk_sl_cui_uint64_xor3(&mk_lib_crypto_hash_block_tiger_base_k_table.m_data.m_uint64s[2 * 256 + cc.m_data.m_ucs[4]], &mk_lib_crypto_hash_block_tiger_base_k_table.m_data.m_uint64s[3 * 256 + cc.m_data.m_ucs[6]], &tb);
	mk_sl_cui_uint64_xor2(&ta, &tb);
	mk_sl_cui_uint64_sub2_wrap_cid_cod(a, &ta);
	mk_sl_cui_uint64_xor3(&mk_lib_crypto_hash_block_tiger_base_k_table.m_data.m_uint64s[3 * 256 + cc.m_data.m_ucs[1]], &mk_lib_crypto_hash_block_tiger_base_k_table.m_data.m_uint64s[2 * 256 + cc.m_data.m_ucs[3]], &ta);
	mk_sl_cui_uint64_xor3(&mk_lib_crypto_hash_block_tiger_base_k_table.m_data.m_uint64s[1 * 256 + cc.m_data.m_ucs[5]], &mk_lib_crypto_hash_block_tiger_base_k_table.m_data.m_uint64s[0 * 256 + cc.m_data.m_ucs[7]], &tb);
	mk_sl_cui_uint64_xor2(&ta, &tb);
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_tiger_base_pass(mk_sl_cui_uint64_prt const a, mk_sl_cui_uint64_prt const b, mk_sl_cui_uint64_prt const c, mk_lib_crypto_hash_block_tiger_base_block2_pct const block, mk_lang_types_sint_t const mul) mk_lang_noexcept
{
	mk_lang_assert(a);
	mk_lang_assert(b);
	mk_lang_assert(c);
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_tiger_base_block8_to_block64(mk_lib_crypto_hash_block_tiger_base_block_pct const block8, mk_lib_crypto_hash_block_tiger_base_block2_pt const block64) mk_lang_noexcept
{
	mk_lang_types_sint_t n mk_lang_constexpr_init;
	mk_lang_types_sint_t i mk_lang_constexpr_init;

	mk_lang_static_assert(sizeof(mk_lib_crypto_hash_block_tiger_base_block2_t) == sizeof(mk_lib_crypto_hash_block_tiger_base_block_t));
	mk_lang_static_assert(mk_lang_alignof(mk_lib_crypto_hash_block_tiger_base_block2_t) == mk_lang_alignof(mk_lib_crypto_hash_block_tiger_base_block_t));

	mk_lang_assert(block8);
	mk_lang_assert(block64);

	n = mk_lang_countof(block64->m_data.m_uint64s);
	for(i = 0; i != n; ++i)
	{
		mk_sl_uint_convert_64_8_le_to_big(&block64->m_data.m_uint64s[i], &block8->m_data.m_uint8s[i * mk_sl_cui_uint64_size_bytes_v]);
	}
}
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_tiger_base_init(mk_lib_crypto_hash_block_tiger_base_pt const tiger_base) mk_lang_noexcept
{
	...
	tiger_base->m_a = mk_lib_crypto_hash_block_tiger_base_k_init[0];
	tiger_base->m_b = mk_lib_crypto_hash_block_tiger_base_k_init[1];
	tiger_base->m_c = mk_lib_crypto_hash_block_tiger_base_k_init[2];
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_tiger_base_append_blocks(mk_lib_crypto_hash_block_tiger_base_pt const tiger_base, mk_lib_crypto_hash_block_tiger_base_block_pct const pblocks, mk_lang_types_usize_t const nblocks) mk_lang_noexcept
{
	...
	mk_lang_assert(nblocks <= mk_lang_limits_usize_max / mk_lib_crypto_hash_block_tiger_base_block_len_v);
	...
	if(nblocks != 0)
	{
		...
		{
			mk_lib_crypto_hash_block_tiger_base_block8_to_block64(&pblocks[iblock], &block);
			aa = a;
			bb = b;
			cc = c;
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_tiger_base_finish(mk_lib_crypto_hash_block_tiger_base_pt const tiger_base, mk_lang_types_bool_t const variant, mk_lib_crypto_hash_block_tiger_base_block_pt const block, mk_lang_types_sint_t const idx, mk_lib_crypto_hash_block_tiger_base_digest_pt const digest) mk_lang_noexcept
{
	...
	mk_lang_assert(tiger_base);
	mk_lang_assert(variant == mk_lang_false || variant == mk_lang_true);
	mk_lang_assert(block);
	mk_lang_assert(idx >= 0 && idx < mk_lib_crypto_hash_block_tiger_base_block_len_v);
	mk_lang_assert(digest);

	ui = mk_lib_crypto_hash_block_tiger_base_block_len_v; mk_sl_cui_uint64_from_bi_uint(&ta, &ui);
	...
	ui = variant ? ((mk_lang_types_uint_t)(0x80)) : ((mk_lang_types_uint_t)(0x01)); mk_sl_cui_uint8_from_bi_uint(&block->m_data.m_uint8s[idx], &ui);
	rest = mk_lib_crypto_hash_block_tiger_base_block_len_v - idx - 1;
	mk_lang_assert(rest >= 0 && rest <= mk_lib_crypto_hash_block_tiger_base_block_len_v - 1);
	...
	else
	{
		...
		mk_lib_crypto_hash_block_tiger_base_append_blocks(tiger_base, block, 1);
		mk_sl_cui_uint8_memclr_fn(&block->m_data.m_uint8s[0], ((mk_lang_types_sint_t)(mk_lib_crypto_hash_block_tiger_base_block_len_v)) - ((mk_lang_types_sint_t)(mk_sl_cui_uint64_size_bytes_v)));
	}

	mk_sl_uint_convert_64_8_le_to_sml(&ta, &block->m_data.m_uint8s[((mk_lang_types_sint_t)(mk_lib_crypto_hash_block_tiger_base_block_len_v)) - ((mk_lang_types_sint_t)(mk_sl_cui_uint64_size_bytes_v))]);
	mk_lib_crypto_hash_block_tiger_base_append_blocks(tiger_base, block, 1);

	mk_sl_uint_convert_64_8_le_to_sml(&tiger_base->m_a, &digest->m_data.m_uint8s[0 * mk_sl_cui_uint64_size_bytes_v]);
	mk_sl_uint_convert_64_8_le_to_sml(&tiger_base->m_b, &digest->m_data.m_uint8s[1 * mk_sl_cui_uint64_size_bytes_v]);
	mk_sl_uint_convert_64_8_le_to_sml(&tiger_base->m_c, &digest->m_data.m_uint8s[2 * mk_sl_cui_uint64_size_bytes_v]);
}
#include "mk_lang_warning_msvc_pop.h"
