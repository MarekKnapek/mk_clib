#ifndef mk_include_guard_mk_lib_crypto_all_piecewise_fuzz_h
#define mk_include_guard_mk_lib_crypto_all_piecewise_fuzz_h
...
#include "mk_lib_crypto_all_piecewise_fuzz.c"
#endif
#endif
