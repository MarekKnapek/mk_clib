#ifndef mk_include_guard_mk_lib_compress_zlib_h
#define mk_include_guard_mk_lib_compress_zlib_h
...
enum mk_lib_compress_zlib_header_len_e{ mk_lib_compress_zlib_header_len_v = mk_sl_cui_uint8_size_bytes_v + mk_sl_cui_uint8_size_bytes_v }; typedef enum mk_lib_compress_zlib_header_len_e mk_lib_compress_zlib_header_len_t;


#include "mk_lang_warning_msvc_push_c4820.h"
struct mk_lib_compress_zlib_s
{
	mk_lib_compress_deflate_t m_deflate;
	mk_lib_hash_adler32_t m_adler32;
	mk_sl_cui_uint8_t m_stream_header_buf[mk_lib_compress_zlib_header_len_v];
...
typedef struct mk_lib_compress_zlib_s mk_lib_compress_zlib_t;
mk_lang_typedef(mk_lib_compress_zlib);
...
#include "mk_lib_compress_zlib.c"
#endif
#endif
