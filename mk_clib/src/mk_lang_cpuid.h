#ifndef mk_include_guard_mk_lang_cpuid_h
#define mk_include_guard_mk_lang_cpuid_h
...
#define mk_lang_cpuid_has_pclmulqdq() 1
#else
#define mk_lang_cpuid_has_pclmulqdq() 0
#endif
...
#define mk_lang_cpuid_init() do{}while(mk_lang_runtime_bool_fn_false)
#define mk_lang_cpuid_reset() do{}while(mk_lang_runtime_bool_fn_false)
#define mk_lang_cpuid_has_pclmulqdq() 0
#define mk_lang_cpuid_has_ssse3() 0
#define mk_lang_cpuid_has_sse41() 0
#define mk_lang_cpuid_has_popcnt() 0
#define mk_lang_cpuid_has_aesni() 0
...
#define mk_lang_cpuid_has_avx512_vl() 0
#define mk_lang_cpuid_has_vaes() 0
#define mk_lang_cpuid_has_sha512() 0
