...
#else
#define mk_lib_stack_trace_impl_rw_construct_void(stack_trace) ((mk_lang_types_void_t)(stack_trace)), mk_lang_check_line
#define mk_lib_stack_trace_impl_rw_construct_capture(stack_trace) ((mk_lang_types_void_t)(stack_trace)), mk_lang_check_line
#define mk_lib_stack_trace_impl_rw_destruct(stack_trace) ((mk_lang_types_void_t)(stack_trace)), mk_lang_check_line
#define mk_lib_stack_trace_impl_ro_get_funcs(stack_trace, funcs) ((mk_lang_types_void_t)(((mk_lang_types_void_t)(stack_trace)), ((mk_lang_types_void_t)(funcs)))), mk_lang_check_line
#define mk_lib_stack_trace_impl_ro_get_hash(stack_trace, hash) ((mk_lang_types_void_t)(((mk_lang_types_void_t)(stack_trace)), ((mk_lang_types_void_t)(hash)))), mk_lang_check_line
#define mk_lib_stack_trace_impl_ro_cmp(a, b, cmp) ((mk_lang_types_void_t)(((mk_lang_types_void_t)(a)), ((mk_lang_types_void_t)(b)), ((mk_lang_types_void_t)(cmp)))), mk_lang_check_line
#endif
