...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_xof_stream_any2_init(mk_lib_crypto_xof_stream_any2_pt const hash_stream_any2, mk_lib_crypto_xof_stream_any1_id_t const id) mk_lang_noexcept
{
	...
	switch(id)
	{
		case mk_lib_crypto_xof_stream_any1_id_e_shake_128: hash_stream_any2->m_data.m_shake_128.m_id = id; mk_lib_crypto_xof_stream_shake_128_init(&hash_stream_any2->m_data.m_shake_128.m_shake_128); break;
		case mk_lib_crypto_xof_stream_any1_id_e_shake_256: hash_stream_any2->m_data.m_shake_256.m_id = id; mk_lib_crypto_xof_stream_shake_256_init(&hash_stream_any2->m_data.m_shake_256.m_shake_256); break;
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_xof_stream_any2_append_u8s(mk_lib_crypto_xof_stream_any2_pt const hash_stream_any2, mk_sl_cui_uint8_pct const u8s, mk_lang_types_usize_t const count) mk_lang_noexcept
{
	...
	{
		case mk_lib_crypto_xof_stream_any1_id_e_shake_128: mk_lib_crypto_xof_stream_shake_128_append_u8s(&hash_stream_any2->m_data.m_shake_128.m_shake_128, u8s, count); break;
		case mk_lib_crypto_xof_stream_any1_id_e_shake_256: mk_lib_crypto_xof_stream_shake_256_append_u8s(&hash_stream_any2->m_data.m_shake_256.m_shake_256, u8s, count); break;
		case mk_lib_crypto_xof_stream_any1_id_e_dummy_end: mk_lang_assert(mk_lang_false); break;
		default: mk_lang_assert(mk_lang_false); break;
	}
}
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_xof_stream_any2_finish(mk_lib_crypto_xof_stream_any2_pt const hash_stream_any2) mk_lang_noexcept
{
	...
	switch(hash_stream_any2->m_data.m_id)
	{
		case mk_lib_crypto_xof_stream_any1_id_e_shake_128: mk_lib_crypto_xof_stream_shake_128_finish(&hash_stream_any2->m_data.m_shake_128.m_shake_128); break;
		case mk_lib_crypto_xof_stream_any1_id_e_shake_256: mk_lib_crypto_xof_stream_shake_256_finish(&hash_stream_any2->m_data.m_shake_256.m_shake_256); break;
		case mk_lib_crypto_xof_stream_any1_id_e_dummy_end: mk_lang_assert(mk_lang_false); break;
		default: mk_lang_assert(mk_lang_false); break;
	}
}
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_xof_stream_any2_squeeze_u8s(mk_lib_crypto_xof_stream_any2_pt const hash_stream_any2, mk_sl_cui_uint8_pt const u8s, mk_lang_types_usize_t const count) mk_lang_noexcept
{
	...
	switch(hash_stream_any2->m_data.m_id)
	{
		case mk_lib_crypto_xof_stream_any1_id_e_shake_128: mk_lib_crypto_xof_stream_shake_128_squeeze_u8s(&hash_stream_any2->m_data.m_shake_128.m_shake_128, u8s, count); break;
		case mk_lib_crypto_xof_stream_any1_id_e_shake_256: mk_lib_crypto_xof_stream_shake_256_squeeze_u8s(&hash_stream_any2->m_data.m_shake_256.m_shake_256, u8s, count); break;
		case mk_lib_crypto_xof_stream_any1_id_e_dummy_end: mk_lang_assert(mk_lang_false); break;
		default: mk_lang_assert(mk_lang_false); break;
	}
}
