...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_wrapper_task_prrw_log(mk_lib_iip_cp_client_wrapper_task_pt const task, mk_lang_types_pchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	mk_lib_iip_cp_client_application_task_pt app;
	mk_lang_types_sint_t err;
	...
	app = ((mk_lib_iip_cp_client_application_task_pt)(task->m_wrapper.m_elements[0])); mk_lang_assert(app);
	err = mk_lib_iip_cp_client_application_task_rw_log(app, str_buf, str_len); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_wrapper_task_prrw_is_connected(mk_lib_iip_cp_client_wrapper_task_pt const task, mk_lib_iip_cp_client_types_handle_socket_connect_pt const socket, mk_lang_types_bool_pt const is) mk_lang_noexcept
{
	mk_lang_bui_uintptr_t uptr;
	...
	err = mk_lib_iip_cp_client_socket_task_rw_is_connected(sck, is); mk_lang_check_rereturn(err);
	return 0;
}

mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_wrapper_task_prrw_recv(mk_lib_iip_cp_client_wrapper_task_pt const task, mk_lib_iip_cp_client_types_handle_socket_connect_pt const socket, mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lang_types_sint_pt const recvd) mk_lang_noexcept
{
	mk_lang_bui_uintptr_t uptr;
	mk_lib_iip_cp_client_socket_task_pt sck;
	mk_lang_types_sint_t err;
	...
	mk_lib_iip_cp_client_types_handle_socket_connect_to_base(socket, &uptr); mk_lang_assert(uptr != 0);
	sck = ((mk_lib_iip_cp_client_socket_task_pt)(uptr)); mk_lang_assert(sck);
	err = mk_lib_iip_cp_client_socket_task_rw_recv(sck, data_buf, data_len, recvd); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_wrapper_task_prrw_socket_drop(mk_lib_iip_cp_client_wrapper_task_pt const task, mk_lib_iip_cp_client_types_handle_socket_connect_pt const socket) mk_lang_noexcept
{
	mk_lang_bui_uintptr_t uptr;
	mk_lib_iip_cp_client_socket_task_pt sck;
	mk_lang_types_sint_t err;
	...
	mk_lib_iip_cp_client_types_handle_socket_connect_to_base(socket, &uptr); mk_lang_assert(uptr != 0);
	sck = ((mk_lib_iip_cp_client_socket_task_pt)(uptr)); mk_lang_assert(sck);
	err = mk_lib_iip_cp_client_socket_task_rw_drop(sck); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_iip_cp_client_wrapper_task_rw_log(mk_lib_iip_cp_client_wrapper_task_pt const task, mk_lang_types_pchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	return mk_lib_iip_cp_client_wrapper_task_prrw_log(task, str_buf, str_len);
}
...
{
	return mk_lib_iip_cp_client_wrapper_task_prrw_is_connected(task, socket, is);
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_iip_cp_client_wrapper_task_rw_socket_drop(mk_lib_iip_cp_client_wrapper_task_pt const task, mk_lib_iip_cp_client_types_handle_socket_connect_pt const socket) mk_lang_noexcept
{
	return mk_lib_iip_cp_client_wrapper_task_prrw_socket_drop(task, socket);
}
