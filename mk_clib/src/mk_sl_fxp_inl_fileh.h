...
{
	mk_sl_fxp_inl_defd_base_t m_data;
};
typedef struct mk_sl_fxp_inl_defd_s mk_sl_fxp_inl_defd_t;
typedef mk_sl_fxp_inl_defd_t const mk_sl_fxp_inl_defd_ct;
typedef mk_sl_fxp_inl_defd_t* mk_sl_fxp_inl_defd_pt;
typedef mk_sl_fxp_inl_defd_t* mk_lang_restrict mk_sl_fxp_inl_defd_prt;
typedef mk_sl_fxp_inl_defd_t const* mk_sl_fxp_inl_defd_pct;
typedef mk_sl_fxp_inl_defd_t const* mk_lang_restrict mk_sl_fxp_inl_defd_prct;
...
enum { mk_sl_fxp_inl_defd_to_str_dec_lene = 9 };
