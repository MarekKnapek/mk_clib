...
mk_lang_extern_c mk_win_base_dll_import mk_lang_nodiscard mk_win_base_wchar_lpt mk_win_base_stdcall GetCommandLineW(mk_lang_types_void_t) mk_lang_noexcept;
