...
mk_lang_nodiscard static mk_lang_inline mk_lib_iip_cp_client_connection_task_pt mk_lib_iip_cp_client_connection_task_prrw_type_to_self(mk_lib_iip_any_data_connection_pt const connection) mk_lang_noexcept
{
	...
	/* for natvis purposes */
	mk_lang_assert(mk_lang_offsetof(mk_lib_iip_cp_client_connection_task_settings_t, m_type) == 0);
	mk_lang_assert(mk_lang_offsetof(mk_lib_iip_cp_client_connection_t, m_settings) == 0);
	mk_lang_assert(mk_lang_offsetof(mk_lib_iip_cp_client_connection_task_t, m_connection) == 0);
	/* for natvis purposes */
