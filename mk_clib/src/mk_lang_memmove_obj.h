#ifndef mk_include_guard_mk_lang_memmove_obj
#define mk_include_guard_mk_lang_memmove_obj
...
#define mk_lang_forb_file "mk_lang_memmove_obj_inl_fileh.h"
