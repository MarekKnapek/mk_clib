#ifndef mk_include_guard_mk_lib_crypto_hash_block_md4_c
#define mk_include_guard_mk_lib_crypto_hash_block_md4_c
...
mk_lang_constexpr_static_inline mk_sl_cui_uint32_t const mk_lib_crypto_hash_block_md4_s_init[4] =
{
...
mk_lang_constexpr_static_inline mk_sl_cui_uint32_t const mk_lib_crypto_hash_block_md4_s_round_2_constant = mk_sl_cui_uint32_c(0x5a827999ul);
mk_lang_constexpr_static_inline mk_sl_cui_uint32_t const mk_lib_crypto_hash_block_md4_s_round_3_constant = mk_sl_cui_uint32_c(0x6ed9eba1ul);


mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_md4_f(mk_sl_cui_uint32_prct const x, mk_sl_cui_uint32_prct const y, mk_sl_cui_uint32_prct const z, mk_sl_cui_uint32_prt const ret) mk_lang_noexcept
{
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_md4_g(mk_sl_cui_uint32_prct const x, mk_sl_cui_uint32_prct const y, mk_sl_cui_uint32_prct const z, mk_sl_cui_uint32_prt const ret) mk_lang_noexcept
{
	mk_sl_cui_uint32_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint32_t tb mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_md4_h(mk_sl_cui_uint32_prct const x, mk_sl_cui_uint32_prct const y, mk_sl_cui_uint32_prct const z, mk_sl_cui_uint32_prt const ret) mk_lang_noexcept
{
	mk_sl_cui_uint32_t ta mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_md4_round_1(mk_sl_cui_uint32_prt const a, mk_sl_cui_uint32_prct const b, mk_sl_cui_uint32_prct const c, mk_sl_cui_uint32_prct const d, mk_lib_crypto_hash_block_md4_block_pct const x, mk_lang_types_sint_t const k, mk_lang_types_sint_t const s) mk_lang_noexcept
{
	mk_sl_cui_uint32_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint32_t tb mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_md4_round_2(mk_sl_cui_uint32_pt const a, mk_sl_cui_uint32_pct const b, mk_sl_cui_uint32_pct const c, mk_sl_cui_uint32_pct const d, mk_lib_crypto_hash_block_md4_block_pct const x, int const k, int const s) mk_lang_noexcept
{
	mk_sl_cui_uint32_t ta mk_lang_constexpr_init;
	...
	mk_sl_cui_uint32_add2_wrap_cid_cod(a, &ta);
	mk_sl_uint_convert_32_8_le_to_big(&ta, &x->m_data.m_uint8s[k * 4]);
	mk_sl_cui_uint32_add2_wrap_cid_cod(a, &ta);
	mk_sl_cui_uint32_add2_wrap_cid_cod(a, &mk_lib_crypto_hash_block_md4_s_round_2_constant);
	mk_sl_cui_uint32_rotl2(a, s);
}

mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_md4_round_3(mk_sl_cui_uint32_pt const a, mk_sl_cui_uint32_pct const b, mk_sl_cui_uint32_pct const c, mk_sl_cui_uint32_pct const d, mk_lib_crypto_hash_block_md4_block_pct const x, int const k, int const s) mk_lang_noexcept
{
	mk_sl_cui_uint32_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint32_t tb mk_lang_constexpr_init;
	...
	mk_sl_uint_convert_32_8_le_to_big(&tb, &x->m_data.m_uint8s[k * 4]);
	mk_sl_cui_uint32_add2_wrap_cid_cod(a, &ta);
	mk_sl_cui_uint32_add2_wrap_cid_cod(&tb, &mk_lib_crypto_hash_block_md4_s_round_3_constant);
	mk_sl_cui_uint32_add2_wrap_cid_cod(a, &tb);
	mk_sl_cui_uint32_rotl2(a, s);
}
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_md4_init(mk_lib_crypto_hash_block_md4_pt const md4) mk_lang_noexcept
{
	...
	md4->m_state[0] = mk_lib_crypto_hash_block_md4_s_init[0];
	md4->m_state[1] = mk_lib_crypto_hash_block_md4_s_init[1];
	md4->m_state[2] = mk_lib_crypto_hash_block_md4_s_init[2];
	md4->m_state[3] = mk_lib_crypto_hash_block_md4_s_init[3];
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_md4_append_blocks(mk_lib_crypto_hash_block_md4_pt const md4, mk_lib_crypto_hash_block_md4_block_pct const pblocks, mk_lang_types_usize_t const nblocks) mk_lang_noexcept
{
	...
	mk_lang_assert(nblocks <= mk_lang_limits_usize_max / mk_lib_crypto_hash_block_md4_block_len_v);
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_md4_finish(mk_lib_crypto_hash_block_md4_pt const md4, mk_lib_crypto_hash_block_md4_block_pt const block, mk_lang_types_sint_t const idx, mk_lib_crypto_hash_block_md4_digest_pt const digest) mk_lang_noexcept
{
	...
	mk_lang_assert(idx >= 0 && idx < mk_lib_crypto_hash_block_md4_block_len_v);
	mk_lang_assert(digest);

	ui = mk_lib_crypto_hash_block_md4_block_len_v; mk_sl_cui_uint64_from_bi_uint(&ta, &ui);
	...
	rest = mk_lib_crypto_hash_block_md4_block_len_v - idx - 1;
	mk_lang_assert(rest >= 0 && rest <= mk_lib_crypto_hash_block_md4_block_len_v - 1);
	if(rest >= 8)
	{
	...
	else
	{
		...
		mk_sl_cui_uint8_memclr_fn(&block->m_data.m_uint8s[0], mk_lib_crypto_hash_block_md4_block_len_v - 8);
	}

	mk_sl_uint_convert_64_8_le_to_sml(&ta, &block->m_data.m_uint8s[mk_lib_crypto_hash_block_md4_block_len_v - 8]);
	mk_lib_crypto_hash_block_md4_append_blocks(md4, block, 1);
	for(i = 0; i != 4; ++i)
	{
		mk_sl_uint_convert_32_8_le_to_sml(&md4->m_state[i], &digest->m_data.m_uint8s[i * 4]);
	}
}
#include "mk_lang_warning_msvc_pop.h"
