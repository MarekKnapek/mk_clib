#ifndef mk_include_guard_mk_lib_crypto_mode_cfb_8_aes_192
#define mk_include_guard_mk_lib_crypto_mode_cfb_8_aes_192
...
#include "mk_lib_crypto_mode_cfb_8_aes_192.c"
#endif
#endif
