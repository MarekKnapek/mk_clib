...
#define mk_sl_flt_defd_cui_pct mk_lang_concat(mk_sl_flt_defd_cui, _pct)
...
#define mk_sl_cui_t_name mk_sl_flt_defd_cuiba_name
#define mk_sl_cui_t_base mk_sl_flt_defd_buiname
#define mk_sl_cui_t_count mk_sl_flt_defd_cuiba_count
#define mk_sl_cui_t_endian mk_lang_endian_little
#define mk_sl_cui_t_base_sizebits_d mk_sl_flt_defd_bui_bits
#include "mk_sl_cui_inl_fileh.h"
#include "mk_sl_cui_inl_filec.h"
#define mk_sl_flt_defd_cuiba_t mk_lang_concat(mk_sl_flt_defd_cuiba_name, _t)
#define mk_sl_flt_defd_cuiba_pt mk_lang_concat(mk_sl_flt_defd_cuiba_name, _pt)
#define mk_sl_flt_defd_cuiba_from_buis_uint_le mk_lang_concat(mk_sl_flt_defd_cuiba_name, _from_buis_uint_le)
#define mk_sl_flt_defd_cuiba_shl2 mk_lang_concat(mk_sl_flt_defd_cuiba_name, _shl2)
#define mk_sl_flt_defd_cuiba_shr2 mk_lang_concat(mk_sl_flt_defd_cuiba_name, _shr2)
#define mk_sl_flt_defd_cuiba_to_str_dec_n mk_lang_concat(mk_sl_flt_defd_cuiba_name, _to_str_dec_n)

#define mk_sl_flt_defd_cuibb_name mk_lang_concat(mk_lang_concat(mk_sl_flt_, mk_sl_flt_defd_name), _bigb_cui)
#define mk_sl_flt_defd_cuibb_count mk_lang_div_roundup(mk_sl_flt_defd_need_bits_b, mk_sl_flt_defd_bui_bits)
#define mk_sl_cui_t_name mk_sl_flt_defd_cuibb_name
#define mk_sl_cui_t_base mk_sl_flt_defd_buiname
#define mk_sl_cui_t_count mk_sl_flt_defd_cuibb_count
#define mk_sl_cui_t_endian mk_lang_endian_little
#define mk_sl_cui_t_base_sizebits_d mk_sl_flt_defd_bui_bits
#include "mk_sl_cui_inl_fileh.h"
#include "mk_sl_cui_inl_filec.h"
#define mk_sl_flt_defd_cuibb_t mk_lang_concat(mk_sl_flt_defd_cuibb_name, _t)
#define mk_sl_flt_defd_cuibb_pt mk_lang_concat(mk_sl_flt_defd_cuibb_name, _pt)
#define mk_sl_flt_defd_cuibb_from_bi_uint mk_lang_concat(mk_sl_flt_defd_cuibb_name, _from_bi_uint)
#define mk_sl_flt_defd_cuibb_to_bi_uint mk_lang_concat(mk_sl_flt_defd_cuibb_name, _to_bi_uint)
#define mk_sl_flt_defd_cuibb_from_buis_uint_le mk_lang_concat(mk_sl_flt_defd_cuibb_name, _from_buis_uint_le)
#define mk_sl_flt_defd_cuibb_is_zero mk_lang_concat(mk_sl_flt_defd_cuibb_name, _is_zero)
#define mk_sl_flt_defd_cuibb_shl2 mk_lang_concat(mk_sl_flt_defd_cuibb_name, _shl2)
#define mk_sl_flt_defd_cuibb_mul4_wrap_wi_smol mk_lang_concat(mk_sl_flt_defd_cuibb_name, _mul4_wrap_wi_smol)
