...
#define mk_sl_flt_defd_cui_to_bi_uint mk_lang_concat(mk_sl_flt_defd_cui, _to_bi_uint)
...
#define mk_sl_flt_defd_cui_inc1 mk_lang_concat(mk_sl_flt_defd_cui, _inc1)
...
#define mk_sl_flt_defd_cui_shr2 mk_lang_concat(mk_sl_flt_defd_cui, _shr2)
