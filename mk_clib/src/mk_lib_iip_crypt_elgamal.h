#ifndef mk_include_guard_mk_lib_iip_crypt_elgamal_h
#define mk_include_guard_mk_lib_iip_crypt_elgamal_h
...
struct mk_lib_iip_crypt_elgamal_key_pri_s
{
	mk_lib_iip_crypt_elgamal_key_pri_data_t m_data;
};
typedef struct mk_lib_iip_crypt_elgamal_key_pri_s mk_lib_iip_crypt_elgamal_key_pri_t;
mk_lang_typedef(mk_lib_iip_crypt_elgamal_key_pri);
...
struct mk_lib_iip_crypt_elgamal_key_pub_s
{
	mk_lib_iip_crypt_elgamal_key_pub_data_t m_data;
};
typedef struct mk_lib_iip_crypt_elgamal_key_pub_s mk_lib_iip_crypt_elgamal_key_pub_t;
...
#include "mk_lib_iip_crypt_elgamal.c"
#endif
#endif
