#ifndef mk_include_guard_mk_lang_stdout_linux_h
#define mk_include_guard_mk_lang_stdout_linux_h
...
#define mk_lang_stdout_linux_print_lit_n(x) mk_lang_stdout_linux_print_n(&(x)[0], mk_lang_countstr((x)))
#define mk_lang_stdout_linux_print_lit_w(x) mk_lang_stdout_linux_print_w(&(x)[0], mk_lang_countstr((x)))
#define mk_lang_stdout_linux_print_lit_t(x) mk_lang_stdout_linux_print_t(&(x)[0], mk_lang_countstr((x)))
#define mk_lang_stdout_linux_println_lit_n(x) mk_lang_stdout_linux_print_lit_n(x "\n")
#define mk_lang_stdout_linux_println_lit_w(x) mk_lang_stdout_linux_print_lit_w(x L"\n")
#define mk_lang_stdout_linux_println_lit_t(x) mk_lang_stdout_linux_print_lit_t(x mk_lang_tchar_c("\n"))


#if mk_lang_jumbo_have
#include "mk_lang_stdout_linux.c"
#endif
#endif
