...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_hash_stream_sha2_384_test_compute_from_str_lit(char const(&str_lit)[str_lit_len]) mk_lang_noexcept
{
	...
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, mk_lib_crypto_hash_block_sha2_384_digest_len> ret mk_lang_constexpr_init;
	...
	mk_lib_crypto_hash_stream_sha2_384_append_u8(&sha2_384, msg.data(), msg.size());
	mk_lib_crypto_hash_stream_sha2_384_finish(&sha2_384, &digest);
	for(i = 0; i != mk_lib_crypto_hash_block_sha2_384_digest_len; ++i){ ret[i] = digest.m_uint8s[i]; }
	return ret;
}
...
mk_lang_extern_c void mk_lib_crypto_hash_stream_sha2_384_test(void) mk_lang_noexcept
{
	#define message_1 ""
	#define message_2 "a"
	...
	int n;
	int i;
	mk_lib_crypto_hash_stream_sha2_384_t sha2_384;
	...
	for(i = 0; i != n; ++i)
	{
		...
		mk_lib_crypto_hash_stream_sha2_384_init(&sha2_384);
		mk_lib_crypto_hash_stream_sha2_384_append(&sha2_384, ((mk_lang_types_uchar_pct)(s_messages[i])), s_message_lens[i]);
		mk_lib_crypto_hash_stream_sha2_384_finish(&sha2_384, &digest);
		for(j = 0; j != mk_lib_crypto_hash_block_sha2_384_digest_len; ++j)
		{
