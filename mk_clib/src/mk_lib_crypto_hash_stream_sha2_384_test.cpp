#ifndef mk_include_guard_mk_lib_crypto_hash_stream_sha2_384_test_cpp
#define mk_include_guard_mk_lib_crypto_hash_stream_sha2_384_test_cpp
...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_hash_stream_sha2_384_test_compute_from_str_lit(mk_lang_types_pchar_t const(&str_lit)[str_lit_len]) mk_lang_noexcept
{
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, str_lit_len - 1> msg mk_lang_constexpr_init;
	mk_lib_crypto_hash_stream_sha2_384_t sha2_384 mk_lang_constexpr_init;
	mk_lib_crypto_hash_stream_sha2_384_digest_t digest mk_lang_constexpr_init;
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, mk_lib_crypto_hash_stream_sha2_384_digest_len_v> ret mk_lang_constexpr_init;

	mk_lang_static_assert(str_lit_len >= 1);

	msg = mk_lib_cpp_constexpr_array_u8_from_pchar_lit(str_lit);
	mk_lib_crypto_hash_stream_sha2_384_init(&sha2_384);
	mk_lib_crypto_hash_stream_sha2_384_append_u8s(&sha2_384, msg.data(), msg.size());
	mk_lib_crypto_hash_stream_sha2_384_finish(&sha2_384, &digest);
...
mk_lang_extern_force_c mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_stream_sha2_384_test(mk_lang_types_void_t) mk_lang_noexcept
{
	#define message_1 ""
	#define message_2 "a"
	...
	#define digest_3 "cb00753f45a35e8bb5a03d699ac65007272c32ab0eded1631a8b605a43ff5bed8086072ba1e7cc2358baeca134c825a7"
	#define digest_4 "473ed35167ec1f5d8e550368a3db39be54639f828868e9454c239fc8b52e3c61dbd0d8b4de1390c256dcbb5d5fd99cd5"
	...
	#define digest_8 "0541e349b6d06749a852ae0a68db73f98620879de6b5b3743d7fca7dda0f81d83b0ca596f710542ed343f1b4214d508c"

	#if mk_lang_version_at_least_cpp_14 || mk_lang_version_at_least_msvc_cpp_14

	mk_lang_constexpr_static auto const s_digest_computed_1 = mk_lib_crypto_hash_stream_sha2_384_test_compute_from_str_lit(message_1);
	mk_lang_constexpr_static auto const s_digest_computed_2 = mk_lib_crypto_hash_stream_sha2_384_test_compute_from_str_lit(message_2);
	mk_lang_constexpr_static auto const s_digest_computed_3 = mk_lib_crypto_hash_stream_sha2_384_test_compute_from_str_lit(message_3);
	mk_lang_constexpr_static auto const s_digest_computed_4 = mk_lib_crypto_hash_stream_sha2_384_test_compute_from_str_lit(message_4);
	...
	for(i = 0; i != n; ++i)
	{
		...
		mk_lib_crypto_hash_stream_sha2_384_init(&sha2_384);
		mk_lib_crypto_hash_stream_sha2_384_append_u8s(&sha2_384, ((mk_sl_cui_uint8_pct)(messages[i])), ((mk_lang_types_usize_t)(message_lens[i])));
		mk_lib_crypto_hash_stream_sha2_384_finish(&sha2_384, &digest);
		for(j = 0; j != mk_lib_crypto_hash_stream_sha2_384_digest_len_v; ++j)
		{
