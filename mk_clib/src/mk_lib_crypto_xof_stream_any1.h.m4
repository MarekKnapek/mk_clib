...
mm_per_xof(`mk_lang_forward(mk_lib_crypto_xof_stream_$1);')


enum mk_lib_crypto_xof_stream_any1_id_e
{
mm_per_xof(`	mk_lib_crypto_xof_stream_any1_id_e_$1,')
...
{
mm_per_xof(`	mk_lib_crypto_xof_stream_$1_pt m_$1;')
};
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_xof_stream_any1_bares_finish(mk_lib_crypto_xof_stream_any1_bare_pt const xof_stream_any1_bare, mk_lib_crypto_xof_stream_any1_id_t const id) mk_lang_noexcept;
