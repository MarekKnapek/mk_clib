...
mk_lib_crypto_xof_stream_any_mm_per_xof(`mk_lang_forward(mk_lib_crypto_xof_stream_$1);', `
')


enum mk_lib_crypto_xof_stream_any1_id_e
{
mk_lib_crypto_xof_stream_any_mm_per_xof(`	mk_lib_crypto_xof_stream_any1_id_e_$1,', `
')
...
{
mk_lib_crypto_xof_stream_any_mm_per_xof(`	mk_lib_crypto_xof_stream_$1_pt m_$1;', `
')
};
