...
mm_per_hash(`mk_lang_forward(mk_lib_crypto_hash_stream_$1);')


enum mk_lib_crypto_hash_stream_any1_id_e
{
mm_per_hash(`	mk_lib_crypto_hash_stream_any1_id_e_$1,')
...
{
mm_per_hash(`	mk_lib_crypto_hash_stream_$1_pt m_$1;')
};
