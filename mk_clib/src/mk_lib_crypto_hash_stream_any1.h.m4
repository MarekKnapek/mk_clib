...
mk_lib_crypto_hash_stream_any_mm_per_hash(`mk_lang_forward(mk_lib_crypto_hash_stream_$1);', `
')


enum mk_lib_crypto_hash_stream_any1_id_e
{
mk_lib_crypto_hash_stream_any_mm_per_hash(`	mk_lib_crypto_hash_stream_any1_id_e_$1,', `
')
...
{
mk_lib_crypto_hash_stream_any_mm_per_hash(`	mk_lib_crypto_hash_stream_$1_pt m_$1;', `
')
};
...
enum mk_lib_crypto_hash_stream_any1_digest_max_len_e{ mk_lib_crypto_hash_stream_any1_digest_max_len_v = 64 }; typedef enum mk_lib_crypto_hash_stream_any1_digest_max_len_e mk_lib_crypto_hash_stream_any1_digest_max_len_t;
