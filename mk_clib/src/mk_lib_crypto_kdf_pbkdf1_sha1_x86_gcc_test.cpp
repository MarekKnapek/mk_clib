#include "mk_lib_crypto_kdf_pbkdf1_sha1_x86_gcc_test.hpp"
...
#include "mk_lib_crypto_kdf_pbkdf1_sha1_x86_gcc.h"
#include "mk_sl_uint8.h"


mk_lang_extern_c void mk_lib_crypto_kdf_pbkdf1_sha1_x86_gcc_test(void) mk_lang_noexcept
{
	...
	for(i = 0; i != n; ++i)
	{
		...
		mk_lib_crypto_kdf_pbkdf1_sha1_x86_gcc(((mk_lang_types_uchar_pct)(s_passwords[i])), s_password_lens[i], salt, s_costs[i], s_key_lens[i], key);
