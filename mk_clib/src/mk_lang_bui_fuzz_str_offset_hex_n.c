...
#define mk_lang_bui_t_name mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lang_bui_fuzz_str_offset_hex_n_uint_to_str_different(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	...
	if(!(size == 2 * sizeof(mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_t)))
	{
		return;
	}
	mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_from_buis_uchar_le(&bui_a, &data[0 * sizeof(mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_t)]);
	mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_from_buis_uchar_le(&bui_b, &data[1 * sizeof(mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_t)]);
	if(!mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_eq(&bui_a, &bui_b))
	{
		len_a = mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_to_str_hex_n(&bui_a, &str_a[0], mk_lang_countof(str_a)); mk_lang_test(len_a >= 1); mk_lang_test(len_a <= mk_lang_countof(str_a));
		len_b = mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_to_str_hex_n(&bui_b, &str_b[0], mk_lang_countof(str_b)); mk_lang_test(len_b >= 1); mk_lang_test(len_b <= mk_lang_countof(str_b));
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lang_bui_fuzz_str_offset_hex_n_uint_to_str_different_full(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	...
	if(!mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_eq(&bui_a, &bui_b))
	{
		len_a = mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_to_str_hexf_n(&bui_a, &str_a[0], mk_lang_countof(str_a)); mk_lang_test(len_a == mk_lang_countof(str_a));
		len_b = mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_to_str_hexf_n(&bui_b, &str_b[0], mk_lang_countof(str_b)); mk_lang_test(len_b == mk_lang_countof(str_b));
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lang_bui_fuzz_str_offset_hex_n_uint_to_str_and_back(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	...
	if(!(size == sizeof(mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_t)))
	{
		return;
	}
	mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_from_buis_uchar_le(&bui_a, data);
	len_a = mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_to_str_hex_n(&bui_a, &str[0], mk_lang_countof(str));
	mk_lang_test(len_a >= 1);
	mk_lang_test(len_a <= mk_lang_countof(str));
	len_b = mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_from_str_hex_n(&bui_b, &str[0], len_a);
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lang_bui_fuzz_str_offset_hex_n_uint_to_str_and_back_full(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	...
	mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_from_buis_uchar_le(&bui_a, data);
	len_a = mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_to_str_hexf_n(&bui_a, &str[0], mk_lang_countof(str));
	mk_lang_test(len_a == mk_lang_countof(str));
	len_b = mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_from_str_hex_n(&bui_b, &str[0], len_a);
	mk_lang_test(len_b == len_a);
	mk_lang_test(mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_eq(&bui_b, &bui_a));
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lang_bui_fuzz_str_offset_hex_n_uint_from_str_and_back(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	...
	len_a = mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_from_str_hex_n(&bui, &str_a[0], sz);
	if(len_a >= 1)
	{
		len_b = mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_to_str_hex_n(&bui, &str_b[0], mk_lang_countof(str_b));
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lang_bui_fuzz_str_offset_hex_n_uint_from_str_vs_cpp_a(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	...
	if(res.ec == std::errc{})
	{
		...
		len_b = mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_from_str_hex_n(&bui_b, &str_a[0], len_a);
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lang_bui_fuzz_str_offset_hex_n_uint_from_str_vs_cpp_b(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	...
	len_a = mk_lang_bui_fuzz_str_offset_hex_n_zzz_uint_from_str_hex_n(&bui_a, &str_a[0], sz);
	if(len_a >= 1)
	{
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lang_bui_fuzz_str_offset_hex_n(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	...
	mk_lang_bui_fuzz_str_offset_hex_n_uint_to_str_different(data, size);
	mk_lang_bui_fuzz_str_offset_hex_n_uint_to_str_different_full(data, size);
	mk_lang_bui_fuzz_str_offset_hex_n_uint_to_str_and_back(data, size);
	mk_lang_bui_fuzz_str_offset_hex_n_uint_to_str_and_back_full(data, size);
	mk_lang_bui_fuzz_str_offset_hex_n_uint_from_str_and_back(data, size);
	mk_lang_bui_fuzz_str_offset_hex_n_uint_from_str_vs_cpp_a(data, size);
	mk_lang_bui_fuzz_str_offset_hex_n_uint_from_str_vs_cpp_b(data, size);
}
