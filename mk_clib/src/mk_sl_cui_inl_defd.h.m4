...
#define mk_sl_cui_inl_defd_base_is_bit mk_lang_concat(mk_sl_cui_inl_defd_base, _is_bit)
...
#define mk_sl_cui_inl_defd_base_to_str_hexf_many_n mk_lang_concat(mk_sl_cui_inl_defd_base, _to_str_hexf_many_n)
#define mk_sl_cui_inl_defd_base_to_str_hexf_many_w mk_lang_concat(mk_sl_cui_inl_defd_base, _to_str_hexf_many_w)
