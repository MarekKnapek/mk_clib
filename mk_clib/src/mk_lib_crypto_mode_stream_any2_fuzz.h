#ifndef mk_include_guard_mk_lib_crypto_mode_stream_any2_fuzz_h
#define mk_include_guard_mk_lib_crypto_mode_stream_any2_fuzz_h
...
#include "mk_lib_crypto_mode_stream_any2_fuzz.c"
#endif
#endif
