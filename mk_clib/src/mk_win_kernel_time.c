...
mk_lang_extern_c mk_win_base_dll_import mk_win_base_dword_t mk_win_base_stdcall GetTickCount(mk_lang_types_void_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_lang_types_void_t mk_win_base_stdcall GetSystemTime(mk_win_kernel_time_system_time_lpt) mk_lang_noexcept;
