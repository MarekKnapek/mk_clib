...
enum mk_lang_stdout_posix_color_text_e
{
	mk_lang_stdout_posix_color_text_e_dark_black,
	mk_lang_stdout_posix_color_text_e_dark_red,
	mk_lang_stdout_posix_color_text_e_dark_green,
	mk_lang_stdout_posix_color_text_e_dark_blue,
	mk_lang_stdout_posix_color_text_e_dark_yellow,
	mk_lang_stdout_posix_color_text_e_dark_magenta,
	mk_lang_stdout_posix_color_text_e_dark_cyan,
	mk_lang_stdout_posix_color_text_e_dark_white,
	mk_lang_stdout_posix_color_text_e_light_black,
	mk_lang_stdout_posix_color_text_e_light_red,
	mk_lang_stdout_posix_color_text_e_light_green,
	mk_lang_stdout_posix_color_text_e_light_blue,
	mk_lang_stdout_posix_color_text_e_light_yellow,
	mk_lang_stdout_posix_color_text_e_light_magenta,
	mk_lang_stdout_posix_color_text_e_light_cyan,
	mk_lang_stdout_posix_color_text_e_light_white,
	mk_lang_stdout_posix_color_text_e_dummy_end
};
typedef enum mk_lang_stdout_posix_color_text_e mk_lang_stdout_posix_color_text_t;
...
#define mk_lang_stdout_posix_no_redirect_print_lit_n(x) mk_lang_stdout_posix_no_redirect_print_n(&(x)[0], mk_lang_countstr((x)))
#define mk_lang_stdout_posix_no_redirect_print_lit_w(x) mk_lang_stdout_posix_no_redirect_print_w(&(x)[0], mk_lang_countstr((x)))
#define mk_lang_stdout_posix_no_redirect_print_lit_t(x) mk_lang_stdout_posix_no_redirect_print_t(&(x)[0], mk_lang_countstr((x)))
#define mk_lang_stdout_posix_no_redirect_println_lit_n(x) mk_lang_stdout_posix_no_redirect_print_lit_n(x "\n")
#define mk_lang_stdout_posix_no_redirect_println_lit_w(x) mk_lang_stdout_posix_no_redirect_print_lit_w(x L"\n")
#define mk_lang_stdout_posix_no_redirect_println_lit_t(x) mk_lang_stdout_posix_no_redirect_print_lit_t(x mk_lang_tchar_c("\n"))
