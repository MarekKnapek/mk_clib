...
#define mk_sl_cui_uint64_base_type_name ulong
...
#define mk_sl_cui_uint64_base_type_name ullong
#define mk_sl_cui_uint64_c(a, b) {{ ((mk_sl_cui_uint64_zzz_base_t)(((mk_sl_cui_uint64_zzz_base_t)(((mk_sl_cui_uint64_zzz_base_t)(a)) << 32)) | ((mk_sl_cui_uint64_zzz_base_t)(b)))) }}
#elif mk_lang_charbit == 8 && mk_lang_sizeof_bi_uint_t == 4
#define mk_sl_cui_uint64_base_type_name uint
...
#define mk_sl_cui_uint64_base_sizeof mk_lang_concat(mk_lang_concat(mk_lang_sizeof_bi_, mk_sl_cui_uint64_base_type_name), _t)


#define mk_lang_bui_t_name mk_sl_cui_uint64_zzz_base
#define mk_lang_bui_t_base mk_sl_cui_uint64_base_type_name
#define mk_lang_bui_t_inline 1
#include "mk_lang_bui_inl_fileh.h"
#include "mk_lang_bui_inl_fileu.h"
#define mk_sl_cui_uint64_zzz_base_size_bits_d (mk_sl_cui_uint64_base_sizeof * mk_lang_charbit)

#define mk_sl_cui_t_name mk_sl_cui_uint64
#define mk_sl_cui_t_base_type_name mk_sl_cui_uint64_zzz_base
