#ifndef mk_include_guard_mk_lib_crypto_alg_serpent_fuzz_h
#define mk_include_guard_mk_lib_crypto_alg_serpent_fuzz_h
...
#include "mk_lib_crypto_alg_serpent_fuzz.c"
#endif
#endif
