...
union mk_lib_iip_cp_client_connection_any2_id_store_data_u
{
	mk_lib_iip_cp_client_connection_any1_id_t m_id;
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_iip_cp_client_connection_any2_id_store_data_u mk_lib_iip_cp_client_connection_any2_id_store_data_t;
struct mk_lib_iip_cp_client_connection_any2_id_store_s
{
	mk_lang_alignas(32) mk_lib_iip_cp_client_connection_any2_id_store_data_t m_data;
};
typedef struct mk_lib_iip_cp_client_connection_any2_id_store_s mk_lib_iip_cp_client_connection_any2_id_store_t;
mk_lang_typedef(mk_lib_iip_cp_client_connection_any2_id_store);
#include "mk_lang_warning_msvc_pop.h"


#include "mk_lang_warning_msvc_push_c4820.h"
mk_lib_iip_cp_client_connection_any_mm_per_type(`struct mk_lib_iip_cp_client_connection_any2_$1_s{ mk_lib_iip_cp_client_connection_any2_id_store_t m_id; $1_t m_$1; }; typedef struct mk_lib_iip_cp_client_connection_any2_$1_s mk_lib_iip_cp_client_connection_any2_$1_t; mk_lang_typedef(mk_lib_iip_cp_client_connection_any2_$1);', `
')
#include "mk_lang_warning_msvc_pop.h"
...
{
	mk_lib_iip_cp_client_connection_any2_id_store_t m_id;
