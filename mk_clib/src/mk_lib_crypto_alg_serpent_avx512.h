...
mk_lang_forceinline static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_serpent_avx512_hlp_ui_assign(mk_lib_crypto_alg_serpent_avx512_uint_prt const a, mk_lib_crypto_alg_serpent_avx512_uint_prct const b) mk_lang_noexcept;
mk_lang_forceinline static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_serpent_avx512_hlp_ui_and2(mk_lib_crypto_alg_serpent_avx512_uint_prt const a, mk_lib_crypto_alg_serpent_avx512_uint_prct const b) mk_lang_noexcept;
mk_lang_forceinline static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_serpent_avx512_hlp_ui_not1(mk_lib_crypto_alg_serpent_avx512_uint_pt const a) mk_lang_noexcept;
mk_lang_forceinline static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_serpent_avx512_hlp_ui_or2(mk_lib_crypto_alg_serpent_avx512_uint_prt const a, mk_lib_crypto_alg_serpent_avx512_uint_prct const b) mk_lang_noexcept;
mk_lang_forceinline static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_serpent_avx512_hlp_ui_rotl2(mk_lib_crypto_alg_serpent_avx512_uint_pt const a, mk_lang_types_sint_t const b) mk_lang_noexcept;
mk_lang_forceinline static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_serpent_avx512_hlp_ui_rotr2(mk_lib_crypto_alg_serpent_avx512_uint_pt const a, mk_lang_types_sint_t const b) mk_lang_noexcept;
mk_lang_forceinline static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_serpent_avx512_hlp_ui_shl3(mk_lib_crypto_alg_serpent_avx512_uint_prct const a, mk_lang_types_sint_t const b, mk_lib_crypto_alg_serpent_avx512_uint_prt const c) mk_lang_noexcept;
mk_lang_forceinline static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_serpent_avx512_hlp_ui_xor2(mk_lib_crypto_alg_serpent_avx512_uint_prt const a, mk_lib_crypto_alg_serpent_avx512_uint_prct const b) mk_lang_noexcept;
mk_lang_forceinline static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_serpent_avx512_hlp_ui_xor3(mk_lib_crypto_alg_serpent_avx512_uint_prct const a, mk_lib_crypto_alg_serpent_avx512_uint_prct const b, mk_lib_crypto_alg_serpent_avx512_uint_prt const c) mk_lang_noexcept;
mk_lang_forceinline static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_serpent_avx512_hlp_ui_broadcast(mk_lib_crypto_alg_serpent_avx512_uint_pt const a, mk_lib_crypto_alg_serpent_avx512_uints_pt const b) mk_lang_noexcept;
