...
typedef mk_lib_crypto_hash_block_sha2_base_64bit_aligned128_t* mk_lib_crypto_hash_block_sha2_base_64bit_aligned128_pt;
typedef mk_lib_crypto_hash_block_sha2_base_64bit_aligned128_t const* mk_lib_crypto_hash_block_sha2_base_64bit_aligned128_pct;

union mk_lib_crypto_hash_block_sha2_base_64bit_aligned64_u
{
	mk_lang_alignas(64) mk_sl_cui_uint8_t m_uint8s[64];
	mk_lang_types_ulllong_t m_ulllong;
};
typedef union mk_lib_crypto_hash_block_sha2_base_64bit_aligned64_u mk_lib_crypto_hash_block_sha2_base_64bit_aligned64_t;
typedef mk_lib_crypto_hash_block_sha2_base_64bit_aligned64_t const mk_lib_crypto_hash_block_sha2_base_64bit_aligned64_ct;
typedef mk_lib_crypto_hash_block_sha2_base_64bit_aligned64_t* mk_lib_crypto_hash_block_sha2_base_64bit_aligned64_pt;
typedef mk_lib_crypto_hash_block_sha2_base_64bit_aligned64_t const* mk_lib_crypto_hash_block_sha2_base_64bit_aligned64_pct;
...
typedef mk_lib_crypto_hash_block_sha2_base_64bit_aligned128_t mk_lib_crypto_hash_block_sha2_base_64bit_block_t;
...
typedef mk_lib_crypto_hash_block_sha2_base_64bit_aligned64_t mk_lib_crypto_hash_block_sha2_base_64bit_digest_t;
