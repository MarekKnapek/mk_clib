...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_session_task_prrw_gimme_msg(mk_lib_iip_cp_client_session_task_pt const task, mk_lib_iip_cp_message_ppt const msg) mk_lang_noexcept
{
	...
	mk_lang_assert
	(
		task->m_step == mk_lib_iip_cp_client_session_task_step_e_create_session_request_pickup ||
		task->m_step == mk_lib_iip_cp_client_session_task_step_e_want_to_send_msg_create_create_lease_set ||
		mk_lang_false
	);
	...
	*msg = &task->m_session.m_state.m_msg;
	...
	else if(task->m_step == mk_lib_iip_cp_client_session_task_step_e_create_session_request_pickup           ){ task->m_step = mk_lib_iip_cp_client_session_task_step_e_waiting_for_session_status; }
	else if(task->m_step == mk_lib_iip_cp_client_session_task_step_e_want_to_send_msg_create_create_lease_set){ task->m_step = mk_lib_iip_cp_client_session_task_step_e_idle                      ; }
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_session_task_prrw_on_msg_request_variable_lease_set(mk_lib_iip_cp_client_session_task_pt const task, mk_lib_iip_cp_message_pt const msg) mk_lang_noexcept
{
	...
	mk_lang_check_return(task->m_step == mk_lib_iip_cp_client_session_task_step_e_waiting_for_request_leaseset);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_session_task_prrw_step_create_session_request_construct(mk_lib_iip_cp_client_session_task_pt const task, mk_lib_iip_cp_client_session_task_result_pt const step_result) mk_lang_noexcept
{
	#define mk_lib_iip_cp_client_session_task_prrw_step_send_create_session_request_my_name "mk_clib_app_iip"
	...
	mk_lang_assert(task->m_step == mk_lib_iip_cp_client_session_task_step_e_create_session_request_construct);
	mk_lang_assert(!task->m_session.m_state.m_has_msg_pending);
	...
	mk_lang_string_memcpy_pc_fn(&str_pair->m_val.m_buf[0], &mk_lib_iip_cp_client_session_task_prrw_step_send_create_session_request_my_name[0], mk_lang_countstr(mk_lib_iip_cp_client_session_task_prrw_step_send_create_session_request_my_name)); str_pair->m_val.m_len = mk_lang_countstr(mk_lib_iip_cp_client_session_task_prrw_step_send_create_session_request_my_name);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_session_task_prrw_step_create_session_request_pickup(mk_lib_iip_cp_client_session_task_pt const task, mk_lib_iip_cp_client_session_task_result_pt const step_result) mk_lang_noexcept
{
	mk_lang_assert(task);
	mk_lang_assert(step_result);
	mk_lang_assert(*step_result == mk_lib_iip_cp_client_session_task_result_e_dummy_end);
	mk_lang_assert(task->m_step == mk_lib_iip_cp_client_session_task_step_e_create_session_request_pickup);
	mk_lang_assert(task->m_session.m_state.m_has_msg_pending);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_session_task_prrw_step_waiting_for_session_status(mk_lib_iip_cp_client_session_task_pt const task, mk_lib_iip_cp_client_session_task_result_pt const step_result) mk_lang_noexcept
{
	mk_lang_assert(task);
	mk_lang_assert(step_result);
	mk_lang_assert(*step_result == mk_lib_iip_cp_client_session_task_result_e_dummy_end);
	mk_lang_assert(task->m_step == mk_lib_iip_cp_client_session_task_step_e_waiting_for_session_status);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_session_task_prrw_step_waiting_for_request_leaseset(mk_lib_iip_cp_client_session_task_pt const task, mk_lib_iip_cp_client_session_task_result_pt const step_result) mk_lang_noexcept
{
	mk_lang_assert(task);
	mk_lang_assert(step_result);
	mk_lang_assert(*step_result == mk_lib_iip_cp_client_session_task_result_e_dummy_end);
	mk_lang_assert(task->m_step == mk_lib_iip_cp_client_session_task_step_e_waiting_for_request_leaseset);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_session_task_prrw_step_want_to_send_msg_create_create_lease_set(mk_lib_iip_cp_client_session_task_pt const task, mk_lib_iip_cp_client_session_task_result_pt const step_result) mk_lang_noexcept
{
	mk_lang_assert(task);
	mk_lang_assert(step_result);
	mk_lang_assert(*step_result == mk_lib_iip_cp_client_session_task_result_e_dummy_end);
	mk_lang_assert(task->m_step == mk_lib_iip_cp_client_session_task_step_e_want_to_send_msg_create_create_lease_set);
	mk_lang_assert(task->m_session.m_state.m_has_msg_pending);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_session_task_prrw_step(mk_lib_iip_cp_client_session_task_pt const task, mk_lib_iip_cp_client_session_task_result_pt const step_result) mk_lang_noexcept
{
	...
	switch(task->m_step)
	{
		case mk_lib_iip_cp_client_session_task_step_e_create_session_request_construct        : err = mk_lib_iip_cp_client_session_task_prrw_step_create_session_request_construct        (task, step_result); mk_lang_check_rereturn(err); mk_lang_assert(*step_result != mk_lib_iip_cp_client_session_task_result_e_dummy_end); break;
		case mk_lib_iip_cp_client_session_task_step_e_create_session_request_pickup           : err = mk_lib_iip_cp_client_session_task_prrw_step_create_session_request_pickup           (task, step_result); mk_lang_check_rereturn(err); mk_lang_assert(*step_result != mk_lib_iip_cp_client_session_task_result_e_dummy_end); break;
		case mk_lib_iip_cp_client_session_task_step_e_waiting_for_session_status              : err = mk_lib_iip_cp_client_session_task_prrw_step_waiting_for_session_status              (task, step_result); mk_lang_check_rereturn(err); mk_lang_assert(*step_result != mk_lib_iip_cp_client_session_task_result_e_dummy_end); break;
		case mk_lib_iip_cp_client_session_task_step_e_waiting_for_request_leaseset            : err = mk_lib_iip_cp_client_session_task_prrw_step_waiting_for_request_leaseset            (task, step_result); mk_lang_check_rereturn(err); mk_lang_assert(*step_result != mk_lib_iip_cp_client_session_task_result_e_dummy_end); break;
		case mk_lib_iip_cp_client_session_task_step_e_want_to_send_msg_create_create_lease_set: err = mk_lib_iip_cp_client_session_task_prrw_step_want_to_send_msg_create_create_lease_set(task, step_result); mk_lang_check_rereturn(err); mk_lang_assert(*step_result != mk_lib_iip_cp_client_session_task_result_e_dummy_end); break;
