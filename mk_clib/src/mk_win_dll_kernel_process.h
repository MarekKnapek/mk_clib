...
mk_win_base_typedef_func(mk_win_base_dword_t, mk_win_base_stdcall, mk_win_dll_kernel_process_thread_start_routine_t, (mk_win_base_void_lpt const parameter));
