...
enum mk_lib_iip_cp_message_host_lookup_request_type_val_e
{
	mk_lib_iip_cp_message_host_lookup_request_type_val_e_hash = 0,
	mk_lib_iip_cp_message_host_lookup_request_type_val_e_name = 1,
	mk_lib_iip_cp_message_host_lookup_request_type_val_e_dummy_end
};
typedef enum mk_lib_iip_cp_message_host_lookup_request_type_val_e mk_lib_iip_cp_message_host_lookup_request_type_val_t;
mk_lang_typedef(mk_lib_iip_cp_message_host_lookup_request_type_val);
...
enum mk_lib_iip_cp_message_certificate_type_val_e
{
	mk_lib_iip_cp_message_certificate_type_val_e_null     = 0,
	mk_lib_iip_cp_message_certificate_type_val_e_hashcash = 1,
	mk_lib_iip_cp_message_certificate_type_val_e_hidden   = 2,
	mk_lib_iip_cp_message_certificate_type_val_e_signed   = 3,
	mk_lib_iip_cp_message_certificate_type_val_e_multiple = 4,
	mk_lib_iip_cp_message_certificate_type_val_e_key      = 5,
	mk_lib_iip_cp_message_certificate_type_val_e_dummy_end
};
typedef enum mk_lib_iip_cp_message_certificate_type_val_e mk_lib_iip_cp_message_certificate_type_val_t;
mk_lang_typedef(mk_lib_iip_cp_message_certificate_type_val);
