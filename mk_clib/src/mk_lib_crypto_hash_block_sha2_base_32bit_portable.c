#ifndef mk_include_guard_mk_lib_crypto_hash_block_sha2_base_32bit_portable_c
#define mk_include_guard_mk_lib_crypto_hash_block_sha2_base_32bit_portable_c
...
union mk_lib_crypto_hash_block_sha2_base_32bit_portable_block2_data_u
{
	mk_lang_alignas(mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_len_v) mk_sl_cui_uint32_t m_uint32s[16];
	mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_t m_align;
};
typedef union mk_lib_crypto_hash_block_sha2_base_32bit_portable_block2_data_u mk_lib_crypto_hash_block_sha2_base_32bit_portable_block2_data_t;
struct mk_lib_crypto_hash_block_sha2_base_32bit_portable_block2_s
{
	mk_lib_crypto_hash_block_sha2_base_32bit_portable_block2_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_sha2_base_32bit_portable_block2_s mk_lib_crypto_hash_block_sha2_base_32bit_portable_block2_t;
mk_lang_typedef(mk_lib_crypto_hash_block_sha2_base_32bit_portable_block);
...
mk_lang_constexpr_static_inline mk_lib_crypto_hash_block_sha2_base_32bit_portable_table_t const mk_lib_crypto_hash_block_sha2_base_32bit_portable_k_table =
{{{
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_portable_ch(mk_sl_cui_uint32_prct const x, mk_sl_cui_uint32_prct const y, mk_sl_cui_uint32_prct const z, mk_sl_cui_uint32_prt const ret) mk_lang_noexcept
{
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_portable_maj(mk_sl_cui_uint32_prct const x, mk_sl_cui_uint32_prct const y, mk_sl_cui_uint32_prct const z, mk_sl_cui_uint32_prt const ret) mk_lang_noexcept
{
	mk_sl_cui_uint32_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint32_t tb mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_portable_sum0(mk_sl_cui_uint32_prct const x, mk_sl_cui_uint32_prt const ret) mk_lang_noexcept
{
	mk_sl_cui_uint32_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint32_t tb mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_portable_sum1(mk_sl_cui_uint32_prct const x, mk_sl_cui_uint32_prt const ret) mk_lang_noexcept
{
	mk_sl_cui_uint32_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint32_t tb mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_portable_sig0(mk_sl_cui_uint32_prct const x, mk_sl_cui_uint32_prt const ret) mk_lang_noexcept
{
	mk_sl_cui_uint32_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint32_t tb mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_portable_sig1(mk_sl_cui_uint32_prct const x, mk_sl_cui_uint32_prt const ret) mk_lang_noexcept
{
	mk_sl_cui_uint32_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint32_t tb mk_lang_constexpr_init;
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_portable_init(mk_lib_crypto_hash_block_sha2_base_32bit_portable_pt const sha2_base_32bit_portable, mk_lang_static_param(mk_sl_cui_uint32_ct, iv, 8)) mk_lang_noexcept
{
	...
	mk_lang_static_assert(sizeof(mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_t) == 64);
	mk_lang_static_assert(sizeof(mk_lib_crypto_hash_block_sha2_base_32bit_portable_digest_t) == 32);

	mk_lang_assert(sha2_base_32bit_portable);
	mk_lang_assert(iv);

	mk_lib_crypto_bitops_bulk_uint32_8_memcpy(&sha2_base_32bit_portable->m_state[0], &iv[0]);
	mk_sl_cui_uint64_set_zero(&sha2_base_32bit_portable->m_len);
}
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_portable_append_blocks(mk_lib_crypto_hash_block_sha2_base_32bit_portable_pt const sha2_base_32bit_portable, mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_pct const pblocks, mk_lang_types_usize_t const nblocks) mk_lang_noexcept
{
	...
	mk_lang_static_assert(sizeof(mk_lib_crypto_hash_block_sha2_base_32bit_portable_block2_t) == sizeof(mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_t));
	mk_lang_static_assert(mk_lang_alignof(mk_lib_crypto_hash_block_sha2_base_32bit_portable_block2_t) == mk_lang_alignof(mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_t));
	...
	mk_lang_assert(nblocks <= mk_lang_limits_usize_max / mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_len_v);
...
#include "mk_lang_warning_msvc_push_c5045.h"
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_portable_finish(mk_lib_crypto_hash_block_sha2_base_32bit_portable_pt const sha2_base_32bit_portable, mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_pt const block, mk_lang_types_sint_t const idx, mk_lib_crypto_hash_block_sha2_base_32bit_portable_digest_pt const digest) mk_lang_noexcept
{
	...
	mk_lang_assert(idx >= 0 && idx < mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_len_v);
	mk_lang_assert(digest);

	ui = mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_len_v; mk_sl_cui_uint64_from_bi_uint(&ta, &ui);
	mk_lang_assert(!mk_sl_cui_uint64_would_overflow_mul(&sha2_base_32bit_portable->m_len, &ta));
	mk_sl_cui_uint64_shl3(&sha2_base_32bit_portable->m_len, 6, &ta);
	...
	rest = mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_len_v - idx - 1;
	mk_lang_assert(rest >= 0 && rest <= mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_len_v - 1);
	...
	else
	{
		...
		mk_lib_crypto_hash_block_sha2_base_32bit_portable_append_blocks(sha2_base_32bit_portable, block, 1);
		mk_sl_cui_uint8_memclr_fn(&block->m_data.m_uint8s[0], ((mk_lang_types_sint_t)(mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_len_v)) - ((mk_lang_types_sint_t)(mk_sl_cui_uint64_size_bytes_v)));
	}

	mk_sl_uint_convert_64_8_be_to_sml(&ta, &block->m_data.m_uint8s[((mk_lang_types_sint_t)(mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_len_v)) - ((mk_lang_types_sint_t)(mk_sl_cui_uint64_size_bytes_v))]);
	mk_lib_crypto_hash_block_sha2_base_32bit_portable_append_blocks(sha2_base_32bit_portable, block, 1);
	for(i = 0; i != mk_lang_countof(sha2_base_32bit_portable->m_state); ++i)
	{
		mk_sl_uint_convert_32_8_be_to_sml(&sha2_base_32bit_portable->m_state[i], &digest->m_data.m_uint8s[i * mk_sl_cui_uint32_size_bytes_v]);
	}
}
#include "mk_lang_warning_msvc_pop.h"
