...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo mk_lang_types_sint_t mk_lang_overlap_inl_defd_fn2(mk_lang_overlap_inl_defd_type_pct const arr1, mk_lang_types_usize_t const len1, mk_lang_overlap_inl_defd_type_pct const arr2, mk_lang_types_usize_t const len2) mk_lang_noexcept
{
	mk_lang_types_usize_t it1 mk_lang_constexpr_init;
	mk_lang_types_usize_t it2 mk_lang_constexpr_init;
	...
	#include "mk_lang_warning_msvc_pop.h"
	{
		...
		else if(((mk_lang_types_uintptr_t)(arr1)) >= ((mk_lang_types_uintptr_t)(arr2)) && ((mk_lang_types_uintptr_t)(((mk_lang_types_sintptr_t)(arr1)))) < ((mk_lang_types_uintptr_t)(arr2 + len2)))
		{
			return 2; /* arr2 is on lower address */
		}
		else if(((mk_lang_types_uintptr_t)(arr2)) >= ((mk_lang_types_uintptr_t)(arr1)) && ((mk_lang_types_uintptr_t)(((mk_lang_types_sintptr_t)(arr2)))) < ((mk_lang_types_uintptr_t)(arr1 + len1)))
		{
			return 1; /* arr1 is on lower address */
		}
		else
		{
			return 0; /* no overlap */
