...
#ifndef mk_include_guard_mk_lib_crypto_alg_stream_any1_h
#define mk_include_guard_mk_lib_crypto_alg_stream_any1_h
...
define(`mk_lib_crypto_alg_stream_any1_h_mm_forwards', `dnl
mk_lang_forward(mk_lib_crypto_alg_stream_$1);
')`'dnl
mk_lib_crypto_alg_stream_mm_recurse(`mk_lib_crypto_alg_stream_any1_h_mm_forwards', mk_lib_crypto_alg_stream_mm_half())dnl

define(`mk_lib_crypto_alg_stream_any1_h_mm_key_forwards', `dnl
mk_lang_forward(mk_lib_crypto_alg_stream_$1_key);
')`'dnl
mk_lib_crypto_alg_stream_mm_recurse(`mk_lib_crypto_alg_stream_any1_h_mm_key_forwards', mk_lib_crypto_alg_stream_mm_half())dnl


enum mk_lib_crypto_alg_stream_any1_id_e
{
define(`mk_lib_crypto_alg_stream_any1_h_mm_enum', `dnl
	mk_lib_crypto_alg_stream_any1_id_e_$1,
')`'dnl
mk_lib_crypto_alg_stream_mm_recurse(`mk_lib_crypto_alg_stream_any1_h_mm_enum', mk_lib_crypto_alg_stream_mm_half())dnl
	mk_lib_crypto_alg_stream_any1_id_e_dummy_end
};
typedef enum mk_lib_crypto_alg_stream_any1_id_e mk_lib_crypto_alg_stream_any1_id_t;

union mk_lib_crypto_alg_stream_any1_bigid_data_u
{
	mk_lib_crypto_alg_stream_any1_id_t m_id;
	mk_lang_types_void_pt m_align;
};
typedef union mk_lib_crypto_alg_stream_any1_bigid_data_u mk_lib_crypto_alg_stream_any1_bigid_data_t;
struct mk_lib_crypto_alg_stream_any1_bigid_s
{
	mk_lib_crypto_alg_stream_any1_bigid_data_t m_data;
};
typedef struct mk_lib_crypto_alg_stream_any1_bigid_s mk_lib_crypto_alg_stream_any1_bigid_t;


union mk_lib_crypto_alg_stream_ckey_any1_ptr_data_u
{
	mk_lang_types_void_pct m_void;
define(`mk_lib_crypto_alg_stream_any1_h_mm_key_member_data', `dnl
	mk_lib_crypto_alg_stream_$1_key_pct m_$1;
')`'dnl
mk_lib_crypto_alg_stream_mm_recurse(`mk_lib_crypto_alg_stream_any1_h_mm_key_member_data', mk_lib_crypto_alg_stream_mm_half())dnl
};
typedef union mk_lib_crypto_alg_stream_ckey_any1_ptr_data_u mk_lib_crypto_alg_stream_ckey_any1_ptr_data_t;
struct mk_lib_crypto_alg_stream_ckey_any1_ptr_s
{
	mk_lib_crypto_alg_stream_ckey_any1_ptr_data_t m_data;
};
typedef struct mk_lib_crypto_alg_stream_ckey_any1_ptr_s mk_lib_crypto_alg_stream_ckey_any1_ptr_t;
mk_lang_typedef(mk_lib_crypto_alg_stream_ckey_any1_ptr);

union mk_lib_crypto_alg_stream_any1_ptr_data_u
{
	mk_lang_types_void_pt m_void;
define(`mk_lib_crypto_alg_stream_any1_h_mm_member_data', `dnl
	mk_lib_crypto_alg_stream_$1_pt m_$1;
')`'dnl
mk_lib_crypto_alg_stream_mm_recurse(`mk_lib_crypto_alg_stream_any1_h_mm_member_data', mk_lib_crypto_alg_stream_mm_half())dnl
};
typedef union mk_lib_crypto_alg_stream_any1_ptr_data_u mk_lib_crypto_alg_stream_any1_ptr_data_t;
struct mk_lib_crypto_alg_stream_any1_ptr_s
{
	mk_lib_crypto_alg_stream_any1_ptr_data_t m_data;
};
typedef struct mk_lib_crypto_alg_stream_any1_ptr_s mk_lib_crypto_alg_stream_any1_ptr_t;
mk_lang_typedef(mk_lib_crypto_alg_stream_any1_ptr);


struct mk_lib_crypto_alg_stream_any1_ptrid_s
{
	mk_lib_crypto_alg_stream_any1_bigid_t m_id;
	mk_lib_crypto_alg_stream_any1_ptr_t m_ptr;
};
typedef struct mk_lib_crypto_alg_stream_any1_ptrid_s mk_lib_crypto_alg_stream_any1_ptrid_t;
mk_lang_typedef(mk_lib_crypto_alg_stream_any1_ptrid);
...
#include "mk_lib_crypto_alg_stream_any1.c"
#endif
#endif
