...
enum mk_sl_io_reader_file_portable_err_e
{
	mk_sl_io_reader_file_portable_err_e_ok,
	mk_sl_io_reader_file_portable_err_e_eof,
	mk_sl_io_reader_file_portable_err_e_err,
	mk_sl_io_reader_file_portable_err_e_dummy
};
typedef enum mk_sl_io_reader_file_portable_err_e mk_sl_io_reader_file_portable_err_t;
