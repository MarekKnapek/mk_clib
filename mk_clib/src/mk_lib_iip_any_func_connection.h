...
enum mk_lib_iip_any_func_connection_type_e
{
	mk_lib_iip_any_func_connection_type_e_mk_lib_iip_cp_client_connection_task,
	mk_lib_iip_any_func_connection_type_e_mk_lib_iip_cp_client_local_client_task,
	mk_lib_iip_any_func_connection_type_e_mk_lib_iip_cp_client_local_listener_task,
	mk_lib_iip_any_func_connection_type_e_dummy_end
};
typedef enum mk_lib_iip_any_func_connection_type_e mk_lib_iip_any_func_connection_type_t;
mk_lang_typedef(mk_lib_iip_any_func_connection_type);
