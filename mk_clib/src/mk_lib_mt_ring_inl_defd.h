...
#define mk_lib_mt_ring_inl_defd_ro_wait_til_empty_for mk_lang_concat(mk_lib_mt_ring_inl_defd_name, _ro_wait_til_empty_for)
#define mk_lib_mt_ring_inl_defd_ro_wait_til_non_empty mk_lang_concat(mk_lib_mt_ring_inl_defd_name, _ro_wait_til_non_empty)
#define mk_lib_mt_ring_inl_defd_ro_wait_til_non_empty_for mk_lang_concat(mk_lib_mt_ring_inl_defd_name, _ro_wait_til_non_empty_for)
...
#define mk_lib_mt_ring_inl_defd_rw_wait_til_empty_for mk_lang_concat(mk_lib_mt_ring_inl_defd_name, _rw_wait_til_empty_for)
#define mk_lib_mt_ring_inl_defd_rw_wait_til_non_empty mk_lang_concat(mk_lib_mt_ring_inl_defd_name, _rw_wait_til_non_empty)
#define mk_lib_mt_ring_inl_defd_rw_wait_til_non_empty_for mk_lang_concat(mk_lib_mt_ring_inl_defd_name, _rw_wait_til_non_empty_for)
...
#define mk_lib_mt_ring_inl_defd_pr_try_pop_front_for_copy mk_lang_concat(mk_lib_mt_ring_inl_defd_name, _pr_try_pop_front_for_copy)
#define mk_lib_mt_ring_inl_defd_rw_try_pop_front_for_copy mk_lang_concat(mk_lib_mt_ring_inl_defd_name, _rw_try_pop_front_for_copy)
