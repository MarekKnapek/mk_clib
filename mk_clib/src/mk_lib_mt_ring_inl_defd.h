...
#define mk_lib_mt_ring_inl_defd_ring_rw_push_back mk_lang_concat(mk_lib_mt_ring_inl_defd_ring_name, _rw_push_back)
...
#define mk_lib_mt_ring_inl_defd_ring_rw_pop_front mk_lang_concat(mk_lib_mt_ring_inl_defd_ring_name, _rw_pop_front)
