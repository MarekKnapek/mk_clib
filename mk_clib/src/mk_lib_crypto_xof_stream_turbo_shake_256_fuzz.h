#ifndef mk_include_guard_mk_lib_crypto_xof_stream_turbo_shake_256_fuzz_h
#define mk_include_guard_mk_lib_crypto_xof_stream_turbo_shake_256_fuzz_h
...
#include "mk_lib_crypto_xof_stream_turbo_shake_256_fuzz.c"
#endif
#endif
