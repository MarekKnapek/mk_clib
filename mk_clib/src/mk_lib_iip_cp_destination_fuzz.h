#ifndef mk_include_guard_mk_lib_iip_cp_destination_fuzz_h
#define mk_include_guard_mk_lib_iip_cp_destination_fuzz_h
...
#include "mk_lib_iip_cp_destination_fuzz.c"
#endif
#endif
