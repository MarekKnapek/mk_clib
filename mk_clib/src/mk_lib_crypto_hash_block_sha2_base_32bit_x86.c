...
mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_x86_init(mk_lib_crypto_hash_block_sha2_base_32bit_x86_pt const sha2_base_32bit_x86, mk_lang_static_param(mk_sl_cui_uint32_ct, iv, 8)) mk_lang_noexcept
{
...
mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_x86_append_blocks(mk_lib_crypto_hash_block_sha2_base_32bit_x86_pt const sha2_base_32bit_x86, mk_lib_crypto_hash_block_sha2_base_32bit_x86_block_pct const pblocks, mk_lang_types_usize_t const nblocks) mk_lang_noexcept
{
...
mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_x86_finish(mk_lib_crypto_hash_block_sha2_base_32bit_x86_pt const sha2_base_32bit_x86, mk_lib_crypto_hash_block_sha2_base_32bit_x86_block_pt const block, mk_lang_types_sint_t const idx, mk_lib_crypto_hash_block_sha2_base_32bit_x86_digest_pt const digest) mk_lang_noexcept
{
	...
	for(i = 0; i != 8; ++i)
	{
		mk_sl_uint_convert_32_8_be_to_sml(&sha2_base_32bit_x86->m_state[i], &digest->m_data.m_uint8s[i * 4]);
	}
}
#include "mk_lang_warning_msvc_pop.h"
