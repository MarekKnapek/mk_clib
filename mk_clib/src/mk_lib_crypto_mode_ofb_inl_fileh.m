define(`mk_lib_crypto_mode_ofb_inl_defd_base_file_name', `mk_lang_concat(`mk_lib_crypto_alg_', mk_lib_crypto_mode_ofb_t_alg)')dnl
define(`mk_lib_crypto_mode_ofb_inl_defd_key_len_m', `mk_lang_concat(`mk_lib_crypto_mode_ofb_', mk_lib_crypto_mode_ofb_t_name, `_key_len_m')')dnl
define(`mk_lib_crypto_mode_ofb_inl_defd_msg_len_m', `mk_lang_concat(`mk_lib_crypto_mode_ofb_', mk_lib_crypto_mode_ofb_t_name, `_msg_len_m')')dnl
define(`mk_lib_crypto_mode_ofb_inl_defd_schedule_len_m', `mk_lang_concat(`mk_lib_crypto_mode_ofb_', mk_lib_crypto_mode_ofb_t_name, `_schedule_len_m')')dnl
define(`mk_lib_crypto_mode_ofb_inl_defd_iv_len_m', `mk_lang_concat(`mk_lib_crypto_mode_ofb_', mk_lib_crypto_mode_ofb_t_name, `_iv_len_m')')dnl
#include "mk_lang_types.h"
`#include' "mk_lib_crypto_mode_ofb_inl_defd_base_file_name.h"
...
enum mk_lib_crypto_mode_ofb_inl_defd_schedule_len_e { mk_lib_crypto_mode_ofb_inl_defd_schedule_len_v = mk_lib_crypto_mode_ofb_inl_defd_schedule_len_m };
...
typedef mk_lib_crypto_mode_ofb_inl_defd_alg_msg_t mk_lib_crypto_mode_ofb_inl_defd_iv_t;
typedef mk_lib_crypto_mode_ofb_inl_defd_iv_t const mk_lib_crypto_mode_ofb_inl_defd_iv_ct;
typedef mk_lib_crypto_mode_ofb_inl_defd_iv_t* mk_lib_crypto_mode_ofb_inl_defd_iv_pt;
typedef mk_lib_crypto_mode_ofb_inl_defd_iv_t const* mk_lib_crypto_mode_ofb_inl_defd_iv_pct;

typedef mk_lib_crypto_mode_ofb_inl_defd_alg_schedule_t mk_lib_crypto_mode_ofb_inl_defd_schedule_t;
typedef mk_lib_crypto_mode_ofb_inl_defd_schedule_t const mk_lib_crypto_mode_ofb_inl_defd_schedule_ct;
typedef mk_lib_crypto_mode_ofb_inl_defd_schedule_t* mk_lib_crypto_mode_ofb_inl_defd_schedule_pt;
typedef mk_lib_crypto_mode_ofb_inl_defd_schedule_t const* mk_lib_crypto_mode_ofb_inl_defd_schedule_pct;
