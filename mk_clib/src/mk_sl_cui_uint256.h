...
#define mk_sl_cui_uint256_base_type_name ulllong
#elif mk_lang_charbit == 8 && mk_lang_sizeof_bi_ulong_t == 8
#define mk_sl_cui_uint256_base_type_name ulong
#elif mk_lang_charbit == 8 && mk_lang_sizeof_bi_ullong_t == 8
#define mk_sl_cui_uint256_base_type_name ullong
#elif mk_lang_charbit == 8 && mk_lang_sizeof_bi_uint_t == 4
#define mk_sl_cui_uint256_base_type_name uint
...
#define mk_sl_cui_uint256_base_sizeof mk_lang_concat(mk_lang_concat(mk_lang_sizeof_bi_, mk_sl_cui_uint256_base_type_name), _t)
