...
`inbound_backup_quantity', `outbound.allowZeroHop',
`inbound_ip_restriction', `inbound.backupQuantity',
`inbound_length', `outbound.backupQuantity',
`inbound_length_variance', `inbound.IPRestriction',
`inbound_nickname', `outbound.IPRestriction',
`inbound_quantity', `inbound.length',
`inbound_random_key', `outbound.length',
`outbound_allow_zero_hop', `inbound.lengthVariance',
`outbound_backup_quantity', `outbound.lengthVariance',
`outbound_ip_restriction', `inbound.nickname',
`outbound_length', `outbound.nickname',
`outbound_length_variance', `outbound.priority',
`outbound_nickname', `inbound.quantity',
`outbound_priority', `outbound.quantity',
`outbound_quantity', `inbound.randomKey',
