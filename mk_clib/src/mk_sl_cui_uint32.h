...
#define mk_sl_cui_uint32_base_type_name uint
#define mk_sl_cui_uint32_c(x) {{ ((mk_sl_cui_uint32_zzz_base_t)(x)) }}
#elif mk_lang_charbit == 8 && mk_lang_sizeof_bi_ulong_t == 4
#define mk_sl_cui_uint32_base_type_name ulong
#define mk_sl_cui_uint32_c(x) {{ ((mk_sl_cui_uint32_zzz_base_t)(x)) }}
#else
#error xxxxxxxxxx
#endif

#define mk_sl_cui_uint32_base_sizeof mk_lang_concat(mk_lang_concat(mk_lang_sizeof_bi_, mk_sl_cui_uint32_base_type_name), _t)


#define mk_lang_bui_t_name mk_sl_cui_uint32_zzz_base
#define mk_lang_bui_t_base mk_sl_cui_uint32_base_type_name
#define mk_lang_bui_t_inline 1
#include "mk_lang_bui_inl_fileh.h"
#include "mk_lang_bui_inl_fileu.h"
#define mk_sl_cui_uint32_zzz_base_size_bits_d (mk_sl_cui_uint32_base_sizeof * mk_lang_charbit)
...
#define mk_lang_memall2_t_name mk_sl_cui_uint32
#define mk_lang_memall2_t_tn mk_sl_cui_uint32
