#ifndef mk_include_guard_mk_lib_iip_key_enc_elgamal_cryptopp_h
#define mk_include_guard_mk_lib_iip_key_enc_elgamal_cryptopp_h
...
#define mk_lib_iip_key_enc_elgamal_cryptopp_pri_len_d 256
#define mk_lib_iip_key_enc_elgamal_cryptopp_pub_len_d 256

enum mk_lib_iip_key_enc_elgamal_cryptopp_pri_len_e{ mk_lib_iip_key_enc_elgamal_cryptopp_pri_len_v = mk_lib_iip_key_enc_elgamal_cryptopp_pri_len_d }; typedef enum mk_lib_iip_key_enc_elgamal_cryptopp_pri_len_e mk_lib_iip_key_enc_elgamal_cryptopp_pri_len_t;
enum mk_lib_iip_key_enc_elgamal_cryptopp_pub_len_e{ mk_lib_iip_key_enc_elgamal_cryptopp_pub_len_v = mk_lib_iip_key_enc_elgamal_cryptopp_pub_len_d }; typedef enum mk_lib_iip_key_enc_elgamal_cryptopp_pub_len_e mk_lib_iip_key_enc_elgamal_cryptopp_pub_len_t;
...
#define mk_lib_iip_key_enc_elgamal_cryptopp_integer_pri_single_size_bytes_d mk_lib_iip_key_enc_elgamal_cryptopp_pri_len_d
#define mk_lib_iip_key_enc_elgamal_cryptopp_integer_pri_single_size_bits_d (mk_lib_iip_key_enc_elgamal_cryptopp_pri_len_d * mk_lang_charbit)
...
#include "mk_sl_cui_inl_fileh.h"
#include "mk_sl_cui_inl_fileu.h"
#define mk_lib_iip_key_enc_elgamal_cryptopp_integer_pub_single_size_bytes_d mk_lib_iip_key_enc_elgamal_cryptopp_pub_len_d
#define mk_lib_iip_key_enc_elgamal_cryptopp_integer_pub_single_size_bits_d (mk_lib_iip_key_enc_elgamal_cryptopp_pub_len_d * mk_lang_charbit)


union mk_lib_iip_key_enc_elgamal_cryptopp_digest_data_u
{
	mk_sl_cui_uint8_t m_uint8s[32];
	mk_lang_types_uint_t m_align;
};
typedef union mk_lib_iip_key_enc_elgamal_cryptopp_digest_data_u mk_lib_iip_key_enc_elgamal_cryptopp_digest_data_t;
struct mk_lib_iip_key_enc_elgamal_cryptopp_digest_s
{
	mk_lib_iip_key_enc_elgamal_cryptopp_digest_data_t m_data;
};
typedef struct mk_lib_iip_key_enc_elgamal_cryptopp_digest_s mk_lib_iip_key_enc_elgamal_cryptopp_digest_t;
mk_lang_typedef(mk_lib_iip_key_enc_elgamal_cryptopp_digest);

union mk_lib_iip_key_enc_elgamal_cryptopp_signature_data_u
{
	mk_sl_cui_uint8_t m_uint8s[32];
	mk_lang_types_uint_t m_align;
};
typedef union mk_lib_iip_key_enc_elgamal_cryptopp_signature_data_u mk_lib_iip_key_enc_elgamal_cryptopp_signature_data_t;
struct mk_lib_iip_key_enc_elgamal_cryptopp_signature_s
{
	mk_lib_iip_key_enc_elgamal_cryptopp_signature_data_t m_data;
};
typedef struct mk_lib_iip_key_enc_elgamal_cryptopp_signature_s mk_lib_iip_key_enc_elgamal_cryptopp_signature_t;
mk_lang_typedef(mk_lib_iip_key_enc_elgamal_cryptopp_signature);


struct mk_lib_iip_key_enc_elgamal_cryptopp_pri_s
{
	mk_lib_iip_key_enc_elgamal_cryptopp_integer_pri_single_t m_integer;
};
typedef struct mk_lib_iip_key_enc_elgamal_cryptopp_pri_s mk_lib_iip_key_enc_elgamal_cryptopp_pri_t;
mk_lang_typedef(mk_lib_iip_key_enc_elgamal_cryptopp_pri);

struct mk_lib_iip_key_enc_elgamal_cryptopp_pub_s
{
	mk_lib_iip_key_enc_elgamal_cryptopp_integer_pub_single_t m_integer;
};
typedef struct mk_lib_iip_key_enc_elgamal_cryptopp_pub_s mk_lib_iip_key_enc_elgamal_cryptopp_pub_t;
mk_lang_typedef(mk_lib_iip_key_enc_elgamal_cryptopp_pub);
...
#include "mk_lib_iip_key_enc_elgamal_cryptopp.c"
#endif
#endif
