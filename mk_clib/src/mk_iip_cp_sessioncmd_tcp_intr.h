#ifndef mk_include_guard_mk_iip_cp_sessioncmd_tcp_intr_h
#define mk_include_guard_mk_iip_cp_sessioncmd_tcp_intr_h
...
mk_lang_struct_forward(mk_iip_cp_sessioncmd_tcp_impl);
mk_lang_struct_forward(mk_iip_cp_socket_tcp_intr);
mk_lang_struct_forward(mk_iip_cp_type_sessionid);


struct mk_iip_cp_sessioncmd_tcp_intr_s
{
	mk_iip_cp_sessioncmd_tcp_impl_pt m_sessioncmd_tcp_impl;
};
typedef struct mk_iip_cp_sessioncmd_tcp_intr_s mk_iip_cp_sessioncmd_tcp_intr_t;
mk_lang_struct_typedef(mk_iip_cp_sessioncmd_tcp_intr);
...
#include "mk_iip_cp_sessioncmd_tcp_intr.c"
#endif
#endif
