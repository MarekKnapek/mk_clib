#ifndef mk_include_guard_mk_lib_iip_key_sgn_dsa_sha1_fuzz_h
#define mk_include_guard_mk_lib_iip_key_sgn_dsa_sha1_fuzz_h
...
#include "mk_lib_iip_key_sgn_dsa_sha1_fuzz.c"
#endif
#endif
