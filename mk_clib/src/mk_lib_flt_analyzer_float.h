#ifndef mk_include_guard_mk_lib_flt_analyzer_float
#define mk_include_guard_mk_lib_flt_analyzer_float
...
#define mk_lib_flt_analyzer_t_name mk_lib_flt_analyzer_float
...
#include "mk_lib_flt_analyzer_float.c"
#endif
#endif
