...
#undef mk_lang_bui_divmod_inl_defd_lena
#undef mk_lang_bui_divmod_inl_defd_lenb
#undef mk_lang_bui_divmod_inl_defd_endian
#undef mk_lang_bui_divmod_inl_defd_alg
#undef mk_lang_bui_divmod_inl_defd_name
...
#undef mk_lang_bui_divmod_inl_defd_endian_idxc
#undef mk_lang_bui_divmod_inl_defd_endian_idxd

#undef mk_lang_bui_divmod_inl_defd_valid
