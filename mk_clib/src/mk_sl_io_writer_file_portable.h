#ifndef mk_include_guard_mk_sl_io_writer_file_portable_h
#define mk_include_guard_mk_sl_io_writer_file_portable_h
...
mk_lang_typedef(mk_sl_io_writer_file_portable);
