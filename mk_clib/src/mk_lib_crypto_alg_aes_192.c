...
{
	mk_sl_cui_uint8_t m_uint8s[mk_lib_crypto_alg_aes_192_sbox_len];
...
{
	mk_sl_cui_uint8_t m_uint8s[mk_lib_crypto_alg_aes_192_word_bytes];
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_sub_byte(mk_sl_cui_uint8_pct const a, mk_sl_cui_uint8_pt const b) mk_lang_noexcept
{
	...
	*b = s_mk_lib_crypto_alg_aes_192_sbox.m_data.m_uint8s[uc];
}

mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_inv_sub_byte(mk_sl_cui_uint8_pct const a, mk_sl_cui_uint8_pt const b) mk_lang_noexcept
{
	mk_lang_types_uchar_t uc mk_lang_constexpr_init;
	...
	mk_sl_cui_uint8_to_bi_uchar(a, &uc);
	*b = s_mk_lib_crypto_alg_aes_192_inv_sbox.m_data.m_uint8s[uc];
}

mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_sub_bytes(mk_lib_crypto_alg_aes_192_msg_pct const a, mk_lib_crypto_alg_aes_192_msg_pt const b) mk_lang_noexcept
{
	...
	{
		mk_lib_crypto_alg_aes_192_sub_byte(&a->m_data.m_uint8s[i], &b->m_data.m_uint8s[i]);
	}
}

mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_inv_sub_bytes(mk_lib_crypto_alg_aes_192_msg_pct const a, mk_lib_crypto_alg_aes_192_msg_pt const b) mk_lang_noexcept
{
	int i mk_lang_constexpr_init;
	...
	for(i = 0; i != mk_lib_crypto_alg_aes_192_msg_len_v; ++i)
	{
		mk_lib_crypto_alg_aes_192_inv_sub_byte(&a->m_data.m_uint8s[i], &b->m_data.m_uint8s[i]);
	}
}

mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_shift_rows(mk_lib_crypto_alg_aes_192_msg_pct const a, mk_lib_crypto_alg_aes_192_msg_pt const b) mk_lang_noexcept
{
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_inv_shift_rows(mk_lib_crypto_alg_aes_192_msg_pct const a, mk_lib_crypto_alg_aes_192_msg_pt const b) mk_lang_noexcept
{
	mk_sl_cui_uint8_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint8_t tb mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_mul_1(mk_sl_cui_uint8_pct const a, mk_sl_cui_uint8_pt const b) mk_lang_noexcept
{
	mk_lang_assert(a);
	mk_lang_assert(b);
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_mul_2(mk_sl_cui_uint8_pct const a, mk_sl_cui_uint8_pt const b) mk_lang_noexcept
{
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_mul_3(mk_sl_cui_uint8_pct const a, mk_sl_cui_uint8_pt const b) mk_lang_noexcept
{
	mk_sl_cui_uint8_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint8_t tb mk_lang_constexpr_init;
	...
	ta = *a;
	tb = *a;
	mk_lib_crypto_alg_aes_192_mul_2(&ta, &ta);
	mk_lib_crypto_alg_aes_192_mul_1(&tb, &tb);
	mk_sl_cui_uint8_xor2(&ta, &tb);
	*b = ta;
}

mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_mul_4(mk_sl_cui_uint8_pct const a, mk_sl_cui_uint8_pt const b) mk_lang_noexcept
{
	mk_sl_cui_uint8_t ta mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_mul_8(mk_sl_cui_uint8_pct const a, mk_sl_cui_uint8_pt const b) mk_lang_noexcept
{
	mk_sl_cui_uint8_t ta mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_mul_9(mk_sl_cui_uint8_pct const a, mk_sl_cui_uint8_pt const b) mk_lang_noexcept
{
	mk_sl_cui_uint8_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint8_t tb mk_lang_constexpr_init;
	...
	ta = *a;
	tb = *a;
	mk_lib_crypto_alg_aes_192_mul_8(&ta, &ta);
	mk_lib_crypto_alg_aes_192_mul_1(&tb, &tb);
	mk_sl_cui_uint8_xor2(&ta, &tb);
	*b = ta;
}

mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_mul_b(mk_sl_cui_uint8_pct const a, mk_sl_cui_uint8_pt const b) mk_lang_noexcept
{
	mk_sl_cui_uint8_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint8_t tb mk_lang_constexpr_init;
	mk_sl_cui_uint8_t tc mk_lang_constexpr_init;
	...
	tc = *a;
	mk_lib_crypto_alg_aes_192_mul_8(&ta, &ta);
	mk_lib_crypto_alg_aes_192_mul_2(&tb, &tb);
	mk_lib_crypto_alg_aes_192_mul_1(&tc, &tc);
	mk_sl_cui_uint8_xor2(&ta, &tb);
	mk_sl_cui_uint8_xor2(&ta, &tc);
	*b = ta;
}

mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_mul_d(mk_sl_cui_uint8_pct const a, mk_sl_cui_uint8_pt const b) mk_lang_noexcept
{
	mk_sl_cui_uint8_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint8_t tb mk_lang_constexpr_init;
	mk_sl_cui_uint8_t tc mk_lang_constexpr_init;
	...
	tc = *a;
	mk_lib_crypto_alg_aes_192_mul_8(&ta, &ta);
	mk_lib_crypto_alg_aes_192_mul_4(&tb, &tb);
	mk_lib_crypto_alg_aes_192_mul_1(&tc, &tc);
	mk_sl_cui_uint8_xor2(&ta, &tb);
	mk_sl_cui_uint8_xor2(&ta, &tc);
	*b = ta;
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_mul_e(mk_sl_cui_uint8_pct const a, mk_sl_cui_uint8_pt const b) mk_lang_noexcept
{
	mk_sl_cui_uint8_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint8_t tb mk_lang_constexpr_init;
	mk_sl_cui_uint8_t tc mk_lang_constexpr_init;
	...
	mk_lib_crypto_alg_aes_192_mul_8(&ta, &ta);
	mk_lib_crypto_alg_aes_192_mul_4(&tb, &tb);
	mk_lib_crypto_alg_aes_192_mul_2(&tc, &tc);
	mk_sl_cui_uint8_xor2(&ta, &tb);
	mk_sl_cui_uint8_xor2(&ta, &tc);
	*b = ta;
}

mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_mix_columns(mk_lib_crypto_alg_aes_192_msg_pct const a, mk_lib_crypto_alg_aes_192_msg_pt const b) mk_lang_noexcept
{
	...
	for(i = 0; i != 4; ++i)
	{
		mk_lib_crypto_alg_aes_192_mul_2(&orig.m_data.m_uint8s[i * 4 + 0], &ta);
		mk_lib_crypto_alg_aes_192_mul_3(&orig.m_data.m_uint8s[i * 4 + 1], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &tc);
		mk_lib_crypto_alg_aes_192_mul_1(&orig.m_data.m_uint8s[i * 4 + 2], &ta);
		mk_lib_crypto_alg_aes_192_mul_1(&orig.m_data.m_uint8s[i * 4 + 3], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &td);
		mk_sl_cui_uint8_xor3(&tc, &td, &b->m_data.m_uint8s[i * 4 + 0]);
		mk_lib_crypto_alg_aes_192_mul_1(&orig.m_data.m_uint8s[i * 4 + 0], &ta);
		mk_lib_crypto_alg_aes_192_mul_2(&orig.m_data.m_uint8s[i * 4 + 1], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &tc);
		mk_lib_crypto_alg_aes_192_mul_3(&orig.m_data.m_uint8s[i * 4 + 2], &ta);
		mk_lib_crypto_alg_aes_192_mul_1(&orig.m_data.m_uint8s[i * 4 + 3], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &td);
		mk_sl_cui_uint8_xor3(&tc, &td, &b->m_data.m_uint8s[i * 4 + 1]);
		mk_lib_crypto_alg_aes_192_mul_1(&orig.m_data.m_uint8s[i * 4 + 0], &ta);
		mk_lib_crypto_alg_aes_192_mul_1(&orig.m_data.m_uint8s[i * 4 + 1], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &tc);
		mk_lib_crypto_alg_aes_192_mul_2(&orig.m_data.m_uint8s[i * 4 + 2], &ta);
		mk_lib_crypto_alg_aes_192_mul_3(&orig.m_data.m_uint8s[i * 4 + 3], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &td);
		mk_sl_cui_uint8_xor3(&tc, &td, &b->m_data.m_uint8s[i * 4 + 2]);
		mk_lib_crypto_alg_aes_192_mul_3(&orig.m_data.m_uint8s[i * 4 + 0], &ta);
		mk_lib_crypto_alg_aes_192_mul_1(&orig.m_data.m_uint8s[i * 4 + 1], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &tc);
		mk_lib_crypto_alg_aes_192_mul_1(&orig.m_data.m_uint8s[i * 4 + 2], &ta);
		mk_lib_crypto_alg_aes_192_mul_2(&orig.m_data.m_uint8s[i * 4 + 3], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &td);
		mk_sl_cui_uint8_xor3(&tc, &td, &b->m_data.m_uint8s[i * 4 + 3]);
	}
}

mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_inv_mix_columns(mk_lib_crypto_alg_aes_192_msg_pct const a, mk_lib_crypto_alg_aes_192_msg_pt const b) mk_lang_noexcept
{
	mk_lib_crypto_alg_aes_192_msg_t orig mk_lang_constexpr_init;
	mk_sl_cui_uint8_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint8_t tb mk_lang_constexpr_init;
	...
	for(i = 0; i != 4; ++i)
	{
		mk_lib_crypto_alg_aes_192_mul_e(&orig.m_data.m_uint8s[i * 4 + 0], &ta);
		mk_lib_crypto_alg_aes_192_mul_b(&orig.m_data.m_uint8s[i * 4 + 1], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &tc);
		mk_lib_crypto_alg_aes_192_mul_d(&orig.m_data.m_uint8s[i * 4 + 2], &ta);
		mk_lib_crypto_alg_aes_192_mul_9(&orig.m_data.m_uint8s[i * 4 + 3], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &td);
		mk_sl_cui_uint8_xor3(&tc, &td, &b->m_data.m_uint8s[i * 4 + 0]);
		mk_lib_crypto_alg_aes_192_mul_9(&orig.m_data.m_uint8s[i * 4 + 0], &ta);
		mk_lib_crypto_alg_aes_192_mul_e(&orig.m_data.m_uint8s[i * 4 + 1], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &tc);
		mk_lib_crypto_alg_aes_192_mul_b(&orig.m_data.m_uint8s[i * 4 + 2], &ta);
		mk_lib_crypto_alg_aes_192_mul_d(&orig.m_data.m_uint8s[i * 4 + 3], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &td);
		mk_sl_cui_uint8_xor3(&tc, &td, &b->m_data.m_uint8s[i * 4 + 1]);
		mk_lib_crypto_alg_aes_192_mul_d(&orig.m_data.m_uint8s[i * 4 + 0], &ta);
		mk_lib_crypto_alg_aes_192_mul_9(&orig.m_data.m_uint8s[i * 4 + 1], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &tc);
		mk_lib_crypto_alg_aes_192_mul_e(&orig.m_data.m_uint8s[i * 4 + 2], &ta);
		mk_lib_crypto_alg_aes_192_mul_b(&orig.m_data.m_uint8s[i * 4 + 3], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &td);
		mk_sl_cui_uint8_xor3(&tc, &td, &b->m_data.m_uint8s[i * 4 + 2]);
		mk_lib_crypto_alg_aes_192_mul_b(&orig.m_data.m_uint8s[i * 4 + 0], &ta);
		mk_lib_crypto_alg_aes_192_mul_d(&orig.m_data.m_uint8s[i * 4 + 1], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &tc);
		mk_lib_crypto_alg_aes_192_mul_9(&orig.m_data.m_uint8s[i * 4 + 2], &ta);
		mk_lib_crypto_alg_aes_192_mul_e(&orig.m_data.m_uint8s[i * 4 + 3], &tb);
		mk_sl_cui_uint8_xor3(&ta, &tb, &td);
		mk_sl_cui_uint8_xor3(&tc, &td, &b->m_data.m_uint8s[i * 4 + 3]);
	}
}

mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_add_key(mk_lib_crypto_alg_aes_192_msg_pct const a, mk_lib_crypto_alg_aes_192_msg_pct const b, mk_lib_crypto_alg_aes_192_msg_pt const c) mk_lang_noexcept
{
	int i mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_rot_word(mk_lib_crypto_alg_aes_192_word_pct const a, mk_lib_crypto_alg_aes_192_word_pt const b) mk_lang_noexcept
{
	mk_sl_cui_uint8_t ta mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_sub_word(mk_lib_crypto_alg_aes_192_word_pct const a, mk_lib_crypto_alg_aes_192_word_pt const b) mk_lang_noexcept
{
	int i mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_xor_word(mk_lib_crypto_alg_aes_192_word_pct const a, mk_sl_cui_uint8_pct const b, mk_lib_crypto_alg_aes_192_word_pt const c, mk_sl_cui_uint8_pt const d) mk_lang_noexcept
{
	mk_lang_assert(a);
	mk_lang_assert(b);
	mk_lang_assert(c);
	...
	mk_lib_crypto_alg_aes_192_mul_2(b, d);
}
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_generate_keys(mk_lib_crypto_alg_aes_192_key_pct const key, mk_lib_crypto_alg_aes_192_msg_pt const keys) mk_lang_noexcept
{
	...
	for(i = 0; i != mk_lib_crypto_alg_aes_192_key_len_m; ++i){ keys[get_outer(i)].m_data.m_uint8s[get_inner(i)] = key->m_data.m_uint8s[i]; }
	for(i = mk_lib_crypto_alg_aes_192_key_words; i != (mk_lib_crypto_alg_aes_192_nr + 1) * mk_lib_crypto_alg_aes_192_msg_words; ++i)
	{
		...
		for(j = 0; j != mk_lib_crypto_alg_aes_192_word_bytes; ++j){ tmp.m_data.m_uint8s[j] = keys[get_outer(idx_prev + j)].m_data.m_uint8s[get_inner(idx_prev + j)]; }
		if(i % mk_lib_crypto_alg_aes_192_key_words == 0)
		{
			mk_lib_crypto_alg_aes_192_rot_word(&tmp, &tmp);
			mk_lib_crypto_alg_aes_192_sub_word(&tmp, &tmp);
			mk_lib_crypto_alg_aes_192_xor_word(&tmp, &rcon, &tmp, &rcon);
		}
		...
		for(j = 0; j != mk_lib_crypto_alg_aes_192_word_bytes; ++j)
		{
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_c_encrypt(mk_lib_crypto_alg_aes_192_key_pct const key, mk_lib_crypto_alg_aes_192_msg_pct const input, mk_lib_crypto_alg_aes_192_msg_pt const output) mk_lang_noexcept
{
	...
	state = *input;
	mk_lib_crypto_alg_aes_192_generate_keys(key, &keys[0]);
	mk_lib_crypto_alg_aes_192_add_key(&state, &keys[0], &state);
	for(ir = 0; ir != mk_lib_crypto_alg_aes_192_nr - 1; ++ir)
	{
		mk_lib_crypto_alg_aes_192_sub_bytes(&state, &state);
		mk_lib_crypto_alg_aes_192_shift_rows(&state, &state);
		mk_lib_crypto_alg_aes_192_mix_columns(&state, &state);
		mk_lib_crypto_alg_aes_192_add_key(&state, &keys[ir + 1], &state);
	}
	mk_lib_crypto_alg_aes_192_sub_bytes(&state, &state);
	mk_lib_crypto_alg_aes_192_shift_rows(&state, &state);
	mk_lib_crypto_alg_aes_192_add_key(&state, &keys[mk_lib_crypto_alg_aes_192_nr], &state);
	*output = state;
}
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_alg_aes_192_c_decrypt(mk_lib_crypto_alg_aes_192_key_pct const key, mk_lib_crypto_alg_aes_192_msg_pct const input, mk_lib_crypto_alg_aes_192_msg_pt const output) mk_lang_noexcept
{
	...
	for(ir = 0; ir != mk_lib_crypto_alg_aes_192_nr - 1; ++ir)
	{
		mk_lib_crypto_alg_aes_192_inv_shift_rows(&state, &state);
		mk_lib_crypto_alg_aes_192_inv_sub_bytes(&state, &state);
		mk_lib_crypto_alg_aes_192_add_key(&state, &keys[mk_lib_crypto_alg_aes_192_nr - (ir + 1)], &state);
		mk_lib_crypto_alg_aes_192_inv_mix_columns(&state, &state);
	}
	mk_lib_crypto_alg_aes_192_inv_shift_rows(&state, &state);
	mk_lib_crypto_alg_aes_192_inv_sub_bytes(&state, &state);
	mk_lib_crypto_alg_aes_192_add_key(&state, &keys[0], &state);
...
static mk_lang_inline __m128i mk_lib_crypto_alg_aes_192_msvc_aes_ni_key_assist(__m128i const a, __m128i const b) mk_lang_noexcept
{
	__m128i ta;
	__m128i tb;
	__m128i tc;
...
static mk_lang_inline void mk_lib_crypto_alg_aes_192_msvc_aes_ni_key_expand_enc(mk_lib_crypto_alg_aes_192_key_pct const key, mk_lib_crypto_alg_aes_192_msvc_aes_ni_schedule_pt const schedule)
{
	...
	ta = mk_lib_crypto_alg_aes_192_msvc_aes_ni_load_m128i(&key->m_data.m_uint8s[0]);
	schedule->m_data.m_keys[0] = ta;
	tb = _mm_aeskeygenassist_si128(ta, 0x01); ta = mk_lib_crypto_alg_aes_192_msvc_aes_ni_key_assist(ta, tb); schedule->m_data.m_keys[ 1] = ta;
	tb = _mm_aeskeygenassist_si128(ta, 0x02); ta = mk_lib_crypto_alg_aes_192_msvc_aes_ni_key_assist(ta, tb); schedule->m_data.m_keys[ 2] = ta;
	tb = _mm_aeskeygenassist_si128(ta, 0x04); ta = mk_lib_crypto_alg_aes_192_msvc_aes_ni_key_assist(ta, tb); schedule->m_data.m_keys[ 3] = ta;
	tb = _mm_aeskeygenassist_si128(ta, 0x08); ta = mk_lib_crypto_alg_aes_192_msvc_aes_ni_key_assist(ta, tb); schedule->m_data.m_keys[ 4] = ta;
	tb = _mm_aeskeygenassist_si128(ta, 0x10); ta = mk_lib_crypto_alg_aes_192_msvc_aes_ni_key_assist(ta, tb); schedule->m_data.m_keys[ 5] = ta;
	tb = _mm_aeskeygenassist_si128(ta, 0x20); ta = mk_lib_crypto_alg_aes_192_msvc_aes_ni_key_assist(ta, tb); schedule->m_data.m_keys[ 6] = ta;
	tb = _mm_aeskeygenassist_si128(ta, 0x40); ta = mk_lib_crypto_alg_aes_192_msvc_aes_ni_key_assist(ta, tb); schedule->m_data.m_keys[ 7] = ta;
	tb = _mm_aeskeygenassist_si128(ta, 0x80); ta = mk_lib_crypto_alg_aes_192_msvc_aes_ni_key_assist(ta, tb); schedule->m_data.m_keys[ 8] = ta;
	tb = _mm_aeskeygenassist_si128(ta, 0x1b); ta = mk_lib_crypto_alg_aes_192_msvc_aes_ni_key_assist(ta, tb); schedule->m_data.m_keys[ 9] = ta;
	tb = _mm_aeskeygenassist_si128(ta, 0x36); ta = mk_lib_crypto_alg_aes_192_msvc_aes_ni_key_assist(ta, tb); schedule->m_data.m_keys[10] = ta;
}
