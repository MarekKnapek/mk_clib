#ifndef include_guard_mk_lang_bui_divmod
#define include_guard_mk_lang_bui_divmod
...
#define mk_lang_bui_divmod_for_bui mk_lang_fora_bui
#define mk_lang_bui_divmod_for_count mk_lang_fora_count
#define mk_lang_bui_divmod_for_count2 mk_lang_fora_count2
#define mk_lang_bui_divmod_for_endian mk_lang_fora_endian
#define mk_lang_bui_divmod_for_divalg mk_lang_fora_divalg
...
#undef mk_lang_bui_divmod_for_bui
#undef mk_lang_bui_divmod_for_count
#undef mk_lang_bui_divmod_for_count2
#undef mk_lang_bui_divmod_for_endian
#undef mk_lang_bui_divmod_for_divalg
