...
#if (_POSIX_C_SOURCE) >= 1l && (_POSIX_C_SOURCE) <= 999999l
...
#define mk_lang_platform_is_posix_at_least_2024_05 (mk_lang_platform_is_posix_ver >= 202405l) /* POSIX.1-2024 */
#define mk_lang_platform_is_posix_at_least_2008_09 (mk_lang_platform_is_posix_ver >= 200809l) /* POSIX.1-2008 */
...
#define mk_lang_platform_is_posix_at_least_any (mk_lang_platform_is_posix_at_least_1)
