...
#define mk_sl_cui_t_name mk_lib_net_iocp_tcp_port
...
#define mk_sl_cui_t_name mk_lib_net_iocp_udp_port
#define mk_sl_cui_t_base_type_name mk_sl_cui_uint16
#define mk_sl_cui_t_count 1
#define mk_sl_cui_t_disable_big_div 1
#define mk_sl_cui_t_base_type_size_bits_d mk_sl_cui_uint16_size_bits_d
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_net_iocp_pr_port_parse_pc(mk_sl_cui_uint16_pt const port, mk_lang_types_pchar_pct const str_buf, mk_lang_types_sint_t const str_len, mk_lang_types_bool_pt const success, mk_lang_types_sint_pt const consumed) mk_lang_noexcept
{
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_net_iocp_pr_port_parse_u8(mk_sl_cui_uint16_pt const port, mk_sl_cui_uint8_pct const bin_buf, mk_lang_types_sint_t const bin_len, mk_lang_types_bool_pt const success, mk_lang_types_sint_pt const consumed) mk_lang_noexcept
{
	...
	err = mk_lib_net_iocp_pr_port_parse_pc(port, &str_buf[0], str_len, success, consumed); mk_lang_check_rereturn(err);
	return 0;
}


mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_tcp_port_parse_pc(mk_lib_net_iocp_tcp_port_pt const tcp_port, mk_lang_types_pchar_pct const str_buf, mk_lang_types_sint_t const str_len, mk_lang_types_bool_pt const success, mk_lang_types_sint_pt const consumed) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	err = mk_lib_net_iocp_pr_port_parse_pc(&tcp_port->m_elements[0], str_buf, str_len, success, consumed); mk_lang_check_rereturn(err);
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_tcp_port_parse_u8(mk_lib_net_iocp_tcp_port_pt const tcp_port, mk_sl_cui_uint8_pct const bin_buf, mk_lang_types_sint_t const bin_len, mk_lang_types_bool_pt const success, mk_lang_types_sint_pt const consumed) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	err = mk_lib_net_iocp_pr_port_parse_u8(&tcp_port->m_elements[0], bin_buf, bin_len, success, consumed); mk_lang_check_rereturn(err);
	return 0;
}


mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_udp_port_parse_pc(mk_lib_net_iocp_udp_port_pt const udp_port, mk_lang_types_pchar_pct const str_buf, mk_lang_types_sint_t const str_len, mk_lang_types_bool_pt const success, mk_lang_types_sint_pt const consumed) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	err = mk_lib_net_iocp_pr_port_parse_pc(&udp_port->m_elements[0], str_buf, str_len, success, consumed); mk_lang_check_rereturn(err);
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_udp_port_parse_u8(mk_lib_net_iocp_udp_port_pt const udp_port, mk_sl_cui_uint8_pct const bin_buf, mk_lang_types_sint_t const bin_len, mk_lang_types_bool_pt const success, mk_lang_types_sint_pt const consumed) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	err = mk_lib_net_iocp_pr_port_parse_u8(&udp_port->m_elements[0], bin_buf, bin_len, success, consumed); mk_lang_check_rereturn(err);
	return 0;
}


mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_ipv4_address_parse_pc(mk_lib_net_iocp_ipv4_address_pt const ipv4_address, mk_lang_types_pchar_pct const str_buf, mk_lang_types_sint_t const str_len, mk_lang_types_bool_pt const success, mk_lang_types_sint_pt const consumed) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_ipv4_address_parse_u8(mk_lib_net_iocp_ipv4_address_pt const ipv4_address, mk_sl_cui_uint8_pct const bin_buf, mk_lang_types_sint_t const bin_len, mk_lang_types_bool_pt const success, mk_lang_types_sint_pt const consumed) mk_lang_noexcept
{
	mk_lang_types_sint_t str_len;
	...
	str_len = mk_lang_min(bin_len, mk_lang_countof(str_buf));
	mk_sl_cui_uint8_to_bi_pchar_many(bin_buf, &str_buf[0], ((mk_lang_types_usize_t)(str_len)));
	err = mk_lib_net_iocp_ipv4_address_parse_pc(ipv4_address, &str_buf[0], str_len, success, consumed); mk_lang_check_rereturn(err);
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_bool_t mk_lib_net_iocp_ipv4_address_is_any(mk_lib_net_iocp_ipv4_address_pct const ipv4_address) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_bool_t mk_lib_net_iocp_ipv4_address_is_none(mk_lib_net_iocp_ipv4_address_pct const ipv4_address) mk_lang_noexcept
{
	mk_lang_types_bool_t is;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_init(mk_lang_types_void_t) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_deinit(mk_lang_types_void_t) mk_lang_noexcept
{
	mk_win_base_sint_t st;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_connect_construct_void(mk_lib_net_iocp_async_connect_pt const async_connect) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_connect_construct(mk_lib_net_iocp_async_connect_pt const async_connect) mk_lang_noexcept
{
	mk_lang_assert(async_connect);
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_connect_reconstruct(mk_lib_net_iocp_async_connect_pt const async_connect) mk_lang_noexcept
{
	mk_lang_assert(async_connect);
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_connect_destroy(mk_lib_net_iocp_async_connect_pt const async_connect) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_connect_reset(mk_lib_net_iocp_async_connect_pt const async_connect) mk_lang_noexcept
{
	mk_lang_types_sint_t err;

	mk_lang_assert(async_connect);

	err = mk_lib_net_iocp_async_connect_destroy(async_connect); mk_lang_check_rereturn(err);
	err = mk_lib_net_iocp_async_connect_construct_void(async_connect); mk_lang_check_rereturn(err);
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_connect_is_ready(mk_lib_net_iocp_async_connect_pt const async_connect, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_connect_wait_timeout(mk_lib_net_iocp_async_connect_pt const async_connect, mk_lang_types_sint_t const ms, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	mk_win_base_dword_t waited;
	mk_lang_types_bool_t is;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_connect_wait_infinite(mk_lib_net_iocp_async_connect_pt const async_connect) mk_lang_noexcept
{
	mk_win_base_dword_t waited;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_connect_get_result(mk_lib_net_iocp_async_connect_pt const async_connect, mk_lang_types_sint_pt const result) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_rwc_construct(mk_lib_net_iocp_async_rwc_pt const async_rwc) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_rwc_destroy(mk_lib_net_iocp_async_rwc_pt const async_rwc) mk_lang_noexcept
{
	mk_win_base_bool_t b;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_rwc_is_ready(mk_lib_net_iocp_async_rwc_pt const async_rwc, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	mk_win_base_dword_t waited;
	mk_lang_types_bool_t is;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_rwc_wait_timeout(mk_lib_net_iocp_async_rwc_pt const async_rwc, mk_lang_types_sint_t const ms, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	mk_win_base_dword_t waited;
	mk_lang_types_bool_t is;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_rwc_wait_infinite(mk_lib_net_iocp_async_rwc_pt const async_rwc) mk_lang_noexcept
{
	mk_win_base_dword_t waited;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_async_rwc_get_result(mk_lib_net_iocp_async_rwc_pt const async_rwc, mk_lang_types_sint_pt const event_id, mk_lang_types_sint_pt const result) mk_lang_noexcept
{
	mk_lang_types_sint_t st;
	mk_win_dll_ws2_network_events_t events;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_write_request_construct_void(mk_lib_net_iocp_write_request_pt const write_request) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_write_request_construct(mk_lib_net_iocp_write_request_pt const write_request, mk_lib_net_iocp_socket_pt const socket, mk_sl_cui_uint8_pct const data_buf, mk_lang_types_sint_t const data_len) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_write_request_reconstruct(mk_lib_net_iocp_write_request_pt const write_request, mk_lib_net_iocp_socket_pt const socket, mk_sl_cui_uint8_pct const data_buf, mk_lang_types_sint_t const data_len) mk_lang_noexcept
{
	mk_win_dll_ws2_event_t event;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_write_request_destroy(mk_lib_net_iocp_write_request_pt const write_request) mk_lang_noexcept
{
	mk_win_base_bool_t b;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_write_request_is_ready(mk_lib_net_iocp_write_request_pt const write_request, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	mk_win_base_dword_t waited;
	mk_lang_types_bool_t is;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_write_request_wait_timeout(mk_lib_net_iocp_write_request_pt const write_request, mk_lang_types_sint_t const ms, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	mk_win_base_dword_t waited;
	mk_lang_types_bool_t is;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_write_request_wait_infinite(mk_lib_net_iocp_write_request_pt const write_request) mk_lang_noexcept
{
	mk_win_base_dword_t waited;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_write_request_get_result(mk_lib_net_iocp_write_request_pt const write_request) mk_lang_noexcept
{
	mk_win_base_bool_t b;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_read_request_construct_void(mk_lib_net_iocp_read_request_pt const read_request) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_read_request_construct(mk_lib_net_iocp_read_request_pt const read_request, mk_lib_net_iocp_socket_pt const socket, mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len) mk_lang_noexcept
{
	mk_win_dll_ws2_event_t event;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_read_request_reconstruct(mk_lib_net_iocp_read_request_pt const read_request, mk_lib_net_iocp_socket_pt const socket, mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len) mk_lang_noexcept
{
	mk_win_dll_ws2_event_t event;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_read_request_destroy(mk_lib_net_iocp_read_request_pt const read_request) mk_lang_noexcept
{
	mk_win_base_bool_t b;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_read_request_is_ready(mk_lib_net_iocp_read_request_pt const read_request, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	mk_win_base_dword_t waited;
	mk_lang_types_bool_t is;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_read_request_wait_timeout(mk_lib_net_iocp_read_request_pt const read_request, mk_lang_types_sint_t const ms, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	mk_win_base_dword_t waited;
	mk_lang_types_bool_t is;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_read_request_wait_infinite(mk_lib_net_iocp_read_request_pt const read_request) mk_lang_noexcept
{
	mk_win_base_dword_t waited;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_read_request_get_result(mk_lib_net_iocp_read_request_pt const read_request) mk_lang_noexcept
{
	mk_win_base_bool_t b;
	mk_win_base_dword_t transferred;
	mk_win_base_dword_t flags;
...
#include "mk_lang_warning_clang_push_sometimes_uninitialized.h"
	...
	mk_lang_assert(socket);
	mk_lang_assert(af >= 0);
	mk_lang_assert(af < mk_lib_net_iocp_address_family_e_dummy_end);
	mk_lang_assert(at >= 0);
	mk_lang_assert(at < mk_lib_net_iocp_address_type_e_dummy_end);
	mk_lang_assert(ap >= 0);
	mk_lang_assert(ap < mk_lib_net_iocp_address_protocol_e_dummy_end);

	switch(af)
	{
		case mk_lib_net_iocp_address_family_e_ipv4: family = mk_win_dll_ws2_address_family_e_inet ; break;
		case mk_lib_net_iocp_address_family_e_ipv6: family = mk_win_dll_ws2_address_family_e_inet6; break;
		case mk_lib_net_iocp_address_family_e_dummy_end: mk_lang_assert_false(); break;
		default: mk_lang_assert_false(); break;
	}
	mk_lang_clobber(&family);
	switch(at)
	{
		case mk_lib_net_iocp_address_type_e_stream: type = mk_win_dll_ws2_address_type_e_stream; break;
		case mk_lib_net_iocp_address_type_e_dgram : type = mk_win_dll_ws2_address_type_e_dgram ; break;
		case mk_lib_net_iocp_address_type_e_dummy_end: mk_lang_assert_false(); break;
		default: mk_lang_assert_false(); break;
	}
	mk_lang_clobber(&type);
	switch(ap)
	{
		case mk_lib_net_iocp_address_protocol_e_tcp : protocol = mk_win_dll_ws2_address_protocol_e_tcp ; break;
		case mk_lib_net_iocp_address_protocol_e_udp : protocol = mk_win_dll_ws2_address_protocol_e_udp ; break;
		case mk_lib_net_iocp_address_protocol_e_icmp: protocol = mk_win_dll_ws2_address_protocol_e_icmp; break;
		case mk_lib_net_iocp_address_protocol_e_dummy_end: mk_lang_assert_false(); break;
		default: mk_lang_assert_false(); break;
	}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_socket_reconstruct(mk_lib_net_iocp_socket_pt const socket, mk_lib_net_iocp_address_family_t const af, mk_lib_net_iocp_address_type_t const at, mk_lib_net_iocp_address_protocol_t const ap) mk_lang_noexcept
{
	...
	{
		err = mk_lib_net_iocp_socket_construct(socket, af, at, ap); mk_lang_check_rereturn(err);
	}
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_socket_set_option_nodelay_true(mk_lib_net_iocp_socket_pt const socket) mk_lang_noexcept
{
	...
	err = mk_lib_net_iocp_socket_set_option_nodelay_val(socket, mk_lang_true); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_socket_set_option_nodelay_false(mk_lib_net_iocp_socket_pt const socket) mk_lang_noexcept
{
	...
	err = mk_lib_net_iocp_socket_set_option_nodelay_val(socket, mk_lang_false); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_iocp_socket_connect(mk_lib_net_iocp_socket_pt const socket, mk_lib_net_iocp_destination_pct const destination) mk_lang_noexcept
{
	...
	mk_lang_assert(socket->m_handle.m_elements[0] != mk_win_dll_ws2_invalid_socket);
	mk_lang_assert(!mk_lib_net_iocp_ipv4_address_is_any(&destination->m_ipv4_address));
	mk_lang_assert(!mk_lib_net_iocp_ipv4_address_is_none(&destination->m_ipv4_address));
	mk_lang_assert(!mk_lib_net_iocp_tcp_port_is_zero(&destination->m_tcp_port));

	s = socket->m_handle;
	mk_lib_net_iocp_tcp_port_to_bi_ushort(&destination->m_tcp_port, &tus);
