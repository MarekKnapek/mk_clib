...
#define mk_lib_mt_mutex_impl_lock      mk_lib_mt_mutex_portable_cpp_lock
#define mk_lib_mt_mutex_impl_unlock    mk_lib_mt_mutex_portable_cpp_unlock
...
#define mk_lib_mt_mutex_impl_lock      mk_lib_mt_mutex_portable_c_lock
#define mk_lib_mt_mutex_impl_unlock    mk_lib_mt_mutex_portable_c_unlock
#else
...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo mk_lang_types_sint_t mk_lib_mt_mutex_lock(mk_lib_mt_mutex_pt const mutex) mk_lang_noexcept
{
	mk_lang_assert(mutex);
	...
	{
		return mk_lib_mt_mutex_impl_lock(&mutex->m_mutex);
	}
}

mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo mk_lang_types_sint_t mk_lib_mt_mutex_unlock(mk_lib_mt_mutex_pt const mutex) mk_lang_noexcept
{
	mk_lang_assert(mutex);
	...
	{
		return mk_lib_mt_mutex_impl_unlock(&mutex->m_mutex);
	}
}
