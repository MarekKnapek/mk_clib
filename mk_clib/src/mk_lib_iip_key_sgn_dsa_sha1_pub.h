#ifndef mk_include_guard_mk_lib_iip_key_sgn_dsa_sha1_pub_h
#define mk_include_guard_mk_lib_iip_key_sgn_dsa_sha1_pub_h
...
union mk_lib_iip_key_sgn_dsa_sha1_pub_data_u
{
	mk_lib_iip_key_sgn_dsa_sha1_pub_integer_single_t m_integer;
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_iip_key_sgn_dsa_sha1_pub_data_u mk_lib_iip_key_sgn_dsa_sha1_pub_data_t;
struct mk_lib_iip_key_sgn_dsa_sha1_pub_s
{
	mk_lib_iip_key_sgn_dsa_sha1_pub_data_t m_data;
};
...
#include "mk_lib_iip_key_sgn_dsa_sha1_pub.c"
#endif
#endif
