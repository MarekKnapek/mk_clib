...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lang_info_platform_print(mk_lang_types_void_t) mk_lang_noexcept
{
	...
	err = mk_lang_stdout_print_lit_n("mk_lang_builtin_has_clzg         : "); mk_lang_check_rereturn(err); err = (mk_lang_builtin_has_clzg          ? mk_lang_stdout_println_lit_n("yes") : mk_lang_stdout_println_lit_n("no")); mk_lang_check_rereturn(err);
	err = mk_lang_stdout_print_lit_n("mk_lang_builtin_has_cpu_supports : "); mk_lang_check_rereturn(err); err = (mk_lang_builtin_has_cpu_supports  ? mk_lang_stdout_println_lit_n("yes") : mk_lang_stdout_println_lit_n("no")); mk_lang_check_rereturn(err);
	err = mk_lang_stdout_print_lit_n("mk_lang_builtin_has_ctzg         : "); mk_lang_check_rereturn(err); err = (mk_lang_builtin_has_ctzg          ? mk_lang_stdout_println_lit_n("yes") : mk_lang_stdout_println_lit_n("no")); mk_lang_check_rereturn(err);
