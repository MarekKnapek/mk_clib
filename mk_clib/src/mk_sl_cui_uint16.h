#ifndef mk_include_guard_mk_sl_cui_uint16_h
#define mk_include_guard_mk_sl_cui_uint16_h
...
#define mk_sl_cui_uint16_base_type_name ushort
#define mk_sl_cui_uint16_c(x) {{ ((mk_sl_cui_uint16_zzz_base_t)(x)) }}
#else
#error xxxxxxxxxx
#endif

#define mk_sl_cui_uint16_base_sizeof mk_lang_concat(mk_lang_concat(mk_lang_sizeof_bi_, mk_sl_cui_uint16_base_type_name), _t)
...
#define mk_sl_cui_uint16_size_bits_d 16
#define mk_sl_cui_uint16_size_bytes_d (mk_sl_cui_uint16_size_bits_d / mk_lang_charbit)
