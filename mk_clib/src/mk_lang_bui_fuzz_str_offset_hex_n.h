#ifndef mk_include_guard_mk_lang_bui_fuzz_str_offset_hex_n
#define mk_include_guard_mk_lang_bui_fuzz_str_offset_hex_n
...
#include "mk_lang_bui_fuzz_str_offset_hex_n.c"
#endif
#endif
