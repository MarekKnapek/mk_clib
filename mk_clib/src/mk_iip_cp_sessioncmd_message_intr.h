#ifndef mk_include_guard_mk_iip_cp_sessioncmd_message_intr_h
#define mk_include_guard_mk_iip_cp_sessioncmd_message_intr_h
...
mk_lang_struct_forward(mk_iip_cp_sessioncmd_message_impl);
mk_lang_struct_forward(mk_iip_cp_type_sessionid);


struct mk_iip_cp_sessioncmd_message_intr_s
{
	mk_iip_cp_sessioncmd_message_impl_pt m_sessioncmd_message_impl;
};
typedef struct mk_iip_cp_sessioncmd_message_intr_s mk_iip_cp_sessioncmd_message_intr_t;
mk_lang_struct_typedef(mk_iip_cp_sessioncmd_message_intr);
...
#include "mk_iip_cp_sessioncmd_message_intr.c"
#endif
#endif
