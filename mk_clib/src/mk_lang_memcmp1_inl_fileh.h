...
typedef mk_lang_memcmp1_inl_defd_type mk_lang_memcmp1_inl_defd_type_t;
typedef mk_lang_memcmp1_inl_defd_type_t const mk_lang_memcmp1_inl_defd_type_ct;
typedef mk_lang_memcmp1_inl_defd_type_t* mk_lang_memcmp1_inl_defd_type_pt;
typedef mk_lang_memcmp1_inl_defd_type_t const* mk_lang_memcmp1_inl_defd_type_pct;
