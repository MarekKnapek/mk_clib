#ifndef mk_include_guard_mk_lang_exception_out_of_memory
#define mk_include_guard_mk_lang_exception_out_of_memory
...
{
	mk_lang_types_usize_t m_requested_bytes;
};
...
mk_lang_jumbo void mk_lang_exception_out_of_memory_make(mk_lang_exception_pt const ex, mk_lang_types_usize_t const requested_bytes) mk_lang_noexcept;
