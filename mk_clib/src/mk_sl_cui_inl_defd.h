...
#define mk_sl_cui_inl_defd_rotr3_v2_simple3 mk_lang_concat(mk_lang_concat(mk_sl_cui_, mk_sl_cui_inl_defd_name), _rotr3_v2_simple3)
#define mk_sl_cui_inl_defd_rotl3_v2_simple3 mk_lang_concat(mk_lang_concat(mk_sl_cui_, mk_sl_cui_inl_defd_name), _rotl3_v2_simple3)
#define mk_sl_cui_inl_defd_rotr3_v2_simple2 mk_lang_concat(mk_lang_concat(mk_sl_cui_, mk_sl_cui_inl_defd_name), _rotr3_v2_simple2)
#define mk_sl_cui_inl_defd_rotl3_v2_simple2 mk_lang_concat(mk_lang_concat(mk_sl_cui_, mk_sl_cui_inl_defd_name), _rotl3_v2_simple2)
#define mk_sl_cui_inl_defd_rotr3_v2_simple1 mk_lang_concat(mk_lang_concat(mk_sl_cui_, mk_sl_cui_inl_defd_name), _rotr3_v2_simple1)
#define mk_sl_cui_inl_defd_rotl3_v2_simple1 mk_lang_concat(mk_lang_concat(mk_sl_cui_, mk_sl_cui_inl_defd_name), _rotl3_v2_simple1)
#define mk_sl_cui_inl_defd_rotl3_v2 mk_lang_concat(mk_lang_concat(mk_sl_cui_, mk_sl_cui_inl_defd_name), _rotl3_v2)
#define mk_sl_cui_inl_defd_rotr3_v2 mk_lang_concat(mk_lang_concat(mk_sl_cui_, mk_sl_cui_inl_defd_name), _rotr3_v2)
