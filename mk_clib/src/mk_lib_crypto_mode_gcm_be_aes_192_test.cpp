...
#include "mk_lib_crypto_mode_gcm_be_aes_192.h"
#include "mk_sl_uint8.h"

#define mk_lang_memcpy_t_name mk_lib_crypto_mode_gcm_be_aes_192_test_memcpyu8
...
struct mk_lib_crypto_mode_gcm_be_aes_192_test_crypt_result_s
{
...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_mode_gcm_be_aes_192_test_encrypt_from_str_lit(mk_lang_types_pchar_t const(&key_lit)[key_lit_len], mk_lang_types_pchar_t const(&iv_lit)[iv_lit_len], mk_lang_types_pchar_t const(&aad_lit)[aad_lit_len], mk_lang_types_pchar_t const(&msg_lit)[msg_lit_len]) mk_lang_noexcept
{
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, mk_lib_crypto_mode_gcm_be_aes_192_key_len_v> key_bytes mk_lang_constexpr_init;
	...
	mk_lib_crypto_mode_gcm_be_aes_192_key_t key mk_lang_constexpr_init;
	mk_lang_types_usize_t n mk_lang_constexpr_init;
	mk_lang_types_usize_t i mk_lang_constexpr_init;
	mk_lib_cpp_constexpr_array_t<mk_lib_crypto_mode_gcm_be_aes_192_msg_t, ((msg_lit_len - 1) / 2) / 16> msgs mk_lang_constexpr_init;
	mk_lib_crypto_mode_gcm_be_aes_192_t cipher mk_lang_constexpr_init;
	mk_lib_crypto_mode_gcm_be_aes_192_msg_t tag mk_lang_constexpr_init;
	mk_lib_crypto_mode_gcm_be_aes_192_test_crypt_result_s<(msg_lit_len - 1) / 2> ret mk_lang_constexpr_init;

	mk_lang_static_assert(key_lit_len == mk_lib_crypto_mode_gcm_be_aes_192_key_len_v * 2 + 1);
	...
	mk_lib_crypto_mode_gcm_be_aes_192_test_memcpyu8_fn(&key.m_data.m_data.m_uint8s[0], key_bytes.cdata(), key_bytes.size());
	n = msgs.size();
	for(i = 0; i != n; ++i)
	{
		mk_lib_crypto_mode_gcm_be_aes_192_test_memcpyu8_fn(&msgs.data()[i].m_data.m_data.m_uint8s[0], msg_bytes.cdata() + i * 16, 16);
	}
	mk_lib_crypto_mode_gcm_be_aes_192_expand_enc(&cipher, &key);
	mk_lib_crypto_mode_gcm_be_aes_192_iv_append(&cipher, iv_bytes.cdata(), iv_bytes.size());
	mk_lib_crypto_mode_gcm_be_aes_192_iv_finish(&cipher);
	mk_lib_crypto_mode_gcm_be_aes_192_aad_append(&cipher, aad_bytes.cdata(), aad_bytes.size());
	mk_lib_crypto_mode_gcm_be_aes_192_aad_finish(&cipher);
	mk_lib_crypto_mode_gcm_be_aes_192_encrypt(&cipher, msgs.cdata(), msgs.data(), msgs.size());
	mk_lib_crypto_mode_gcm_be_aes_192_finish_enc(&cipher, msg_bytes.cdata() + msgs.size() * 16, msg_bytes.data() + msgs.size() * 16, msg_bytes.size() % 16, &tag);
	for(i = 0; i != n; ++i)
	{
		mk_lib_crypto_mode_gcm_be_aes_192_test_memcpyu8_fn(msg_bytes.data() + i * 16, &msgs.cdata()[i].m_data.m_data.m_uint8s[0], 16);
	}
	ret.m_bytes = msg_bytes;
	mk_lib_crypto_mode_gcm_be_aes_192_test_memcpyu8_fn(ret.m_tag.data(), &tag.m_data.m_data.m_uint8s[0], 16);
	return ret;
}

template<mk_lang_types_usize_t key_lit_len, mk_lang_types_usize_t iv_lit_len, mk_lang_types_usize_t aad_lit_len, mk_lang_types_usize_t msg_lit_len>
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_mode_gcm_be_aes_192_test_decrypt_from_str_lit(mk_lang_types_pchar_t const(&key_lit)[key_lit_len], mk_lang_types_pchar_t const(&iv_lit)[iv_lit_len], mk_lang_types_pchar_t const(&aad_lit)[aad_lit_len], mk_lang_types_pchar_t const(&msg_lit)[msg_lit_len]) mk_lang_noexcept
{
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, mk_lib_crypto_mode_gcm_be_aes_192_key_len_v> key_bytes mk_lang_constexpr_init;
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, (iv_lit_len - 1) / 2> iv_bytes mk_lang_constexpr_init;
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, (aad_lit_len - 1) / 2> aad_bytes mk_lang_constexpr_init;
	...
	mk_lib_crypto_mode_gcm_be_aes_192_expand_dec(&cipher, &key);
	mk_lib_crypto_mode_gcm_be_aes_192_iv_append(&cipher, iv_bytes.cdata(), iv_bytes.size());
	mk_lib_crypto_mode_gcm_be_aes_192_iv_finish(&cipher);
	mk_lib_crypto_mode_gcm_be_aes_192_aad_append(&cipher, aad_bytes.cdata(), aad_bytes.size());
	mk_lib_crypto_mode_gcm_be_aes_192_aad_finish(&cipher);
	mk_lib_crypto_mode_gcm_be_aes_192_decrypt(&cipher, msgs.cdata(), msgs.data(), msgs.size());
	mk_lib_crypto_mode_gcm_be_aes_192_finish_dec(&cipher, msg_bytes.cdata() + msgs.size() * 16, msg_bytes.data() + msgs.size() * 16, msg_bytes.size() % 16, &tag);
	for(i = 0; i != n; ++i)
	{
		mk_lib_crypto_mode_gcm_be_aes_192_test_memcpyu8_fn(msg_bytes.data() + i * 16, &msgs.cdata()[i].m_data.m_data.m_uint8s[0], 16);
	}
...
mk_lang_extern_c mk_lang_types_void_t mk_lib_crypto_mode_gcm_be_aes_192_test(mk_lang_types_void_t) mk_lang_noexcept
{
	#define key_1 "000000000000000000000000000000000000000000000000"
	#define key_2 "000000000000000000000000000000000000000000000000"
	#define key_3 "feffe9928665731c6d6a8f9467308308feffe9928665731c"
	#define key_4 "feffe9928665731c6d6a8f9467308308feffe9928665731c"
	#define key_5 "feffe9928665731c6d6a8f9467308308feffe9928665731c"
	#define key_6 "feffe9928665731c6d6a8f9467308308feffe9928665731c"
	...
	#define out_1 ""
	#define out_2 "98e7247c07f0fe411c267e4384b0f600"
	#define out_3 "3980ca0b3c00e841eb06fac4872a2757859e1ceaa6efd984628593b40ca1e19c7d773d00c144c525ac619d18c84a3f4718e2448b2fe324d9ccda2710acade256"
	#define out_4 "3980ca0b3c00e841eb06fac4872a2757859e1ceaa6efd984628593b40ca1e19c7d773d00c144c525ac619d18c84a3f4718e2448b2fe324d9ccda2710"
	#define out_5 "0f10f599ae14a154ed24b36e25324db8c566632ef2bbb34f8347280fc4507057fddc29df9a471f75c66541d4d4dad1c9e93a19a58e8b473fa0f062f7"
	#define out_6 "d27e88681ce3243c4830165a8fdcf9ff1de9a1d8e6b447ef6ef7b79828666e4581e79012af34ddd9e2f037589b292db3e67c036745fa22e7e9b7373b"

	#define tag_1 "cd33b28ac773f74ba00ed1f312572435"
	#define tag_2 "2ff58d80033927ab8ef4d4587514f0fb"
	#define tag_3 "9924a7c8587336bfb118024db8674a14"
	#define tag_4 "2519498e80f1478f37ba55bd6d27618c"
	#define tag_5 "65dcc57fcf623a24094fcca40d3533f8"
	#define tag_6 "dcf566ff291c25bbb8568fc3d376a6d9"
	...
	mk_lang_constexpr_static auto const s_out_computed_1 = mk_lib_crypto_mode_gcm_be_aes_192_test_encrypt_from_str_lit(key_1, iv_1, aad_1, msg_1);
	mk_lang_constexpr_static auto const s_out_computed_2 = mk_lib_crypto_mode_gcm_be_aes_192_test_encrypt_from_str_lit(key_2, iv_2, aad_2, msg_2);
	mk_lang_constexpr_static auto const s_out_computed_3 = mk_lib_crypto_mode_gcm_be_aes_192_test_encrypt_from_str_lit(key_3, iv_3, aad_3, msg_3);
	mk_lang_constexpr_static auto const s_out_computed_4 = mk_lib_crypto_mode_gcm_be_aes_192_test_encrypt_from_str_lit(key_4, iv_4, aad_4, msg_4);
	mk_lang_constexpr_static auto const s_out_computed_5 = mk_lib_crypto_mode_gcm_be_aes_192_test_encrypt_from_str_lit(key_5, iv_5, aad_5, msg_5);
	mk_lang_constexpr_static auto const s_out_computed_6 = mk_lib_crypto_mode_gcm_be_aes_192_test_encrypt_from_str_lit(key_6, iv_6, aad_6, msg_6);

	mk_lang_constexpr_static auto const s_msg_computed_1 = mk_lib_crypto_mode_gcm_be_aes_192_test_decrypt_from_str_lit(key_1, iv_1, aad_1, out_1);
	mk_lang_constexpr_static auto const s_msg_computed_2 = mk_lib_crypto_mode_gcm_be_aes_192_test_decrypt_from_str_lit(key_2, iv_2, aad_2, out_2);
	mk_lang_constexpr_static auto const s_msg_computed_3 = mk_lib_crypto_mode_gcm_be_aes_192_test_decrypt_from_str_lit(key_3, iv_3, aad_3, out_3);
	mk_lang_constexpr_static auto const s_msg_computed_4 = mk_lib_crypto_mode_gcm_be_aes_192_test_decrypt_from_str_lit(key_4, iv_4, aad_4, out_4);
	mk_lang_constexpr_static auto const s_msg_computed_5 = mk_lib_crypto_mode_gcm_be_aes_192_test_decrypt_from_str_lit(key_5, iv_5, aad_5, out_5);
	mk_lang_constexpr_static auto const s_msg_computed_6 = mk_lib_crypto_mode_gcm_be_aes_192_test_decrypt_from_str_lit(key_6, iv_6, aad_6, out_6);
	...
	mk_lib_crypto_mode_gcm_be_aes_192_key_t key;
	mk_lib_crypto_mode_gcm_be_aes_192_t cipher;
	mk_lang_types_sint_t m;
	mk_sl_cui_uint8_t u8;
	mk_lang_types_sint_t k;
	mk_lib_crypto_mode_gcm_be_aes_192_msg_t msg;
	mk_lib_crypto_mode_gcm_be_aes_192_msg_t tag;
	...
	mk_lang_static_assert(mk_lib_crypto_mode_gcm_be_aes_192_msg_len_v == 16);
	...
	{
		{
			for(j = 0; j != mk_lib_crypto_mode_gcm_be_aes_192_key_len_v; ++j)
			{
			...
			for(j = 0; j != m; ++j)
			{
				...
				mk_lib_crypto_mode_gcm_be_aes_192_iv_append(&cipher, &u8, 1);
			}
			mk_lib_crypto_mode_gcm_be_aes_192_iv_finish(&cipher);
			...
			for(j = 0; j != m; ++j)
			{
				...
				byte = ((mk_lang_types_uchar_t)(((mk_lang_types_uchar_t)(hi << 4)) | ((mk_lang_types_uchar_t)(lo << 0))));
				mk_sl_cui_uint8_from_bi_uchar(&u8, &byte);
				mk_lib_crypto_mode_gcm_be_aes_192_aad_append(&cipher, &u8, 1);
			}
			mk_lib_crypto_mode_gcm_be_aes_192_aad_finish(&cipher);
			...
			for(j = 0; j != m / 16; ++j)
			{
				...
				mk_lib_crypto_mode_gcm_be_aes_192_encrypt(&cipher, &msg, &msg, 1);
				for(k = 0; k != 16; ++k)
				{
			...
			mk_lib_crypto_mode_gcm_be_aes_192_finish_enc(&cipher, &msg.m_data.m_data.m_uint8s[0], &msg.m_data.m_data.m_uint8s[0], m % 16, &tag);
			for(k = 0; k != m % 16; ++k)
			{
				hi = mk_lib_cpp_constexpr_char_to_nibble(s_outs[i][(j * 16 + k) * 2 + 0]); mk_lang_assert(hi >= 0x00 && hi <= 0x0f);
				lo = mk_lib_cpp_constexpr_char_to_nibble(s_outs[i][(j * 16 + k) * 2 + 1]); mk_lang_assert(lo >= 0x00 && lo <= 0x0f);
			...
			for(j = 0; j != mk_lib_crypto_mode_gcm_be_aes_192_msg_len_v; ++j)
			{
		...
		}
		{
			...
			for(j = 0; j != m / 16; ++j)
			{
				...
				mk_lib_crypto_mode_gcm_be_aes_192_decrypt(&cipher, &msg, &msg, 1);
				for(k = 0; k != 16; ++k)
				{
					hi = mk_lib_cpp_constexpr_char_to_nibble(s_msgs[i][(j * 16 + k) * 2 + 0]); mk_lang_assert(hi >= 0x00 && hi <= 0x0f);
					lo = mk_lib_cpp_constexpr_char_to_nibble(s_msgs[i][(j * 16 + k) * 2 + 1]); mk_lang_assert(lo >= 0x00 && lo <= 0x0f);
			...
			mk_lib_crypto_mode_gcm_be_aes_192_finish_dec(&cipher, &msg.m_data.m_data.m_uint8s[0], &msg.m_data.m_data.m_uint8s[0], m % 16, &tag);
			for(k = 0; k != m % 16; ++k)
			{
				hi = mk_lib_cpp_constexpr_char_to_nibble(s_msgs[i][(j * 16 + k) * 2 + 0]); mk_lang_assert(hi >= 0x00 && hi <= 0x0f);
				lo = mk_lib_cpp_constexpr_char_to_nibble(s_msgs[i][(j * 16 + k) * 2 + 1]); mk_lang_assert(lo >= 0x00 && lo <= 0x0f);
