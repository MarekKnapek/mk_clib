...
#elif mk_lang_forb4_id == mk_lang_for_constants_bui
#define mk_lang_forb_bui_file "mk_lang_forb3.h"
#include "mk_lang_forb_bui.h"
#elif mk_lang_forb4_id == mk_lang_for_constants_bui2
#define mk_lang_forb_bui2_file "mk_lang_forb3.h"
