...
{
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, mk_lib_crypto_mode_cfb_8_aes_128_iv_len_v> iv_bytes mk_lang_constexpr_init;
	...
	mk_lib_crypto_mode_cfb_8_aes_128_iv_t iv mk_lang_constexpr_init;
	...
	mk_lang_static_assert(iv_lit_len == mk_lib_crypto_mode_cfb_8_aes_128_iv_len_v * 2 + 1);
	...
	for(i = 0; i != mk_lib_crypto_mode_cfb_8_aes_128_iv_len_v; ++i){ iv.m_data.m_uint8s[i] = iv_bytes[i]; }
...
mk_lang_extern_c void mk_lib_crypto_mode_cfb_8_aes_128_test(void) mk_lang_noexcept
{
	...
	mk_lib_crypto_mode_cfb_8_aes_128_iv_t iv;
	...
	for(i = 0; i != n; ++i)
	{
		...
		msg_len = (msg_len - 1) / 2;
		for(j = 0; j != mk_lib_crypto_mode_cfb_8_aes_128_iv_len_v; ++j)
		{
