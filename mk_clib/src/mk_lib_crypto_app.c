...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_app_encrypt_mode_8(mk_lib_crypto_app_pt const app, mk_lang_types_usize_t const idx) mk_lang_noexcept
{
	int id mk_lang_constexpr_init;
	...
	switch(id)
	{
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_cbc_aes_128_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_aes_128_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_128_msg_len_v     + + i]; } } mk_lib_crypto_mode_cbc_aes_128_schedule_encrypt    (&app->m_mode.m_data.m_cbc_aes_128    , &app->m_schedule.m_data.m_cbc_aes_128    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_aes_128_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_128_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_128_aes_128_msg_t msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v + + i]; } } mk_lib_crypto_mode_cfb_128_aes_128_schedule_encrypt(&app->m_mode.m_data.m_cfb_128_aes_128, &app->m_schedule.m_data.m_cfb_128_aes_128, &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_8_aes_128_msg_t   msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v  ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v   + + i]; } } mk_lib_crypto_mode_cfb_8_aes_128_schedule_encrypt  (&app->m_mode.m_data.m_cfb_8_aes_128  , &app->m_schedule.m_data.m_cfb_8_aes_128  , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v  ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v   + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ctr_be_aes_128_msg_t  msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v  + + i]; } } mk_lib_crypto_mode_ctr_be_aes_128_schedule_encrypt (&app->m_mode.m_data.m_ctr_be_aes_128 , &app->m_schedule.m_data.m_ctr_be_aes_128 , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v  + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ecb_aes_128_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_aes_128_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_128_msg_len_v     + + i]; } } mk_lib_crypto_mode_ecb_aes_128_schedule_encrypt    (&app->m_mode.m_data.m_ecb_aes_128    , &app->m_schedule.m_data.m_ecb_aes_128    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_aes_128_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_128_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ofb_aes_128_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_aes_128_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_128_msg_len_v     + + i]; } } mk_lib_crypto_mode_ofb_aes_128_schedule_encrypt    (&app->m_mode.m_data.m_ofb_aes_128    , &app->m_schedule.m_data.m_ofb_aes_128    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_aes_128_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_128_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_cbc_aes_192_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_aes_192_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_192_msg_len_v     + + i]; } } mk_lib_crypto_mode_cbc_aes_192_schedule_encrypt    (&app->m_mode.m_data.m_cbc_aes_192    , &app->m_schedule.m_data.m_cbc_aes_192    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_aes_192_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_192_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_128_aes_192_msg_t msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v + + i]; } } mk_lib_crypto_mode_cfb_128_aes_192_schedule_encrypt(&app->m_mode.m_data.m_cfb_128_aes_192, &app->m_schedule.m_data.m_cfb_128_aes_192, &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_8_aes_192_msg_t   msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v  ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v   + + i]; } } mk_lib_crypto_mode_cfb_8_aes_192_schedule_encrypt  (&app->m_mode.m_data.m_cfb_8_aes_192  , &app->m_schedule.m_data.m_cfb_8_aes_192  , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v  ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v   + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ctr_be_aes_192_msg_t  msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v  + + i]; } } mk_lib_crypto_mode_ctr_be_aes_192_schedule_encrypt (&app->m_mode.m_data.m_ctr_be_aes_192 , &app->m_schedule.m_data.m_ctr_be_aes_192 , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v  + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ecb_aes_192_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_aes_192_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_192_msg_len_v     + + i]; } } mk_lib_crypto_mode_ecb_aes_192_schedule_encrypt    (&app->m_mode.m_data.m_ecb_aes_192    , &app->m_schedule.m_data.m_ecb_aes_192    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_aes_192_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_192_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ofb_aes_192_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_aes_192_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_192_msg_len_v     + + i]; } } mk_lib_crypto_mode_ofb_aes_192_schedule_encrypt    (&app->m_mode.m_data.m_ofb_aes_192    , &app->m_schedule.m_data.m_ofb_aes_192    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_aes_192_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_192_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_cbc_aes_256_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_aes_256_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_256_msg_len_v     + + i]; } } mk_lib_crypto_mode_cbc_aes_256_schedule_encrypt    (&app->m_mode.m_data.m_cbc_aes_256    , &app->m_schedule.m_data.m_cbc_aes_256    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_aes_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_256_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_128_aes_256_msg_t msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v + + i]; } } mk_lib_crypto_mode_cfb_128_aes_256_schedule_encrypt(&app->m_mode.m_data.m_cfb_128_aes_256, &app->m_schedule.m_data.m_cfb_128_aes_256, &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_8_aes_256_msg_t   msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v  ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v   + + i]; } } mk_lib_crypto_mode_cfb_8_aes_256_schedule_encrypt  (&app->m_mode.m_data.m_cfb_8_aes_256  , &app->m_schedule.m_data.m_cfb_8_aes_256  , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v  ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v   + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ctr_be_aes_256_msg_t  msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v  + + i]; } } mk_lib_crypto_mode_ctr_be_aes_256_schedule_encrypt (&app->m_mode.m_data.m_ctr_be_aes_256 , &app->m_schedule.m_data.m_ctr_be_aes_256 , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v  + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ecb_aes_256_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_aes_256_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_256_msg_len_v     + + i]; } } mk_lib_crypto_mode_ecb_aes_256_schedule_encrypt    (&app->m_mode.m_data.m_ecb_aes_256    , &app->m_schedule.m_data.m_ecb_aes_256    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_aes_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_256_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ofb_aes_256_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_aes_256_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_256_msg_len_v     + + i]; } } mk_lib_crypto_mode_ofb_aes_256_schedule_encrypt    (&app->m_mode.m_data.m_ofb_aes_256    , &app->m_schedule.m_data.m_ofb_aes_256    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_aes_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_256_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_cbc_serpent_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_serpent_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_serpent_msg_len_v     + + i]; } } mk_lib_crypto_mode_cbc_serpent_schedule_encrypt    (&app->m_mode.m_data.m_cbc_serpent    , &app->m_schedule.m_data.m_cbc_serpent    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_serpent_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_serpent_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_128_serpent_msg_t msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_serpent_msg_len_v; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_serpent_msg_len_v + + i]; } } mk_lib_crypto_mode_cfb_128_serpent_schedule_encrypt(&app->m_mode.m_data.m_cfb_128_serpent, &app->m_schedule.m_data.m_cfb_128_serpent, &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_serpent_msg_len_v; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_serpent_msg_len_v + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_8_serpent_msg_t   msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_serpent_msg_len_v  ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_serpent_msg_len_v   + + i]; } } mk_lib_crypto_mode_cfb_8_serpent_schedule_encrypt  (&app->m_mode.m_data.m_cfb_8_serpent  , &app->m_schedule.m_data.m_cfb_8_serpent  , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_serpent_msg_len_v  ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_serpent_msg_len_v   + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ctr_be_serpent_msg_t  msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_serpent_msg_len_v ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_serpent_msg_len_v  + + i]; } } mk_lib_crypto_mode_ctr_be_serpent_schedule_encrypt (&app->m_mode.m_data.m_ctr_be_serpent , &app->m_schedule.m_data.m_ctr_be_serpent , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_serpent_msg_len_v ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_serpent_msg_len_v  + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ecb_serpent_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_serpent_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_serpent_msg_len_v     + + i]; } } mk_lib_crypto_mode_ecb_serpent_schedule_encrypt    (&app->m_mode.m_data.m_ecb_serpent    , &app->m_schedule.m_data.m_ecb_serpent    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_serpent_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_serpent_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ofb_serpent_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_serpent_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_serpent_msg_len_v     + + i]; } } mk_lib_crypto_mode_ofb_serpent_schedule_encrypt    (&app->m_mode.m_data.m_ofb_serpent    , &app->m_schedule.m_data.m_ofb_serpent    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_serpent_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_serpent_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		default: mk_lang_assert(0); break;
	}
}
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_app_decrypt_mode_8(mk_lib_crypto_app_pt const app, mk_lang_types_usize_t const idx) mk_lang_noexcept
{
	int id mk_lang_constexpr_init;
	int iblock mk_lang_constexpr_init;
	int i mk_lang_constexpr_init;
	...
	switch(id)
	{
		...
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_128_aes_128_msg_t msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v + i]; } } mk_lib_crypto_mode_cfb_128_aes_128_schedule_decrypt(&app->m_mode.m_data.m_cfb_128_aes_128, &app->m_schedule.m_data.m_cfb_128_aes_128, &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_8_aes_128_msg_t   msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v  ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v   + i]; } } mk_lib_crypto_mode_cfb_8_aes_128_schedule_decrypt  (&app->m_mode.m_data.m_cfb_8_aes_128  , &app->m_schedule.m_data.m_cfb_8_aes_128  , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v  ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v   + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		...
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ofb_aes_128_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_aes_128_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_128_msg_len_v     + i]; } } mk_lib_crypto_mode_ofb_aes_128_schedule_decrypt    (&app->m_mode.m_data.m_ofb_aes_128    , &app->m_schedule.m_data.m_ofb_aes_128    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_aes_128_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_128_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_cbc_aes_192_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_aes_192_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_192_msg_len_v     + i]; } } mk_lib_crypto_mode_cbc_aes_192_schedule_decrypt    (&app->m_mode.m_data.m_cbc_aes_192    , &app->m_schedule.m_data.m_cbc_aes_192    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_aes_192_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_192_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_128_aes_192_msg_t msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v + i]; } } mk_lib_crypto_mode_cfb_128_aes_192_schedule_decrypt(&app->m_mode.m_data.m_cfb_128_aes_192, &app->m_schedule.m_data.m_cfb_128_aes_192, &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_8_aes_192_msg_t   msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v  ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v   + i]; } } mk_lib_crypto_mode_cfb_8_aes_192_schedule_decrypt  (&app->m_mode.m_data.m_cfb_8_aes_192  , &app->m_schedule.m_data.m_cfb_8_aes_192  , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v  ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v   + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ctr_be_aes_192_msg_t  msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v  + i]; } } mk_lib_crypto_mode_ctr_be_aes_192_schedule_decrypt (&app->m_mode.m_data.m_ctr_be_aes_192 , &app->m_schedule.m_data.m_ctr_be_aes_192 , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v  + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ecb_aes_192_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_aes_192_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_192_msg_len_v     + i]; } } mk_lib_crypto_mode_ecb_aes_192_schedule_decrypt    (&app->m_mode.m_data.m_ecb_aes_192    , &app->m_schedule.m_data.m_ecb_aes_192    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_aes_192_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_192_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ofb_aes_192_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_aes_192_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_192_msg_len_v     + i]; } } mk_lib_crypto_mode_ofb_aes_192_schedule_decrypt    (&app->m_mode.m_data.m_ofb_aes_192    , &app->m_schedule.m_data.m_ofb_aes_192    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_aes_192_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_192_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_cbc_aes_256_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_aes_256_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_256_msg_len_v     + i]; } } mk_lib_crypto_mode_cbc_aes_256_schedule_decrypt    (&app->m_mode.m_data.m_cbc_aes_256    , &app->m_schedule.m_data.m_cbc_aes_256    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_aes_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_256_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_128_aes_256_msg_t msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v + i]; } } mk_lib_crypto_mode_cfb_128_aes_256_schedule_decrypt(&app->m_mode.m_data.m_cfb_128_aes_256, &app->m_schedule.m_data.m_cfb_128_aes_256, &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_8_aes_256_msg_t   msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v  ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v   + i]; } } mk_lib_crypto_mode_cfb_8_aes_256_schedule_decrypt  (&app->m_mode.m_data.m_cfb_8_aes_256  , &app->m_schedule.m_data.m_cfb_8_aes_256  , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v  ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v   + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ctr_be_aes_256_msg_t  msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v  + i]; } } mk_lib_crypto_mode_ctr_be_aes_256_schedule_decrypt (&app->m_mode.m_data.m_ctr_be_aes_256 , &app->m_schedule.m_data.m_ctr_be_aes_256 , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v  + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ecb_aes_256_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_aes_256_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_256_msg_len_v     + i]; } } mk_lib_crypto_mode_ecb_aes_256_schedule_decrypt    (&app->m_mode.m_data.m_ecb_aes_256    , &app->m_schedule.m_data.m_ecb_aes_256    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_aes_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_256_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ofb_aes_256_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_aes_256_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_256_msg_len_v     + i]; } } mk_lib_crypto_mode_ofb_aes_256_schedule_decrypt    (&app->m_mode.m_data.m_ofb_aes_256    , &app->m_schedule.m_data.m_ofb_aes_256    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_aes_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_256_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		...
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_128_serpent_msg_t msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_serpent_msg_len_v; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_serpent_msg_len_v + i]; } } mk_lib_crypto_mode_cfb_128_serpent_schedule_decrypt(&app->m_mode.m_data.m_cfb_128_serpent, &app->m_schedule.m_data.m_cfb_128_serpent, &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_serpent_msg_len_v; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_serpent_msg_len_v + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(32) mk_lib_crypto_mode_cfb_8_serpent_msg_t   msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_serpent_msg_len_v  ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_serpent_msg_len_v   + i]; } } mk_lib_crypto_mode_cfb_8_serpent_schedule_decrypt  (&app->m_mode.m_data.m_cfb_8_serpent  , &app->m_schedule.m_data.m_cfb_8_serpent  , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_serpent_msg_len_v  ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_serpent_msg_len_v   + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ctr_be_serpent_msg_t  msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_serpent_msg_len_v ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_serpent_msg_len_v  + i]; } } mk_lib_crypto_mode_ctr_be_serpent_schedule_decrypt (&app->m_mode.m_data.m_ctr_be_serpent , &app->m_schedule.m_data.m_ctr_be_serpent , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_serpent_msg_len_v ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_serpent_msg_len_v  + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(32) mk_lib_crypto_mode_ecb_serpent_msg_t     msg[8] mk_lang_constexpr_init; for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_serpent_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_serpent_msg_len_v     + i]; } } mk_lib_crypto_mode_ecb_serpent_schedule_decrypt    (&app->m_mode.m_data.m_ecb_serpent    , &app->m_schedule.m_data.m_ecb_serpent    , &msg[0], &msg[0], 8); for(iblock = 0; iblock != 8; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_serpent_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_serpent_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_ssize_t mk_lib_crypto_app_impl_encrypt_append(mk_lib_crypto_app_pt const app, mk_lang_types_usize_t const len) mk_lang_noexcept
{
	...
	for(i = 0; i != (n / 8) * 8; i += 8)
	{
		mk_lib_crypto_app_encrypt_mode_8(app, i * msg_len);
	}
	for(; i != n; ++i)
	{
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_ssize_t mk_lib_crypto_app_impl_decrypt_append(mk_lib_crypto_app_pt const app, mk_lang_types_usize_t const len) mk_lang_noexcept
{
	...
	for(i = 0; i != (n / 8) * 8; i += 8)
	{
		mk_lib_crypto_app_decrypt_mode_8(app, i * msg_len);
	}
	for(; i != n; ++i)
	{
