...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_ssize_t mk_lib_crypto_app_impl_init(mk_lib_crypto_app_pt const app) mk_lang_noexcept
{
	...
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_cbc    ){ for(i = 0; i != mk_lib_crypto_mode_cbc_twofish_256_key_len_v    ; ++i){ app->m_key.m_data.m_cbc_twofish_256    .m_data.m_uint8s[i] = key_data[i]; } }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_cfb_128){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_twofish_256_key_len_v; ++i){ app->m_key.m_data.m_cfb_128_twofish_256.m_data.m_uint8s[i] = key_data[i]; } }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_cfb_8  ){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_twofish_256_key_len_v  ; ++i){ app->m_key.m_data.m_cfb_8_twofish_256  .m_data.m_uint8s[i] = key_data[i]; } }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_ctr_be ){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_twofish_256_key_len_v ; ++i){ app->m_key.m_data.m_ctr_be_twofish_256 .m_data.m_uint8s[i] = key_data[i]; } }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_ecb    ){ for(i = 0; i != mk_lib_crypto_alg_twofish_256_key_len_v         ; ++i){ app->m_key.m_data.m_cbc_twofish_256    .m_data.m_uint8s[i] = key_data[i]; } }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_ofb    ){ for(i = 0; i != mk_lib_crypto_mode_ofb_twofish_256_key_len_v    ; ++i){ app->m_key.m_data.m_ofb_twofish_256    .m_data.m_uint8s[i] = key_data[i]; } }
	else{ mk_lang_assert(0); }
	return iv_len;
}
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_app_encrypt_mode(mk_lib_crypto_app_pt const app, mk_lang_types_usize_t const idx) mk_lang_noexcept
{
	...
	switch(id)
	{
		...
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_twofish_256_msg_t     msg mk_lang_constexpr_init; for(i = 0; i != mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ; ++i){ msg.m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + i]; } mk_lib_crypto_mode_cbc_twofish_256_schedule_encrypt    (&app->m_mode.m_data.m_cbc_twofish_256    , &app->m_schedule.m_data.m_cbc_twofish_256    , &msg, &msg, 1); for(i = 0; i != mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + i] = msg.m_data.m_uint8s[i]; } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_128_twofish_256_msg_t msg mk_lang_constexpr_init; for(i = 0; i != mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v; ++i){ msg.m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + i]; } mk_lib_crypto_mode_cfb_128_twofish_256_schedule_encrypt(&app->m_mode.m_data.m_cfb_128_twofish_256, &app->m_schedule.m_data.m_cfb_128_twofish_256, &msg, &msg, 1); for(i = 0; i != mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v; ++i){ app->m_buffer.m_data.m_uint8s[idx + i] = msg.m_data.m_uint8s[i]; } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_twofish_256_msg_t   msg mk_lang_constexpr_init; for(i = 0; i != mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ; ++i){ msg.m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + i]; } mk_lib_crypto_mode_cfb_8_twofish_256_schedule_encrypt  (&app->m_mode.m_data.m_cfb_8_twofish_256  , &app->m_schedule.m_data.m_cfb_8_twofish_256  , &msg, &msg, 1); for(i = 0; i != mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ; ++i){ app->m_buffer.m_data.m_uint8s[idx + i] = msg.m_data.m_uint8s[i]; } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_twofish_256_msg_t  msg mk_lang_constexpr_init; for(i = 0; i != mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ; ++i){ msg.m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + i]; } mk_lib_crypto_mode_ctr_be_twofish_256_schedule_encrypt (&app->m_mode.m_data.m_ctr_be_twofish_256 , &app->m_schedule.m_data.m_ctr_be_twofish_256 , &msg, &msg, 1); for(i = 0; i != mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ; ++i){ app->m_buffer.m_data.m_uint8s[idx + i] = msg.m_data.m_uint8s[i]; } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_twofish_256_msg_t     msg mk_lang_constexpr_init; for(i = 0; i != mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ; ++i){ msg.m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + i]; } mk_lib_crypto_mode_ecb_twofish_256_schedule_encrypt    (&app->m_mode.m_data.m_ecb_twofish_256    , &app->m_schedule.m_data.m_ecb_twofish_256    , &msg, &msg, 1); for(i = 0; i != mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + i] = msg.m_data.m_uint8s[i]; } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_twofish_256_msg_t     msg mk_lang_constexpr_init; for(i = 0; i != mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ; ++i){ msg.m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + i]; } mk_lib_crypto_mode_ofb_twofish_256_schedule_encrypt    (&app->m_mode.m_data.m_ofb_twofish_256    , &app->m_schedule.m_data.m_ofb_twofish_256    , &msg, &msg, 1); for(i = 0; i != mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + i] = msg.m_data.m_uint8s[i]; } } break;
		default: mk_lang_assert(0); break;
	}
}
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_app_encrypt_mode_16(mk_lib_crypto_app_pt const app, mk_lang_types_usize_t const idx) mk_lang_noexcept
{
	...
	switch(id)
	{
		...
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_twofish_256_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_twofish_256_msg_len_v     + i]; } } mk_lib_crypto_mode_cbc_twofish_256_schedule_encrypt    (&app->m_mode.m_data.m_cbc_twofish_256    , &app->m_schedule.m_data.m_cbc_twofish_256    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_twofish_256_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_128_twofish_256_msg_t msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v + i]; } } mk_lib_crypto_mode_cfb_128_twofish_256_schedule_encrypt(&app->m_mode.m_data.m_cfb_128_twofish_256, &app->m_schedule.m_data.m_cfb_128_twofish_256, &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_twofish_256_msg_t   msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v   + i]; } } mk_lib_crypto_mode_cfb_8_twofish_256_schedule_encrypt  (&app->m_mode.m_data.m_cfb_8_twofish_256  , &app->m_schedule.m_data.m_cfb_8_twofish_256  , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v   + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_twofish_256_msg_t  msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v  + i]; } } mk_lib_crypto_mode_ctr_be_twofish_256_schedule_encrypt (&app->m_mode.m_data.m_ctr_be_twofish_256 , &app->m_schedule.m_data.m_ctr_be_twofish_256 , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v  + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_twofish_256_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_twofish_256_msg_len_v     + i]; } } mk_lib_crypto_mode_ecb_twofish_256_schedule_encrypt    (&app->m_mode.m_data.m_ecb_twofish_256    , &app->m_schedule.m_data.m_ecb_twofish_256    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_twofish_256_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_twofish_256_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_twofish_256_msg_len_v     + i]; } } mk_lib_crypto_mode_ofb_twofish_256_schedule_encrypt    (&app->m_mode.m_data.m_ofb_twofish_256    , &app->m_schedule.m_data.m_ofb_twofish_256    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_twofish_256_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		default: mk_lang_assert(0); break;
	}
}
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_app_decrypt_mode(mk_lib_crypto_app_pt const app, mk_lang_types_usize_t const idx) mk_lang_noexcept
{
	...
	switch(id)
	{
		...
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_twofish_256_msg_t     msg mk_lang_constexpr_init; for(i = 0; i != mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ; ++i){ msg.m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + i]; } mk_lib_crypto_mode_cbc_twofish_256_schedule_decrypt    (&app->m_mode.m_data.m_cbc_twofish_256    , &app->m_schedule.m_data.m_cbc_twofish_256    , &msg, &msg, 1); for(i = 0; i != mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + i] = msg.m_data.m_uint8s[i]; } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_128_twofish_256_msg_t msg mk_lang_constexpr_init; for(i = 0; i != mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v; ++i){ msg.m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + i]; } mk_lib_crypto_mode_cfb_128_twofish_256_schedule_decrypt(&app->m_mode.m_data.m_cfb_128_twofish_256, &app->m_schedule.m_data.m_cfb_128_twofish_256, &msg, &msg, 1); for(i = 0; i != mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v; ++i){ app->m_buffer.m_data.m_uint8s[idx + i] = msg.m_data.m_uint8s[i]; } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_twofish_256_msg_t   msg mk_lang_constexpr_init; for(i = 0; i != mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ; ++i){ msg.m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + i]; } mk_lib_crypto_mode_cfb_8_twofish_256_schedule_decrypt  (&app->m_mode.m_data.m_cfb_8_twofish_256  , &app->m_schedule.m_data.m_cfb_8_twofish_256  , &msg, &msg, 1); for(i = 0; i != mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ; ++i){ app->m_buffer.m_data.m_uint8s[idx + i] = msg.m_data.m_uint8s[i]; } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_twofish_256_msg_t  msg mk_lang_constexpr_init; for(i = 0; i != mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ; ++i){ msg.m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + i]; } mk_lib_crypto_mode_ctr_be_twofish_256_schedule_decrypt (&app->m_mode.m_data.m_ctr_be_twofish_256 , &app->m_schedule.m_data.m_ctr_be_twofish_256 , &msg, &msg, 1); for(i = 0; i != mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ; ++i){ app->m_buffer.m_data.m_uint8s[idx + i] = msg.m_data.m_uint8s[i]; } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_twofish_256_msg_t     msg mk_lang_constexpr_init; for(i = 0; i != mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ; ++i){ msg.m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + i]; } mk_lib_crypto_mode_ecb_twofish_256_schedule_decrypt    (&app->m_mode.m_data.m_ecb_twofish_256    , &app->m_schedule.m_data.m_ecb_twofish_256    , &msg, &msg, 1); for(i = 0; i != mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + i] = msg.m_data.m_uint8s[i]; } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_twofish_256_msg_t     msg mk_lang_constexpr_init; for(i = 0; i != mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ; ++i){ msg.m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + i]; } mk_lib_crypto_mode_ofb_twofish_256_schedule_decrypt    (&app->m_mode.m_data.m_ofb_twofish_256    , &app->m_schedule.m_data.m_ofb_twofish_256    , &msg, &msg, 1); for(i = 0; i != mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + i] = msg.m_data.m_uint8s[i]; } } break;
		default: mk_lang_assert(0); break;
	}
}
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_app_decrypt_mode_16(mk_lib_crypto_app_pt const app, mk_lang_types_usize_t const idx) mk_lang_noexcept
{
	...
	switch(id)
	{
		...
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_twofish_256_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_twofish_256_msg_len_v     + i]; } } mk_lib_crypto_mode_cbc_twofish_256_schedule_decrypt    (&app->m_mode.m_data.m_cbc_twofish_256    , &app->m_schedule.m_data.m_cbc_twofish_256    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_twofish_256_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_128_twofish_256_msg_t msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v + i]; } } mk_lib_crypto_mode_cfb_128_twofish_256_schedule_decrypt(&app->m_mode.m_data.m_cfb_128_twofish_256, &app->m_schedule.m_data.m_cfb_128_twofish_256, &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_twofish_256_msg_t   msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v   + i]; } } mk_lib_crypto_mode_cfb_8_twofish_256_schedule_decrypt  (&app->m_mode.m_data.m_cfb_8_twofish_256  , &app->m_schedule.m_data.m_cfb_8_twofish_256  , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v   + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_twofish_256_msg_t  msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v  + i]; } } mk_lib_crypto_mode_ctr_be_twofish_256_schedule_decrypt (&app->m_mode.m_data.m_ctr_be_twofish_256 , &app->m_schedule.m_data.m_ctr_be_twofish_256 , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v  + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_twofish_256_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_twofish_256_msg_len_v     + i]; } } mk_lib_crypto_mode_ecb_twofish_256_schedule_decrypt    (&app->m_mode.m_data.m_ecb_twofish_256    , &app->m_schedule.m_data.m_ecb_twofish_256    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_twofish_256_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_twofish_256_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ; ++i){ msg[iblock].m_data.m_uint8s[i] = app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_twofish_256_msg_len_v     + i]; } } mk_lib_crypto_mode_ofb_twofish_256_schedule_decrypt    (&app->m_mode.m_data.m_ofb_twofish_256    , &app->m_schedule.m_data.m_ofb_twofish_256    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ for(i = 0; i != mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ; ++i){ app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_twofish_256_msg_len_v     + i] = msg[iblock].m_data.m_uint8s[i]; } } } break;
		default: mk_lang_assert(0); break;
	}
}
