...
#include "mk_lib_crypto_mode_cbc_twofish_256.h"
...
#include "mk_lib_crypto_mode_cfb_128_twofish_256.h"
...
#include "mk_lib_crypto_mode_cfb_8_twofish_256.h"
...
#include "mk_lib_crypto_mode_ctr_be_twofish_256.h"
...
#include "mk_lib_crypto_mode_ecb_twofish_256.h"
...
#include "mk_lib_crypto_mode_ofb_twofish_256.h"
...
#define mk_lang_memcpy_t_name mk_lib_crypto_app_memcpyu8
...
#define mk_lib_crypto_app_name_code_alg_twofish "twofish"
...
#define mk_lib_crypto_app_name_pretty_alg_twofish "Twofish"
...
#define mk_lib_crypto_app_namelen_code_alg_twofish ((mk_lang_types_uchar_t)(sizeof(mk_lib_crypto_app_name_code_alg_twofish ) / sizeof(mk_lib_crypto_app_name_code_alg_twofish [0]) - 1))
...
#define mk_lib_crypto_app_namelen_pretty_alg_twofish ((mk_lang_types_uchar_t)(sizeof(mk_lib_crypto_app_name_pretty_alg_twofish ) / sizeof(mk_lib_crypto_app_name_pretty_alg_twofish [0]) - 1))
...
#define mk_lib_crypto_app_name_code_algs \
	...
	mk_lib_crypto_app_name_code_alg_twofish \
	""
...
#define mk_lib_crypto_app_name_pretty_algs \
	...
	mk_lib_crypto_app_name_pretty_alg_twofish \
	""
...
#define mk_lib_crypto_app_namelen_code_algs \
	...
	mk_lib_crypto_app_namelen_code_alg_twofish, \
...
#define mk_lib_crypto_app_namelen_pretty_algs \
	...
	mk_lib_crypto_app_namelen_pretty_alg_twofish, \
...
union mk_lib_crypto_app_aligned_iv_u
{
	...
	mk_lib_crypto_mode_cbc_twofish_256_iv_t     m_cbc_twofish_256    ;
	...
	mk_lib_crypto_mode_cfb_128_twofish_256_iv_t m_cfb_128_twofish_256;
	...
	mk_lib_crypto_mode_cfb_8_twofish_256_iv_t   m_cfb_8_twofish_256  ;
	...
	mk_lib_crypto_mode_ctr_be_twofish_256_iv_t  m_ctr_be_twofish_256 ;
	...
	mk_lib_crypto_mode_ofb_twofish_256_iv_t     m_ofb_twofish_256    ;
...
mk_lang_constexpr_static_inline mk_lang_types_uchar_t const s_mk_lib_crypto_app_order_algs[] =
{
	...
	((mk_lang_types_uchar_t)(mk_lib_crypto_app_alg_id_e_twofish_256)),
...
enum mk_lib_crypto_app_mode_alg_id_e
{
	...
	mk_lib_crypto_app_mode_alg_id_e_cbc_twofish_256,
	...
	mk_lib_crypto_app_mode_alg_id_e_cfb_128_twofish_256,
	...
	mk_lib_crypto_app_mode_alg_id_e_cfb_8_twofish_256,
	...
	mk_lib_crypto_app_mode_alg_id_e_ctr_be_twofish_256,
	...
	mk_lib_crypto_app_mode_alg_id_e_ecb_twofish_256,
	...
	mk_lib_crypto_app_mode_alg_id_e_ofb_twofish_256,
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline int mk_lib_crypto_app_get_key_size_max_f(void) mk_lang_noexcept
{
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_cbc_twofish_256_key_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_cfb_128_twofish_256_key_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_cfb_8_twofish_256_key_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_ctr_be_twofish_256_key_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_ecb_twofish_256_key_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_ofb_twofish_256_key_len_v);
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline int mk_lib_crypto_app_get_msg_size_max_f(void) mk_lang_noexcept
{
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_cbc_twofish_256_msg_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_ecb_twofish_256_msg_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_ofb_twofish_256_msg_len_v);
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline int mk_lib_crypto_app_get_iv_size_max_f(void) mk_lang_noexcept
{
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_cbc_twofish_256_iv_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_cfb_128_twofish_256_iv_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_cfb_8_twofish_256_iv_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_ctr_be_twofish_256_iv_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_ecb_twofish_256_iv_len_v);
	...
	s = mk_lang_max(s, mk_lib_crypto_mode_ofb_twofish_256_iv_len_v);
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_ssize_t mk_lib_crypto_app_impl_get_names(mk_lib_crypto_app_pt const app) mk_lang_noexcept
{
	...
	mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[0], &s_mk_lib_crypto_app_get_names_str.m_data[0], s_mk_lib_crypto_app_get_names_str.s_size);
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_sl_cui_uint8_pct mk_lib_crypto_app_init_buff(mk_sl_cui_uint8_pct const ptr, int const len, mk_sl_cui_uint8_pt const dst) mk_lang_noexcept
{
	...
	p = ptr;
	mk_lib_crypto_app_memcpyu8_fn(&dst[0], &p[0], len); p += len;
	return p;
}
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_sl_cui_uint8_pct mk_lib_crypto_app_init_iv(mk_sl_cui_uint8_pct const ptr, mk_lib_crypto_app_alg_id_t const alg_id, mk_lib_crypto_app_mode_id_t const mode_id, mk_lib_crypto_app_iv_pt const iv) mk_lang_noexcept
{
	...
	if(mode_id != mk_lib_crypto_app_mode_id_e_ecb)
	{
		...
		switch(id)
		{
			...
			case ((int)(((int)(mk_lib_crypto_app_mode_id_e_cbc    )) * ((int)(mk_lib_crypto_app_alg_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_alg_id_e_twofish_256)))): ((void)(mk_lib_crypto_app_init_buff(p, mk_lib_crypto_mode_cbc_twofish_256_iv_len_v    , &iv->m_data.m_cbc_twofish_256    .m_data.m_uint8s[0]))); break;
			...
			case ((int)(((int)(mk_lib_crypto_app_mode_id_e_cfb_128)) * ((int)(mk_lib_crypto_app_alg_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_alg_id_e_twofish_256)))): ((void)(mk_lib_crypto_app_init_buff(p, mk_lib_crypto_mode_cfb_128_twofish_256_iv_len_v, &iv->m_data.m_cfb_128_twofish_256.m_data.m_uint8s[0]))); break;
			...
			case ((int)(((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )) * ((int)(mk_lib_crypto_app_alg_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_alg_id_e_twofish_256)))): ((void)(mk_lib_crypto_app_init_buff(p, mk_lib_crypto_mode_cfb_8_twofish_256_iv_len_v  , &iv->m_data.m_cfb_8_twofish_256  .m_data.m_uint8s[0]))); break;
			...
			case ((int)(((int)(mk_lib_crypto_app_mode_id_e_ctr_be )) * ((int)(mk_lib_crypto_app_alg_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_alg_id_e_twofish_256)))): ((void)(mk_lib_crypto_app_init_buff(p, mk_lib_crypto_mode_ctr_be_twofish_256_iv_len_v , &iv->m_data.m_ctr_be_twofish_256 .m_data.m_uint8s[0]))); break;
			...
			case ((int)(((int)(mk_lib_crypto_app_mode_id_e_ofb    )) * ((int)(mk_lib_crypto_app_alg_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_alg_id_e_twofish_256)))): ((void)(mk_lib_crypto_app_init_buff(p, mk_lib_crypto_mode_ofb_twofish_256_iv_len_v    , &iv->m_data.m_ofb_twofish_256    .m_data.m_uint8s[0]))); break;
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_ssize_t mk_lib_crypto_app_impl_init(mk_lib_crypto_app_pt const app) mk_lang_noexcept
{
	...
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_ecb    ){ iv_len = mk_lib_crypto_mode_ecb_twofish_256_iv_len_v; }
	...
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_cbc    ){ iv_len = mk_lib_crypto_mode_cbc_twofish_256_iv_len_v    ; mk_lib_crypto_mode_cbc_twofish_256_init    (&app->m_mode.m_data.m_cbc_twofish_256    , &iv.m_data.m_cbc_twofish_256    ); }
	...
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_cfb_128){ iv_len = mk_lib_crypto_mode_cfb_128_twofish_256_iv_len_v; mk_lib_crypto_mode_cfb_128_twofish_256_init(&app->m_mode.m_data.m_cfb_128_twofish_256, &iv.m_data.m_cfb_128_twofish_256); }
	...
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_cfb_8  ){ iv_len = mk_lib_crypto_mode_cfb_8_twofish_256_iv_len_v  ; mk_lib_crypto_mode_cfb_8_twofish_256_init  (&app->m_mode.m_data.m_cfb_8_twofish_256  , &iv.m_data.m_cfb_8_twofish_256  ); }
	...
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_ctr_be ){ iv_len = mk_lib_crypto_mode_ctr_be_twofish_256_iv_len_v ; mk_lib_crypto_mode_ctr_be_twofish_256_init (&app->m_mode.m_data.m_ctr_be_twofish_256 , &iv.m_data.m_ctr_be_twofish_256 ); }
	...
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_ofb    ){ iv_len = mk_lib_crypto_mode_ofb_twofish_256_iv_len_v    ; mk_lib_crypto_mode_ofb_twofish_256_init    (&app->m_mode.m_data.m_ofb_twofish_256    , &iv.m_data.m_ofb_twofish_256    ); }
	...
	switch(alg_id)
	{
		...
		case mk_lib_crypto_app_alg_id_e_twofish_256: key_len = mk_lib_crypto_alg_twofish_256_key_len_v; break;
		case mk_lib_crypto_app_alg_id_e_dummy_end: mk_lang_assert(0); break;
		default: mk_lang_assert(0); break;
	}
	switch(kdf_id)
	{
		...
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_blake2s_128 : mk_lib_crypto_kdf_pbkdf2_blake2s_128  (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_blake2s_160 : mk_lib_crypto_kdf_pbkdf2_blake2s_160  (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_blake2s_224 : mk_lib_crypto_kdf_pbkdf2_blake2s_224  (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_blake2s_256 : mk_lib_crypto_kdf_pbkdf2_blake2s_256  (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_blake3      : mk_lib_crypto_kdf_pbkdf2_blake3       (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_md2         : mk_lib_crypto_kdf_pbkdf2_md2          (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_md4         : mk_lib_crypto_kdf_pbkdf2_md4          (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_md5         : mk_lib_crypto_kdf_pbkdf2_md5          (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_sha0        : mk_lib_crypto_kdf_pbkdf2_sha0         (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_sha1        : mk_lib_crypto_kdf_pbkdf2_sha1         (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_sha2_224    : mk_lib_crypto_kdf_pbkdf2_sha2_224     (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_sha2_256    : mk_lib_crypto_kdf_pbkdf2_sha2_256     (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_sha2_384    : mk_lib_crypto_kdf_pbkdf2_sha2_384     (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_sha2_512    : mk_lib_crypto_kdf_pbkdf2_sha2_512     (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_sha2_512_224: mk_lib_crypto_kdf_pbkdf2_sha2_512_224 (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_sha2_512_256: mk_lib_crypto_kdf_pbkdf2_sha2_512_256 (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_sha3_224    : mk_lib_crypto_kdf_pbkdf2_sha3_224     (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_sha3_256    : mk_lib_crypto_kdf_pbkdf2_sha3_256     (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_sha3_384    : mk_lib_crypto_kdf_pbkdf2_sha3_384     (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_sha3_512    : mk_lib_crypto_kdf_pbkdf2_sha3_512     (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_streebog_256: mk_lib_crypto_kdf_pbkdf2_streebog_256 (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_streebog_512: mk_lib_crypto_kdf_pbkdf2_streebog_512 (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_tiger2_128  : mk_lib_crypto_kdf_pbkdf2_tiger2_128   (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_tiger2_160  : mk_lib_crypto_kdf_pbkdf2_tiger2_160   (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_tiger2_192  : mk_lib_crypto_kdf_pbkdf2_tiger2_192   (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_tiger_128   : mk_lib_crypto_kdf_pbkdf2_tiger_128    (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_tiger_160   : mk_lib_crypto_kdf_pbkdf2_tiger_160    (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_tiger_192   : mk_lib_crypto_kdf_pbkdf2_tiger_192    (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_pbkdf2_whirlpool   : mk_lib_crypto_kdf_pbkdf2_whirlpool    (pwd_buf, pwd_len, slt_buf, slt_len, cost_ul, key_len, &key_data[0]); break;
		case mk_lib_crypto_app_kdf_id_e_dummy_end: mk_lang_assert(0); break;
		default: mk_lang_assert(0); break;
	}
	if(0){}
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_128     && mode_id == mk_lib_crypto_app_mode_id_e_cbc    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cbc_aes_128        .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cbc_aes_128_key_len_v        ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_128     && mode_id == mk_lib_crypto_app_mode_id_e_cfb_128){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_128_aes_128    .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_128_aes_128_key_len_v    ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_128     && mode_id == mk_lib_crypto_app_mode_id_e_cfb_8  ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_8_aes_128      .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_8_aes_128_key_len_v      ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_128     && mode_id == mk_lib_crypto_app_mode_id_e_ctr_be ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ctr_be_aes_128     .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ctr_be_aes_128_key_len_v     ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_128     && mode_id == mk_lib_crypto_app_mode_id_e_ecb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ecb_aes_128        .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_alg_aes_128_key_len_v             ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_128     && mode_id == mk_lib_crypto_app_mode_id_e_ofb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ofb_aes_128        .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ofb_aes_128_key_len_v        ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_192     && mode_id == mk_lib_crypto_app_mode_id_e_cbc    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cbc_aes_192        .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cbc_aes_192_key_len_v        ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_192     && mode_id == mk_lib_crypto_app_mode_id_e_cfb_128){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_128_aes_192    .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_128_aes_192_key_len_v    ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_192     && mode_id == mk_lib_crypto_app_mode_id_e_cfb_8  ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_8_aes_192      .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_8_aes_192_key_len_v      ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_192     && mode_id == mk_lib_crypto_app_mode_id_e_ctr_be ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ctr_be_aes_192     .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ctr_be_aes_192_key_len_v     ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_192     && mode_id == mk_lib_crypto_app_mode_id_e_ecb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ecb_aes_192        .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_alg_aes_192_key_len_v             ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_192     && mode_id == mk_lib_crypto_app_mode_id_e_ofb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ofb_aes_192        .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ofb_aes_192_key_len_v        ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_256     && mode_id == mk_lib_crypto_app_mode_id_e_cbc    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cbc_aes_256        .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cbc_aes_256_key_len_v        ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_256     && mode_id == mk_lib_crypto_app_mode_id_e_cfb_128){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_128_aes_256    .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_128_aes_256_key_len_v    ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_256     && mode_id == mk_lib_crypto_app_mode_id_e_cfb_8  ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_8_aes_256      .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_8_aes_256_key_len_v      ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_256     && mode_id == mk_lib_crypto_app_mode_id_e_ctr_be ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ctr_be_aes_256     .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ctr_be_aes_256_key_len_v     ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_256     && mode_id == mk_lib_crypto_app_mode_id_e_ecb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cbc_aes_256        .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_alg_aes_256_key_len_v             ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_aes_256     && mode_id == mk_lib_crypto_app_mode_id_e_ofb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ofb_aes_256        .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ofb_aes_256_key_len_v        ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_des         && mode_id == mk_lib_crypto_app_mode_id_e_cbc    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cbc_des            .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cbc_des_key_len_v            ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_des         && mode_id == mk_lib_crypto_app_mode_id_e_cfb_128){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_64_des         .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_64_des_key_len_v         ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_des         && mode_id == mk_lib_crypto_app_mode_id_e_cfb_8  ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_8_des          .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_8_des_key_len_v          ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_des         && mode_id == mk_lib_crypto_app_mode_id_e_ctr_be ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ctr_be_des         .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ctr_be_des_key_len_v         ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_des         && mode_id == mk_lib_crypto_app_mode_id_e_ecb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cbc_des            .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_alg_des_key_len_v                 ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_des         && mode_id == mk_lib_crypto_app_mode_id_e_ofb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ofb_des            .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ofb_des_key_len_v            ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_serpent     && mode_id == mk_lib_crypto_app_mode_id_e_cbc    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cbc_serpent        .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cbc_serpent_key_len_v        ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_serpent     && mode_id == mk_lib_crypto_app_mode_id_e_cfb_128){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_128_serpent    .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_128_serpent_key_len_v    ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_serpent     && mode_id == mk_lib_crypto_app_mode_id_e_cfb_8  ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_8_serpent      .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_8_serpent_key_len_v      ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_serpent     && mode_id == mk_lib_crypto_app_mode_id_e_ctr_be ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ctr_be_serpent     .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ctr_be_serpent_key_len_v     ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_serpent     && mode_id == mk_lib_crypto_app_mode_id_e_ecb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cbc_serpent        .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_alg_serpent_key_len_v             ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_serpent     && mode_id == mk_lib_crypto_app_mode_id_e_ofb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ofb_serpent        .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ofb_serpent_key_len_v        ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_tdes2       && mode_id == mk_lib_crypto_app_mode_id_e_cbc    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cbc_tdes2          .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cbc_tdes2_key_len_v          ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_tdes2       && mode_id == mk_lib_crypto_app_mode_id_e_cfb_128){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_64_tdes2       .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_64_tdes2_key_len_v       ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_tdes2       && mode_id == mk_lib_crypto_app_mode_id_e_cfb_8  ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_8_tdes2        .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_8_tdes2_key_len_v        ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_tdes2       && mode_id == mk_lib_crypto_app_mode_id_e_ctr_be ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ctr_be_tdes2       .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ctr_be_tdes2_key_len_v       ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_tdes2       && mode_id == mk_lib_crypto_app_mode_id_e_ecb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cbc_tdes2          .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_alg_tdes2_key_len_v               ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_tdes2       && mode_id == mk_lib_crypto_app_mode_id_e_ofb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ofb_tdes2          .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ofb_tdes2_key_len_v          ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_tdes3       && mode_id == mk_lib_crypto_app_mode_id_e_cbc    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cbc_tdes3          .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cbc_tdes3_key_len_v          ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_tdes3       && mode_id == mk_lib_crypto_app_mode_id_e_cfb_128){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_64_tdes3       .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_64_tdes3_key_len_v       ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_tdes3       && mode_id == mk_lib_crypto_app_mode_id_e_cfb_8  ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_8_tdes3        .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_8_tdes3_key_len_v        ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_tdes3       && mode_id == mk_lib_crypto_app_mode_id_e_ctr_be ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ctr_be_tdes3       .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ctr_be_tdes3_key_len_v       ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_tdes3       && mode_id == mk_lib_crypto_app_mode_id_e_ecb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cbc_tdes3          .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_alg_tdes3_key_len_v               ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_tdes3       && mode_id == mk_lib_crypto_app_mode_id_e_ofb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ofb_tdes3          .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ofb_tdes3_key_len_v          ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_cbc    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cbc_twofish_256    .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cbc_twofish_256_key_len_v    ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_cfb_128){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_128_twofish_256.m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_128_twofish_256_key_len_v); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_cfb_8  ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cfb_8_twofish_256  .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_cfb_8_twofish_256_key_len_v  ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_ctr_be ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ctr_be_twofish_256 .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ctr_be_twofish_256_key_len_v ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_ecb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_cbc_twofish_256    .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_alg_twofish_256_key_len_v         ); }
	else if(alg_id == mk_lib_crypto_app_alg_id_e_twofish_256 && mode_id == mk_lib_crypto_app_mode_id_e_ofb    ){ mk_lib_crypto_app_memcpyu8_fn(&app->m_key.m_data.m_ofb_twofish_256    .m_data.m_uint8s[0], &key_data[0], mk_lib_crypto_mode_ofb_twofish_256_key_len_v    ); }
	else{ mk_lang_assert(0); }
	return iv_len;
}
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline int mk_lib_crypto_app_get_msg_len(mk_lib_crypto_app_alg_id_t const alg_id, mk_lib_crypto_app_mode_id_t const mode_id) mk_lang_noexcept
{
	...
	switch(id)
	{
		...
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): len = mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ; break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): len = mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v; break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): len = mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ; break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): len = mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ; break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): len = mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ; break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): len = mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ; break;
		default: mk_lang_assert(0); break;
	}
	return len;
}
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_app_encrypt_mode(mk_lib_crypto_app_pt const app, mk_lang_types_usize_t const idx) mk_lang_noexcept
{
	...
	switch(id)
	{
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_aes_128_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_aes_128_msg_len_v        ); mk_lib_crypto_mode_cbc_aes_128_schedule_encrypt        (&app->m_mode.m_data.m_cbc_aes_128        , &app->m_schedule.m_data.m_cbc_aes_128        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_aes_128_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_128_aes_128_msg_t     msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v    ); mk_lib_crypto_mode_cfb_128_aes_128_schedule_encrypt    (&app->m_mode.m_data.m_cfb_128_aes_128    , &app->m_schedule.m_data.m_cfb_128_aes_128    , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v    ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_aes_128_msg_t       msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v      ); mk_lib_crypto_mode_cfb_8_aes_128_schedule_encrypt      (&app->m_mode.m_data.m_cfb_8_aes_128      , &app->m_schedule.m_data.m_cfb_8_aes_128      , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v      ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_aes_128_msg_t      msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v     ); mk_lib_crypto_mode_ctr_be_aes_128_schedule_encrypt     (&app->m_mode.m_data.m_ctr_be_aes_128     , &app->m_schedule.m_data.m_ctr_be_aes_128     , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v     ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_aes_128_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_aes_128_msg_len_v        ); mk_lib_crypto_mode_ecb_aes_128_schedule_encrypt        (&app->m_mode.m_data.m_ecb_aes_128        , &app->m_schedule.m_data.m_ecb_aes_128        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_aes_128_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_aes_128_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_aes_128_msg_len_v        ); mk_lib_crypto_mode_ofb_aes_128_schedule_encrypt        (&app->m_mode.m_data.m_ofb_aes_128        , &app->m_schedule.m_data.m_ofb_aes_128        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_aes_128_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_aes_192_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_aes_192_msg_len_v        ); mk_lib_crypto_mode_cbc_aes_192_schedule_encrypt        (&app->m_mode.m_data.m_cbc_aes_192        , &app->m_schedule.m_data.m_cbc_aes_192        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_aes_192_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_128_aes_192_msg_t     msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v    ); mk_lib_crypto_mode_cfb_128_aes_192_schedule_encrypt    (&app->m_mode.m_data.m_cfb_128_aes_192    , &app->m_schedule.m_data.m_cfb_128_aes_192    , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v    ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_aes_192_msg_t       msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v      ); mk_lib_crypto_mode_cfb_8_aes_192_schedule_encrypt      (&app->m_mode.m_data.m_cfb_8_aes_192      , &app->m_schedule.m_data.m_cfb_8_aes_192      , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v      ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_aes_192_msg_t      msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v     ); mk_lib_crypto_mode_ctr_be_aes_192_schedule_encrypt     (&app->m_mode.m_data.m_ctr_be_aes_192     , &app->m_schedule.m_data.m_ctr_be_aes_192     , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v     ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_aes_192_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_aes_192_msg_len_v        ); mk_lib_crypto_mode_ecb_aes_192_schedule_encrypt        (&app->m_mode.m_data.m_ecb_aes_192        , &app->m_schedule.m_data.m_ecb_aes_192        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_aes_192_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_aes_192_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_aes_192_msg_len_v        ); mk_lib_crypto_mode_ofb_aes_192_schedule_encrypt        (&app->m_mode.m_data.m_ofb_aes_192        , &app->m_schedule.m_data.m_ofb_aes_192        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_aes_192_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_aes_256_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_aes_256_msg_len_v        ); mk_lib_crypto_mode_cbc_aes_256_schedule_encrypt        (&app->m_mode.m_data.m_cbc_aes_256        , &app->m_schedule.m_data.m_cbc_aes_256        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_aes_256_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_128_aes_256_msg_t     msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v    ); mk_lib_crypto_mode_cfb_128_aes_256_schedule_encrypt    (&app->m_mode.m_data.m_cfb_128_aes_256    , &app->m_schedule.m_data.m_cfb_128_aes_256    , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v    ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_aes_256_msg_t       msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v      ); mk_lib_crypto_mode_cfb_8_aes_256_schedule_encrypt      (&app->m_mode.m_data.m_cfb_8_aes_256      , &app->m_schedule.m_data.m_cfb_8_aes_256      , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v      ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_aes_256_msg_t      msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v     ); mk_lib_crypto_mode_ctr_be_aes_256_schedule_encrypt     (&app->m_mode.m_data.m_ctr_be_aes_256     , &app->m_schedule.m_data.m_ctr_be_aes_256     , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v     ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_aes_256_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_aes_256_msg_len_v        ); mk_lib_crypto_mode_ecb_aes_256_schedule_encrypt        (&app->m_mode.m_data.m_ecb_aes_256        , &app->m_schedule.m_data.m_ecb_aes_256        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_aes_256_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_aes_256_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_aes_256_msg_len_v        ); mk_lib_crypto_mode_ofb_aes_256_schedule_encrypt        (&app->m_mode.m_data.m_ofb_aes_256        , &app->m_schedule.m_data.m_ofb_aes_256        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_aes_256_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_des_msg_t             msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_des_msg_len_v            ); mk_lib_crypto_mode_cbc_des_schedule_encrypt            (&app->m_mode.m_data.m_cbc_des            , &app->m_schedule.m_data.m_cbc_des            , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_des_msg_len_v            ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_64_des_msg_t          msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_64_des_msg_len_v         ); mk_lib_crypto_mode_cfb_64_des_schedule_encrypt         (&app->m_mode.m_data.m_cfb_64_des         , &app->m_schedule.m_data.m_cfb_64_des         , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_64_des_msg_len_v         ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_des_msg_t           msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_des_msg_len_v          ); mk_lib_crypto_mode_cfb_8_des_schedule_encrypt          (&app->m_mode.m_data.m_cfb_8_des          , &app->m_schedule.m_data.m_cfb_8_des          , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_des_msg_len_v          ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_des_msg_t          msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_des_msg_len_v         ); mk_lib_crypto_mode_ctr_be_des_schedule_encrypt         (&app->m_mode.m_data.m_ctr_be_des         , &app->m_schedule.m_data.m_ctr_be_des         , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_des_msg_len_v         ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_des_msg_t             msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_des_msg_len_v            ); mk_lib_crypto_mode_ecb_des_schedule_encrypt            (&app->m_mode.m_data.m_ecb_des            , &app->m_schedule.m_data.m_ecb_des            , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_des_msg_len_v            ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_des_msg_t             msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_des_msg_len_v            ); mk_lib_crypto_mode_ofb_des_schedule_encrypt            (&app->m_mode.m_data.m_ofb_des            , &app->m_schedule.m_data.m_ofb_des            , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_des_msg_len_v            ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_serpent_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_serpent_msg_len_v        ); mk_lib_crypto_mode_cbc_serpent_schedule_encrypt        (&app->m_mode.m_data.m_cbc_serpent        , &app->m_schedule.m_data.m_cbc_serpent        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_serpent_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_128_serpent_msg_t     msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_128_serpent_msg_len_v    ); mk_lib_crypto_mode_cfb_128_serpent_schedule_encrypt    (&app->m_mode.m_data.m_cfb_128_serpent    , &app->m_schedule.m_data.m_cfb_128_serpent    , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_serpent_msg_len_v    ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_serpent_msg_t       msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_serpent_msg_len_v      ); mk_lib_crypto_mode_cfb_8_serpent_schedule_encrypt      (&app->m_mode.m_data.m_cfb_8_serpent      , &app->m_schedule.m_data.m_cfb_8_serpent      , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_serpent_msg_len_v      ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_serpent_msg_t      msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_serpent_msg_len_v     ); mk_lib_crypto_mode_ctr_be_serpent_schedule_encrypt     (&app->m_mode.m_data.m_ctr_be_serpent     , &app->m_schedule.m_data.m_ctr_be_serpent     , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_serpent_msg_len_v     ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_serpent_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_serpent_msg_len_v        ); mk_lib_crypto_mode_ecb_serpent_schedule_encrypt        (&app->m_mode.m_data.m_ecb_serpent        , &app->m_schedule.m_data.m_ecb_serpent        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_serpent_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_serpent_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_serpent_msg_len_v        ); mk_lib_crypto_mode_ofb_serpent_schedule_encrypt        (&app->m_mode.m_data.m_ofb_serpent        , &app->m_schedule.m_data.m_ofb_serpent        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_serpent_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_tdes2_msg_t           msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_tdes2_msg_len_v          ); mk_lib_crypto_mode_cbc_tdes2_schedule_encrypt          (&app->m_mode.m_data.m_cbc_tdes2          , &app->m_schedule.m_data.m_cbc_tdes2          , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_tdes2_msg_len_v          ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_64_tdes2_msg_t        msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_64_tdes2_msg_len_v       ); mk_lib_crypto_mode_cfb_64_tdes2_schedule_encrypt       (&app->m_mode.m_data.m_cfb_64_tdes2       , &app->m_schedule.m_data.m_cfb_64_tdes2       , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_64_tdes2_msg_len_v       ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_tdes2_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_tdes2_msg_len_v        ); mk_lib_crypto_mode_cfb_8_tdes2_schedule_encrypt        (&app->m_mode.m_data.m_cfb_8_tdes2        , &app->m_schedule.m_data.m_cfb_8_tdes2        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_tdes2_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_tdes2_msg_t        msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_tdes2_msg_len_v       ); mk_lib_crypto_mode_ctr_be_tdes2_schedule_encrypt       (&app->m_mode.m_data.m_ctr_be_tdes2       , &app->m_schedule.m_data.m_ctr_be_tdes2       , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_tdes2_msg_len_v       ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_tdes2_msg_t           msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_tdes2_msg_len_v          ); mk_lib_crypto_mode_ecb_tdes2_schedule_encrypt          (&app->m_mode.m_data.m_ecb_tdes2          , &app->m_schedule.m_data.m_ecb_tdes2          , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_tdes2_msg_len_v          ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_tdes2_msg_t           msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_tdes2_msg_len_v          ); mk_lib_crypto_mode_ofb_tdes2_schedule_encrypt          (&app->m_mode.m_data.m_ofb_tdes2          , &app->m_schedule.m_data.m_ofb_tdes2          , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_tdes2_msg_len_v          ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_tdes3_msg_t           msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_tdes3_msg_len_v          ); mk_lib_crypto_mode_cbc_tdes3_schedule_encrypt          (&app->m_mode.m_data.m_cbc_tdes3          , &app->m_schedule.m_data.m_cbc_tdes3          , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_tdes3_msg_len_v          ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_64_tdes3_msg_t        msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_64_tdes3_msg_len_v       ); mk_lib_crypto_mode_cfb_64_tdes3_schedule_encrypt       (&app->m_mode.m_data.m_cfb_64_tdes3       , &app->m_schedule.m_data.m_cfb_64_tdes3       , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_64_tdes3_msg_len_v       ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_tdes3_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_tdes3_msg_len_v        ); mk_lib_crypto_mode_cfb_8_tdes3_schedule_encrypt        (&app->m_mode.m_data.m_cfb_8_tdes3        , &app->m_schedule.m_data.m_cfb_8_tdes3        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_tdes3_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_tdes3_msg_t        msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_tdes3_msg_len_v       ); mk_lib_crypto_mode_ctr_be_tdes3_schedule_encrypt       (&app->m_mode.m_data.m_ctr_be_tdes3       , &app->m_schedule.m_data.m_ctr_be_tdes3       , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_tdes3_msg_len_v       ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_tdes3_msg_t           msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_tdes3_msg_len_v          ); mk_lib_crypto_mode_ecb_tdes3_schedule_encrypt          (&app->m_mode.m_data.m_ecb_tdes3          , &app->m_schedule.m_data.m_ecb_tdes3          , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_tdes3_msg_len_v          ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_tdes3_msg_t           msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_tdes3_msg_len_v          ); mk_lib_crypto_mode_ofb_tdes3_schedule_encrypt          (&app->m_mode.m_data.m_ofb_tdes3          , &app->m_schedule.m_data.m_ofb_tdes3          , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_tdes3_msg_len_v          ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_twofish_256_msg_t     msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ); mk_lib_crypto_mode_cbc_twofish_256_schedule_encrypt    (&app->m_mode.m_data.m_cbc_twofish_256    , &app->m_schedule.m_data.m_cbc_twofish_256    , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_128_twofish_256_msg_t msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v); mk_lib_crypto_mode_cfb_128_twofish_256_schedule_encrypt(&app->m_mode.m_data.m_cfb_128_twofish_256, &app->m_schedule.m_data.m_cfb_128_twofish_256, &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_twofish_256_msg_t   msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ); mk_lib_crypto_mode_cfb_8_twofish_256_schedule_encrypt  (&app->m_mode.m_data.m_cfb_8_twofish_256  , &app->m_schedule.m_data.m_cfb_8_twofish_256  , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_twofish_256_msg_t  msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ); mk_lib_crypto_mode_ctr_be_twofish_256_schedule_encrypt (&app->m_mode.m_data.m_ctr_be_twofish_256 , &app->m_schedule.m_data.m_ctr_be_twofish_256 , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_twofish_256_msg_t     msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ); mk_lib_crypto_mode_ecb_twofish_256_schedule_encrypt    (&app->m_mode.m_data.m_ecb_twofish_256    , &app->m_schedule.m_data.m_ecb_twofish_256    , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_twofish_256_msg_t     msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ); mk_lib_crypto_mode_ofb_twofish_256_schedule_encrypt    (&app->m_mode.m_data.m_ofb_twofish_256    , &app->m_schedule.m_data.m_ofb_twofish_256    , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ); } break;
		default: mk_lang_assert(0); break;
	}
}
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_app_encrypt_mode_16(mk_lib_crypto_app_pt const app, mk_lang_types_usize_t const idx) mk_lang_noexcept
{
	...
	switch(id)
	{
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_aes_128_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_128_msg_len_v         + 0], mk_lib_crypto_mode_cbc_aes_128_msg_len_v        ); } mk_lib_crypto_mode_cbc_aes_128_schedule_encrypt        (&app->m_mode.m_data.m_cbc_aes_128        , &app->m_schedule.m_data.m_cbc_aes_128        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_128_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_aes_128_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_128_aes_128_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v     + 0], mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v    ); } mk_lib_crypto_mode_cfb_128_aes_128_schedule_encrypt    (&app->m_mode.m_data.m_cfb_128_aes_128    , &app->m_schedule.m_data.m_cfb_128_aes_128    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v     + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v    ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_aes_128_msg_t       msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v       + 0], mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v      ); } mk_lib_crypto_mode_cfb_8_aes_128_schedule_encrypt      (&app->m_mode.m_data.m_cfb_8_aes_128      , &app->m_schedule.m_data.m_cfb_8_aes_128      , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v       + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v      ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_aes_128_msg_t      msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v      + 0], mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v     ); } mk_lib_crypto_mode_ctr_be_aes_128_schedule_encrypt     (&app->m_mode.m_data.m_ctr_be_aes_128     , &app->m_schedule.m_data.m_ctr_be_aes_128     , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v      + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v     ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_aes_128_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_128_msg_len_v         + 0], mk_lib_crypto_mode_ecb_aes_128_msg_len_v        ); } mk_lib_crypto_mode_ecb_aes_128_schedule_encrypt        (&app->m_mode.m_data.m_ecb_aes_128        , &app->m_schedule.m_data.m_ecb_aes_128        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_128_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_aes_128_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_aes_128_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_128_msg_len_v         + 0], mk_lib_crypto_mode_ofb_aes_128_msg_len_v        ); } mk_lib_crypto_mode_ofb_aes_128_schedule_encrypt        (&app->m_mode.m_data.m_ofb_aes_128        , &app->m_schedule.m_data.m_ofb_aes_128        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_128_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_aes_128_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_aes_192_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_192_msg_len_v         + 0], mk_lib_crypto_mode_cbc_aes_192_msg_len_v        ); } mk_lib_crypto_mode_cbc_aes_192_schedule_encrypt        (&app->m_mode.m_data.m_cbc_aes_192        , &app->m_schedule.m_data.m_cbc_aes_192        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_192_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_aes_192_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_128_aes_192_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v     + 0], mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v    ); } mk_lib_crypto_mode_cfb_128_aes_192_schedule_encrypt    (&app->m_mode.m_data.m_cfb_128_aes_192    , &app->m_schedule.m_data.m_cfb_128_aes_192    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v     + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v    ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_aes_192_msg_t       msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v       + 0], mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v      ); } mk_lib_crypto_mode_cfb_8_aes_192_schedule_encrypt      (&app->m_mode.m_data.m_cfb_8_aes_192      , &app->m_schedule.m_data.m_cfb_8_aes_192      , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v       + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v      ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_aes_192_msg_t      msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v      + 0], mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v     ); } mk_lib_crypto_mode_ctr_be_aes_192_schedule_encrypt     (&app->m_mode.m_data.m_ctr_be_aes_192     , &app->m_schedule.m_data.m_ctr_be_aes_192     , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v      + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v     ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_aes_192_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_192_msg_len_v         + 0], mk_lib_crypto_mode_ecb_aes_192_msg_len_v        ); } mk_lib_crypto_mode_ecb_aes_192_schedule_encrypt        (&app->m_mode.m_data.m_ecb_aes_192        , &app->m_schedule.m_data.m_ecb_aes_192        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_192_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_aes_192_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_aes_192_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_192_msg_len_v         + 0], mk_lib_crypto_mode_ofb_aes_192_msg_len_v        ); } mk_lib_crypto_mode_ofb_aes_192_schedule_encrypt        (&app->m_mode.m_data.m_ofb_aes_192        , &app->m_schedule.m_data.m_ofb_aes_192        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_192_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_aes_192_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_aes_256_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_256_msg_len_v         + 0], mk_lib_crypto_mode_cbc_aes_256_msg_len_v        ); } mk_lib_crypto_mode_cbc_aes_256_schedule_encrypt        (&app->m_mode.m_data.m_cbc_aes_256        , &app->m_schedule.m_data.m_cbc_aes_256        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_256_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_aes_256_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_128_aes_256_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v     + 0], mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v    ); } mk_lib_crypto_mode_cfb_128_aes_256_schedule_encrypt    (&app->m_mode.m_data.m_cfb_128_aes_256    , &app->m_schedule.m_data.m_cfb_128_aes_256    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v     + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v    ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_aes_256_msg_t       msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v       + 0], mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v      ); } mk_lib_crypto_mode_cfb_8_aes_256_schedule_encrypt      (&app->m_mode.m_data.m_cfb_8_aes_256      , &app->m_schedule.m_data.m_cfb_8_aes_256      , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v       + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v      ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_aes_256_msg_t      msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v      + 0], mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v     ); } mk_lib_crypto_mode_ctr_be_aes_256_schedule_encrypt     (&app->m_mode.m_data.m_ctr_be_aes_256     , &app->m_schedule.m_data.m_ctr_be_aes_256     , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v      + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v     ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_aes_256_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_256_msg_len_v         + 0], mk_lib_crypto_mode_ecb_aes_256_msg_len_v        ); } mk_lib_crypto_mode_ecb_aes_256_schedule_encrypt        (&app->m_mode.m_data.m_ecb_aes_256        , &app->m_schedule.m_data.m_ecb_aes_256        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_256_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_aes_256_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_aes_256_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_256_msg_len_v         + 0], mk_lib_crypto_mode_ofb_aes_256_msg_len_v        ); } mk_lib_crypto_mode_ofb_aes_256_schedule_encrypt        (&app->m_mode.m_data.m_ofb_aes_256        , &app->m_schedule.m_data.m_ofb_aes_256        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_256_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_aes_256_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_des_msg_t             msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_des_msg_len_v             + 0], mk_lib_crypto_mode_cbc_des_msg_len_v            ); } mk_lib_crypto_mode_cbc_des_schedule_encrypt            (&app->m_mode.m_data.m_cbc_des            , &app->m_schedule.m_data.m_cbc_des            , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_des_msg_len_v             + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_des_msg_len_v            ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_64_des_msg_t          msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_64_des_msg_len_v          + 0], mk_lib_crypto_mode_cfb_64_des_msg_len_v         ); } mk_lib_crypto_mode_cfb_64_des_schedule_encrypt         (&app->m_mode.m_data.m_cfb_64_des         , &app->m_schedule.m_data.m_cfb_64_des         , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_64_des_msg_len_v          + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_64_des_msg_len_v         ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_des_msg_t           msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_des_msg_len_v           + 0], mk_lib_crypto_mode_cfb_8_des_msg_len_v          ); } mk_lib_crypto_mode_cfb_8_des_schedule_encrypt          (&app->m_mode.m_data.m_cfb_8_des          , &app->m_schedule.m_data.m_cfb_8_des          , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_des_msg_len_v           + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_des_msg_len_v          ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_des_msg_t          msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_des_msg_len_v          + 0], mk_lib_crypto_mode_ctr_be_des_msg_len_v         ); } mk_lib_crypto_mode_ctr_be_des_schedule_encrypt         (&app->m_mode.m_data.m_ctr_be_des         , &app->m_schedule.m_data.m_ctr_be_des         , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_des_msg_len_v          + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_des_msg_len_v         ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_des_msg_t             msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_des_msg_len_v             + 0], mk_lib_crypto_mode_ecb_des_msg_len_v            ); } mk_lib_crypto_mode_ecb_des_schedule_encrypt            (&app->m_mode.m_data.m_ecb_des            , &app->m_schedule.m_data.m_ecb_des            , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_des_msg_len_v             + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_des_msg_len_v            ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_serpent_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_serpent_msg_len_v         + 0], mk_lib_crypto_mode_cbc_serpent_msg_len_v        ); } mk_lib_crypto_mode_cbc_serpent_schedule_encrypt        (&app->m_mode.m_data.m_cbc_serpent        , &app->m_schedule.m_data.m_cbc_serpent        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_serpent_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_serpent_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_128_serpent_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_serpent_msg_len_v     + 0], mk_lib_crypto_mode_cfb_128_serpent_msg_len_v    ); } mk_lib_crypto_mode_cfb_128_serpent_schedule_encrypt    (&app->m_mode.m_data.m_cfb_128_serpent    , &app->m_schedule.m_data.m_cfb_128_serpent    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_serpent_msg_len_v     + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_serpent_msg_len_v    ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_serpent_msg_t       msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_serpent_msg_len_v       + 0], mk_lib_crypto_mode_cfb_8_serpent_msg_len_v      ); } mk_lib_crypto_mode_cfb_8_serpent_schedule_encrypt      (&app->m_mode.m_data.m_cfb_8_serpent      , &app->m_schedule.m_data.m_cfb_8_serpent      , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_serpent_msg_len_v       + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_serpent_msg_len_v      ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_serpent_msg_t      msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_serpent_msg_len_v      + 0], mk_lib_crypto_mode_ctr_be_serpent_msg_len_v     ); } mk_lib_crypto_mode_ctr_be_serpent_schedule_encrypt     (&app->m_mode.m_data.m_ctr_be_serpent     , &app->m_schedule.m_data.m_ctr_be_serpent     , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_serpent_msg_len_v      + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_serpent_msg_len_v     ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_serpent_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_serpent_msg_len_v         + 0], mk_lib_crypto_mode_ecb_serpent_msg_len_v        ); } mk_lib_crypto_mode_ecb_serpent_schedule_encrypt        (&app->m_mode.m_data.m_ecb_serpent        , &app->m_schedule.m_data.m_ecb_serpent        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_serpent_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_serpent_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_serpent_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_serpent_msg_len_v         + 0], mk_lib_crypto_mode_ofb_serpent_msg_len_v        ); } mk_lib_crypto_mode_ofb_serpent_schedule_encrypt        (&app->m_mode.m_data.m_ofb_serpent        , &app->m_schedule.m_data.m_ofb_serpent        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_serpent_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_serpent_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_tdes2_msg_t           msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_tdes2_msg_len_v           + 0], mk_lib_crypto_mode_cbc_tdes2_msg_len_v          ); } mk_lib_crypto_mode_cbc_tdes2_schedule_encrypt          (&app->m_mode.m_data.m_cbc_tdes2          , &app->m_schedule.m_data.m_cbc_tdes2          , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_tdes2_msg_len_v           + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_tdes2_msg_len_v          ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_64_tdes2_msg_t        msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_64_tdes2_msg_len_v        + 0], mk_lib_crypto_mode_cfb_64_tdes2_msg_len_v       ); } mk_lib_crypto_mode_cfb_64_tdes2_schedule_encrypt       (&app->m_mode.m_data.m_cfb_64_tdes2       , &app->m_schedule.m_data.m_cfb_64_tdes2       , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_64_tdes2_msg_len_v        + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_64_tdes2_msg_len_v       ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_tdes2_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_tdes2_msg_len_v         + 0], mk_lib_crypto_mode_cfb_8_tdes2_msg_len_v        ); } mk_lib_crypto_mode_cfb_8_tdes2_schedule_encrypt        (&app->m_mode.m_data.m_cfb_8_tdes2        , &app->m_schedule.m_data.m_cfb_8_tdes2        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_tdes2_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_tdes2_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_tdes2_msg_t        msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_tdes2_msg_len_v        + 0], mk_lib_crypto_mode_ctr_be_tdes2_msg_len_v       ); } mk_lib_crypto_mode_ctr_be_tdes2_schedule_encrypt       (&app->m_mode.m_data.m_ctr_be_tdes2       , &app->m_schedule.m_data.m_ctr_be_tdes2       , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_tdes2_msg_len_v        + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_tdes2_msg_len_v       ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_tdes2_msg_t           msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_tdes2_msg_len_v           + 0], mk_lib_crypto_mode_ecb_tdes2_msg_len_v          ); } mk_lib_crypto_mode_ecb_tdes2_schedule_encrypt          (&app->m_mode.m_data.m_ecb_tdes2          , &app->m_schedule.m_data.m_ecb_tdes2          , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_tdes2_msg_len_v           + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_tdes2_msg_len_v          ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_tdes3_msg_t           msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_tdes3_msg_len_v           + 0], mk_lib_crypto_mode_cbc_tdes3_msg_len_v          ); } mk_lib_crypto_mode_cbc_tdes3_schedule_encrypt          (&app->m_mode.m_data.m_cbc_tdes3          , &app->m_schedule.m_data.m_cbc_tdes3          , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_tdes3_msg_len_v           + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_tdes3_msg_len_v          ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_64_tdes3_msg_t        msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_64_tdes3_msg_len_v        + 0], mk_lib_crypto_mode_cfb_64_tdes3_msg_len_v       ); } mk_lib_crypto_mode_cfb_64_tdes3_schedule_encrypt       (&app->m_mode.m_data.m_cfb_64_tdes3       , &app->m_schedule.m_data.m_cfb_64_tdes3       , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_64_tdes3_msg_len_v        + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_64_tdes3_msg_len_v       ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_tdes3_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_tdes3_msg_len_v         + 0], mk_lib_crypto_mode_cfb_8_tdes3_msg_len_v        ); } mk_lib_crypto_mode_cfb_8_tdes3_schedule_encrypt        (&app->m_mode.m_data.m_cfb_8_tdes3        , &app->m_schedule.m_data.m_cfb_8_tdes3        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_tdes3_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_tdes3_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_tdes3_msg_t        msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_tdes3_msg_len_v        + 0], mk_lib_crypto_mode_ctr_be_tdes3_msg_len_v       ); } mk_lib_crypto_mode_ctr_be_tdes3_schedule_encrypt       (&app->m_mode.m_data.m_ctr_be_tdes3       , &app->m_schedule.m_data.m_ctr_be_tdes3       , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_tdes3_msg_len_v        + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_tdes3_msg_len_v       ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_tdes3_msg_t           msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_tdes3_msg_len_v           + 0], mk_lib_crypto_mode_ecb_tdes3_msg_len_v          ); } mk_lib_crypto_mode_ecb_tdes3_schedule_encrypt          (&app->m_mode.m_data.m_ecb_tdes3          , &app->m_schedule.m_data.m_ecb_tdes3          , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_tdes3_msg_len_v           + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_tdes3_msg_len_v          ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_twofish_256_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_twofish_256_msg_len_v     + 0], mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ); } mk_lib_crypto_mode_cbc_twofish_256_schedule_encrypt    (&app->m_mode.m_data.m_cbc_twofish_256    , &app->m_schedule.m_data.m_cbc_twofish_256    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_twofish_256_msg_len_v     + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_128_twofish_256_msg_t msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v + 0], mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v); } mk_lib_crypto_mode_cfb_128_twofish_256_schedule_encrypt(&app->m_mode.m_data.m_cfb_128_twofish_256, &app->m_schedule.m_data.m_cfb_128_twofish_256, &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_twofish_256_msg_t   msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v   + 0], mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ); } mk_lib_crypto_mode_cfb_8_twofish_256_schedule_encrypt  (&app->m_mode.m_data.m_cfb_8_twofish_256  , &app->m_schedule.m_data.m_cfb_8_twofish_256  , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v   + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_twofish_256_msg_t  msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v  + 0], mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ); } mk_lib_crypto_mode_ctr_be_twofish_256_schedule_encrypt (&app->m_mode.m_data.m_ctr_be_twofish_256 , &app->m_schedule.m_data.m_ctr_be_twofish_256 , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v  + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_twofish_256_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_twofish_256_msg_len_v     + 0], mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ); } mk_lib_crypto_mode_ecb_twofish_256_schedule_encrypt    (&app->m_mode.m_data.m_ecb_twofish_256    , &app->m_schedule.m_data.m_ecb_twofish_256    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_twofish_256_msg_len_v     + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_twofish_256_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_twofish_256_msg_len_v     + 0], mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ); } mk_lib_crypto_mode_ofb_twofish_256_schedule_encrypt    (&app->m_mode.m_data.m_ofb_twofish_256    , &app->m_schedule.m_data.m_ofb_twofish_256    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_twofish_256_msg_len_v     + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ); } } break;
		default: mk_lang_assert(0); break;
	}
}
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_app_decrypt_mode(mk_lib_crypto_app_pt const app, mk_lang_types_usize_t const idx) mk_lang_noexcept
{
	...
	switch(id)
	{
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_aes_128_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_aes_128_msg_len_v        ); mk_lib_crypto_mode_cbc_aes_128_schedule_decrypt        (&app->m_mode.m_data.m_cbc_aes_128        , &app->m_schedule.m_data.m_cbc_aes_128        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_aes_128_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_128_aes_128_msg_t     msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v    ); mk_lib_crypto_mode_cfb_128_aes_128_schedule_decrypt    (&app->m_mode.m_data.m_cfb_128_aes_128    , &app->m_schedule.m_data.m_cfb_128_aes_128    , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v    ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_aes_128_msg_t       msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v      ); mk_lib_crypto_mode_cfb_8_aes_128_schedule_decrypt      (&app->m_mode.m_data.m_cfb_8_aes_128      , &app->m_schedule.m_data.m_cfb_8_aes_128      , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v      ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_aes_128_msg_t      msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v     ); mk_lib_crypto_mode_ctr_be_aes_128_schedule_decrypt     (&app->m_mode.m_data.m_ctr_be_aes_128     , &app->m_schedule.m_data.m_ctr_be_aes_128     , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v     ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_aes_128_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_aes_128_msg_len_v        ); mk_lib_crypto_mode_ecb_aes_128_schedule_decrypt        (&app->m_mode.m_data.m_ecb_aes_128        , &app->m_schedule.m_data.m_ecb_aes_128        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_aes_128_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_aes_128_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_aes_128_msg_len_v        ); mk_lib_crypto_mode_ofb_aes_128_schedule_decrypt        (&app->m_mode.m_data.m_ofb_aes_128        , &app->m_schedule.m_data.m_ofb_aes_128        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_aes_128_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_aes_192_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_aes_192_msg_len_v        ); mk_lib_crypto_mode_cbc_aes_192_schedule_decrypt        (&app->m_mode.m_data.m_cbc_aes_192        , &app->m_schedule.m_data.m_cbc_aes_192        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_aes_192_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_128_aes_192_msg_t     msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v    ); mk_lib_crypto_mode_cfb_128_aes_192_schedule_decrypt    (&app->m_mode.m_data.m_cfb_128_aes_192    , &app->m_schedule.m_data.m_cfb_128_aes_192    , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v    ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_aes_192_msg_t       msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v      ); mk_lib_crypto_mode_cfb_8_aes_192_schedule_decrypt      (&app->m_mode.m_data.m_cfb_8_aes_192      , &app->m_schedule.m_data.m_cfb_8_aes_192      , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v      ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_aes_192_msg_t      msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v     ); mk_lib_crypto_mode_ctr_be_aes_192_schedule_decrypt     (&app->m_mode.m_data.m_ctr_be_aes_192     , &app->m_schedule.m_data.m_ctr_be_aes_192     , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v     ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_aes_192_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_aes_192_msg_len_v        ); mk_lib_crypto_mode_ecb_aes_192_schedule_decrypt        (&app->m_mode.m_data.m_ecb_aes_192        , &app->m_schedule.m_data.m_ecb_aes_192        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_aes_192_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_aes_192_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_aes_192_msg_len_v        ); mk_lib_crypto_mode_ofb_aes_192_schedule_decrypt        (&app->m_mode.m_data.m_ofb_aes_192        , &app->m_schedule.m_data.m_ofb_aes_192        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_aes_192_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_aes_256_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_aes_256_msg_len_v        ); mk_lib_crypto_mode_cbc_aes_256_schedule_decrypt        (&app->m_mode.m_data.m_cbc_aes_256        , &app->m_schedule.m_data.m_cbc_aes_256        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_aes_256_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_128_aes_256_msg_t     msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v    ); mk_lib_crypto_mode_cfb_128_aes_256_schedule_decrypt    (&app->m_mode.m_data.m_cfb_128_aes_256    , &app->m_schedule.m_data.m_cfb_128_aes_256    , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v    ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_aes_256_msg_t       msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v      ); mk_lib_crypto_mode_cfb_8_aes_256_schedule_decrypt      (&app->m_mode.m_data.m_cfb_8_aes_256      , &app->m_schedule.m_data.m_cfb_8_aes_256      , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v      ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_aes_256_msg_t      msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v     ); mk_lib_crypto_mode_ctr_be_aes_256_schedule_decrypt     (&app->m_mode.m_data.m_ctr_be_aes_256     , &app->m_schedule.m_data.m_ctr_be_aes_256     , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v     ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_aes_256_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_aes_256_msg_len_v        ); mk_lib_crypto_mode_ecb_aes_256_schedule_decrypt        (&app->m_mode.m_data.m_ecb_aes_256        , &app->m_schedule.m_data.m_ecb_aes_256        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_aes_256_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_aes_256_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_aes_256_msg_len_v        ); mk_lib_crypto_mode_ofb_aes_256_schedule_decrypt        (&app->m_mode.m_data.m_ofb_aes_256        , &app->m_schedule.m_data.m_ofb_aes_256        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_aes_256_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_des_msg_t             msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_des_msg_len_v            ); mk_lib_crypto_mode_cbc_des_schedule_decrypt            (&app->m_mode.m_data.m_cbc_des            , &app->m_schedule.m_data.m_cbc_des            , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_des_msg_len_v            ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_64_des_msg_t          msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_64_des_msg_len_v         ); mk_lib_crypto_mode_cfb_64_des_schedule_decrypt         (&app->m_mode.m_data.m_cfb_64_des         , &app->m_schedule.m_data.m_cfb_64_des         , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_64_des_msg_len_v         ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_des_msg_t           msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_des_msg_len_v          ); mk_lib_crypto_mode_cfb_8_des_schedule_decrypt          (&app->m_mode.m_data.m_cfb_8_des          , &app->m_schedule.m_data.m_cfb_8_des          , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_des_msg_len_v          ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_des_msg_t          msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_des_msg_len_v         ); mk_lib_crypto_mode_ctr_be_des_schedule_decrypt         (&app->m_mode.m_data.m_ctr_be_des         , &app->m_schedule.m_data.m_ctr_be_des         , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_des_msg_len_v         ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_des_msg_t             msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_des_msg_len_v            ); mk_lib_crypto_mode_ecb_des_schedule_decrypt            (&app->m_mode.m_data.m_ecb_des            , &app->m_schedule.m_data.m_ecb_des            , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_des_msg_len_v            ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_des_msg_t             msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_des_msg_len_v            ); mk_lib_crypto_mode_ofb_des_schedule_decrypt            (&app->m_mode.m_data.m_ofb_des            , &app->m_schedule.m_data.m_ofb_des            , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_des_msg_len_v            ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_serpent_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_serpent_msg_len_v        ); mk_lib_crypto_mode_cbc_serpent_schedule_decrypt        (&app->m_mode.m_data.m_cbc_serpent        , &app->m_schedule.m_data.m_cbc_serpent        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_serpent_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_128_serpent_msg_t     msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_128_serpent_msg_len_v    ); mk_lib_crypto_mode_cfb_128_serpent_schedule_decrypt    (&app->m_mode.m_data.m_cfb_128_serpent    , &app->m_schedule.m_data.m_cfb_128_serpent    , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_serpent_msg_len_v    ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_serpent_msg_t       msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_serpent_msg_len_v      ); mk_lib_crypto_mode_cfb_8_serpent_schedule_decrypt      (&app->m_mode.m_data.m_cfb_8_serpent      , &app->m_schedule.m_data.m_cfb_8_serpent      , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_serpent_msg_len_v      ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_serpent_msg_t      msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_serpent_msg_len_v     ); mk_lib_crypto_mode_ctr_be_serpent_schedule_decrypt     (&app->m_mode.m_data.m_ctr_be_serpent     , &app->m_schedule.m_data.m_ctr_be_serpent     , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_serpent_msg_len_v     ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_serpent_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_serpent_msg_len_v        ); mk_lib_crypto_mode_ecb_serpent_schedule_decrypt        (&app->m_mode.m_data.m_ecb_serpent        , &app->m_schedule.m_data.m_ecb_serpent        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_serpent_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_serpent_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_serpent_msg_len_v        ); mk_lib_crypto_mode_ofb_serpent_schedule_decrypt        (&app->m_mode.m_data.m_ofb_serpent        , &app->m_schedule.m_data.m_ofb_serpent        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_serpent_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_tdes2_msg_t           msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_tdes2_msg_len_v          ); mk_lib_crypto_mode_cbc_tdes2_schedule_decrypt          (&app->m_mode.m_data.m_cbc_tdes2          , &app->m_schedule.m_data.m_cbc_tdes2          , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_tdes2_msg_len_v          ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_64_tdes2_msg_t        msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_64_tdes2_msg_len_v       ); mk_lib_crypto_mode_cfb_64_tdes2_schedule_decrypt       (&app->m_mode.m_data.m_cfb_64_tdes2       , &app->m_schedule.m_data.m_cfb_64_tdes2       , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_64_tdes2_msg_len_v       ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_tdes2_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_tdes2_msg_len_v        ); mk_lib_crypto_mode_cfb_8_tdes2_schedule_decrypt        (&app->m_mode.m_data.m_cfb_8_tdes2        , &app->m_schedule.m_data.m_cfb_8_tdes2        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_tdes2_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_tdes2_msg_t        msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_tdes2_msg_len_v       ); mk_lib_crypto_mode_ctr_be_tdes2_schedule_decrypt       (&app->m_mode.m_data.m_ctr_be_tdes2       , &app->m_schedule.m_data.m_ctr_be_tdes2       , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_tdes2_msg_len_v       ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_tdes2_msg_t           msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_tdes2_msg_len_v          ); mk_lib_crypto_mode_ecb_tdes2_schedule_decrypt          (&app->m_mode.m_data.m_ecb_tdes2          , &app->m_schedule.m_data.m_ecb_tdes2          , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_tdes2_msg_len_v          ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_tdes2_msg_t           msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_tdes2_msg_len_v          ); mk_lib_crypto_mode_ofb_tdes2_schedule_decrypt          (&app->m_mode.m_data.m_ofb_tdes2          , &app->m_schedule.m_data.m_ofb_tdes2          , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_tdes2_msg_len_v          ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_tdes3_msg_t           msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_tdes3_msg_len_v          ); mk_lib_crypto_mode_cbc_tdes3_schedule_decrypt          (&app->m_mode.m_data.m_cbc_tdes3          , &app->m_schedule.m_data.m_cbc_tdes3          , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_tdes3_msg_len_v          ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_64_tdes3_msg_t        msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_64_tdes3_msg_len_v       ); mk_lib_crypto_mode_cfb_64_tdes3_schedule_decrypt       (&app->m_mode.m_data.m_cfb_64_tdes3       , &app->m_schedule.m_data.m_cfb_64_tdes3       , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_64_tdes3_msg_len_v       ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_tdes3_msg_t         msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_tdes3_msg_len_v        ); mk_lib_crypto_mode_cfb_8_tdes3_schedule_decrypt        (&app->m_mode.m_data.m_cfb_8_tdes3        , &app->m_schedule.m_data.m_cfb_8_tdes3        , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_tdes3_msg_len_v        ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_tdes3_msg_t        msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_tdes3_msg_len_v       ); mk_lib_crypto_mode_ctr_be_tdes3_schedule_decrypt       (&app->m_mode.m_data.m_ctr_be_tdes3       , &app->m_schedule.m_data.m_ctr_be_tdes3       , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_tdes3_msg_len_v       ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_tdes3_msg_t           msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_tdes3_msg_len_v          ); mk_lib_crypto_mode_ecb_tdes3_schedule_decrypt          (&app->m_mode.m_data.m_ecb_tdes3          , &app->m_schedule.m_data.m_ecb_tdes3          , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_tdes3_msg_len_v          ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_tdes3_msg_t           msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_tdes3_msg_len_v          ); mk_lib_crypto_mode_ofb_tdes3_schedule_decrypt          (&app->m_mode.m_data.m_ofb_tdes3          , &app->m_schedule.m_data.m_ofb_tdes3          , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_tdes3_msg_len_v          ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lib_crypto_mode_cbc_twofish_256_msg_t     msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ); mk_lib_crypto_mode_cbc_twofish_256_schedule_decrypt    (&app->m_mode.m_data.m_cbc_twofish_256    , &app->m_schedule.m_data.m_cbc_twofish_256    , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lib_crypto_mode_cfb_128_twofish_256_msg_t msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v); mk_lib_crypto_mode_cfb_128_twofish_256_schedule_decrypt(&app->m_mode.m_data.m_cfb_128_twofish_256, &app->m_schedule.m_data.m_cfb_128_twofish_256, &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lib_crypto_mode_cfb_8_twofish_256_msg_t   msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ); mk_lib_crypto_mode_cfb_8_twofish_256_schedule_decrypt  (&app->m_mode.m_data.m_cfb_8_twofish_256  , &app->m_schedule.m_data.m_cfb_8_twofish_256  , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lib_crypto_mode_ctr_be_twofish_256_msg_t  msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ); mk_lib_crypto_mode_ctr_be_twofish_256_schedule_decrypt (&app->m_mode.m_data.m_ctr_be_twofish_256 , &app->m_schedule.m_data.m_ctr_be_twofish_256 , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lib_crypto_mode_ecb_twofish_256_msg_t     msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ); mk_lib_crypto_mode_ecb_twofish_256_schedule_decrypt    (&app->m_mode.m_data.m_ecb_twofish_256    , &app->m_schedule.m_data.m_ecb_twofish_256    , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ); } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lib_crypto_mode_ofb_twofish_256_msg_t     msg mk_lang_constexpr_init; mk_lib_crypto_app_memcpyu8_fn(&msg.m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + 0], mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ); mk_lib_crypto_mode_ofb_twofish_256_schedule_decrypt    (&app->m_mode.m_data.m_ofb_twofish_256    , &app->m_schedule.m_data.m_ofb_twofish_256    , &msg, &msg, 1); mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + 0], &msg.m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ); } break;
		default: mk_lang_assert(0); break;
	}
}
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_app_decrypt_mode_16(mk_lib_crypto_app_pt const app, mk_lang_types_usize_t const idx) mk_lang_noexcept
{
	...
	switch(id)
	{
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_aes_128_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_128_msg_len_v         + 0], mk_lib_crypto_mode_cbc_aes_128_msg_len_v        ); } mk_lib_crypto_mode_cbc_aes_128_schedule_decrypt        (&app->m_mode.m_data.m_cbc_aes_128        , &app->m_schedule.m_data.m_cbc_aes_128        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_128_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_aes_128_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_128_aes_128_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v     + 0], mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v    ); } mk_lib_crypto_mode_cfb_128_aes_128_schedule_decrypt    (&app->m_mode.m_data.m_cfb_128_aes_128    , &app->m_schedule.m_data.m_cfb_128_aes_128    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v     + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_aes_128_msg_len_v    ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_aes_128_msg_t       msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v       + 0], mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v      ); } mk_lib_crypto_mode_cfb_8_aes_128_schedule_decrypt      (&app->m_mode.m_data.m_cfb_8_aes_128      , &app->m_schedule.m_data.m_cfb_8_aes_128      , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v       + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_aes_128_msg_len_v      ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_aes_128_msg_t      msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v      + 0], mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v     ); } mk_lib_crypto_mode_ctr_be_aes_128_schedule_decrypt     (&app->m_mode.m_data.m_ctr_be_aes_128     , &app->m_schedule.m_data.m_ctr_be_aes_128     , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v      + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_aes_128_msg_len_v     ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_aes_128_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_128_msg_len_v         + 0], mk_lib_crypto_mode_ecb_aes_128_msg_len_v        ); } mk_lib_crypto_mode_ecb_aes_128_schedule_decrypt        (&app->m_mode.m_data.m_ecb_aes_128        , &app->m_schedule.m_data.m_ecb_aes_128        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_128_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_aes_128_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_128    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_aes_128_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_128_msg_len_v         + 0], mk_lib_crypto_mode_ofb_aes_128_msg_len_v        ); } mk_lib_crypto_mode_ofb_aes_128_schedule_decrypt        (&app->m_mode.m_data.m_ofb_aes_128        , &app->m_schedule.m_data.m_ofb_aes_128        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_128_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_aes_128_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_aes_192_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_192_msg_len_v         + 0], mk_lib_crypto_mode_cbc_aes_192_msg_len_v        ); } mk_lib_crypto_mode_cbc_aes_192_schedule_decrypt        (&app->m_mode.m_data.m_cbc_aes_192        , &app->m_schedule.m_data.m_cbc_aes_192        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_192_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_aes_192_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_128_aes_192_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v     + 0], mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v    ); } mk_lib_crypto_mode_cfb_128_aes_192_schedule_decrypt    (&app->m_mode.m_data.m_cfb_128_aes_192    , &app->m_schedule.m_data.m_cfb_128_aes_192    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v     + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_aes_192_msg_len_v    ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_aes_192_msg_t       msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v       + 0], mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v      ); } mk_lib_crypto_mode_cfb_8_aes_192_schedule_decrypt      (&app->m_mode.m_data.m_cfb_8_aes_192      , &app->m_schedule.m_data.m_cfb_8_aes_192      , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v       + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_aes_192_msg_len_v      ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_aes_192_msg_t      msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v      + 0], mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v     ); } mk_lib_crypto_mode_ctr_be_aes_192_schedule_decrypt     (&app->m_mode.m_data.m_ctr_be_aes_192     , &app->m_schedule.m_data.m_ctr_be_aes_192     , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v      + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_aes_192_msg_len_v     ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_aes_192_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_192_msg_len_v         + 0], mk_lib_crypto_mode_ecb_aes_192_msg_len_v        ); } mk_lib_crypto_mode_ecb_aes_192_schedule_decrypt        (&app->m_mode.m_data.m_ecb_aes_192        , &app->m_schedule.m_data.m_ecb_aes_192        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_192_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_aes_192_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_192    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_aes_192_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_192_msg_len_v         + 0], mk_lib_crypto_mode_ofb_aes_192_msg_len_v        ); } mk_lib_crypto_mode_ofb_aes_192_schedule_decrypt        (&app->m_mode.m_data.m_ofb_aes_192        , &app->m_schedule.m_data.m_ofb_aes_192        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_192_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_aes_192_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_aes_256_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_256_msg_len_v         + 0], mk_lib_crypto_mode_cbc_aes_256_msg_len_v        ); } mk_lib_crypto_mode_cbc_aes_256_schedule_decrypt        (&app->m_mode.m_data.m_cbc_aes_256        , &app->m_schedule.m_data.m_cbc_aes_256        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_aes_256_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_aes_256_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_128_aes_256_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v     + 0], mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v    ); } mk_lib_crypto_mode_cfb_128_aes_256_schedule_decrypt    (&app->m_mode.m_data.m_cfb_128_aes_256    , &app->m_schedule.m_data.m_cfb_128_aes_256    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v     + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_aes_256_msg_len_v    ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_aes_256_msg_t       msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v       + 0], mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v      ); } mk_lib_crypto_mode_cfb_8_aes_256_schedule_decrypt      (&app->m_mode.m_data.m_cfb_8_aes_256      , &app->m_schedule.m_data.m_cfb_8_aes_256      , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v       + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_aes_256_msg_len_v      ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_aes_256_msg_t      msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v      + 0], mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v     ); } mk_lib_crypto_mode_ctr_be_aes_256_schedule_decrypt     (&app->m_mode.m_data.m_ctr_be_aes_256     , &app->m_schedule.m_data.m_ctr_be_aes_256     , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v      + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_aes_256_msg_len_v     ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_aes_256_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_256_msg_len_v         + 0], mk_lib_crypto_mode_ecb_aes_256_msg_len_v        ); } mk_lib_crypto_mode_ecb_aes_256_schedule_decrypt        (&app->m_mode.m_data.m_ecb_aes_256        , &app->m_schedule.m_data.m_ecb_aes_256        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_aes_256_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_aes_256_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_aes_256    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_aes_256_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_256_msg_len_v         + 0], mk_lib_crypto_mode_ofb_aes_256_msg_len_v        ); } mk_lib_crypto_mode_ofb_aes_256_schedule_decrypt        (&app->m_mode.m_data.m_ofb_aes_256        , &app->m_schedule.m_data.m_ofb_aes_256        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_aes_256_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_aes_256_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_des_msg_t             msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_des_msg_len_v             + 0], mk_lib_crypto_mode_cbc_des_msg_len_v            ); } mk_lib_crypto_mode_cbc_des_schedule_decrypt            (&app->m_mode.m_data.m_cbc_des            , &app->m_schedule.m_data.m_cbc_des            , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_des_msg_len_v             + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_des_msg_len_v            ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_64_des_msg_t          msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_64_des_msg_len_v          + 0], mk_lib_crypto_mode_cfb_64_des_msg_len_v         ); } mk_lib_crypto_mode_cfb_64_des_schedule_decrypt         (&app->m_mode.m_data.m_cfb_64_des         , &app->m_schedule.m_data.m_cfb_64_des         , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_64_des_msg_len_v          + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_64_des_msg_len_v         ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_des_msg_t           msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_des_msg_len_v           + 0], mk_lib_crypto_mode_cfb_8_des_msg_len_v          ); } mk_lib_crypto_mode_cfb_8_des_schedule_decrypt          (&app->m_mode.m_data.m_cfb_8_des          , &app->m_schedule.m_data.m_cfb_8_des          , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_des_msg_len_v           + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_des_msg_len_v          ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_des_msg_t          msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_des_msg_len_v          + 0], mk_lib_crypto_mode_ctr_be_des_msg_len_v         ); } mk_lib_crypto_mode_ctr_be_des_schedule_decrypt         (&app->m_mode.m_data.m_ctr_be_des         , &app->m_schedule.m_data.m_ctr_be_des         , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_des_msg_len_v          + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_des_msg_len_v         ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_des_msg_t             msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_des_msg_len_v             + 0], mk_lib_crypto_mode_ecb_des_msg_len_v            ); } mk_lib_crypto_mode_ecb_des_schedule_decrypt            (&app->m_mode.m_data.m_ecb_des            , &app->m_schedule.m_data.m_ecb_des            , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_des_msg_len_v             + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_des_msg_len_v            ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_des        )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_des_msg_t             msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_des_msg_len_v             + 0], mk_lib_crypto_mode_ofb_des_msg_len_v            ); } mk_lib_crypto_mode_ofb_des_schedule_decrypt            (&app->m_mode.m_data.m_ofb_des            , &app->m_schedule.m_data.m_ofb_des            , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_des_msg_len_v             + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_des_msg_len_v            ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_serpent_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_serpent_msg_len_v         + 0], mk_lib_crypto_mode_cbc_serpent_msg_len_v        ); } mk_lib_crypto_mode_cbc_serpent_schedule_decrypt        (&app->m_mode.m_data.m_cbc_serpent        , &app->m_schedule.m_data.m_cbc_serpent        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_serpent_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_serpent_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_128_serpent_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_serpent_msg_len_v     + 0], mk_lib_crypto_mode_cfb_128_serpent_msg_len_v    ); } mk_lib_crypto_mode_cfb_128_serpent_schedule_decrypt    (&app->m_mode.m_data.m_cfb_128_serpent    , &app->m_schedule.m_data.m_cfb_128_serpent    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_serpent_msg_len_v     + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_serpent_msg_len_v    ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_serpent_msg_t       msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_serpent_msg_len_v       + 0], mk_lib_crypto_mode_cfb_8_serpent_msg_len_v      ); } mk_lib_crypto_mode_cfb_8_serpent_schedule_decrypt      (&app->m_mode.m_data.m_cfb_8_serpent      , &app->m_schedule.m_data.m_cfb_8_serpent      , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_serpent_msg_len_v       + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_serpent_msg_len_v      ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_serpent_msg_t      msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_serpent_msg_len_v      + 0], mk_lib_crypto_mode_ctr_be_serpent_msg_len_v     ); } mk_lib_crypto_mode_ctr_be_serpent_schedule_decrypt     (&app->m_mode.m_data.m_ctr_be_serpent     , &app->m_schedule.m_data.m_ctr_be_serpent     , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_serpent_msg_len_v      + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_serpent_msg_len_v     ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_serpent_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_serpent_msg_len_v         + 0], mk_lib_crypto_mode_ecb_serpent_msg_len_v        ); } mk_lib_crypto_mode_ecb_serpent_schedule_decrypt        (&app->m_mode.m_data.m_ecb_serpent        , &app->m_schedule.m_data.m_ecb_serpent        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_serpent_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_serpent_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_serpent    )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_serpent_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_serpent_msg_len_v         + 0], mk_lib_crypto_mode_ofb_serpent_msg_len_v        ); } mk_lib_crypto_mode_ofb_serpent_schedule_decrypt        (&app->m_mode.m_data.m_ofb_serpent        , &app->m_schedule.m_data.m_ofb_serpent        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_serpent_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_serpent_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_tdes2_msg_t           msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_tdes2_msg_len_v           + 0], mk_lib_crypto_mode_cbc_tdes2_msg_len_v          ); } mk_lib_crypto_mode_cbc_tdes2_schedule_decrypt          (&app->m_mode.m_data.m_cbc_tdes2          , &app->m_schedule.m_data.m_cbc_tdes2          , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_tdes2_msg_len_v           + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_tdes2_msg_len_v          ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_64_tdes2_msg_t        msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_64_tdes2_msg_len_v        + 0], mk_lib_crypto_mode_cfb_64_tdes2_msg_len_v       ); } mk_lib_crypto_mode_cfb_64_tdes2_schedule_decrypt       (&app->m_mode.m_data.m_cfb_64_tdes2       , &app->m_schedule.m_data.m_cfb_64_tdes2       , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_64_tdes2_msg_len_v        + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_64_tdes2_msg_len_v       ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_tdes2_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_tdes2_msg_len_v         + 0], mk_lib_crypto_mode_cfb_8_tdes2_msg_len_v        ); } mk_lib_crypto_mode_cfb_8_tdes2_schedule_decrypt        (&app->m_mode.m_data.m_cfb_8_tdes2        , &app->m_schedule.m_data.m_cfb_8_tdes2        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_tdes2_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_tdes2_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_tdes2_msg_t        msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_tdes2_msg_len_v        + 0], mk_lib_crypto_mode_ctr_be_tdes2_msg_len_v       ); } mk_lib_crypto_mode_ctr_be_tdes2_schedule_decrypt       (&app->m_mode.m_data.m_ctr_be_tdes2       , &app->m_schedule.m_data.m_ctr_be_tdes2       , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_tdes2_msg_len_v        + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_tdes2_msg_len_v       ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_tdes2_msg_t           msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_tdes2_msg_len_v           + 0], mk_lib_crypto_mode_ecb_tdes2_msg_len_v          ); } mk_lib_crypto_mode_ecb_tdes2_schedule_decrypt          (&app->m_mode.m_data.m_ecb_tdes2          , &app->m_schedule.m_data.m_ecb_tdes2          , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_tdes2_msg_len_v           + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_tdes2_msg_len_v          ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes2      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_tdes2_msg_t           msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_tdes2_msg_len_v           + 0], mk_lib_crypto_mode_ofb_tdes2_msg_len_v          ); } mk_lib_crypto_mode_ofb_tdes2_schedule_decrypt          (&app->m_mode.m_data.m_ofb_tdes2          , &app->m_schedule.m_data.m_ofb_tdes2          , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_tdes2_msg_len_v           + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_tdes2_msg_len_v          ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_tdes3_msg_t           msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_tdes3_msg_len_v           + 0], mk_lib_crypto_mode_cbc_tdes3_msg_len_v          ); } mk_lib_crypto_mode_cbc_tdes3_schedule_decrypt          (&app->m_mode.m_data.m_cbc_tdes3          , &app->m_schedule.m_data.m_cbc_tdes3          , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_tdes3_msg_len_v           + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_tdes3_msg_len_v          ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_64_tdes3_msg_t        msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_64_tdes3_msg_len_v        + 0], mk_lib_crypto_mode_cfb_64_tdes3_msg_len_v       ); } mk_lib_crypto_mode_cfb_64_tdes3_schedule_decrypt       (&app->m_mode.m_data.m_cfb_64_tdes3       , &app->m_schedule.m_data.m_cfb_64_tdes3       , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_64_tdes3_msg_len_v        + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_64_tdes3_msg_len_v       ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_tdes3_msg_t         msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_tdes3_msg_len_v         + 0], mk_lib_crypto_mode_cfb_8_tdes3_msg_len_v        ); } mk_lib_crypto_mode_cfb_8_tdes3_schedule_decrypt        (&app->m_mode.m_data.m_cfb_8_tdes3        , &app->m_schedule.m_data.m_cfb_8_tdes3        , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_tdes3_msg_len_v         + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_tdes3_msg_len_v        ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_tdes3_msg_t        msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_tdes3_msg_len_v        + 0], mk_lib_crypto_mode_ctr_be_tdes3_msg_len_v       ); } mk_lib_crypto_mode_ctr_be_tdes3_schedule_decrypt       (&app->m_mode.m_data.m_ctr_be_tdes3       , &app->m_schedule.m_data.m_ctr_be_tdes3       , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_tdes3_msg_len_v        + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_tdes3_msg_len_v       ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_tdes3_msg_t           msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_tdes3_msg_len_v           + 0], mk_lib_crypto_mode_ecb_tdes3_msg_len_v          ); } mk_lib_crypto_mode_ecb_tdes3_schedule_decrypt          (&app->m_mode.m_data.m_ecb_tdes3          , &app->m_schedule.m_data.m_ecb_tdes3          , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_tdes3_msg_len_v           + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_tdes3_msg_len_v          ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_tdes3      )) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_tdes3_msg_t           msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_tdes3_msg_len_v           + 0], mk_lib_crypto_mode_ofb_tdes3_msg_len_v          ); } mk_lib_crypto_mode_ofb_tdes3_schedule_decrypt          (&app->m_mode.m_data.m_ofb_tdes3          , &app->m_schedule.m_data.m_ofb_tdes3          , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_tdes3_msg_len_v           + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_tdes3_msg_len_v          ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cbc_twofish_256_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_twofish_256_msg_len_v     + 0], mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ); } mk_lib_crypto_mode_cbc_twofish_256_schedule_decrypt    (&app->m_mode.m_data.m_cbc_twofish_256    , &app->m_schedule.m_data.m_cbc_twofish_256    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cbc_twofish_256_msg_len_v     + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cbc_twofish_256_msg_len_v    ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_128_twofish_256_msg_t msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v + 0], mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v); } mk_lib_crypto_mode_cfb_128_twofish_256_schedule_decrypt(&app->m_mode.m_data.m_cfb_128_twofish_256, &app->m_schedule.m_data.m_cfb_128_twofish_256, &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_128_twofish_256_msg_len_v); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): { mk_lang_alignas(64) mk_lib_crypto_mode_cfb_8_twofish_256_msg_t   msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v   + 0], mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ); } mk_lib_crypto_mode_cfb_8_twofish_256_schedule_decrypt  (&app->m_mode.m_data.m_cfb_8_twofish_256  , &app->m_schedule.m_data.m_cfb_8_twofish_256  , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v   + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_cfb_8_twofish_256_msg_len_v  ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ctr_be_twofish_256_msg_t  msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v  + 0], mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ); } mk_lib_crypto_mode_ctr_be_twofish_256_schedule_decrypt (&app->m_mode.m_data.m_ctr_be_twofish_256 , &app->m_schedule.m_data.m_ctr_be_twofish_256 , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v  + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ctr_be_twofish_256_msg_len_v ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ecb_twofish_256_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_twofish_256_msg_len_v     + 0], mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ); } mk_lib_crypto_mode_ecb_twofish_256_schedule_decrypt    (&app->m_mode.m_data.m_ecb_twofish_256    , &app->m_schedule.m_data.m_ecb_twofish_256    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ecb_twofish_256_msg_len_v     + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ecb_twofish_256_msg_len_v    ); } } break;
		case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): { mk_lang_alignas(64) mk_lib_crypto_mode_ofb_twofish_256_msg_t     msg[16] mk_lang_constexpr_init; for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&msg[iblock].m_data.m_uint8s[0], &app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_twofish_256_msg_len_v     + 0], mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ); } mk_lib_crypto_mode_ofb_twofish_256_schedule_decrypt    (&app->m_mode.m_data.m_ofb_twofish_256    , &app->m_schedule.m_data.m_ofb_twofish_256    , &msg[0], &msg[0], 16); for(iblock = 0; iblock != 16; ++iblock){ mk_lib_crypto_app_memcpyu8_fn(&app->m_buffer.m_data.m_uint8s[idx + iblock * mk_lib_crypto_mode_ofb_twofish_256_msg_len_v     + 0], &msg[iblock].m_data.m_uint8s[0], mk_lib_crypto_mode_ofb_twofish_256_msg_len_v    ); } } break;
		default: mk_lang_assert(0); break;
	}
}
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_app_impl_expand_enc(mk_lib_crypto_app_pt const app) mk_lang_noexcept
{
	...
	if(app->m_expanded != 1)
	{
		...
		switch(id)
		{
			...
			case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): mk_lib_crypto_mode_cbc_twofish_256_expand_enc    (&app->m_key.m_data.m_cbc_twofish_256    , &app->m_schedule.m_data.m_cbc_twofish_256    ); break;
			case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): mk_lib_crypto_mode_cfb_128_twofish_256_expand_enc(&app->m_key.m_data.m_cfb_128_twofish_256, &app->m_schedule.m_data.m_cfb_128_twofish_256); break;
			case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): mk_lib_crypto_mode_cfb_8_twofish_256_expand_enc  (&app->m_key.m_data.m_cfb_8_twofish_256  , &app->m_schedule.m_data.m_cfb_8_twofish_256  ); break;
			case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): mk_lib_crypto_mode_ctr_be_twofish_256_expand_enc (&app->m_key.m_data.m_ctr_be_twofish_256 , &app->m_schedule.m_data.m_ctr_be_twofish_256 ); break;
			case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): mk_lib_crypto_mode_ecb_twofish_256_expand_enc    (&app->m_key.m_data.m_ecb_twofish_256    , &app->m_schedule.m_data.m_ecb_twofish_256    ); break;
			case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): mk_lib_crypto_mode_ofb_twofish_256_expand_enc    (&app->m_key.m_data.m_ofb_twofish_256    , &app->m_schedule.m_data.m_ofb_twofish_256    ); break;
			default: mk_lang_assert(0); break;
		}
	}
}
...
mk_lang_constexpr static mk_lang_inline void mk_lib_crypto_app_impl_expand_dec(mk_lib_crypto_app_pt const app) mk_lang_noexcept
{
	...
	if(app->m_expanded != 2)
	{
		...
		switch(id)
		{
			...
			case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cbc    )))): mk_lib_crypto_mode_cbc_twofish_256_expand_dec    (&app->m_key.m_data.m_cbc_twofish_256    , &app->m_schedule.m_data.m_cbc_twofish_256    ); break;
			case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_128)))): mk_lib_crypto_mode_cfb_128_twofish_256_expand_dec(&app->m_key.m_data.m_cfb_128_twofish_256, &app->m_schedule.m_data.m_cfb_128_twofish_256); break;
			case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_cfb_8  )))): mk_lib_crypto_mode_cfb_8_twofish_256_expand_dec  (&app->m_key.m_data.m_cfb_8_twofish_256  , &app->m_schedule.m_data.m_cfb_8_twofish_256  ); break;
			case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ctr_be )))): mk_lib_crypto_mode_ctr_be_twofish_256_expand_dec (&app->m_key.m_data.m_ctr_be_twofish_256 , &app->m_schedule.m_data.m_ctr_be_twofish_256 ); break;
			case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ecb    )))): mk_lib_crypto_mode_ecb_twofish_256_expand_dec    (&app->m_key.m_data.m_ecb_twofish_256    , &app->m_schedule.m_data.m_ecb_twofish_256    ); break;
			case ((int)(((int)(mk_lib_crypto_app_alg_id_e_twofish_256)) * ((int)(mk_lib_crypto_app_mode_id_e_dummy_end)) + ((int)(mk_lib_crypto_app_mode_id_e_ofb    )))): mk_lib_crypto_mode_ofb_twofish_256_expand_dec    (&app->m_key.m_data.m_ofb_twofish_256    , &app->m_schedule.m_data.m_ofb_twofish_256    ); break;
			default: mk_lang_assert(0); break;
		}
	}
}
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_ssize_t mk_lib_crypto_app_impl_encrypt_finish(mk_lib_crypto_app_pt const app, mk_lang_types_usize_t const len) mk_lang_noexcept
{
	...
	{
		case mk_lib_crypto_app_padding_id_e_pkcs7:      mk_lib_crypto_padding_pkcs7_pad      (&app->m_buffer.m_data.m_uint8s[len - q], ((mk_lang_types_sint_t)(q)), msg_len); break;
		case mk_lib_crypto_app_padding_id_e_iso9797pm2: mk_lib_crypto_padding_iso9797pm2_pad (&app->m_buffer.m_data.m_uint8s[len - q], ((mk_lang_types_sint_t)(q)), msg_len); break;
		case mk_lib_crypto_app_padding_id_e_dummy_end: mk_lang_assert(0); break;
		default: mk_lang_assert(0); break;
	}
