...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_sl_speedometer_pr_report_impl(mk_sl_speedometer_pt const speedometer, mk_lang_tchar_pt const str_buf, mk_lang_types_sint_t const str_len, mk_lang_types_bool_pt const reported, mk_lang_types_sint_pt const out_len) mk_lang_noexcept
{
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_sl_speedometer_pr_report(mk_sl_speedometer_pt const speedometer, mk_lang_tchar_pt const str_buf, mk_lang_types_sint_t const str_len, mk_lang_types_bool_pt const reported, mk_lang_types_sint_pt const out_len) mk_lang_noexcept
{
	...
	if(want)
	{
		err = mk_sl_speedometer_pr_report_impl(speedometer, str_buf, str_len, reported, out_len); mk_lang_check_rereturn(err);
	}
	*reported = want;
	return 0;
}
