...
struct mk_lib_vc_key_material_data_s
{
...
typedef struct mk_lib_vc_key_material_data_s mk_lib_vc_key_material_data_t;

struct mk_lib_vc_key_material_s
{
	mk_lib_vc_key_material_data_t m_data;
};
typedef struct mk_lib_vc_key_material_s mk_lib_vc_key_material_t;
typedef mk_lib_vc_key_material_t const mk_lib_vc_key_material_ct;
typedef mk_lib_vc_key_material_t* mk_lib_vc_key_material_pt;
typedef mk_lib_vc_key_material_t const* mk_lib_vc_key_material_pct;
