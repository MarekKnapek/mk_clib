...
static mk_lang_inline mk_lang_types_void_t mk_lib_net_destination_to_addr(mk_lib_net_destination_pct const destination, mk_win_dll_ws2_sock_addr_pt const addr) mk_lang_noexcept
{
	mk_lang_static_assert(mk_lang_countof(destination->m_ipv4_address.m_data.m_u8s) == mk_lang_countof(addr->m_data.m_ipv4.m_address.m_data.m_ucs));
	...
	mk_lib_net_tcp_port_to_bi_ushort(&destination->m_tcp_port, &addr->m_data.m_ipv4.m_port);
	mk_sl_cui_uint8_to_bi_uchar_many(&destination->m_ipv4_address.m_data.m_u8s[0], &addr->m_data.m_ipv4.m_address.m_data.m_ucs[0], mk_lang_countof(destination->m_ipv4_address.m_data.m_u8s));
	mk_lang_string_memclr_uc_fn(&addr->m_data.m_ipv4.m_zeros[0], mk_lang_countof(addr->m_data.m_ipv4.m_zeros));
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_ipv4_address_parse_pc(mk_lib_net_ipv4_address_pt const ipv4_address, mk_lang_types_pchar_pct const str_buf, mk_lang_types_sint_t const str_len, mk_lang_types_bool_pt const success, mk_lang_types_sint_pt const consumed) mk_lang_noexcept
{
	...
	mk_sl_cui_uint32_from_bi_ulong(&ipv4_address->m_data.m_u32s[0], &addr.m_data.m_uls[0]);
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_bool_t mk_lib_net_ipv4_address_is_any(mk_lib_net_ipv4_address_pct const ipv4_address) mk_lang_noexcept
{
	...
	is = mk_sl_cui_uint32_is_zero(&ipv4_address->m_data.m_u32s[0]);
	return is;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_bool_t mk_lib_net_ipv4_address_is_none(mk_lib_net_ipv4_address_pct const ipv4_address) mk_lang_noexcept
{
	...
	is = mk_sl_cui_uint32_is_max(&ipv4_address->m_data.m_u32s[0]);
	return is;
}


mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_net_destination_clear(mk_lib_net_destination_pt const destination) mk_lang_noexcept
{
	mk_lang_assert(destination);

	mk_sl_cui_uint8_memclr_fn(&destination->m_ipv4_address.m_data.m_u8s[0], mk_lang_countof(destination->m_ipv4_address.m_data.m_u8s));
	mk_lib_net_tcp_port_set_zero(&destination->m_tcp_port);
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_async_connect_is_ready(mk_lib_net_async_connect_pt const async_connect, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	...
	waited = mk_win_dll_ws2_wait_for_multiple_events(1, &async_connect->m_event, mk_win_base_false, 0, mk_win_base_false); mk_lang_check_return(waited == 0 || waited == mk_win_dll_ws2_wait_timeout);
	is = waited == 0;
	*is_ready = is;
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_async_connect_wait_timeout(mk_lib_net_async_connect_pt const async_connect, mk_lang_types_sint_t const ms, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	...
	waited = mk_win_dll_ws2_wait_for_multiple_events(1, &async_connect->m_event, mk_win_base_false, ((mk_win_base_dword_t)(ms)), mk_win_base_false); mk_lang_check_return(waited == 0 || waited == mk_win_dll_ws2_wait_timeout);
	is = waited == 0;
	*is_ready = is;
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_async_connect_get_result(mk_lib_net_async_connect_pt const async_connect, mk_lang_types_sint_pt const result) mk_lang_noexcept
{
	...
	mk_lang_assert(!mk_win_dll_ws2_socket_is_invalid(async_connect->m_socket->m_handle));
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_async_rwc_is_ready(mk_lib_net_async_rwc_pt const async_rwc, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	...
	waited = mk_win_dll_ws2_wait_for_multiple_events(1, &async_rwc->m_event, mk_win_base_false, 0, mk_win_base_false); mk_lang_check_return(waited == 0 || waited == mk_win_dll_ws2_wait_timeout);
	is = waited == 0;
	*is_ready = is;
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_async_rwc_wait_timeout(mk_lib_net_async_rwc_pt const async_rwc, mk_lang_types_sint_t const ms, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	...
	waited = mk_win_dll_ws2_wait_for_multiple_events(1, &async_rwc->m_event, mk_win_base_false, ((mk_win_base_dword_t)(ms)), mk_win_base_false); mk_lang_check_return(waited == 0 || waited == mk_win_dll_ws2_wait_timeout);
	is = waited == 0;
	*is_ready = is;
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_async_rwc_get_result(mk_lib_net_async_rwc_pt const async_rwc, mk_lang_types_sint_pt const event_id, mk_lang_types_sint_pt const result) mk_lang_noexcept
{
	...
	mk_lang_assert(!mk_win_dll_ws2_socket_is_invalid(async_rwc->m_socket->m_handle));
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_connect_request_construct_void(mk_lib_net_connect_request_pt const connect_request) mk_lang_noexcept
{
	mk_lang_assert(connect_request);

	mk_lang_assert((connect_request->m_socket = mk_lang_null, mk_lang_true));
	connect_request->m_event = mk_win_dll_ws2_event_get_null();
	mk_lib_net_destination_clear(&connect_request->m_destination);
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_connect_request_construct(mk_lib_net_connect_request_pt const connect_request, mk_lib_net_socket_pt const socket, mk_lib_net_destination_pct const destination) mk_lang_noexcept
{
	mk_lang_assert(connect_request);
	...
	connect_request->m_socket = socket;
	connect_request->m_event = mk_win_dll_ws2_create_event(); mk_lang_check_return(!mk_win_dll_ws2_event_is_null(connect_request->m_event));
	connect_request->m_destination = *destination;
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_connect_request_reconstruct(mk_lib_net_connect_request_pt const connect_request, mk_lib_net_socket_pt const socket, mk_lib_net_destination_pct const destination) mk_lang_noexcept
{
	mk_lang_assert(connect_request);
	mk_lang_assert(socket);
	mk_lang_assert(!mk_win_dll_ws2_socket_is_invalid(socket->m_handle));
	...
	connect_request->m_socket = socket;
	if(mk_win_dll_ws2_event_is_null(connect_request->m_event))
	{
		connect_request->m_event = mk_win_dll_ws2_create_event(); mk_lang_check_return(!mk_win_dll_ws2_event_is_null(connect_request->m_event));
	}
	connect_request->m_destination = *destination;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_connect_request_destroy(mk_lib_net_connect_request_pt const connect_request) mk_lang_noexcept
{
	mk_win_base_bool_t b;
	...
	if(!mk_win_dll_ws2_event_is_null(connect_request->m_event))
	{
		b = mk_win_dll_ws2_close_event(connect_request->m_event); mk_lang_check_return(b != mk_win_base_false);
	}
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_connect_request_reset(mk_lib_net_connect_request_pt const connect_request) mk_lang_noexcept
{
	mk_win_base_bool_t b;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_connect_request_issue(mk_lib_net_connect_request_pt const connect_request) mk_lang_noexcept
{
	...
	mk_lang_assert(connect_request);
	mk_lang_assert(connect_request->m_socket);
	mk_lang_assert(!mk_win_dll_ws2_socket_is_invalid(connect_request->m_socket->m_handle));
	mk_lang_assert(!mk_win_dll_ws2_event_is_null(connect_request->m_event));

	mk_lib_net_destination_to_addr(&connect_request->m_destination, &addr);
	st = mk_win_dll_ws2_event_select(connect_request->m_socket->m_handle, connect_request->m_event, mk_win_dll_ws2_sck_evt_id_e_fd_connect); mk_lang_check_return(st == 0);
	st = mk_win_dll_ws2_connect2(connect_request->m_socket->m_handle, &addr, sizeof(addr), mk_lang_null, mk_lang_null, mk_lang_null, mk_lang_null); mk_lang_check_return(st == 0 || (gle = mk_win_dll_ws2_get_last_error()) == mk_win_dll_kernel_errors_id_e_wsaewouldblock);
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_connect_request_is_ready(mk_lib_net_connect_request_pt const connect_request, mk_lang_types_bool_pt const is) mk_lang_noexcept
{
	mk_lang_assert(connect_request);
	mk_lang_assert(is);
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_connect_request_wait_timeout(mk_lib_net_connect_request_pt const connect_request, mk_lang_types_sint_t const ms, mk_lang_types_bool_pt const is) mk_lang_noexcept
{
	mk_lang_assert(connect_request);
	mk_lang_assert(ms >= 0);
	mk_lang_assert(ms <= 10 * 1000);
	mk_lang_assert(is);
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_connect_request_wait_infinite(mk_lib_net_connect_request_pt const connect_request) mk_lang_noexcept
{
	mk_lang_assert(connect_request);
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_connect_request_get_result(mk_lib_net_connect_request_pt const connect_request) mk_lang_noexcept
{
	mk_lang_assert(connect_request);
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_write_request_reset(mk_lib_net_write_request_pt const write_request) mk_lang_noexcept
{
	mk_win_base_bool_t b;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_write_request_issue(mk_lib_net_write_request_pt const write_request) mk_lang_noexcept
{
	mk_lang_types_sint_t err;

	mk_lang_assert(write_request);

	err = mk_lib_net_socket_send(write_request->m_socket, write_request); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_write_request_is_ready(mk_lib_net_write_request_pt const write_request, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	...
	mk_lang_assert(!mk_win_dll_ws2_socket_is_invalid(write_request->m_socket->m_handle));

	waited = mk_win_dll_ws2_wait_for_multiple_events(1, &write_request->m_overlapped.m_event, mk_win_base_false, 0, mk_win_base_false); mk_lang_check_return(waited == 0 || waited == mk_win_dll_ws2_wait_timeout);
	is = waited == 0;
	*is_ready = is;
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_write_request_wait_timeout(mk_lib_net_write_request_pt const write_request, mk_lang_types_sint_t const ms, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	...
	waited = mk_win_dll_ws2_wait_for_multiple_events(1, &write_request->m_overlapped.m_event, mk_win_base_false, ((mk_win_base_dword_t)(ms)), mk_win_base_false); mk_lang_check_return(waited == 0 || waited == mk_win_dll_ws2_wait_timeout);
	is = waited == 0;
	*is_ready = is;
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_read_request_reset(mk_lib_net_read_request_pt const read_request) mk_lang_noexcept
{
	mk_win_base_bool_t b;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_read_request_issue(mk_lib_net_read_request_pt const read_request) mk_lang_noexcept
{
	mk_lang_types_sint_t err;

	mk_lang_assert(read_request);

	err = mk_lib_net_socket_recv(read_request->m_socket, read_request); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_read_request_is_ready(mk_lib_net_read_request_pt const read_request, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	...
	mk_lang_assert(!mk_win_dll_ws2_socket_is_invalid(read_request->m_socket->m_handle));

	waited = mk_win_dll_ws2_wait_for_multiple_events(1, &read_request->m_overlapped.m_event, mk_win_base_false, 0, mk_win_base_false); mk_lang_check_return(waited == 0 || waited == mk_win_dll_ws2_wait_timeout);
	is = waited == 0;
	*is_ready = is;
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_read_request_wait_timeout(mk_lib_net_read_request_pt const read_request, mk_lang_types_sint_t const ms, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	...
	waited = mk_win_dll_ws2_wait_for_multiple_events(1, &read_request->m_overlapped.m_event, mk_win_base_false, ((mk_win_base_dword_t)(ms)), mk_win_base_false); mk_lang_check_return(waited == 0 || waited == mk_win_dll_ws2_wait_timeout);
	is = waited == 0;
	*is_ready = is;
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_read_request_get_result(mk_lib_net_read_request_pt const read_request) mk_lang_noexcept
{
	...
	mk_lang_assert(read_request->m_transferred == -1 || read_request->m_transferred == ((mk_lang_types_sint_t)(transferred)));
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_ioctl_request_construct_void(mk_lib_net_ioctl_request_pt const ioctl_request) mk_lang_noexcept
{
	...
	ioctl_request->m_socket = mk_lang_null;
	ioctl_request->m_in_data_buf = mk_lang_null;
	ioctl_request->m_out_data_buf = mk_lang_null;
	ioctl_request->m_in_data_len = 0;
	ioctl_request->m_out_data_len = 0;
	ioctl_request->m_control_code = 0;
	ioctl_request->m_flags = 0;
	ioctl_request->m_transferred = 0;
	ioctl_request->m_b = mk_lang_false;
	ioctl_request->m_done = mk_lang_false;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_ioctl_request_destroy(mk_lib_net_ioctl_request_pt const ioctl_request) mk_lang_noexcept
{
	...
	if(!mk_win_dll_ws2_event_is_null(ioctl_request->m_overlapped.m_event))
	{
		mk_lang_assert(!mk_win_dll_ws2_socket_is_invalid(ioctl_request->m_socket->m_handle));
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_ioctl_request_is_ready(mk_lib_net_ioctl_request_pt const ioctl_request, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	...
	if(ioctl_request->m_done)
	{
		*is_ready = mk_lang_true;
	}
	else
	{
		waited = mk_win_dll_ws2_wait_for_multiple_events(1, &ioctl_request->m_overlapped.m_event, mk_win_base_false, 0, mk_win_base_false); mk_lang_check_return(waited == 0 || waited == mk_win_dll_ws2_wait_timeout);
		is = waited == 0;
		ioctl_request->m_done = is;
		*is_ready = is;
	}
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_ioctl_request_wait_timeout(mk_lib_net_ioctl_request_pt const ioctl_request, mk_lang_types_sint_t const ms, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	...
	waited = mk_win_dll_ws2_wait_for_multiple_events(1, &ioctl_request->m_overlapped.m_event, mk_win_base_false, ((mk_win_base_dword_t)(ms)), mk_win_base_false); mk_lang_check_return(waited == 0 || waited == mk_win_dll_ws2_wait_timeout);
	is = waited == 0;
	*is_ready = is;
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_accept_request_construct(mk_lib_net_accept_request_pt const accept_request, mk_lang_types_void_pct const fn_ptr_accept_ex, mk_lang_types_void_pct const fn_ptr_get_accept_ex_sock_addrs, mk_lib_net_socket_pt const socket_listen, mk_lib_net_socket_pt const socket_accept, mk_sl_cui_uint8_pt const out_data_buf, mk_lang_types_sint_t const out_data_len) mk_lang_noexcept
{
	...
	mk_lang_assert(!mk_win_dll_ws2_socket_is_invalid(socket_listen->m_handle));
	mk_lang_assert(!mk_win_dll_ws2_socket_is_invalid(socket_accept->m_handle));
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_accept_request_destroy(mk_lib_net_accept_request_pt const accept_request) mk_lang_noexcept
{
	...
	if(!mk_win_dll_ws2_event_is_null(accept_request->m_overlapped.m_event))
	{
		...
		mk_lang_assert(!mk_win_dll_ws2_socket_is_invalid(accept_request->m_socket_listen->m_handle));
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_accept_request_is_ready(mk_lib_net_accept_request_pt const accept_request, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	...
	waited = mk_win_dll_ws2_wait_for_multiple_events(1, &accept_request->m_overlapped.m_event, mk_win_base_false, 0, mk_win_base_false); mk_lang_check_return(waited == 0 || waited == mk_win_dll_ws2_wait_timeout);
	is = waited == 0;
	*is_ready = is;
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_accept_request_wait_timeout(mk_lib_net_accept_request_pt const accept_request, mk_lang_types_sint_t const ms, mk_lang_types_bool_pt const is_ready) mk_lang_noexcept
{
	...
	waited = mk_win_dll_ws2_wait_for_multiple_events(1, &accept_request->m_overlapped.m_event, mk_win_base_false, ((mk_win_base_dword_t)(ms)), mk_win_base_false); mk_lang_check_return(waited == 0 || waited == mk_win_dll_ws2_wait_timeout);
	is = waited == 0;
	*is_ready = is;
	return 0;
}
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_net_pr_addr_to_address(mk_win_dll_ws2_sock_addr_pct addr, mk_lib_net_destination_pt const address) mk_lang_noexcept
{
	...
	{
		case mk_win_dll_ws2_address_family_e_unspec:
		{
			mk_sl_cui_uint8_set_zero(&address->m_ipv4_address.m_data.m_u8s[0]);
			mk_sl_cui_uint8_set_zero(&address->m_ipv4_address.m_data.m_u8s[1]);
			mk_sl_cui_uint8_set_zero(&address->m_ipv4_address.m_data.m_u8s[2]);
			mk_sl_cui_uint8_set_zero(&address->m_ipv4_address.m_data.m_u8s[3]);
			mk_lib_net_tcp_port_set_zero(&address->m_tcp_port);
		}
		break;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_socket_construct_void(mk_lib_net_socket_pt const socket) mk_lang_noexcept
{
	...
	socket->m_handle = mk_win_dll_ws2_socket_get_invalid();
	return 0;
}
...
#include "mk_lang_warning_clang_push_sometimes_uninitialized.h"
	...
	socket->m_handle = mk_win_dll_ws2_socketw(family, type, protocol, protocol_info, group, flags); mk_lang_check_return(!mk_win_dll_ws2_socket_is_invalid(socket->m_handle));
	return 0;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_socket_reconstruct(mk_lib_net_socket_pt const socket, mk_lib_net_address_family_t const af, mk_lib_net_address_type_t const at, mk_lib_net_address_protocol_t const ap) mk_lang_noexcept
{
	...
	if(mk_win_dll_ws2_socket_is_invalid(socket->m_handle))
	{
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_socket_set_option_update_accept_context(mk_lib_net_socket_pt const socket, mk_lib_net_socket_pct const src) mk_lang_noexcept
{
	mk_win_base_uintptr_t vvv;
	mk_win_dll_ws2_socket_t s;
	mk_win_base_sint_t level;
	mk_win_base_sint_t opt_name;
	mk_win_base_void_pct opt_val_buf;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_socket_get_addresses(mk_lib_net_socket_pt const socket, mk_lib_net_destination_pt const destination_local, mk_lib_net_destination_pt const destination_remote) mk_lang_noexcept
{
	mk_win_base_sint_t addr_local_real;
	mk_win_dll_ws2_sock_addr_t addr_local_obj;
	mk_win_base_sint_t addr_remote_real;
	mk_win_dll_ws2_sock_addr_t addr_remote_obj;
	mk_lang_types_sint_t st;
	mk_lang_types_sint_t err;

	mk_lang_assert(socket);
	mk_lang_assert(destination_local);
	mk_lang_assert(destination_remote);
	mk_lang_assert(!mk_win_dll_ws2_socket_is_invalid(socket->m_handle));

	addr_local_real = ((mk_win_base_sint_t)(sizeof(addr_local_obj)));
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_socket_connect(mk_lib_net_socket_pt const socket, mk_lib_net_destination_pct const destination) mk_lang_noexcept
{
	...
	mk_sl_cui_uint32_to_bi_ulong(&destination->m_ipv4_address.m_data.m_u32s[0], &addr.m_data.m_ipv4.m_address.m_data.m_uls[0]);
	addr_buf = &addr;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_socket_bind(mk_lib_net_socket_pt const socket, mk_lib_net_destination_pct const destination) mk_lang_noexcept
{
	...
	mk_sl_cui_uint32_to_bi_ulong(&destination->m_ipv4_address.m_data.m_u32s[0], &addr_obj.m_data.m_ipv4.m_address.m_data.m_uls[0]);
	addr_buf = &addr_obj;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_net_socket_recv(mk_lib_net_socket_pt const socket, mk_lib_net_read_request_pt const read_request) mk_lang_noexcept
{
	...
	st = mk_win_dll_ws2_recv2(socket->m_handle, &buf, 1, &read, &flags, &read_request->m_overlapped, mk_lang_null); mk_lang_check_return((st == 0) || (st != 0 && (gle = mk_win_dll_ws2_get_last_error()) == mk_win_dll_kernel_errors_id_e_io_pending));
	if(st == 0)
	{
		read_request->m_transferred = ((mk_lang_types_sint_t)(read));
	}
	return 0;
}
