#ifndef mk_include_guard_mk_lib_crypto_xof_block_shake_256_c
#define mk_include_guard_mk_lib_crypto_xof_block_shake_256_c
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_xof_block_shake_256_mix_block(mk_lib_crypto_xof_block_shake_256_pt const sha3_256, mk_lib_crypto_xof_block_shake_256_block_pct const block) mk_lang_noexcept
{
	mk_lang_types_sint_t n mk_lang_constexpr_init;
	mk_lang_types_sint_t i mk_lang_constexpr_init;
	mk_sl_cui_uint64_t ta mk_lang_constexpr_init;

	mk_lang_static_assert((((mk_lang_types_sint_t)(mk_lib_crypto_xof_block_shake_256_block_len_v)) % ((mk_lang_types_sint_t)(mk_sl_cui_uint64_size_bytes_v))) == 0);

	mk_lang_assert(sha3_256);
	mk_lang_assert(block);

	n = ((mk_lang_types_sint_t)(mk_lib_crypto_xof_block_shake_256_block_len_v)) / ((mk_lang_types_sint_t)(mk_sl_cui_uint64_size_bytes_v));
	for(i = 0; i != n; ++i)
	{
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_xof_block_shake_256_init(mk_lib_crypto_xof_block_shake_256_pt const shake_256) mk_lang_noexcept
{
	...
	mk_lang_static_assert(sizeof(mk_lib_crypto_xof_block_shake_256_digest_t) == 136);

	mk_lang_assert(shake_256);

	mk_lib_crypto_hash_block_sha3_base_init(&shake_256->m_sha3_base);
}
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_xof_block_shake_256_append_blocks(mk_lib_crypto_xof_block_shake_256_pt const shake_256, mk_lib_crypto_xof_block_shake_256_block_pct const pblocks, mk_lang_types_usize_t const nblocks) mk_lang_noexcept
{
	...
	mk_lang_assert(nblocks <= mk_lang_limits_usize_max / mk_lib_crypto_xof_block_shake_256_block_len_v);
	...
	for(iblock = 0; iblock != nblocks; ++iblock)
	{
		...
		mk_lib_crypto_hash_block_sha3_base_f(&shake_256->m_sha3_base);
	}
}
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_xof_block_shake_256_finish(mk_lib_crypto_xof_block_shake_256_pt const shake_256, mk_lib_crypto_xof_block_shake_256_block_pt const block, mk_lang_types_sint_t const idx) mk_lang_noexcept
{
	...
	mk_lang_assert(shake_256);
	mk_lang_assert(block);
	mk_lang_assert(idx >= 0 && idx < mk_lib_crypto_xof_block_shake_256_block_len_v);

	tuc = 0x1f; mk_sl_cui_uint8_from_bi_uchar(&block->m_data.m_uint8s[idx], &tuc);
	rest = mk_lib_crypto_xof_block_shake_256_block_len_v - idx - 1;
	...
	mk_sl_cui_uint8_or2(&block->m_data.m_uint8s[mk_lib_crypto_xof_block_shake_256_block_len_v - 1], &tu8);
	mk_lib_crypto_xof_block_shake_256_mix_block(shake_256, block);
}

mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_xof_block_shake_256_squeeze_block(mk_lib_crypto_xof_block_shake_256_pt const shake_256, mk_lib_crypto_xof_block_shake_256_digest_pt const digest) mk_lang_noexcept
{
	mk_lang_types_sint_t n mk_lang_constexpr_init;
	mk_lang_types_sint_t i mk_lang_constexpr_init;

	mk_lang_static_assert(((mk_lang_types_sint_t)(mk_lib_crypto_xof_block_shake_256_block_len_v)) % ((mk_lang_types_sint_t)(mk_sl_cui_uint64_size_bytes_v)) == 0);
	mk_lang_static_assert(((mk_lang_types_sint_t)(mk_lib_crypto_xof_block_shake_256_block_len_v)) / ((mk_lang_types_sint_t)(mk_sl_cui_uint64_size_bytes_v)) <= mk_lang_countof(shake_256->m_sha3_base.m_data.m_uint64s));
	...
	for(i = 0; i != n; ++i)
	{
		mk_sl_uint_convert_64_8_le_to_sml(&shake_256->m_sha3_base.m_data.m_uint64s[i], &digest->m_data.m_uint8s[i * mk_sl_cui_uint64_size_bytes_v]);
	}
}
