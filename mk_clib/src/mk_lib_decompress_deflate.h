#ifndef mk_include_guard_mk_lib_decompress_deflate_h
#define mk_include_guard_mk_lib_decompress_deflate_h
...
/*union mk_lib_decompress_deflate_buf_data_u
{
	mk_lang_alignas(1024) mk_sl_cui_uint8_t m_u8s[mk_lib_decompress_deflate_uncompressed_data_len_max_v];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_decompress_deflate_buf_data_u mk_lib_decompress_deflate_buf_data_t;
struct mk_lib_decompress_deflate_buf_s
{
	mk_lib_decompress_deflate_buf_data_t m_data;
};
typedef struct mk_lib_decompress_deflate_buf_s mk_lib_decompress_deflate_buf_t;
mk_lang_typedef(mk_lib_decompress_deflate_buf);*/


#include "mk_lang_warning_msvc_push_c4820.h"
struct mk_lib_decompress_deflate_s
{
	mk_sl_cui_uint8_t m_block_header_buf[mk_lib_decompress_deflate_block_non_compressed_header_len_v];
	mk_lang_types_sint_t m_block_header_idx;
	mk_lang_types_sint_t m_uncompressed_data_len;
	mk_lang_types_sint_t m_uncompressed_data_idx;
	mk_lang_types_bool_t m_last_block;
};
typedef struct mk_lib_decompress_deflate_s mk_lib_decompress_deflate_t;
mk_lang_typedef(mk_lib_decompress_deflate);
...
#include "mk_lib_decompress_deflate.c"
#endif
#endif
