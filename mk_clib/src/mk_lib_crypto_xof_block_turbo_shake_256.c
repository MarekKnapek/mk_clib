#ifndef mk_include_guard_mk_lib_crypto_xof_block_turbo_shake_256_c
#define mk_include_guard_mk_lib_crypto_xof_block_turbo_shake_256_c
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_xof_block_turbo_shake_256_mix_block(mk_lib_crypto_xof_block_turbo_shake_256_pt const sha3_256, mk_lib_crypto_xof_block_turbo_shake_256_block_pct const block) mk_lang_noexcept
{
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_xof_block_turbo_shake_256_init(mk_lib_crypto_xof_block_turbo_shake_256_pt const turbo_shake_256) mk_lang_noexcept
{
	...
	mk_lang_static_assert(sizeof(mk_lib_crypto_xof_block_turbo_shake_256_block_t) == 136);
	mk_lang_static_assert(sizeof(mk_lib_crypto_xof_block_turbo_shake_256_digest_t) == 136);

	mk_lang_assert(turbo_shake_256);

	mk_lib_crypto_hash_block_sha3_base_init(&turbo_shake_256->m_sha3_base);
}

mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_xof_block_turbo_shake_256_append_blocks(mk_lib_crypto_xof_block_turbo_shake_256_pt const turbo_shake_256, mk_lib_crypto_xof_block_turbo_shake_256_block_pct const pblocks, mk_lang_types_usize_t const nblocks) mk_lang_noexcept
{
	...
	mk_lang_assert(nblocks <= mk_lang_limits_usize_max / mk_lib_crypto_xof_block_turbo_shake_256_block_len_v);
	#include "mk_lang_warning_gcc_pop.h"
	#include "mk_lang_warning_msvc_pop.h"

	for(iblock = 0; iblock != nblocks; ++iblock)
	{
		mk_lib_crypto_xof_block_turbo_shake_256_mix_block(turbo_shake_256, &pblocks[iblock]);
		mk_lib_crypto_hash_block_sha3_base_f_turbo(&turbo_shake_256->m_sha3_base);
	}
}

mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_xof_block_turbo_shake_256_finish(mk_lib_crypto_xof_block_turbo_shake_256_pt const turbo_shake_256, mk_lib_crypto_xof_block_turbo_shake_256_block_pt const block, mk_lang_types_sint_t const idx) mk_lang_noexcept
{
	...
	mk_lang_assert(turbo_shake_256);
	mk_lang_assert(block);
	mk_lang_assert(idx >= 0 && idx < mk_lib_crypto_xof_block_turbo_shake_256_block_len_v);

	tuc = 0x1f; mk_sl_cui_uint8_from_bi_uchar(&block->m_data.m_uint8s[idx], &tuc);
	rest = mk_lib_crypto_xof_block_turbo_shake_256_block_len_v - idx - 1;
	...
	mk_sl_cui_uint8_xor2(&block->m_data.m_uint8s[mk_lib_crypto_xof_block_turbo_shake_256_block_len_v - 1], &tu8);
	mk_lib_crypto_xof_block_turbo_shake_256_mix_block(turbo_shake_256, block);
}
