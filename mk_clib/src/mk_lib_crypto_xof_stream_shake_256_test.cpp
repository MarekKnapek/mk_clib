...
struct mk_lib_crypto_xof_stream_shake_256_test_digest_s
{
	mk_sl_cui_uint8_t m_uint8s[mk_lang_div_roundup(xof_bits, 8)];
};
typedef struct mk_lib_crypto_xof_stream_shake_256_test_digest_s mk_lib_crypto_xof_stream_shake_256_test_digest_t;
...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_xof_stream_shake_256_test_compute_from_str_lit(char const(&str_lit)[str_lit_len]) mk_lang_noexcept
{
	...
	mk_lib_crypto_xof_stream_shake_256_append_u8(&shake_256, msg.data(), msg.size());
	mk_lib_crypto_xof_stream_shake_256_finish(&shake_256);
	mk_lib_crypto_xof_stream_shake_256_squeeze(&shake_256, xof_bits / 8, &digest.m_uint8s[0]);
...
mk_lang_extern_c mk_lang_types_void_t mk_lib_crypto_xof_stream_shake_256_test(mk_lang_types_void_t) mk_lang_noexcept
{
	#define message_1 ""
	#define message_2 "a"
	...
	for(i = 0; i != n; ++i)
	{
		...
		mk_lib_crypto_xof_stream_shake_256_finish(&shake_256);
		mk_lib_crypto_xof_stream_shake_256_squeeze(&shake_256, xof_bits / 8, &digest[0]);
