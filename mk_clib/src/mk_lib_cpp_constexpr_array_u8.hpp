...
template<mk_lang_types_usize_t str_lit_len>
mk_lang_constexpr mk_lang_types_void_t mk_lib_cpp_constexpr_array_u8_from_pchar_lit(mk_sl_cui_uint8_t const(&arr)[str_lit_len - 1], mk_lang_types_pchar_t const(&str_lit)[str_lit_len]) mk_lang_noexcept
{
	mk_lang_types_usize_t n mk_lang_constexpr_init;
	mk_lang_types_usize_t i mk_lang_constexpr_init;
	...
	for(i = 0; i != n; ++i)
	{
		mk_sl_cui_uint8_from_bi_pchar(&arr[i], &str_lit[i]);
	}
}

template<mk_lang_types_usize_t hex_lit_len>
mk_lang_constexpr mk_lang_types_void_t mk_lib_cpp_constexpr_array_u8_from_hex_lit(mk_sl_cui_uint8_t(&arr)[(hex_lit_len - 1) / mk_sl_cui_uint8_strlen_hex_v], mk_lang_types_pchar_t const(&hex_lit)[hex_lit_len]) mk_lang_noexcept
{
	mk_lang_types_usize_t n mk_lang_constexpr_init;
	mk_lang_types_usize_t i mk_lang_constexpr_init;
	mk_lang_types_sint_t len mk_lang_constexpr_init;
