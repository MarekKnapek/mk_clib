#ifndef mk_include_guard_mk_sl_io_appender_file_windows_h
#define mk_include_guard_mk_sl_io_appender_file_windows_h
...
typedef mk_win_base_handle_t mk_sl_io_appender_file_windows_handle_t;

struct mk_sl_io_appender_file_windows_s
{
	mk_sl_io_appender_file_windows_handle_t m_file_handle;
};
typedef struct mk_sl_io_appender_file_windows_s mk_sl_io_appender_file_windows_t;
mk_lang_typedef(mk_sl_io_appender_file_windows);
...
#include "mk_sl_io_appender_file_windows.c"
#endif
#endif
