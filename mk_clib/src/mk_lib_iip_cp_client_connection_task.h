...
enum mk_lib_iip_cp_client_connection_task_init_e
{
	mk_lib_iip_cp_client_connection_task_init_e_create_socket,
	mk_lib_iip_cp_client_connection_task_init_e_want_associate_socket,
	mk_lib_iip_cp_client_connection_task_init_e_connect_begin,
	mk_lib_iip_cp_client_connection_task_init_e_connect_finish,
	mk_lib_iip_cp_client_connection_task_init_e_send_get_date_request,
	mk_lib_iip_cp_client_connection_task_init_e_send_get_date_finish,
	mk_lib_iip_cp_client_connection_task_init_e_recv_set_date_request,
	mk_lib_iip_cp_client_connection_task_init_e_recv_set_date_finish,
	mk_lib_iip_cp_client_connection_task_init_e_send_bandwidth_request,
	mk_lib_iip_cp_client_connection_task_init_e_send_bandwidth_finish,
	mk_lib_iip_cp_client_connection_task_init_e_recv_bandwidth_request,
	mk_lib_iip_cp_client_connection_task_init_e_recv_bandwidth_finish,
	mk_lib_iip_cp_client_connection_task_init_e_ready,
	mk_lib_iip_cp_client_connection_task_init_e_dummy_end
};
typedef enum mk_lib_iip_cp_client_connection_task_init_e mk_lib_iip_cp_client_connection_task_init_t;

#include "mk_lang_warning_msvc_push_c4820.h"
struct mk_lib_iip_cp_client_connection_state_s
{
	mk_lib_iip_cp_client_connection_task_init_t m_init_state;
	...
	mk_lib_iip_cp_client_session_task_ppt m_session_want_die;
	mk_lib_iip_cp_client_session_task_pt m_session_want_snd;
	mk_lib_iip_cp_client_session_task_pt m_session_want_rcv;
	...
	mk_lang_types_bool_t m_has_msg;
