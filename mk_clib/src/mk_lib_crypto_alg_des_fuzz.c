...
mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_alg_des_fuzz(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	mk_lang_types_uchar_pct d;
	mk_lang_types_usize_t s;
	mk_lang_types_sint_t i;
	mk_lib_crypto_alg_des_key_t key;
	mk_lib_crypto_alg_des_msg_t pt1;
	mk_lib_crypto_alg_des_msg_t ct;
	mk_lib_crypto_alg_des_msg_t pt2;
