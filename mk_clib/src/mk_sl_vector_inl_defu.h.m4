...
mm_per_typedef(`#undef mk_sl_vector_inl_defd_element_$1')
...
mm_per_typedef(`#undef mk_sl_vector_inl_defd_$1')
...
#undef mk_sl_vector_inl_defd_prrw_elements_move_assign_many
#undef mk_sl_vector_inl_defd_prrw_elements_copy_construct_many
#undef mk_sl_vector_inl_defd_prrw_elements_copy_assign_many
