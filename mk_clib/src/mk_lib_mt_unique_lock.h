...
typedef mk_lib_mt_unique_lock_exclusive_windows_wosa_t mk_lib_mt_unique_lock_exclusive_impl_t;
typedef mk_lib_mt_unique_lock_shared_windows_wosa_t    mk_lib_mt_unique_lock_shared_impl_t;
