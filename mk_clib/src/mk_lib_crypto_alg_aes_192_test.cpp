...
{
	mk_lib_cpp_constexpr_array_t<mk_lang_types_uchar_t, mk_lib_crypto_alg_aes_192_key_len_v> key_bytes mk_lang_constexpr_init;
	mk_lib_cpp_constexpr_array_t<mk_lang_types_uchar_t, mk_lib_crypto_alg_aes_192_msg_len_v> msg_bytes mk_lang_constexpr_init;
	...
	mk_lib_cpp_constexpr_array_t<mk_lang_types_uchar_t, mk_lib_crypto_alg_aes_192_msg_len_v> out_bytes mk_lang_constexpr_init;
	...
	for(i = 0; i != mk_lib_crypto_alg_aes_192_key_len_v; ++i){ key.m_data.m_uchars[i] = key_bytes[i]; }
	for(i = 0; i != mk_lib_crypto_alg_aes_192_msg_len_v; ++i){ msg.m_data.m_uchars[i] = msg_bytes[i]; }
	mk_lib_crypto_alg_aes_192_encrypt(&key, &msg, &msg);
	for(i = 0; i != mk_lib_crypto_alg_aes_192_msg_len_v; ++i){ out_bytes[i] = msg.m_data.m_uchars[i]; }
	return out_bytes;
}

template<mk_lang_types_usize_t key_lit_len, mk_lang_types_usize_t msg_bytes_len>
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_alg_aes_192_test_decrypt_from_str_lit(char const(&key_lit)[key_lit_len], mk_lib_cpp_constexpr_array_t<mk_lang_types_uchar_t, msg_bytes_len> const& msg_bytes) mk_lang_noexcept
{
	mk_lib_cpp_constexpr_array_t<mk_lang_types_uchar_t, mk_lib_crypto_alg_aes_192_key_len_v> key_bytes mk_lang_constexpr_init;
	mk_lib_crypto_alg_aes_192_key_t key mk_lang_constexpr_init;
	mk_lib_crypto_alg_aes_192_msg_t msg mk_lang_constexpr_init;
	...
	mk_lang_static_assert(key_lit_len == mk_lib_crypto_alg_aes_192_key_len_v * 2 + 1);
	mk_lang_static_assert(msg_bytes_len == mk_lib_crypto_alg_aes_192_msg_len_v);
