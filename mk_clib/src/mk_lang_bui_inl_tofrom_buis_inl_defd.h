...
#define mk_lang_bui_inl_tofrom_buis_inl_defd_idx(x) ((mk_lang_concat(mk_lang_bui_inl_tofrom_buis_for_endian, _value) == mk_lang_endian_little) ? (x) : ((mk_lang_concat(mk_lang_bui_inl_tofrom_buis_for_endian, _value) == mk_lang_endian_big) ? (((mk_lang_bui_inl_tofrom_buis_inl_defd_count) - 1) - (x)) : (mk_lang_assert(0), 0)))
