...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_sl_io_async_reader_file_windows_open_n(mk_sl_io_async_reader_file_windows_pt const reader, mk_lang_types_pchar_pct const name) mk_lang_noexcept
{
	...
	file = mk_win_kernel_files_a_create_file(name, mk_win_advapi_base_right_generic_e_read, mk_win_kernel_files_share_e_read | mk_win_kernel_files_share_e_delete, mk_win_base_null, mk_win_kernel_files_create_e_open_existing, mk_win_kernel_files_attribute_e_normal | mk_win_kernel_files_flag_e_sequential_scan | mk_win_kernel_files_flag_e_overlapped, mk_win_base_handle_get_null()); mk_lang_check_return(file.m_data != mk_win_base_handle_invalid);
	reader->m_file = file;
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_sl_io_async_reader_file_windows_open_w(mk_sl_io_async_reader_file_windows_pt const reader, mk_lang_types_wchar_pct const name) mk_lang_noexcept
{
	...
	file = mk_win_kernel_files_w_create_file(name, mk_win_advapi_base_right_generic_e_read, mk_win_kernel_files_share_e_read | mk_win_kernel_files_share_e_delete, mk_win_base_null, mk_win_kernel_files_create_e_open_existing, mk_win_kernel_files_attribute_e_normal | mk_win_kernel_files_flag_e_sequential_scan | mk_win_kernel_files_flag_e_overlapped, mk_win_base_handle_get_null()); mk_lang_check_return(file.m_data != mk_win_base_handle_invalid);
	reader->m_file = file;
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_sl_io_async_reader_file_windows_open_tx_n(mk_sl_io_async_reader_file_windows_pt const reader, mk_lang_types_pchar_pct const name, mk_sl_io_transaction_windows_pt const tx) mk_lang_noexcept
{
	...
	file = mk_win_ktmw32_transaction_a_create_file_transacted(name, mk_win_advapi_base_right_generic_e_read, mk_win_kernel_files_share_e_read | mk_win_kernel_files_share_e_delete, mk_win_base_null, mk_win_kernel_files_create_e_open_existing, mk_win_kernel_files_attribute_e_normal | mk_win_kernel_files_flag_e_sequential_scan | mk_win_kernel_files_flag_e_overlapped, mk_win_base_handle_get_null(), tx->m_transaction, &mv, mk_win_base_null); mk_lang_check_return(file.m_data != mk_win_base_handle_invalid);
	reader->m_file = file;
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_sl_io_async_reader_file_windows_open_tx_w(mk_sl_io_async_reader_file_windows_pt const reader, mk_lang_types_wchar_pct const name, mk_sl_io_transaction_windows_pt const tx) mk_lang_noexcept
{
	mk_win_base_ushort_t mv;
	mk_win_base_handle_t file;
	...
	mv = mk_win_ktmw32_transaction_txfs_miniversion_view_e_committed;
	file = mk_win_ktmw32_transaction_w_create_file_transacted(name, mk_win_advapi_base_right_generic_e_read, mk_win_kernel_files_share_e_read | mk_win_kernel_files_share_e_delete, mk_win_base_null, mk_win_kernel_files_create_e_open_existing, mk_win_kernel_files_attribute_e_normal | mk_win_kernel_files_flag_e_sequential_scan | mk_win_kernel_files_flag_e_overlapped, mk_win_base_handle_get_null(), tx->m_transaction, &mv, mk_win_base_null); mk_lang_check_return(file.m_data != mk_win_base_handle_invalid);
	reader->m_file = file;
	return 0;
}
