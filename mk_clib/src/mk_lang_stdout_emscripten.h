...
#define mk_lang_stdout_emscripten_no_redirect_print_lit_n(x) mk_lang_stdout_emscripten_no_redirect_print_n(&(x)[0], mk_lang_countstr((x)))
#define mk_lang_stdout_emscripten_no_redirect_print_lit_w(x) mk_lang_stdout_emscripten_no_redirect_print_w(&(x)[0], mk_lang_countstr((x)))
#define mk_lang_stdout_emscripten_no_redirect_print_lit_t(x) mk_lang_stdout_emscripten_no_redirect_print_t(&(x)[0], mk_lang_countstr((x)))
#define mk_lang_stdout_emscripten_no_redirect_println_lit_n(x) mk_lang_stdout_emscripten_no_redirect_print_lit_n(x "\n")
#define mk_lang_stdout_emscripten_no_redirect_println_lit_w(x) mk_lang_stdout_emscripten_no_redirect_print_lit_w(x L"\n")
#define mk_lang_stdout_emscripten_no_redirect_println_lit_t(x) mk_lang_stdout_emscripten_no_redirect_print_lit_t(x mk_lang_tchar_c("\n"))
