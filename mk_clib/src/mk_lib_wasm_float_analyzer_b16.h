#ifndef mk_include_guard_mk_lib_wasm_float_analyzer_b16_h
#define mk_include_guard_mk_lib_wasm_float_analyzer_b16_h
...
mk_lang_forward(mk_lib_float_analyzer_b16);
...
#include "mk_lib_wasm_float_analyzer_b16.c"
#endif
#endif
