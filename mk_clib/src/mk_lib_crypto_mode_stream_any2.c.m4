...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_sint_t mk_lib_crypto_mode_stream_any2_prro_get_idx(mk_lib_crypto_mode_stream_any2_pct const any2) mk_lang_noexcept
{
...
define(`mk_lib_crypto_mode_stream_any2_c_mm_fnc_prrw_set_iv', `dnl
		case mk_lib_crypto_mode_stream_any1_id_e_$1_$2: idx = any2->m_data.m_$1_$2.m_$1_$2.m_idx; break;
')`'dnl
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_sl_cui_uint8_pt mk_lib_crypto_mode_stream_any2_prrw_get_ptr(mk_lib_crypto_mode_stream_any2_pt const any2) mk_lang_noexcept
{
	...
	{
define(`mk_lib_crypto_mode_stream_any2_c_mm_fnc_prrw_set_iv', `dnl
		case mk_lib_crypto_mode_stream_any1_id_e_$1_$2: ptr = &any2->m_data.m_$1_$2.m_$1_$2.m_msg.m_data.m_uint8s[0]; break;
')`'dnl
mk_lib_crypto_mode_stream_mm_recurse(`mk_lib_crypto_mode_stream_any2_c_mm_fnc_prrw_set_iv', mk_lib_crypto_mode_stream_mm_list())dnl
		case mk_lib_crypto_mode_stream_any1_id_e_dummy_end: mk_lang_assert_false(); break;
		default: mk_lang_assert_false(); break;
...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo mk_lang_types_sint_t mk_lib_crypto_mode_stream_any2_ro_get_idx(mk_lib_crypto_mode_stream_any2_pct const any2) mk_lang_noexcept
{
	return mk_lib_crypto_mode_stream_any2_prro_get_idx(any2);
}

mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo mk_sl_cui_uint8_pt mk_lib_crypto_mode_stream_any2_rw_get_ptr(mk_lib_crypto_mode_stream_any2_pt const any2) mk_lang_noexcept
{
	return mk_lib_crypto_mode_stream_any2_prrw_get_ptr(any2);
}
