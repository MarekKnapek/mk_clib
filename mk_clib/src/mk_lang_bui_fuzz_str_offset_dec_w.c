...
static mk_lang_inline mk_lang_types_void_t mk_lang_bui_fuzz_str_offset_dec_w_uint_to_str_different(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	mk_lang_bui_fuzz_str_offset_dec_w_zzz_uint_t bui_a;
	mk_lang_bui_fuzz_str_offset_dec_w_zzz_uint_t bui_b;
	mk_lang_types_sint_t len_a;
	mk_lang_types_wchar_t str_a[mk_lang_bui_fuzz_str_offset_dec_w_zzz_uint_strlendec_v];
	mk_lang_types_sint_t len_b;
	mk_lang_types_wchar_t str_b[mk_lang_bui_fuzz_str_offset_dec_w_zzz_uint_strlendec_v];
...
static mk_lang_inline mk_lang_types_void_t mk_lang_bui_fuzz_str_offset_dec_w_uint_to_str_and_back(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	mk_lang_bui_fuzz_str_offset_dec_w_zzz_uint_t bui_a;
	mk_lang_types_sint_t len_a;
	mk_lang_types_wchar_t str[mk_lang_bui_fuzz_str_offset_dec_w_zzz_uint_strlendec_v];
	mk_lang_types_sint_t len_b;
	mk_lang_bui_fuzz_str_offset_dec_w_zzz_uint_t bui_b;
...
static mk_lang_inline mk_lang_types_void_t mk_lang_bui_fuzz_str_offset_dec_w_uint_from_str_and_back(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	mk_lang_types_wchar_t str_a[4 * mk_lang_bui_fuzz_str_offset_dec_w_zzz_uint_strlendec_v];
	mk_lang_types_sint_t sz;
	mk_lang_types_sint_t i;
	mk_lang_types_sint_t len_a;
	mk_lang_bui_fuzz_str_offset_dec_w_zzz_uint_t bui;
	mk_lang_types_sint_t len_b;
	mk_lang_types_wchar_t str_b[mk_lang_bui_fuzz_str_offset_dec_w_zzz_uint_strlendec_v];
...
mk_lang_jumbo mk_lang_types_void_t mk_lang_bui_fuzz_str_offset_dec_w(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	mk_lang_assert(data || size == 0);
	mk_lang_assert(size >= 0);
