#ifndef mk_include_guard_mk_sl_io_writer_file_linux_c
#define mk_include_guard_mk_sl_io_writer_file_linux_c
...
#else
static void mk_sl_io_writer_file_linux_dummy(void);
#endif
#endif
