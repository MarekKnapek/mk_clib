...
{
	mk_lang_assert(g_mk_win_unicode_api == mk_win_unicode_api_is_wide_e_not_tested);
	g_mk_win_unicode_api = LoadIconW(mk_win_base_null, ((mk_win_base_wchar_lpct)(((mk_win_base_uintptr_t)(32512)))) /* mk_win_user_icon_id_e_application */) == mk_win_base_null ? mk_win_unicode_api_is_wide_e_ansi : mk_win_unicode_api_is_wide_e_wide;
}
