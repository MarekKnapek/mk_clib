#ifndef mk_include_guard_mk_lang_alignof_h
#define mk_include_guard_mk_lang_alignof_h
...
#if mk_lang_version_at_least_cpp_11 || mk_lang_version_at_least_msvc_cpp_14 || (mk_lang_version_at_least_c_23  && (mk_lang_msvc_ver == 0 || mk_lang_msvc_ver >= 9999l)) /* todo when msvc starts supporting this */
...
#elif defined LONG_SIZE
#define mk_lang_alignof_bi_ulong_t LONG_SIZE
#else
