...
mk_lang_jumbo void mk_lib_crypto_alg_aes_fuzz_my(mk_lang_types_bool_t const cpuida, mk_lang_types_bool_t const cpuidb, mk_lib_crypto_app_alg_id_t const alg_id, mk_lib_crypto_app_padding_id_t const padding_id, mk_lib_crypto_app_mode_id_t const mode_id, mk_lang_types_uchar_pct const key, mk_lang_types_uchar_pct const iv, mk_lang_types_uchar_pct const msg, mk_lang_types_sint_t const msg_len, mk_lang_types_uchar_pt const out, mk_lang_types_uint_pt const padding_len) mk_lang_noexcept
{
	...
	g_app.m_alg_id = alg_id;
	g_app.m_padding_id = padding_id;
	g_app.m_mode_id = mode_id;
...
mk_lang_jumbo void mk_lib_crypto_alg_aes_fuzz_accelerated(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	...
	mk_lang_cpuid_init();
	{
		...
		memcpy(&key, d, mk_lib_crypto_alg_aes_portable_128_key_len_v);
		d += mk_lib_crypto_alg_aes_portable_128_key_len_v;
		s -= mk_lib_crypto_alg_aes_portable_128_key_len_v;
		if(!(s >= sizeof(msgs))) return;
		memcpy(&msgs, d, sizeof(msgs));
		d += sizeof(msgs);
		s -= sizeof(msgs);
	...
	}
	{
		...
		memcpy(&key, d, mk_lib_crypto_alg_aes_portable_192_key_len_v);
		d += mk_lib_crypto_alg_aes_portable_192_key_len_v;
		s -= mk_lib_crypto_alg_aes_portable_192_key_len_v;
		if(!(s >= sizeof(msgs))) return;
		memcpy(&msgs, d, sizeof(msgs));
		d += sizeof(msgs);
		s -= sizeof(msgs);
	...
	}
	{
		...
		memcpy(&key, d, mk_lib_crypto_alg_aes_portable_256_key_len_v);
		d += mk_lib_crypto_alg_aes_portable_256_key_len_v;
		s -= mk_lib_crypto_alg_aes_portable_256_key_len_v;
		if(!(s >= sizeof(msgs))) return;
		memcpy(&msgs, d, sizeof(msgs));
		d += sizeof(msgs);
		s -= sizeof(msgs);
...
mk_lang_jumbo void mk_lib_crypto_alg_aes_fuzz_win(mk_lang_types_bool_t const cpuida, mk_lang_types_bool_t const cpuidb, mk_lib_crypto_app_alg_id_t const alg_id, mk_lib_crypto_app_padding_id_t const padding_id, mk_lib_crypto_app_mode_id_t const mode_id, mk_lang_types_uchar_pct const key, mk_lang_types_uchar_pct const iv, mk_lang_types_uchar_pct const msg, mk_lang_types_uint_t const msg_len, mk_lang_types_uchar_pt const out, mk_lang_types_uint_pct const padding_len) mk_lang_noexcept
{
	...
	switch(mode_id)
	{
		case mk_lib_crypto_app_mode_id_e_cbc:     good = good && mk_lang_true;  break;
		case mk_lib_crypto_app_mode_id_e_cfb_128: good = good && mk_lang_false; break;
		case mk_lib_crypto_app_mode_id_e_cfb_8:   good = good && mk_lang_true;  break;
		case mk_lib_crypto_app_mode_id_e_ctr_be:  good = good && mk_lang_false; break;
		case mk_lib_crypto_app_mode_id_e_ecb:     good = good && mk_lang_true;  break;
		case mk_lib_crypto_app_mode_id_e_ofb:     good = good && mk_lang_false; break;
		default: mk_lang_assert(0); break;
	}
	switch(padding_id)
	{
		case mk_lib_crypto_app_padding_id_e_pkcs7:      good = good && mk_lang_true;  break;
		case mk_lib_crypto_app_padding_id_e_iso9797pm2: good = good && mk_lang_false; break;
		default: mk_lang_assert(0); break;
	}
	if(!good)
	{
...
mk_lang_jumbo void mk_lib_crypto_alg_aes_fuzz_winng(mk_lang_types_bool_t const cpuida, mk_lang_types_bool_t const cpuidb, mk_lib_crypto_app_alg_id_t const alg_id, mk_lib_crypto_app_padding_id_t const padding_id, mk_lib_crypto_app_mode_id_t const mode_id, mk_lang_types_uchar_pct const key, mk_lang_types_uchar_pct const iv, mk_lang_types_uchar_pct const msg, mk_lang_types_uint_t const msg_len, mk_lang_types_uchar_pt const out, mk_lang_types_uint_pct const padding_len) mk_lang_noexcept
{
	...
	switch(mode_id)
	{
		case mk_lib_crypto_app_mode_id_e_cbc:     win_mode = ((mk_lang_types_uchar_pct)(mk_win_bcrypt_bcrypt_chain_mode_cbc)); win_mode_len = ((mk_lang_types_ulong_t)(sizeof(mk_win_bcrypt_bcrypt_chain_mode_cbc))); win_feedback_bytes =  0; break;
		case mk_lib_crypto_app_mode_id_e_cfb_128: win_mode = ((mk_lang_types_uchar_pct)(mk_win_bcrypt_bcrypt_chain_mode_cfb)); win_mode_len = ((mk_lang_types_ulong_t)(sizeof(mk_win_bcrypt_bcrypt_chain_mode_cfb))); win_feedback_bytes = 16; break;
		case mk_lib_crypto_app_mode_id_e_cfb_8:   win_mode = ((mk_lang_types_uchar_pct)(mk_win_bcrypt_bcrypt_chain_mode_cfb)); win_mode_len = ((mk_lang_types_ulong_t)(sizeof(mk_win_bcrypt_bcrypt_chain_mode_cfb))); win_feedback_bytes =  1; break;
		case mk_lib_crypto_app_mode_id_e_ctr_be:  win_mode = ((mk_lang_types_uchar_pct)(mk_lang_null));                        win_mode_len = ((mk_lang_types_ulong_t)(0));                                           win_feedback_bytes =  0; break;
		case mk_lib_crypto_app_mode_id_e_ecb:     win_mode = ((mk_lang_types_uchar_pct)(mk_win_bcrypt_bcrypt_chain_mode_ecb)); win_mode_len = ((mk_lang_types_ulong_t)(sizeof(mk_win_bcrypt_bcrypt_chain_mode_ecb))); win_feedback_bytes =  0; break;
		case mk_lib_crypto_app_mode_id_e_ofb:     win_mode = ((mk_lang_types_uchar_pct)(mk_lang_null));                        win_mode_len = ((mk_lang_types_ulong_t)(0));                                           win_feedback_bytes =  0; break;
		default: mk_lang_assert(0); break;
	}
	...
	if(padding_id != mk_lib_crypto_app_padding_id_e_pkcs7)
	{
		return;
	}
	for(i = 0; i != 0x10; ++i){ win_iv[i] = iv[i]; }
	win_iv_len = mode_id != mk_lib_crypto_app_mode_id_e_ecb ? 0x10 : 0x00;
	win_piv = mode_id != mk_lib_crypto_app_mode_id_e_ecb ? &win_iv[0] : mk_lang_null;
	switch(alg_id)
	{
		case mk_lib_crypto_app_alg_id_e_aes_128: key_len = 16; break;
		case mk_lib_crypto_app_alg_id_e_aes_192: key_len = 24; break;
		case mk_lib_crypto_app_alg_id_e_aes_256: key_len = 32; break;
		default: mk_lang_assert(0); break;
	}
...
mk_lang_jumbo void mk_lib_crypto_alg_aes_fuzz(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	...
	mk_lib_crypto_app_mode_id_t mode_e;
	...
	#endif
	mk_lib_crypto_alg_aes_fuzz_accelerated(data, size);
}
