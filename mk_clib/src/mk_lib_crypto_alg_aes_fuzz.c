...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_crypto_alg_aes_fuzz(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	...
	pmsg = &msg[(((mk_lang_types_uintptr_t)(mk_lib_crypto_alg_aes_128_msg_len_v)) - (((mk_lang_types_uintptr_t)(&msg[0])) & ((mk_lang_types_uintptr_t)(mk_lib_crypto_alg_aes_128_msg_len_v - 1)))) + ((mk_lang_types_uintptr_t)(block_offset_s * (128 / mk_lang_charbit)))];

	pouta_my = &outa_my[(((mk_lang_types_uintptr_t)(mk_lib_crypto_alg_aes_128_msg_len_v)) - (((mk_lang_types_uintptr_t)(&outa_my[0])) & ((mk_lang_types_uintptr_t)(mk_lib_crypto_alg_aes_128_msg_len_v - 1)))) + ((mk_lang_types_uintptr_t)(outa_offset_s * (128 / mk_lang_charbit)))];
	poutb_my = &outb_my[(((mk_lang_types_uintptr_t)(mk_lib_crypto_alg_aes_128_msg_len_v)) - (((mk_lang_types_uintptr_t)(&outb_my[0])) & ((mk_lang_types_uintptr_t)(mk_lib_crypto_alg_aes_128_msg_len_v - 1)))) + ((mk_lang_types_uintptr_t)(outb_offset_s * (128 / mk_lang_charbit)))];
	...
	#if mk_lang_platform_is_windows_at_least_any
	pout_win = &out_win[(((mk_lang_types_uintptr_t)(mk_lib_crypto_alg_aes_128_msg_len_v)) - (((mk_lang_types_uintptr_t)(&out_win[0])) & ((mk_lang_types_uintptr_t)(mk_lib_crypto_alg_aes_128_msg_len_v - 1)))) + ((mk_lang_types_uintptr_t)(outa_offset_s * (128 / mk_lang_charbit)))];
