...
#define mk_lang_check_break()
#else
#define mk_lang_check_line ((mk_lang_types_sint_t)(__LINE__))
#define mk_lang_check_break() __debugbreak()
#endif
...
#define mk_lang_check_return(x) do{ if(!mk_lang_check_to_bool(x)){ mk_lang_unlikely mk_lang_check_break(); return mk_lang_check_line; } }while(0)
#define mk_lang_check_goto_exret(x) do{ if(!mk_lang_check_to_bool(x)){ mk_lang_unlikely mk_lang_check_break(); goto exret; } }while(0)
#define mk_lang_check_crash(x) do{ if(!mk_lang_check_to_bool(x)){ mk_lang_unlikely mk_lang_check_break(); mk_lang_crash(); } }while(0)
