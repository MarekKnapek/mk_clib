...
#define mk_lang_check_rereturn(x) { mk_lang_types_sint_t err_ mk_lang_constexpr_init; err_ = ((mk_lang_types_sint_t)(x)); if(err_ != 0){ mk_lang_unlikely return err_; } } ((mk_lang_types_void_t)(0))
#define mk_lang_check_rebreak(x) { mk_lang_types_sint_t err_ mk_lang_constexpr_init; err_ = ((mk_lang_types_sint_t)(x)); if(err_ != 0){ mk_lang_unlikely break; } } ((mk_lang_types_void_t)(0))
#define mk_lang_check_regoto_exret(x) { mk_lang_types_sint_t err_ mk_lang_constexpr_init; err_ = ((mk_lang_types_sint_t)(x)); if(err_ != 0){ mk_lang_unlikely ret = err_; goto exret; } } ((mk_lang_types_void_t)(0))
#define mk_lang_check_recrash(x) { mk_lang_types_sint_t err_ mk_lang_constexpr_init; err_ = ((mk_lang_types_sint_t)(x)); if(err_ != 0){ mk_lang_unlikely mk_lang_crash(); } } ((mk_lang_types_void_t)(0))
