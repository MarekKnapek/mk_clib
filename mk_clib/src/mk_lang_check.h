...
#define mk_lang_check_rereturn(x) do{ mk_lang_types_sint_t err_ mk_lang_constexpr_init; err_ = ((mk_lang_types_sint_t)(x)); if(err_ != 0){ mk_lang_unlikely return err_; } }while(0)
...
#define mk_lang_check_regoto_exret(x) do{ mk_lang_types_sint_t err_ mk_lang_constexpr_init; err_ = ((mk_lang_types_sint_t)(x)); if(err_ != 0){ mk_lang_unlikely ret = err_; goto exret; } }while(0)
