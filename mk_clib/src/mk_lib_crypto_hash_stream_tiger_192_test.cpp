...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_hash_stream_tiger_192_test_compute_from_str_lit(char const(&str_lit)[str_lit_len]) mk_lang_noexcept
{
	...
	mk_lib_cpp_constexpr_array_t<mk_lang_types_uchar_t, mk_lib_crypto_hash_block_tiger_192_digest_len> ret mk_lang_constexpr_init;
	...
	for(i = 0; i  != s_len; ++i)
	{
		...
		mk_lib_crypto_hash_stream_tiger_192_append(&tiger_192, &uch, 1);
	}
