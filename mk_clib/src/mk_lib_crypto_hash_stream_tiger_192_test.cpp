...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_hash_stream_tiger_192_test_compute_from_str_lit(char const(&str_lit)[str_lit_len]) mk_lang_noexcept
{
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, str_lit_len - 1> msg mk_lang_constexpr_init;
	mk_lib_crypto_hash_stream_tiger_192_t tiger_192 mk_lang_constexpr_init;
	mk_lib_crypto_hash_block_tiger_192_digest_t digest mk_lang_constexpr_init;
	mk_lang_types_usize_t i mk_lang_constexpr_init;
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, mk_lib_crypto_hash_block_tiger_192_digest_len> ret mk_lang_constexpr_init;

	mk_lang_static_assert(str_lit_len >= 1);

	msg = mk_lib_cpp_constexpr_str_lit_to_u8s(str_lit);
	mk_lib_crypto_hash_stream_tiger_192_init(&tiger_192);
	mk_lib_crypto_hash_stream_tiger_192_append_u8(&tiger_192, msg.data(), msg.size());
	mk_lib_crypto_hash_stream_tiger_192_finish(&tiger_192, &digest);
	for(i = 0; i != mk_lib_crypto_hash_block_tiger_192_digest_len; ++i){ ret[i] = digest.m_uint8s[i]; }
	return ret;
}
...
mk_lang_extern_c void mk_lib_crypto_hash_stream_tiger_192_test(void) mk_lang_noexcept
{
	#define message_1 ""
	...
	#define digest_1 "3293ac630c13f0245f92bbb1766e16167a4e58492dde73f3"
	#define digest_2 "2aab1484e8c158f2bfb8c5ff41b57a525129131c957b5f93"
	#define digest_3 "dd00230799f5009fec6debc838bb6a27df2b9d6f110c7937"
	#define digest_4 "f71c8583902afb879edfe610f82c0d4786a3a534504486b5"
	#define digest_5 "48ceeb6308b87d46e95d656112cdf18d97915f9765658957"
	#define digest_6 "8a866829040a410c729ad23f5ada711603b3cdd357e4c15e"
	#define digest_7 "ce55a6afd591f5ebac547ff84f89227f9331dab0b611c889"
	#define digest_8 "631abdd103eb9a3d245b6dfd4d77b257fc7439501d1568dd"
	#define digest_9 "c54034e5b43eb8005848a7e0ae6aac76e4ff590ae715fd25"

	#if mk_lang_version_at_least_cpp_14 || mk_lang_version_at_least_msvc_cpp_14

	mk_lang_constexpr_static auto const s_digest_computed_1 = mk_lib_crypto_hash_stream_tiger_192_test_compute_from_str_lit(message_1);
	mk_lang_constexpr_static auto const s_digest_computed_2 = mk_lib_crypto_hash_stream_tiger_192_test_compute_from_str_lit(message_2);
	mk_lang_constexpr_static auto const s_digest_computed_3 = mk_lib_crypto_hash_stream_tiger_192_test_compute_from_str_lit(message_3);
	mk_lang_constexpr_static auto const s_digest_computed_4 = mk_lib_crypto_hash_stream_tiger_192_test_compute_from_str_lit(message_4);
	mk_lang_constexpr_static auto const s_digest_computed_5 = mk_lib_crypto_hash_stream_tiger_192_test_compute_from_str_lit(message_5);
	mk_lang_constexpr_static auto const s_digest_computed_6 = mk_lib_crypto_hash_stream_tiger_192_test_compute_from_str_lit(message_6);
	mk_lang_constexpr_static auto const s_digest_computed_7 = mk_lib_crypto_hash_stream_tiger_192_test_compute_from_str_lit(message_7);
	mk_lang_constexpr_static auto const s_digest_computed_8 = mk_lib_crypto_hash_stream_tiger_192_test_compute_from_str_lit(message_8);
	mk_lang_constexpr_static auto const s_digest_computed_9 = mk_lib_crypto_hash_stream_tiger_192_test_compute_from_str_lit(message_9);
	...
	mk_lang_constexpr_static auto const s_digest_precomputed_9 = mk_lib_cpp_constexpr_hex_str_lit_to_u8s(digest_9);
	...
	int n;
	int i;
	mk_lib_crypto_hash_stream_tiger_192_t tiger_192;
	...
	for(i = 0; i != n; ++i)
	{
		...
		mk_lib_crypto_hash_stream_tiger_192_init(&tiger_192);
		mk_lib_crypto_hash_stream_tiger_192_append(&tiger_192, ((mk_lang_types_uchar_pct)(s_messages[i])), s_message_lens[i]);
		mk_lib_crypto_hash_stream_tiger_192_finish(&tiger_192, &digest);
		for(j = 0; j != mk_lib_crypto_hash_block_tiger_192_digest_len; ++j)
		{
