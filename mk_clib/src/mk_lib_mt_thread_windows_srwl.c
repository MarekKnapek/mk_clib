...
struct mk_lib_mt_thread_windows_srwl_args_s
{
	mk_lib_mt_mutex_windows_srwl_t m_mutex;
	mk_lib_mt_cv_windows_srwl_t m_cv;
	mk_lang_types_bool_t m_inited;
	mk_lib_mt_thread_windows_srwl_callback_t m_callback;
	mk_lang_types_void_pt m_context;
};
typedef struct mk_lib_mt_thread_windows_srwl_args_s mk_lib_mt_thread_windows_srwl_args_t;
typedef mk_lib_mt_thread_windows_srwl_args_t const mk_lib_mt_thread_windows_srwl_args_ct;
typedef mk_lib_mt_thread_windows_srwl_args_t* mk_lib_mt_thread_windows_srwl_args_pt;
typedef mk_lib_mt_thread_windows_srwl_args_t const* mk_lib_mt_thread_windows_srwl_args_pct;


mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_mt_thread_windows_srwl_procedure_impl_1(mk_lang_types_void_pt const arg) mk_lang_noexcept
{
	mk_lib_mt_thread_windows_srwl_args_pt args;
	mk_lang_types_sint_t err;
	mk_lib_mt_unique_lock_exclusive_windows_srwl_t ul;
	mk_lib_mt_thread_windows_srwl_callback_t callback;
	mk_lang_types_void_pt context;

	mk_lang_assert(arg);

	args = ((mk_lib_mt_thread_windows_srwl_args_pt)(arg));
...
mk_lang_nodiscard static mk_win_base_dword_t mk_win_base_stdcall mk_lib_mt_thread_windows_srwl_procedure(mk_win_base_void_lpt const arg) mk_lang_noexcept
{
	mk_lang_types_sint_t err;

	err = mk_lib_mt_thread_windows_srwl_procedure_impl_1(arg); mk_lang_check_recrash(err);
	return 0;
}

mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_mt_thread_windows_srwl_create_impl_4(mk_lib_mt_thread_windows_srwl_args_pt const args, mk_lib_mt_unique_lock_exclusive_windows_srwl_pt const ul) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_mt_thread_windows_srwl_create_impl_3(mk_lib_mt_thread_windows_srwl_args_pt const args) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	mk_lib_mt_unique_lock_exclusive_windows_srwl_t ul;
	...
	err = mk_lib_mt_unique_lock_exclusive_windows_srwl_construct(&ul, &args->m_mutex); mk_lang_check_rereturn(err);
	err_b = mk_lib_mt_thread_windows_srwl_create_impl_4(args, &ul);
	err = mk_lib_mt_unique_lock_exclusive_windows_srwl_destruct(&ul); mk_lang_check_rereturn(err);
	mk_lang_check_rereturn(err_b);
	return 0;
}

mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_mt_thread_windows_srwl_create_impl_2(mk_lib_mt_thread_windows_srwl_pt const thread, mk_lib_mt_thread_windows_srwl_args_pt const args) mk_lang_noexcept
{
	...
	start = &mk_lib_mt_thread_windows_srwl_procedure;
	t = mk_win_kernel_thread_create(mk_win_base_null, 0, start, args, 0, &tid); mk_lang_check_return(t.m_data);
	thread->m_thread = t;
	err = mk_lib_mt_thread_windows_srwl_create_impl_3(args); mk_lang_check_rereturn(err);
	return 0;
}

mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_mt_thread_windows_srwl_create_impl_1(mk_lib_mt_thread_windows_srwl_pt const thread, mk_lib_mt_thread_windows_srwl_args_pt const args) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	mk_lang_types_sint_t err_b;
	...
	err_b = mk_lib_mt_thread_windows_srwl_create_impl_2(thread, args);
...
{
	mk_lib_mt_thread_windows_srwl_args_t args;
	mk_lang_types_sint_t err;
	mk_lang_types_sint_t err_b;
