#ifndef mk_include_guard_mk_lib_crypto_alg_aes_256_test_cpp
#define mk_include_guard_mk_lib_crypto_alg_aes_256_test_cpp
...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_alg_aes_256_test_encrypt_from_str_lit(mk_lang_types_pchar_t const(&key_lit)[key_lit_len], mk_lang_types_pchar_t const(&msg_lit)[msg_lit_len]) mk_lang_noexcept
{
	mk_lib_crypto_alg_aes_256_key_t key mk_lang_constexpr_init;
	mk_lib_crypto_alg_aes_256_msg_t msg mk_lang_constexpr_init;
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, mk_lib_crypto_alg_aes_256_msg_len_v> ret mk_lang_constexpr_init;

	mk_lang_static_assert(key_lit_len == ((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)) + 1);
	mk_lang_static_assert(msg_lit_len == ((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_msg_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)) + 1);
...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_alg_aes_256_test_decrypt_from_str_lit(mk_lang_types_pchar_t const(&key_lit)[key_lit_len], mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, msg_len> const& msg_in) mk_lang_noexcept
{
	mk_lib_crypto_alg_aes_256_key_t key mk_lang_constexpr_init;
	mk_lib_crypto_alg_aes_256_msg_t msg mk_lang_constexpr_init;
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, mk_lib_crypto_alg_aes_256_msg_len_v> ret mk_lang_constexpr_init;
	...
	mk_lang_static_assert(key_lit_len == ((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)) + 1);
	mk_lang_static_assert(msg_len == mk_lib_crypto_alg_aes_256_msg_len_v);
...
mk_lang_extern_force_c mk_lang_types_void_t mk_lib_crypto_alg_aes_256_test(mk_lang_types_void_t) mk_lang_noexcept
{
	...
	for(i = 0; i != n; ++i)
	{
		mk_lang_assert(key_lens[i] == ((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_key_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)));
		mk_lang_assert(msg_lens[i] == ((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_msg_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)));
		mk_lang_assert(out_lens[i] == ((mk_lang_types_sint_t)(mk_lib_crypto_alg_aes_256_msg_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)));
		len = mk_sl_cui_uint8_from_str_hex_many_n(&key.m_data.m_uint8s[0], mk_lib_crypto_alg_aes_256_key_len_v, &keys[i][0], key_lens[i]); mk_lang_assert(len == key_lens[i]);
		len = mk_sl_cui_uint8_from_str_hex_many_n(&msg.m_data.m_uint8s[0], mk_lib_crypto_alg_aes_256_msg_len_v, &msgs[i][0], msg_lens[i]); mk_lang_assert(len == msg_lens[i]);
		mk_lib_crypto_alg_aes_256_encrypt(&key, &msg, &msg);
