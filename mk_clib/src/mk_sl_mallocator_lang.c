...
#define mk_sl_mallocator_lang_m std::malloc
#define mk_sl_mallocator_lang_f std::free
#else
#include <stdlib.h> /* malloc free */
#define mk_sl_mallocator_lang_m malloc
#define mk_sl_mallocator_lang_f free
#endif
...
static mk_lang_size_t g_mk_sl_mallocator_lang_allocated;
#endif
...
mk_lang_jumbo void* mk_sl_mallocator_lang_allocate(mk_lang_size_t const bytes_count) mk_lang_noexcept
{
	...
	ptr = mk_sl_mallocator_lang_m(bytes_count);
	#if mk_sl_mallocator_lang_want_statistics_impl
	if(ptr)
	{
		g_mk_sl_mallocator_lang_allocated += bytes_count;
	}
	#endif
	return ptr;
}

mk_lang_jumbo void mk_sl_mallocator_lang_deallocate(void const* const ptr, mk_lang_size_t const bytes_count) mk_lang_noexcept
{
	#if mk_sl_mallocator_lang_want_statistics_impl
	g_mk_sl_mallocator_lang_allocated -= bytes_count;
	#else
