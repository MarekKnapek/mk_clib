...
struct mk_lib_iip_cp_types_destination_elgamal_dsa_s
{
...
typedef struct mk_lib_iip_cp_types_destination_elgamal_dsa_s mk_lib_iip_cp_types_destination_elgamal_dsa_t;
mk_lang_typedef(mk_lib_iip_cp_types_destination_elgamal_dsa);

#include "mk_lang_warning_msvc_push_c4820.h"
struct mk_lib_iip_cp_types_leaseset_s
{
	mk_lib_iip_cp_types_destination_elgamal_dsa_t m_destination;
...
//mk_lang_jumbo mk_lang_types_void_t mk_lib_iip_cp_types_destination_elgamal_dsa_generate_random(mk_lib_iip_cp_types_destination_elgamal_dsa_pt const destination) mk_lang_noexcept;
