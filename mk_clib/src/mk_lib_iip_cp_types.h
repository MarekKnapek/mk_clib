...
enum mk_lib_iip_cp_types_private_destination_type_e
{
	...
	mk_lib_iip_cp_types_private_destination_type_e_dummy_end
};
typedef enum mk_lib_iip_cp_types_private_destination_type_e mk_lib_iip_cp_types_private_destination_type_t;
union mk_lib_iip_cp_types_private_destination_data_u
{
	mk_lib_iip_cp_types_private_destination_elgamal_dsa_sha1_t m_elgamal_dsa_sha1;
};
typedef union mk_lib_iip_cp_types_private_destination_data_u mk_lib_iip_cp_types_private_destination_data_t;
struct mk_lib_iip_cp_types_private_destination_s
{
	mk_lib_iip_cp_types_private_destination_type_t m_type;
	mk_lib_iip_cp_types_private_destination_data_t m_data;
};
typedef struct mk_lib_iip_cp_types_private_destination_s mk_lib_iip_cp_types_private_destination_t;
mk_lang_typedef(mk_lib_iip_cp_types_private_destination);
#include "mk_lang_warning_msvc_pop.h"

#include "mk_lang_warning_msvc_push_c4820.h"
struct mk_lib_iip_cp_types_remote_destination_any_any_s
{
	mk_lib_iip_cp_types_destination_buffer_t m_destination_buffer;
};
typedef struct mk_lib_iip_cp_types_remote_destination_any_any_s mk_lib_iip_cp_types_remote_destination_any_any_t;
mk_lang_typedef(mk_lib_iip_cp_types_remote_destination_any_any);
...
struct mk_lib_iip_cp_types_remote_destination_elgamal_ecdsa_sha256_p256_s
{
	mk_lib_iip_key_enc_elgamal_pub_t m_enc_pub;
	mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_t m_sgn_pub;
	mk_sl_cui_uint8_t m_padding_2[128 - mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_size_bytes_v];
};
typedef struct mk_lib_iip_cp_types_remote_destination_elgamal_ecdsa_sha256_p256_s mk_lib_iip_cp_types_remote_destination_elgamal_ecdsa_sha256_p256_t;
mk_lang_typedef(mk_lib_iip_cp_types_remote_destination_elgamal_ecdsa_sha256_p256);
struct mk_lib_iip_cp_types_remote_destination_elgamal_eddsa_sha512_ed25519_s
{
	...
	mk_sl_cui_uint8_t m_padding_2[128 - mk_lib_iip_key_sgn_eddsa_sha512_ed25519_pub_integer_single_size_bytes_v];
};
...
{
	mk_lib_iip_cp_types_remote_destination_any_any_t m_any_any;
	mk_lib_iip_cp_types_remote_destination_elgamal_dsa_sha1_t m_legacy;
	mk_lib_iip_cp_types_remote_destination_elgamal_dsa_sha1_t m_elgamal_dsa_sha1;
	mk_lib_iip_cp_types_remote_destination_elgamal_ecdsa_sha256_p256_t m_elgamal_ecdsa_sha256_p256;
...
struct mk_lib_iip_cp_types_destination2_s
{
	mk_lib_iip_cp_types_remote_destination_type_t m_type;
	mk_lib_iip_cp_types_private_destination_elgamal_dsa_sha1_t m_private_data;
	mk_lib_iip_cp_types_remote_destination_data_t m_public_data;
};
typedef struct mk_lib_iip_cp_types_destination2_s mk_lib_iip_cp_types_destination2_t;
mk_lang_typedef(mk_lib_iip_cp_types_destination2);
#include "mk_lang_warning_msvc_pop.h"
