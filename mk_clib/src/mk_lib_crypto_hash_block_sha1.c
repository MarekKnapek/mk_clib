...
union mk_lib_crypto_hash_block_sha1_block2_data_u
{
	mk_sl_cui_uint32_t m_u32s[16];
	mk_lib_crypto_hash_block_sha1_block_t m_align;
};
typedef union mk_lib_crypto_hash_block_sha1_block2_data_u mk_lib_crypto_hash_block_sha1_block2_data_t;
struct mk_lib_crypto_hash_block_sha1_block2_s
{
	mk_lang_alignas(mk_lib_crypto_hash_block_sha1_block_len_v) mk_lib_crypto_hash_block_sha1_block2_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_sha1_block2_s mk_lib_crypto_hash_block_sha1_block2_t;
typedef mk_lib_crypto_hash_block_sha1_block2_t const mk_lib_crypto_hash_block_sha1_block2_ct;
typedef mk_lib_crypto_hash_block_sha1_block2_t* mk_lib_crypto_hash_block_sha1_block2_pt;
typedef mk_lib_crypto_hash_block_sha1_block2_t const* mk_lib_crypto_hash_block_sha1_block2_pct;


mk_lang_constexpr_static_inline mk_sl_cui_uint32_t const mk_lib_crypto_hash_block_sha1_s_init[5] =
{
...
mk_lang_constexpr_static_inline mk_sl_cui_uint32_t const mk_lib_crypto_hash_block_sha1_s_table[4] =
{
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha1_ch(mk_sl_cui_uint32_prct const x, mk_sl_cui_uint32_prct const y, mk_sl_cui_uint32_prct const z, mk_sl_cui_uint32_prt const ret) mk_lang_noexcept
{
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha1_parity(mk_sl_cui_uint32_prct const x, mk_sl_cui_uint32_prct const y, mk_sl_cui_uint32_prct const z, mk_sl_cui_uint32_prt const ret) mk_lang_noexcept
{
	mk_sl_cui_uint32_t ta mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha1_maj(mk_sl_cui_uint32_prct const x, mk_sl_cui_uint32_prct const y, mk_sl_cui_uint32_prct const z, mk_sl_cui_uint32_prt const ret) mk_lang_noexcept
{
	mk_sl_cui_uint32_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint32_t tb mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha1_f(mk_lang_types_sint_t const idx, mk_sl_cui_uint32_prct const x, mk_sl_cui_uint32_prct const y, mk_sl_cui_uint32_prct const z, mk_sl_cui_uint32_prt const ret) mk_lang_noexcept
{
	...
	switch(idx / 20)
	{
		case 0: mk_lib_crypto_hash_block_sha1_ch    (x, y, z, ret); break;
		case 1: mk_lib_crypto_hash_block_sha1_parity(x, y, z, ret); break;
		case 2: mk_lib_crypto_hash_block_sha1_maj   (x, y, z, ret); break;
		case 3: mk_lib_crypto_hash_block_sha1_parity(x, y, z, ret); break;
	}
}
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha1_init(mk_lib_crypto_hash_block_sha1_pt const sha1) mk_lang_noexcept
{
	...
	sha1->m_state[0] = mk_lib_crypto_hash_block_sha1_s_init[0];
	sha1->m_state[1] = mk_lib_crypto_hash_block_sha1_s_init[1];
	sha1->m_state[2] = mk_lib_crypto_hash_block_sha1_s_init[2];
	sha1->m_state[3] = mk_lib_crypto_hash_block_sha1_s_init[3];
	sha1->m_state[4] = mk_lib_crypto_hash_block_sha1_s_init[4];
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha1_append_blocks(mk_lib_crypto_hash_block_sha1_pt const sha1, mk_lib_crypto_hash_block_sha1_block_pct const pblocks, mk_lang_types_usize_t const nblocks) mk_lang_noexcept
{
	...
	mk_lib_crypto_hash_block_sha1_block2_t w mk_lang_constexpr_init;
	mk_sl_cui_uint32_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint32_t tb mk_lang_constexpr_init;
	mk_sl_cui_uint32_t t mk_lang_constexpr_init;

	mk_lang_static_assert(sizeof(mk_lib_crypto_hash_block_sha1_block2_t) == sizeof(mk_lib_crypto_hash_block_sha1_block_t));
	mk_lang_static_assert(mk_lang_alignof(mk_lib_crypto_hash_block_sha1_block2_t) == mk_lang_alignof(mk_lib_crypto_hash_block_sha1_block_t));
	...
	mk_lang_assert(!mk_sl_cui_uint64_would_overflow_add_cc(&sha1->m_len, &tt));
	mk_sl_cui_uint64_add2_wrap_cid_cod(&sha1->m_len, &tt);
	oldh[0] = sha1->m_state[0];
	oldh[1] = sha1->m_state[1];
	oldh[2] = sha1->m_state[2];
	oldh[3] = sha1->m_state[3];
	oldh[4] = sha1->m_state[4];
	a = &h[0];
	b = &h[1];
	c = &h[2];
	d = &h[3];
	...
	for(iblock = 0; iblock != nblocks; ++iblock)
	{
		...
		for(i = 0; i != 80; ++i)
		{
			if(i >= 16)
			{
				...
				mk_sl_cui_uint32_xor2(&ta, &tb);
				mk_sl_cui_uint32_rotl3(&ta, 1, &w.m_data.m_u32s[(i - 0) % 16]);
			}
			/* t = rotl(a, 5) + f(i, b, c, d) + e + k(i) + w[i]; */
			mk_sl_cui_uint32_rotl3(a, 5, &ta);
			mk_lib_crypto_hash_block_sha1_f(i, b, c, d, &tb);
			mk_sl_cui_uint32_add2_wrap_cid_cod(&ta, &tb);
			mk_sl_cui_uint32_add3_wrap_cid_cod(e, &w.m_data.m_u32s[(i - 0) % 16], &tb);
			mk_sl_cui_uint32_add2_wrap_cid_cod(&tb, &mk_lib_crypto_hash_block_sha1_s_table[i / 20]);
	...
	sha1->m_state[0] = oldh[0];
	sha1->m_state[1] = oldh[1];
	sha1->m_state[2] = oldh[2];
	sha1->m_state[3] = oldh[3];
	sha1->m_state[4] = oldh[4];
}
#include "mk_lang_warning_msvc_pop.h"
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha1_finish(mk_lib_crypto_hash_block_sha1_pt const sha1, mk_lib_crypto_hash_block_sha1_block_pt const block, mk_lang_types_sint_t const idx, mk_lib_crypto_hash_block_sha1_digest_pt const digest) mk_lang_noexcept
{
	...
	ui = mk_lib_crypto_hash_block_sha1_block_len_v; mk_sl_cui_uint64_from_bi_uint(&ta, &ui);
	...
	rest = mk_lib_crypto_hash_block_sha1_block_len_v - idx - 1;
	mk_lang_assert(rest >= 0 && rest <= mk_lib_crypto_hash_block_sha1_block_len_v - 1);
	...
	else
	{
		...
		mk_lib_crypto_hash_block_sha1_append_blocks(sha1, block, 1);
		mk_sl_cui_uint8_memclr_fn(&block->m_data.m_uint8s[0], ((mk_lang_types_sint_t)(mk_lib_crypto_hash_block_sha1_block_len_v)) - ((mk_lang_types_sint_t)(mk_sl_cui_uint64_size_bytes_v)));
	}

	mk_sl_uint_convert_64_8_be_to_sml(&ta, &block->m_data.m_uint8s[((mk_lang_types_sint_t)(mk_lib_crypto_hash_block_sha1_block_len_v)) - ((mk_lang_types_sint_t)(mk_sl_cui_uint64_size_bytes_v))]);
	mk_lib_crypto_hash_block_sha1_append_blocks(sha1, block, 1);
	for(i = 0; i != mk_lang_countof(sha1->m_state); ++i)
	{
		mk_sl_uint_convert_32_8_be_to_sml(&sha1->m_state[i], &digest->m_data.m_uint8s[i * mk_sl_cui_uint32_size_bytes_v]);
	}
}
#include "mk_lang_warning_msvc_pop.h"
