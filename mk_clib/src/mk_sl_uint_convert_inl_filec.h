...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_sl_uint_convert_inl_defd_to_sml_multi(mk_sl_uint_convert_inl_defd_big_pct const big, mk_lang_static_param(mk_sl_uint_convert_inl_defd_sml_t, sml, mk_sl_uint_convert_inl_defd_big_size_bits_v / mk_sl_uint_convert_inl_defd_sml_size_bits_v), mk_lang_types_usize_t const count) mk_lang_noexcept
{
	...
	for(i = 0; i != n; ++i)
	{
		mk_sl_uint_convert_inl_defd_to_sml(&big[i], &sml[i * (((mk_lang_types_sint_t)(mk_sl_uint_convert_inl_defd_big_size_bits_v)) / ((mk_lang_types_sint_t)(mk_sl_uint_convert_inl_defd_sml_size_bits_v)))]);
	}
}

mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_sl_uint_convert_inl_defd_to_big_multi(mk_sl_uint_convert_inl_defd_big_pt const big, mk_lang_static_param(mk_sl_uint_convert_inl_defd_sml_ct, sml, mk_sl_uint_convert_inl_defd_big_size_bits_v / mk_sl_uint_convert_inl_defd_sml_size_bits_v), mk_lang_types_usize_t const count) mk_lang_noexcept
{
	mk_lang_types_usize_t n mk_lang_constexpr_init;
	mk_lang_types_usize_t i mk_lang_constexpr_init;
	...
	for(i = 0; i != n; ++i)
	{
		mk_sl_uint_convert_inl_defd_to_big(&big[i], &sml[i * (((mk_lang_types_sint_t)(mk_sl_uint_convert_inl_defd_big_size_bits_v)) / ((mk_lang_types_sint_t)(mk_sl_uint_convert_inl_defd_sml_size_bits_v)))]);
	}
}
