...
typedef mk_lang_types_uint_t mk_win_base_dword_t;
...
struct mk_win_base_handle_s{ mk_win_base_void_pct m_data; };
...
typedef mk_win_base_handle_t* mk_lang_restrict mk_win_base_handle_prt;
typedef mk_win_base_handle_t const* mk_lang_restrict mk_win_base_handle_prct;
typedef mk_win_base_handle_t mk_win_base_far* mk_lang_restrict mk_win_base_handle_lprt;
typedef mk_win_base_handle_t mk_win_base_far const* mk_lang_restrict mk_win_base_handle_lprct;
typedef mk_win_base_handle_t mk_win_base_near* mk_lang_restrict mk_win_base_handle_nprt;
typedef mk_win_base_handle_t mk_win_base_near const* mk_lang_restrict mk_win_base_handle_nprct;
...
#define mk_win_base_make_handle(x) \
	...
	mk_lang_constexpr static mk_lang_inline mk_lang_concat(x, _t) mk_lang_concat(x, _null)(mk_lang_types_void_t) mk_lang_noexcept { mk_lang_concat(x, _t) r mk_lang_constexpr_init; r.m_data = mk_win_base_null; return r; } \

struct mk_win_base_instance_s{ mk_win_base_void_pct m_data; };
typedef struct mk_win_base_instance_s mk_win_base_instance_t;
typedef mk_win_base_instance_t const mk_win_base_instance_ct;
typedef mk_win_base_instance_t* mk_win_base_instance_pt;
typedef mk_win_base_instance_t const* mk_win_base_instance_pct;
typedef mk_win_base_instance_t mk_win_base_far* mk_win_base_instance_lpt;
typedef mk_win_base_instance_t mk_win_base_far const* mk_win_base_instance_lpct;
typedef mk_win_base_instance_t mk_win_base_near* mk_win_base_instance_npt;
typedef mk_win_base_instance_t mk_win_base_near const* mk_win_base_instance_npct;
typedef mk_win_base_instance_t* mk_lang_restrict mk_win_base_instance_prt;
typedef mk_win_base_instance_t const* mk_lang_restrict mk_win_base_instance_prct;
typedef mk_win_base_instance_t mk_win_base_far* mk_lang_restrict mk_win_base_instance_lprt;
typedef mk_win_base_instance_t mk_win_base_far const* mk_lang_restrict mk_win_base_instance_lprct;
typedef mk_win_base_instance_t mk_win_base_near* mk_lang_restrict mk_win_base_instance_nprt;
typedef mk_win_base_instance_t mk_win_base_near const* mk_lang_restrict mk_win_base_instance_nprct;
...
#define mk_win_base_page_4k (4 * 1024)
#define mk_win_base_page_64k (64 * 1024)
#define mk_win_base_page_2m (2 * 1024 * 1024)
static mk_win_base_instance_t const mk_win_base_instance_null = { mk_win_base_null };
