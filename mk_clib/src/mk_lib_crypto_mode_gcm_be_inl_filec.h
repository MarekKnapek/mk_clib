...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_mode_gcm_be_inl_defd_ctr_increment(mk_lib_crypto_mode_gcm_be_inl_defd_ctr_iv_pt const msg) mk_lang_noexcept;
