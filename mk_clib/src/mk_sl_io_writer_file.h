#ifndef mk_include_guard_mk_sl_io_writer_file_h
#define mk_include_guard_mk_sl_io_writer_file_h
...
typedef mk_sl_io_writer_file_posix_t mk_sl_io_writer_file_handle_t;
