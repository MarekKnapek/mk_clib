...
mk_lang_extern_c mk_win_base_dll_import mk_win_user_window_t mk_win_base_stdcall CreateWindowExA(mk_win_base_dword_t, mk_win_base_pchar_lpct, mk_win_base_pchar_lpct, mk_win_base_dword_t, int, int, int, int, mk_win_user_window_t, mk_win_user_menu_t, mk_win_base_instance_t, mk_win_base_void_lpt) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_uintptr_t mk_win_base_stdcall SetWindowLongA(mk_win_user_window_t, int, mk_win_base_uintptr_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_uintptr_t mk_win_base_stdcall SetWindowLongPtrA(mk_win_user_window_t, int, mk_win_base_uintptr_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_uintptr_t mk_win_base_stdcall GetWindowLongA(mk_win_user_window_t, int) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_uintptr_t mk_win_base_stdcall GetWindowLongPtrA(mk_win_user_window_t, int) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_user_window_lresult_t mk_win_base_stdcall DefWindowProcA(mk_win_user_window_t, mk_win_base_uint_t, mk_win_user_window_wparam_t, mk_win_user_window_lparam_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall PostMessageA(mk_win_user_window_t, mk_win_base_uint_t, mk_win_user_window_wparam_t, mk_win_user_window_lparam_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import int mk_win_base_stdcall GetWindowTextA(mk_win_user_window_t, mk_win_base_pchar_lpt, int) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall SetWindowTextA(mk_win_user_window_t, mk_win_base_pchar_lpct) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_user_window_lresult_t mk_win_base_stdcall CallWindowProcA(mk_win_user_window_wndproc_t, mk_win_user_window_t, mk_win_base_uint_t, mk_win_user_window_wparam_t, mk_win_user_window_lparam_t) mk_lang_noexcept;

mk_lang_extern_c mk_win_base_dll_import mk_win_user_window_t mk_win_base_stdcall CreateWindowExW(mk_win_base_dword_t, mk_win_base_wchar_lpct, mk_win_base_wchar_lpct, mk_win_base_dword_t, int, int, int, int, mk_win_user_window_t, mk_win_user_menu_t, mk_win_base_instance_t, mk_win_base_void_lpt) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_uintptr_t mk_win_base_stdcall SetWindowLongW(mk_win_user_window_t, int, mk_win_base_uintptr_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_uintptr_t mk_win_base_stdcall SetWindowLongPtrW(mk_win_user_window_t, int, mk_win_base_uintptr_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_uintptr_t mk_win_base_stdcall GetWindowLongW(mk_win_user_window_t, int) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_uintptr_t mk_win_base_stdcall GetWindowLongPtrW(mk_win_user_window_t, int) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_user_window_lresult_t mk_win_base_stdcall DefWindowProcW(mk_win_user_window_t, mk_win_base_uint_t, mk_win_user_window_wparam_t, mk_win_user_window_lparam_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall PostMessageW(mk_win_user_window_t, mk_win_base_uint_t, mk_win_user_window_wparam_t, mk_win_user_window_lparam_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import int mk_win_base_stdcall GetWindowTextW(mk_win_user_window_t, mk_win_base_wchar_lpt, int) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall SetWindowTextW(mk_win_user_window_t, mk_win_base_wchar_lpct) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_user_window_lresult_t mk_win_base_stdcall CallWindowProcW(mk_win_user_window_wndproc_t, mk_win_user_window_t, mk_win_base_uint_t, mk_win_user_window_wparam_t, mk_win_user_window_lparam_t) mk_lang_noexcept;

mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall ShowWindow(mk_win_user_window_t, int) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall UpdateWindow(mk_win_user_window_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall GetClientRect(mk_win_user_window_t, mk_win_base_rect_lpt) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall GetWindowRect(mk_win_user_window_t, mk_win_base_rect_lpt) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall SetWindowPos(mk_win_user_window_t, mk_win_user_window_t, int, int, int, int, mk_win_base_uint_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_gdi_dc_t mk_win_base_stdcall BeginPaint(mk_win_user_window_t, mk_win_user_window_paint_lpt) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall EndPaint(mk_win_user_window_t, mk_win_user_window_paint_lpct) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_user_window_t mk_win_base_stdcall SetFocus(mk_win_user_window_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_user_window_t mk_win_base_stdcall GetParent(mk_win_user_window_t) mk_lang_noexcept;
...
mk_lang_extern_c mk_win_base_dll_import mk_win_gdi_dc_t mk_win_base_stdcall GetDC(mk_win_user_window_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import int mk_win_base_stdcall ReleaseDC(mk_win_user_window_t, mk_win_gdi_dc_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall InvalidateRect(mk_win_user_window_t, mk_win_base_rect_lpct, mk_lang_bool_t) mk_lang_noexcept;

mk_lang_extern_c mk_win_base_dll_import mk_win_user_window_t mk_win_base_stdcall GetDesktopWindow(void) mk_lang_noexcept;
