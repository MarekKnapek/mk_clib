...
mk_lang_extern_c mk_lang_nodiscard mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall ReadFile(mk_win_base_handle_t, mk_win_base_void_lpt, mk_win_base_dword_t, mk_win_base_dword_lpt, mk_win_base_void_lpt /*todo overlapped*/) mk_lang_noexcept;
mk_lang_extern_c mk_lang_nodiscard mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall WriteFile(mk_win_base_handle_t, mk_win_base_void_lpct, mk_win_base_dword_t, mk_win_base_dword_lpt, mk_win_base_void_lpt /*todo overlapped*/) mk_lang_noexcept;
mk_lang_extern_c mk_lang_nodiscard mk_win_base_dll_import mk_win_base_dword_t mk_win_base_stdcall GetFileSize(mk_win_base_handle_t, mk_win_base_dword_lpt) mk_lang_noexcept;
mk_lang_extern_c mk_lang_nodiscard mk_win_base_dll_import mk_win_base_dword_t mk_win_base_stdcall SetFilePointer(mk_win_base_handle_t, mk_win_base_slong_t, mk_win_base_slong_lpt, mk_win_base_dword_t) mk_lang_noexcept;
