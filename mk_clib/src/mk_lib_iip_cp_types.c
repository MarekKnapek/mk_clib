...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_types_remote_destination_prrw_to_bytes(mk_lib_iip_cp_types_remote_destination_pct const obj, mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lang_types_bool_pt const succeeded, mk_lang_types_sint_pt const consumed) mk_lang_noexcept
{
	...
	if(obj->m_type != mk_lib_iip_cp_types_remote_destination_type_e_legacy)
	{
		...
		switch(sgn_type_id)
		{
			...
			case mk_lib_iip_cp_types_sign_key_type_e_ecdsa_sha256_p256     : mk_sl_cui_uint8_memcpy_fn(sgn_data_buf, &obj->m_data.m_elgamal_ecdsa_sha256_p256.m_padding_2[0], ((mk_lang_types_usize_t)(mk_lang_countof(obj->m_data.m_elgamal_ecdsa_sha256_p256.m_padding_2)))); mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_to_u8s_be(&obj->m_data.m_elgamal_ecdsa_sha256_p256.m_sgn_pub.m_data.m_integer, sgn_data_buf + 128 - mk_lib_iip_key_sgn_ecdsa_sha256_p256_pub_integer_single_size_bytes_v); break;
			...
			case mk_lib_iip_cp_types_sign_key_type_e_eddsa_sha512_ed25519  : mk_sl_cui_uint8_memcpy_fn(sgn_data_buf, &obj->m_data.m_elgamal_eddsa_sha512_ed25519.m_padding_2[0], ((mk_lang_types_usize_t)(mk_lang_countof(obj->m_data.m_elgamal_eddsa_sha512_ed25519.m_padding_2)))); mk_lib_iip_key_sgn_eddsa_sha512_ed25519_pub_integer_single_to_u8s_be(&obj->m_data.m_elgamal_eddsa_sha512_ed25519.m_sgn_pub.m_data.m_integer, sgn_data_buf + 128 - mk_lib_iip_key_sgn_eddsa_sha512_ed25519_pub_integer_single_size_bytes_v); break;
