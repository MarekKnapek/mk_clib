...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_destination_elgamal_dsa_sha1_generate_new_random(mk_lib_iip_cp_types_destination2_pt const destination) mk_lang_noexcept
{
	...
	mk_lang_assert(destination);
	mk_lang_assert(destination->m_type == mk_lib_iip_cp_types_remote_destination_type_e_legacy); /*todo*/

	err = mk_lib_iip_key_enc_elgamal_pri_generate_random(&destination->m_private_data.m_key_elgamal_pri); mk_lang_check_rereturn(err);
	err = mk_lib_iip_key_sgn_dsa_sha1_pri_rw_generate_random(&destination->m_private_data.m_key_dsa_sha1_pri); mk_lang_check_rereturn(err);
	mk_lib_iip_key_enc_elgamal_pri_compute_public(&destination->m_private_data.m_key_elgamal_pri, &destination->m_public_data.m_legacy.m_enc_pub);
	err = mk_lib_iip_key_sgn_dsa_sha1_pri_rw_get_public(&destination->m_private_data.m_key_dsa_sha1_pri, &destination->m_public_data.m_legacy.m_sgn_pub); mk_lang_check_rereturn(err);
	return 0;
}

mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_destination_elgamal_dsa_sha1_save_pri_only(mk_lib_iip_cp_types_destination2_pct const destination, mk_lang_types_pchar_pct const file_name) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	mk_sl_io_writer_file_t writer;
	mk_lang_types_sint_t str_len;
	mk_lang_types_pchar_t str_buf[mk_lang_max(((mk_lang_types_sint_t)(mk_lib_iip_key_enc_elgamal_pri_integer_single_strlen_hex_v)), ((mk_lang_types_sint_t)(((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pri_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)))))];
	mk_sl_cui_uint8_t bin_buf[mk_lang_countof(str_buf)];
	mk_lang_types_sint_t written;
	mk_sl_cui_uint8_t u8s[mk_lib_iip_key_sgn_dsa_sha1_pri_len_v];
	...
	str_len = mk_lib_iip_key_enc_elgamal_pri_integer_single_to_str_hexf_n(&destination->m_private_data.m_key_elgamal_pri.m_data.m_integer, &str_buf[0], mk_lang_countof(str_buf)); mk_lang_assert(str_len == mk_lib_iip_key_enc_elgamal_pri_integer_single_strlen_hex_v);
	...
	err = mk_lib_iip_key_sgn_dsa_sha1_pri_rw_export_pri_to_u8s(&destination->m_private_data.m_key_dsa_sha1_pri, &u8s[0]); mk_lang_check_rereturn(err);
	str_len = mk_sl_cui_uint8_to_str_hexf_many_n(&u8s[0], mk_lib_iip_key_sgn_dsa_sha1_pri_len_v, &str_buf[0], mk_lang_countof(str_buf)); mk_lang_assert(str_len == ((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pri_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)));
	mk_sl_cui_uint8_from_bi_pchar_many(&bin_buf[0], &str_buf[0], ((mk_lang_types_usize_t)(str_len)));
	err = mk_sl_io_writer_file_write(&writer, &bin_buf[0], str_len, &written); mk_lang_check_rereturn(err); mk_lang_check_return(written == str_len);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_destination_elgamal_dsa_sha1_save_pri_pub(mk_lib_iip_cp_types_destination2_pct const destination, mk_lang_types_pchar_pct const file_name) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	mk_sl_io_writer_file_t writer;
	mk_lang_types_sint_t str_len;
	mk_lang_types_pchar_t str_buf[mk_lang_max(mk_lang_max(mk_lang_max(((mk_lang_types_sint_t)(mk_lib_iip_key_enc_elgamal_pri_integer_single_strlen_hex_v)), ((mk_lang_types_sint_t)(((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pri_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v))))), ((mk_lang_types_sint_t)(mk_lib_iip_key_enc_elgamal_pub_integer_single_strlen_hex_v))), ((mk_lang_types_sint_t)(((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pub_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)))))];
	mk_sl_cui_uint8_t bin_buf[mk_lang_countof(str_buf)];
	mk_lang_types_sint_t written;
	mk_sl_cui_uint8_t u8s[mk_lang_max(((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pri_len_v)), ((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pub_len_v)))];
	...
	str_len = mk_lib_iip_key_enc_elgamal_pub_integer_single_to_str_hexf_n(&destination->m_public_data.m_legacy.m_enc_pub.m_data.m_integer, &str_buf[0], mk_lang_countof(str_buf)); mk_lang_assert(str_len == mk_lib_iip_key_enc_elgamal_pub_integer_single_strlen_hex_v);
	mk_sl_cui_uint8_from_bi_pchar_many(&bin_buf[0], &str_buf[0], ((mk_lang_types_usize_t)(str_len)));
	err = mk_sl_io_writer_file_write(&writer, &bin_buf[0], str_len, &written); mk_lang_check_rereturn(err); mk_lang_check_return(written == str_len);
	...
	err = mk_lib_iip_key_sgn_dsa_sha1_pub_rw_export_to_u8s(&destination->m_public_data.m_legacy.m_sgn_pub, &u8s[0]); mk_lang_check_rereturn(err);
	str_len = mk_sl_cui_uint8_to_str_hexf_many_n(&u8s[0], mk_lib_iip_key_sgn_dsa_sha1_pub_len_v, &str_buf[0], mk_lang_countof(str_buf)); mk_lang_assert(str_len == ((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pub_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)));
	mk_sl_cui_uint8_from_bi_pchar_many(&bin_buf[0], &str_buf[0], ((mk_lang_types_usize_t)(str_len)));
	err = mk_sl_io_writer_file_write(&writer, &bin_buf[0], str_len, &written); mk_lang_check_rereturn(err); mk_lang_check_return(written == str_len);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_destination_elgamal_dsa_sha1_generate_new_random_and_save_pri_only(mk_lib_iip_cp_types_destination2_pt const destination, mk_lang_types_pchar_pct const file_name) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_destination_elgamal_dsa_sha1_generate_new_random_and_save_pri_pub(mk_lib_iip_cp_types_destination2_pt const destination, mk_lang_types_pchar_pct const file_name) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_destination_elgamal_dsa_sha1_load_pri_only(mk_lib_iip_cp_types_destination2_pt const destination, mk_lang_types_pchar_pct const file_name) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	mk_sl_io_reader_file_t reader;
	mk_lang_types_sint_t str_len;
	mk_sl_cui_uint8_t bin_buf[mk_lang_max(((mk_lang_types_sint_t)(mk_lib_iip_key_enc_elgamal_pri_integer_single_strlen_hex_v)), ((mk_lang_types_sint_t)(((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pri_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)))))];
	...
	str_len = mk_lib_iip_key_enc_elgamal_pri_integer_single_from_str_hex_n(&destination->m_private_data.m_key_elgamal_pri.m_data.m_integer, &str_buf[0], str_len); mk_lang_assert(str_len == mk_lib_iip_key_enc_elgamal_pri_integer_single_strlen_hex_v);
	...
	str_len = ((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pri_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v));
	err = mk_sl_io_reader_file_read(&reader, &bin_buf[0], str_len, &read); mk_lang_check_rereturn(err); mk_lang_check_return(read == str_len);
	mk_sl_cui_uint8_to_bi_pchar_many(&bin_buf[0], &str_buf[0], ((mk_lang_types_usize_t)(str_len)));
	str_len = mk_sl_cui_uint8_from_str_hex_many_n(&u8s[0], mk_lib_iip_key_sgn_dsa_sha1_pri_len_v, &str_buf[0], str_len); mk_lang_assert(str_len == ((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pri_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)));
	err = mk_lib_iip_key_sgn_dsa_sha1_pri_rw_construct_from_u8s(&destination->m_private_data.m_key_dsa_sha1_pri, &u8s[0]); mk_lang_check_rereturn(err);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_destination_elgamal_dsa_sha1_load_pri_pub(mk_lib_iip_cp_destination_local_pt const destination, mk_lang_types_pchar_pct const file_name) mk_lang_noexcept
{
	...
	mk_sl_io_reader_file_t reader;
	mk_lang_types_sint_t str_len;
	mk_sl_cui_uint8_t bin_buf[mk_lang_max(mk_lang_max(mk_lang_max(((mk_lang_types_sint_t)(mk_lib_iip_key_enc_elgamal_pri_integer_single_strlen_hex_v)), ((mk_lang_types_sint_t)(((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pri_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v))))), ((mk_lang_types_sint_t)(mk_lib_iip_key_enc_elgamal_pub_integer_single_strlen_hex_v))), ((mk_lang_types_sint_t)(((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pub_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)))))];
	mk_lang_types_sint_t read;
	mk_lang_types_pchar_t str_buf[mk_lang_countof(bin_buf)];
	//mk_sl_cui_uint8_t u8s[mk_lang_max(((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pri_len_v)), ((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pub_len_v)))];
	...
	mk_sl_cui_uint8_to_bi_pchar_many(&bin_buf[0], &str_buf[0], ((mk_lang_types_usize_t)(str_len)));
	//str_len = mk_lib_iip_key_enc_elgamal_pri_integer_single_from_str_hex_n(&destination->m_private_data.m_key_elgamal_pri.m_data.m_integer, &str_buf[0], str_len); mk_lang_assert(str_len == mk_lib_iip_key_enc_elgamal_pri_integer_single_strlen_hex_v);
	str_len = mk_sl_cui_uint8_from_str_hex_many_n(&destination->m_basic_buffer.m_enc_pri_key.m_bytes[0], mk_lang_countof(destination->m_basic_buffer.m_enc_pri_key.m_bytes), &str_buf[0], str_len); mk_lang_assert(str_len == mk_lang_countof(destination->m_basic_buffer.m_enc_pri_key.m_bytes) * mk_sl_cui_uint8_strlen_hex_v);
	...
	//str_len = mk_sl_cui_uint8_from_str_hex_many_n(&u8s[0], mk_lib_iip_key_sgn_dsa_sha1_pri_len_v, &str_buf[0], str_len); mk_lang_assert(str_len == ((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pri_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)));
	//err = mk_lib_iip_key_sgn_dsa_sha1_pri_rw_construct_from_u8s(&destination->m_private_data.m_key_dsa_sha1_pri, &u8s[0]); mk_lang_check_rereturn(err);
	str_len = mk_sl_cui_uint8_from_str_hex_many_n(&destination->m_basic_buffer.m_sgn_pri_key.m_bytes[0], mk_lang_countof(destination->m_basic_buffer.m_sgn_pri_key.m_bytes), &str_buf[0], str_len); mk_lang_assert(str_len == mk_lang_countof(destination->m_basic_buffer.m_sgn_pri_key.m_bytes) * mk_sl_cui_uint8_strlen_hex_v);
	...
	err = mk_sl_io_reader_file_read(&reader, &bin_buf[0], str_len, &read); mk_lang_check_rereturn(err); mk_lang_check_return(read == str_len);
	mk_sl_cui_uint8_to_bi_pchar_many(&bin_buf[0], &str_buf[0], ((mk_lang_types_usize_t)(str_len)));
	//str_len = mk_lib_iip_key_enc_elgamal_pub_integer_single_from_str_hex_n(&destination->m_public_data.m_legacy.m_enc_pub.m_data.m_integer, &str_buf[0], str_len); mk_lang_assert(str_len == mk_lib_iip_key_enc_elgamal_pub_integer_single_strlen_hex_v);
	str_len = mk_sl_cui_uint8_from_str_hex_many_n(&destination->m_remote_destination.m_basic_buffer.m_enc_pub_key.m_bytes[0], mk_lang_countof(destination->m_remote_destination.m_basic_buffer.m_enc_pub_key.m_bytes), &str_buf[0], str_len); mk_lang_assert(str_len == mk_lang_countof(destination->m_remote_destination.m_basic_buffer.m_enc_pub_key.m_bytes) * mk_sl_cui_uint8_strlen_hex_v);
	...
	str_len = ((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pub_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v));
	err = mk_sl_io_reader_file_read(&reader, &bin_buf[0], str_len, &read); mk_lang_check_rereturn(err); mk_lang_check_return(read == str_len);
	mk_sl_cui_uint8_to_bi_pchar_many(&bin_buf[0], &str_buf[0], ((mk_lang_types_usize_t)(str_len)));
	//str_len = mk_sl_cui_uint8_from_str_hex_many_n(&u8s[0], mk_lib_iip_key_sgn_dsa_sha1_pub_len_v, &str_buf[0], str_len); mk_lang_assert(str_len == ((mk_lang_types_sint_t)(mk_lib_iip_key_sgn_dsa_sha1_pub_len_v)) * ((mk_lang_types_sint_t)(mk_sl_cui_uint8_strlen_hex_v)));
	//err = mk_lib_iip_key_sgn_dsa_sha1_pub_rw_construct_from_u8s(&destination->m_public_data.m_legacy.m_sgn_pub, &u8s[0]); mk_lang_check_rereturn(err);
	str_len = mk_sl_cui_uint8_from_str_hex_many_n(&destination->m_remote_destination.m_basic_buffer.m_sgn_pub_key.m_bytes[0], mk_lang_countof(destination->m_remote_destination.m_basic_buffer.m_sgn_pub_key.m_bytes), &str_buf[0], str_len); mk_lang_assert(str_len == mk_lang_countof(destination->m_remote_destination.m_basic_buffer.m_sgn_pub_key.m_bytes) * mk_sl_cui_uint8_strlen_hex_v);

	err = mk_sl_io_reader_file_close(&reader); mk_lang_check_rereturn(err);
	return 0;
}
#if 0
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_destination_elgamal_dsa_sha1_save_base64(mk_lib_iip_cp_types_destination2_pt const destination, mk_lang_types_pchar_pct const file_name) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	mk_sl_io_writer_file_t writer;
	...
	err = mk_sl_io_writer_file_open_n(&writer, file_name); mk_lang_check_rereturn(err);
	ptr = 0;
	mk_lib_iip_key_enc_elgamal_pub_integer_single_to_u8s(&destination->m_public_data.m_legacy.m_enc_pub.m_data.m_integer, &bin_buf[ptr]); ptr += 256;
	err = mk_lib_iip_key_sgn_dsa_sha1_pub_rw_export_to_u8s(&destination->m_public_data.m_legacy.m_sgn_pub, &bin_buf[ptr]); mk_lang_check_rereturn(err); ptr += 128;
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_bool_t mk_clib_app_iip_web_servers_compare(mk_lib_iip_http_buffer_pct const buf, mk_lang_types_pchar_pct const str) mk_lang_noexcept
{
	...
	eq = mk_lang_true;
	n = mk_lib_iip_http_buffer_ro_get_size(buf);
	for(i = 0; i != n; ++i)
	{
		mk_sl_cui_uint8_from_bi_pchar(&u8, &str[i]);
		if(!mk_sl_cui_uint8_eq(&u8, mk_lib_iip_http_buffer_ro_get_at(buf, i)))
		{
			eq = mk_lang_false;
			break;
		}
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_web_servers_check_one(web_servers_pt const web_servers, mk_lib_iip_cp_client_types_handle_socket_listener_pt const socket, mk_lib_iip_http_pt const http) mk_lang_noexcept
{
	...
	(
		...
		(mk_lib_iip_http_buffer_ro_get_size(&http->m_uri) == mk_lang_countstr(mk_clib_app_iip_web_servers_k_uri_root)) &&
...
struct mk_clib_app_iip_example1_s
{
	...
	mk_lang_types_bool_t m_http_resource_done;
	...
	mk_sl_io_writer_file_t m_writer;
};
...
mk_lang_constexpr_static_inline mk_lang_types_pchar_t const mk_clib_app_iip_example1_k_domain[] = "planet.i2p";
...
mk_lang_constexpr_static_inline mk_lang_types_pchar_t const mk_clib_app_iip_example1_k_resource[] = "/images/logo.png";
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_example1_rw_construct(mk_clib_app_iip_example1_pt const example1, mk_lib_iip_cp_client_wrapper_task_pt const wrp, mk_lib_iip_cp_client_types_handle_session_pt const session) mk_lang_noexcept
{
	...
	example1->m_http_resource_done = mk_lang_false;
	...
	err = mk_sl_io_writer_file_open_n(&example1->m_writer, "downloaded"); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_example1_rw_destroy(mk_clib_app_iip_example1_pt const example1) mk_lang_noexcept
{
	...
	err = mk_sl_io_writer_file_close(&example1->m_writer); mk_lang_check_rereturn(err);
	return 0;
}

mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_example1_rw_reset(mk_clib_app_iip_example1_pt const example1) mk_lang_noexcept
{
	mk_lib_iip_cp_client_wrapper_task_pt wrp;
	mk_lib_iip_cp_client_types_handle_session_pt session;
	mk_lang_types_sint_t err;

	mk_lang_assert(example1);

	wrp = example1->m_wrp;
	session = example1->m_session;
	err = mk_clib_app_iip_example1_rw_destroy(example1); mk_lang_check_rereturn(err);
	err = mk_clib_app_iip_example1_rw_construct(example1, wrp, session); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_example1_rw_on_idle_send_lookup_request(mk_clib_app_iip_example1_pt const example1) mk_lang_noexcept
{
	...
	mk_lang_types_slong_t elapsed_ms;
	mk_lang_types_sint_t err;
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_example1_prrw_print_address(mk_clib_app_iip_example1_pt const example1) mk_lang_noexcept
{
	...
	if(example1->m_request.m_result_code == 0)
	{
		...
		err = mk_lib_iip_buffer_rw_consolidate(&example1->m_request.m_destination); mk_lang_check_rereturn(err);
		mk_lib_crypto_hash_stream_sha2_256_init(&hasher);
		mk_lib_crypto_hash_stream_sha2_256_append_u8s(&hasher, mk_lib_iip_buffer_ro_get_data_a(&example1->m_request.m_destination), mk_lib_iip_buffer_ro_get_size(&example1->m_request.m_destination));
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_example1_rw_on_idle_process_address(mk_clib_app_iip_example1_pt const example1) mk_lang_noexcept
{
	...
	if(example1->m_lookup_request_sent && !example1->m_lookup_request_finished)
	{
		if(example1->m_request.m_done)
		{
			...
			if(example1->m_request.m_result_code == 0)
			{
				...
				err = mk_lib_iip_buffer_rw_consolidate(&example1->m_request.m_destination); mk_lang_check_rereturn(err);
				dst_data = mk_lib_iip_buffer_rw_get_data_a(&example1->m_request.m_destination); mk_lang_assert(dst_data);
				dst_sise = mk_lib_iip_buffer_rw_get_sise_a(&example1->m_request.m_destination); mk_lang_assert(dst_sise >= 1);
				gud = mk_lang_true;
				...
				err = mk_lib_iip_buffer_rw_reset(&example1->m_request.m_destination); mk_lang_check_rereturn(err);
			}
			else
			{
				example1->m_remote_address_has = mk_lang_false;
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_example1_rw_on_idle_connect(mk_clib_app_iip_example1_pt const example1) mk_lang_noexcept
{
	...
	if(example1->m_lookup_request_finished && !example1->m_connect_sent)
	{
		if(example1->m_remote_address_has)
		{
			example1->m_connect_sent = mk_lang_true;
			example1->m_connect_settings.m_session = *example1->m_session;
			example1->m_connect_settings.m_remote_destination = example1->m_remote_destination;
...
{
	mk_lang_types_sint_t err;
	mk_lang_types_bool_t connected;

	mk_lang_assert(example1);

	if(example1->m_connect_sent && !example1->m_connected)
	{
		err = mk_lib_iip_cp_client_wrapper_task_rw_is_connected(example1->m_wrp, &example1->m_connection, &connected); mk_lang_check_rereturn(err);
		example1->m_connected = connected;
	}
	return 0;
}
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_example1_rw_on_idle_send_http_req(mk_clib_app_iip_example1_pt const example1) mk_lang_noexcept
{
	...
	if(example1->m_connected && !example1->m_http_request_sent)
	{
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_example1_rw_on_idle_recv(mk_clib_app_iip_example1_pt const example1) mk_lang_noexcept
{
	...
	if(example1->m_http_request_sent && !example1->m_http_resource_done)
	{
		data_buf = &data_sto[0];
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_example1_rw_on_idle_save(mk_clib_app_iip_example1_pt const example1) mk_lang_noexcept
{
	mk_sl_cui_uint8_pt data_buf;
	mk_lang_types_sint_t data_len;
	mk_lang_types_sint_t err;
	...
	if(example1->m_http_request_sent && !example1->m_http_resource_done)
	{
		if(!mk_lib_iip_cp_dynamic_ring_u8_rw_is_empty(&example1->m_http_response.m_resource))
		{
			data_buf = mk_lib_iip_cp_dynamic_ring_u8_rw_get_data_a(&example1->m_http_response.m_resource); mk_lang_assert(data_buf);
			data_len = mk_lib_iip_cp_dynamic_ring_u8_rw_get_sise_a(&example1->m_http_response.m_resource); mk_lang_assert(data_len >= 1);
			err = mk_sl_io_writer_file_write(&example1->m_writer, data_buf, data_len, &written); mk_lang_check_rereturn(err);
			err = mk_lib_iip_cp_dynamic_ring_u8_rw_pop_front_many(&example1->m_http_response.m_resource, ((mk_lang_types_usize_t)(written))); mk_lang_check_rereturn(err);
		}
	}
	return 0;
}

mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_example1_ro_print_done(mk_clib_app_iip_example1_pct const example1) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_example1_rw_on_idle_close(mk_clib_app_iip_example1_pt const example1) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	if(example1->m_http_request_sent && !example1->m_http_resource_done)
	{
		if(example1->m_http_response.m_resource_done)
		{
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_example1_rw_on_idle(mk_clib_app_iip_example1_pt const example1) mk_lang_noexcept
{
	...
	err = mk_clib_app_iip_example1_rw_on_idle_send_http_req(example1); mk_lang_check_rereturn(err);
	err = mk_clib_app_iip_example1_rw_on_idle_recv(example1); mk_lang_check_rereturn(err);
	err = mk_clib_app_iip_example1_rw_on_idle_save(example1); mk_lang_check_rereturn(err);
	err = mk_clib_app_iip_example1_rw_on_idle_close(example1); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_work(mk_lang_types_sint_t const argc, mk_lang_tchar_pcpct const argv, mk_lang_types_sint_pct const lens) mk_lang_noexcept
{
	...
	err = mk_clib_app_iip_destination_elgamal_dsa_sha1_load_pri_pub(&session_settings_1.m_local_destination, "destination1.txt"); mk_lang_check_rereturn(err);
	err = mk_clib_app_iip_parse_settings_from_hardcoded(&connection_settings_2); mk_lang_check_rereturn(err);
	err = mk_clib_app_iip_destination_elgamal_dsa_sha1_load_pri_pub(&session_settings_2.m_local_destination, "destination2.txt"); mk_lang_check_rereturn(err);
	err = mk_clib_app_iip_destination_elgamal_dsa_sha1_load_pri_pub(&session_settings_3.m_local_destination, "destination3.txt"); mk_lang_check_rereturn(err);
	session_settings_3.m_local_destination.m_basic_buffer.m_enc_pri_key = session_settings_2.m_local_destination.m_basic_buffer.m_enc_pri_key;
	session_settings_3.m_local_destination.m_remote_destination.m_basic_buffer.m_enc_pub_key = session_settings_2.m_local_destination.m_remote_destination.m_basic_buffer.m_enc_pub_key;
