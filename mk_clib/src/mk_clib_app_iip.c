...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_task_connection_iip_cp_rw_step(mk_clib_app_iip_task_connection_iip_cp_pt const task, mk_lang_types_bool_t const allow_to_block, mk_clib_app_iip_step_result_pt const step_result) mk_lang_noexcept
{
	...
	switch(task->m_step)
	{
		case mk_clib_app_iip_task_connection_iip_cp_step_e_connect_request       : err = mk_clib_app_iip_task_connection_iip_cp_prrw_step_connect_request       (task, allow_to_block, step_result); mk_lang_check_rereturn(err); break;
		case mk_clib_app_iip_task_connection_iip_cp_step_e_connect_finish        : err = mk_clib_app_iip_task_connection_iip_cp_prrw_step_connect_finish        (task, allow_to_block, step_result); mk_lang_check_rereturn(err); break;
		case mk_clib_app_iip_task_connection_iip_cp_step_e_send_get_date_request : err = mk_clib_app_iip_task_connection_iip_cp_prrw_step_send_get_date_request (task, allow_to_block, step_result); mk_lang_check_rereturn(err); break;
		case mk_clib_app_iip_task_connection_iip_cp_step_e_send_get_date_finish  : err = mk_clib_app_iip_task_connection_iip_cp_prrw_step_send_get_date_finish  (task, allow_to_block, step_result); mk_lang_check_rereturn(err); break;
		case mk_clib_app_iip_task_connection_iip_cp_step_e_recv_set_date_request : err = mk_clib_app_iip_task_connection_iip_cp_prrw_step_recv_set_date_request (task, allow_to_block, step_result); mk_lang_check_rereturn(err); break;
		case mk_clib_app_iip_task_connection_iip_cp_step_e_recv_set_date_finish  : err = mk_clib_app_iip_task_connection_iip_cp_prrw_step_recv_set_date_finish  (task, allow_to_block, step_result); mk_lang_check_rereturn(err); break;
		case mk_clib_app_iip_task_connection_iip_cp_step_e_send_bandwidth_request: err = mk_clib_app_iip_task_connection_iip_cp_prrw_step_send_bandwidth_request(task, allow_to_block, step_result); mk_lang_check_rereturn(err); break;
		case mk_clib_app_iip_task_connection_iip_cp_step_e_send_bandwidth_finish : err = mk_clib_app_iip_task_connection_iip_cp_prrw_step_send_bandwidth_finish (task, allow_to_block, step_result); mk_lang_check_rereturn(err); break;
		case mk_clib_app_iip_task_connection_iip_cp_step_e_recv_bandwidth_request: err = mk_clib_app_iip_task_connection_iip_cp_prrw_step_recv_bandwidth_request(task, allow_to_block, step_result); mk_lang_check_rereturn(err); break;
		case mk_clib_app_iip_task_connection_iip_cp_step_e_recv_bandwidth_finish : err = mk_clib_app_iip_task_connection_iip_cp_prrw_step_recv_bandwidth_finish (task, allow_to_block, step_result); mk_lang_check_rereturn(err); break;
		case mk_clib_app_iip_task_connection_iip_cp_step_e_idle                  : err = mk_clib_app_iip_task_connection_iip_cp_prrw_step_idle                  (task, allow_to_block, step_result); mk_lang_check_rereturn(err); break;
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_pr_step_connect_request(mk_clib_app_iip_pt const app) mk_lang_noexcept
{
	...
	err = mk_lib_net_socket_construct(&app->m_connection.m_state.m_socket, mk_lib_net_address_family_e_ipv4, mk_lib_net_address_type_e_stream, mk_lib_net_address_protocol_e_tcp); mk_lang_check_rereturn(err);
	err = mk_lib_net_socket_set_option_nodelay_true(&app->m_connection.m_state.m_socket); mk_lang_check_rereturn(err);

	err = mk_lib_net_async_connect_construct(&app->m_connection.m_state.m_async_connect); mk_lang_check_rereturn(err);
	err = mk_lib_net_socket_associate_async_connect(&app->m_connection.m_state.m_socket, &app->m_connection.m_state.m_async_connect); mk_lang_check_rereturn(err);
	err = mk_lib_net_socket_connect(&app->m_connection.m_state.m_socket, &app->m_connection.m_settings.m_destination); mk_lang_check_rereturn(err);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_pr_step_connect_finish(mk_clib_app_iip_pt const app) mk_lang_noexcept
{
	...
	err = mk_lib_net_async_connect_wait_infinite(&app->m_connection.m_state.m_async_connect); mk_lang_check_rereturn(err);
	err = mk_lib_net_async_connect_get_result(&app->m_connection.m_state.m_async_connect, &st); mk_lang_check_rereturn(err); mk_lang_check_return(st == 0);
	err = mk_lib_net_async_connect_destroy(&app->m_connection.m_state.m_async_connect); mk_lang_check_rereturn(err);
	app->m_step = ((mk_clib_app_iip_step_t)(((mk_lang_types_sint_t)(app->m_step)) + 1));
	return 0;
}
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_pr_step_send_get_date_request(mk_clib_app_iip_pt const app) mk_lang_noexcept
{
	...
	tuc = 0x2a; mk_sl_cui_uint8_from_bi_uchar(&app->m_connection.m_state.m_store.m_data.m_u8s[0], &tuc);
	err = mk_lib_iip_cp_message_construct(&msg, mk_lib_iip_cp_message_message_type_id_e_get_date); mk_lang_check_rereturn(err);
	err = mk_lib_iip_cp_message_serialize_message(&app->m_connection.m_state.m_store.m_data.m_u8s[1], mk_lang_countof(app->m_connection.m_state.m_store.m_data.m_u8s) - 1, &serialize_error_code, &consumed, &msg); mk_lang_check_rereturn(err); mk_lang_check_return(serialize_error_code == mk_lib_iip_cp_message_serialize_error_code_e_ok); mk_lang_check_return(consumed >= 1);
	err = mk_clib_app_iip_debug_msg(&msg, mk_lang_false); mk_lang_check_rereturn(err);
	err = mk_lib_iip_cp_message_destroy(&msg); mk_lang_check_rereturn(err);

	err = mk_lib_net_write_request_construct(&app->m_connection.m_state.m_write_request, &app->m_connection.m_state.m_socket, &app->m_connection.m_state.m_store.m_data.m_u8s[0], 1 + consumed); mk_lang_check_rereturn(err);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_destroy(mk_clib_app_iip_pt const app) mk_lang_noexcept
{
	...
	err = mk_lib_net_write_request_destroy(&app->m_connection.m_state.m_write_request); mk_lang_check_rereturn(err);
	err = mk_lib_net_read_request_destroy(&app->m_connection.m_state.m_read_request); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_app_iip_work(mk_lang_types_sint_t const argc, mk_lang_tchar_pcpct const argv, mk_lang_types_sint_pct const lens) mk_lang_noexcept
{
	...
	err = mk_lib_net_ipv4_address_parse_pc(&app.m_connection.m_settings.m_destination.m_ipv4_address, address_buf, address_len, &gud, &consumed); mk_lang_check_rereturn(err); mk_lang_check_return(gud); mk_lang_assert(consumed >= 1 && consumed <= address_len); mk_lang_check_return(!mk_lib_net_ipv4_address_is_any(&app.m_connection.m_settings.m_destination.m_ipv4_address)); mk_lang_check_return(!mk_lib_net_ipv4_address_is_none(&app.m_connection.m_settings.m_destination.m_ipv4_address));
	err = mk_lib_net_tcp_port_parse_pc(&app.m_connection.m_settings.m_destination.m_tcp_port, port_buf, port_len, &gud, &consumed); mk_lang_check_rereturn(err); mk_lang_check_return(gud); mk_lang_assert(consumed >= 1 && consumed <= port_len); mk_lang_check_return(!mk_lib_net_tcp_port_is_zero(&app.m_connection.m_settings.m_destination.m_tcp_port)); mk_lang_check_return(!mk_lib_net_tcp_port_is_max(&app.m_connection.m_settings.m_destination.m_tcp_port));
