...
mk_lang_extern_force_c mk_lang_nodiscard mk_win_base_dll_import mk_win_base_ullong_t mk_win_base_stdcall GetTickCount64(mk_lang_types_void_t) mk_lang_noexcept;
...
mk_lang_extern_force_c mk_lang_nodiscard mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall QueryPerformanceFrequency(mk_win_base_large_integer_pt const frequency) mk_lang_noexcept;
mk_lang_extern_force_c mk_lang_nodiscard mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall QueryPerformanceCounter(mk_win_base_large_integer_pt const counter) mk_lang_noexcept;
...
mk_lang_nodiscard mk_lang_jumbo mk_win_base_ullong_t mk_win_dll_kernel_time_get_tick_count64(mk_lang_types_void_t) mk_lang_noexcept
{
	mk_win_base_ullong_t ret;
...
mk_lang_nodiscard mk_lang_jumbo mk_win_base_bool_t mk_win_dll_kernel_time_query_performance_frequency(mk_win_base_large_integer_pt const frequency) mk_lang_noexcept
{
	mk_win_base_bool_t ret;
...
mk_lang_nodiscard mk_lang_jumbo mk_win_base_bool_t mk_win_dll_kernel_time_query_performance_counter(mk_win_base_large_integer_pt const counter) mk_lang_noexcept
{
	mk_win_base_bool_t ret;
