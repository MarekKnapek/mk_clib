#ifndef mk_include_guard_mk_sl_io_reader_file_windows
#define mk_include_guard_mk_sl_io_reader_file_windows
...
typedef mk_sl_io_reader_file_windows_t const mk_sl_io_reader_file_windows_ct;
typedef mk_sl_io_reader_file_windows_t* mk_sl_io_reader_file_windows_pt;
typedef mk_sl_io_reader_file_windows_t* mk_lang_restrict mk_sl_io_reader_file_windows_prt;
typedef mk_sl_io_reader_file_windows_t const* mk_sl_io_reader_file_windows_pct;
typedef mk_sl_io_reader_file_windows_t const* mk_lang_restrict mk_sl_io_reader_file_windows_prct;
