...
#define mk_sl_io_writer_file_impl_open_n   mk_sl_io_writer_file_posix_open_n
#define mk_sl_io_writer_file_impl_open_w   mk_sl_io_writer_file_posix_open_w
#define mk_sl_io_writer_file_impl_write    mk_sl_io_writer_file_posix_write
#define mk_sl_io_writer_file_impl_close    mk_sl_io_writer_file_posix_close
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_sl_io_writer_file_open_t(mk_sl_io_writer_file_pt const writer, mk_lang_tchar_pct const name) mk_lang_noexcept
{
	...
	ret = mk_lang_concat(mk_sl_io_writer_file_impl_open_, mk_lang_tchar_suffix)(&writer->m_file_handle, name);
	return ret;
}
