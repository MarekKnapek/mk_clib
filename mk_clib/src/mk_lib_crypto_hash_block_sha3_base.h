...
typedef mk_lib_crypto_hash_block_sha3_base_aligned200_t mk_lib_crypto_hash_block_sha3_base_state_t;
typedef mk_lib_crypto_hash_block_sha3_base_state_t const mk_lib_crypto_hash_block_sha3_base_state_ct;
typedef mk_lib_crypto_hash_block_sha3_base_state_t* mk_lib_crypto_hash_block_sha3_base_state_pt;
typedef mk_lib_crypto_hash_block_sha3_base_state_t* mk_lang_restrict mk_lib_crypto_hash_block_sha3_base_state_prt;
typedef mk_lib_crypto_hash_block_sha3_base_state_t const* mk_lib_crypto_hash_block_sha3_base_state_pct;
typedef mk_lib_crypto_hash_block_sha3_base_state_t const* mk_lang_restrict mk_lib_crypto_hash_block_sha3_base_state_prct;
