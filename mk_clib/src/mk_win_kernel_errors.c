...
mk_lang_extern_c mk_win_base_dll_import mk_win_base_dword_t mk_win_base_stdcall GetLastError(void) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import void mk_win_base_stdcall SetLastError(mk_win_base_dword_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_uint_t mk_win_base_stdcall SetErrorMode(mk_win_base_uint_t) mk_lang_noexcept;
