#ifndef mk_include_guard_mk_lib_hash_crc32_portable_c
#define mk_include_guard_mk_lib_hash_crc32_portable_c
...
union mk_lib_hash_crc32_portable_table_data_u
{
	mk_sl_cui_uint32_t m_u32s[0xff + 1];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_hash_crc32_portable_table_data_u mk_lib_hash_crc32_portable_table_data_t;
struct mk_lib_hash_crc32_portable_table_s
{
	mk_lang_alignas(64) mk_lib_hash_crc32_portable_table_data_t m_data;
};
typedef struct mk_lib_hash_crc32_portable_table_s mk_lib_hash_crc32_portable_table_t;


mk_lang_constexpr_static_inline mk_lib_hash_crc32_portable_table_t const mk_lib_hash_crc32_portable_k_table =
{{{
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_hash_crc32_portable_init(mk_lib_hash_crc32_portable_pt const crc32) mk_lang_noexcept
{
	...
	mk_sl_cui_uint32_set_zero(&crc32->m_state);
}
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_hash_crc32_portable_append(mk_lib_hash_crc32_portable_pt const crc32, mk_sl_cui_uint8_pct const data_buf, mk_lang_types_usize_t const data_len) mk_lang_noexcept
{
	...
	buf = data_buf;
	len = data_len;
	mk_sl_cui_uint32_not1(&crc32->m_state);
	n = len;
	for(i = 0; i != n; ++i)
	{
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_hash_crc32_portable_finish(mk_lib_hash_crc32_portable_pt const crc32, mk_lib_hash_crc32_portable_digest_pt const digest) mk_lang_noexcept
{
	...
	mk_sl_uint_convert_32_8_le_to_sml(&crc32->m_state, &digest->m_data.m_uint8s[0]);
}
