...
#include "mk_lib_crypto_xof_kt128_fuzz.hpp"
...
#include "mk_lib_float_analyzer_b64_fuzz.h"
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_fuzz_process_ctx(mk_clib_fuzz_ctx_pt const ctx) mk_lang_noexcept
{
	...
	if(ctx && ctx->m_argc == 2 && ctx->m_line == -1)
	{
		...
		else if(line == 0 && mk_lang_str_match_n(ctx->m_argv[1], len, mk_clib_fuzz_str_lit("mk_lib_crypto_xof_kt128_fuzz"))){ line = __LINE__; }
		else if(line == 0 && mk_lang_str_match_n(ctx->m_argv[1], len, mk_clib_fuzz_str_lit("mk_lib_crypto_xof_kt256_fuzz"))){ line = __LINE__; }
		...
		else if(line == 0 && mk_lang_str_match_n(ctx->m_argv[1], len, mk_clib_fuzz_str_lit("mk_lib_float_analyzer_b32_fuzz"))){ line = __LINE__; }
		else if(line == 0 && mk_lang_str_match_n(ctx->m_argv[1], len, mk_clib_fuzz_str_lit("mk_lib_float_analyzer_b64_fuzz"))){ line = __LINE__; }
		else if(line == 0 && mk_lang_str_match_n(ctx->m_argv[1], len, mk_clib_fuzz_str_lit("mk_lib_hash_crc32_fuzz"))){ line = __LINE__; }
		...
		else if(line == 0 && mk_lang_str_match_n(ctx->m_argv[1], len, mk_clib_fuzz_str_lit("mk_lib_iip_cp_destination_fuzz"))){ line = __LINE__; }
		else if(line == 0 && mk_lang_str_match_n(ctx->m_argv[1], len, mk_clib_fuzz_str_lit("mk_lib_iip_key_sgn_dsa_sha1_fuzz"))){ line = __LINE__; }
		else if(line == 0 && mk_lang_str_match_n(ctx->m_argv[1], len, mk_clib_fuzz_str_lit("mk_lib_iip_time_fuzz"))){ line = __LINE__; }
		else if(line == 0 && mk_lang_str_match_n(ctx->m_argv[1], len, mk_clib_fuzz_str_lit("mk_sl_cui_fuzz"))){ line = __LINE__; }
		else if(line == 0 && mk_lang_str_match_n(ctx->m_argv[1], len, mk_clib_fuzz_str_lit("mk_sl_sort_merge_fuzz"))){ line = __LINE__; }
		else if(line == 0 && mk_lang_str_match_n(ctx->m_argv[1], len, mk_clib_fuzz_str_lit("mk_sl_time_fuzz"))){ line = __LINE__; }
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_clib_fuzz_fn(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size, mk_lang_types_bool_t const allow_all, mk_clib_fuzz_ctx_pt const ctx) mk_lang_noexcept
{
	...
	if(all || curr == ((mk_lang_types_uint_t)(__LINE__))){ err = mk_lib_crypto_xof_kt128_fuzz(d, s); mk_lang_check_rereturn(err); }
	if(all || curr == ((mk_lang_types_uint_t)(__LINE__))){ err = mk_lib_crypto_xof_kt256_fuzz(d, s); mk_lang_check_rereturn(err); }
	...
	if(all || curr == ((mk_lang_types_uint_t)(__LINE__))){ err = mk_lib_float_analyzer_b32_fuzz(d, s); mk_lang_check_rereturn(err); }
	if(all || curr == ((mk_lang_types_uint_t)(__LINE__))){ err = mk_lib_float_analyzer_b64_fuzz(d, s); mk_lang_check_rereturn(err); }
	if(all || curr == ((mk_lang_types_uint_t)(__LINE__))){ err = mk_lib_hash_crc32_fuzz(d, s); mk_lang_check_rereturn(err); }
	...
	if(all || curr == ((mk_lang_types_uint_t)(__LINE__))){ err = mk_lib_iip_cp_destination_fuzz(d, s); mk_lang_check_rereturn(err); }
	if(all || curr == ((mk_lang_types_uint_t)(__LINE__))){ err = mk_lib_iip_key_sgn_dsa_sha1_fuzz(d, s); mk_lang_check_rereturn(err); }
	if(all || curr == ((mk_lang_types_uint_t)(__LINE__))){ err = mk_lib_iip_time_fuzz(d, s); mk_lang_check_rereturn(err); }
	if(all || curr == ((mk_lang_types_uint_t)(__LINE__))){ err = mk_sl_cui_fuzz(d, s, allow_all); mk_lang_check_rereturn(err); }
	if(all || curr == ((mk_lang_types_uint_t)(__LINE__))){ err = mk_sl_sort_merge_fuzz(d, s); mk_lang_check_rereturn(err); }
	if(all || curr == ((mk_lang_types_uint_t)(__LINE__))){ err = mk_sl_time_fuzz(d, s); mk_lang_check_rereturn(err); }
