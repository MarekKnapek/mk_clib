...
#define mk_lib_crypto_hash_block_sha2_base_32bit_test_ct ((mk_lang_msvc_ver >= mk_lang_msvc_ver_2015 || mk_lang_compiler_is_at_least_gcc(11, 1)) && (mk_lang_arch_is_x8632 || mk_lang_arch_is_x8664))
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_init(mk_lib_crypto_hash_block_sha2_base_32bit_pt const sha2_base_32bit, mk_lang_static_param(mk_sl_cui_uint32_ct, iv, 8)) mk_lang_noexcept
{
	...
	{
		mk_lang_static_assert(sizeof(mk_lib_crypto_hash_block_sha2_base_32bit_t) == sizeof(mk_lib_crypto_hash_block_sha2_base_32bit_portable_t));
		mk_lang_static_assert(mk_lang_alignof(mk_lib_crypto_hash_block_sha2_base_32bit_t) == mk_lang_alignof(mk_lib_crypto_hash_block_sha2_base_32bit_portable_t));
		mk_lang_static_assert(sizeof(sha2_base_32bit->m_state) == sizeof(((mk_lib_crypto_hash_block_sha2_base_32bit_portable_pt)(mk_lang_null))->m_state));
		mk_lang_static_assert(sizeof(sha2_base_32bit->m_len) == sizeof(((mk_lib_crypto_hash_block_sha2_base_32bit_portable_pt)(mk_lang_null))->m_len));
		mk_lang_static_assert(mk_lang_offsetof(mk_lib_crypto_hash_block_sha2_base_32bit_t, m_state) == mk_lang_offsetof(mk_lib_crypto_hash_block_sha2_base_32bit_portable_t, m_state));
		mk_lang_static_assert(mk_lang_offsetof(mk_lib_crypto_hash_block_sha2_base_32bit_t, m_len) == mk_lang_offsetof(mk_lib_crypto_hash_block_sha2_base_32bit_portable_t, m_len));
		mk_lib_crypto_hash_block_sha2_base_32bit_portable_init(((mk_lib_crypto_hash_block_sha2_base_32bit_portable_pt)(sha2_base_32bit)), iv);
	}
	else
	{
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_append_blocks(mk_lib_crypto_hash_block_sha2_base_32bit_pt const sha2_base_32bit, mk_lib_crypto_hash_block_sha2_base_32bit_block_pct const pblocks, mk_lang_types_usize_t const nblocks) mk_lang_noexcept
{
	...
	#include "mk_lang_warning_msvc_pop.h"
	{
		...
		mk_lang_static_assert(mk_lang_offsetof(mk_lib_crypto_hash_block_sha2_base_32bit_t, m_state) == mk_lang_offsetof(mk_lib_crypto_hash_block_sha2_base_32bit_portable_t, m_state));
		mk_lang_static_assert(mk_lang_offsetof(mk_lib_crypto_hash_block_sha2_base_32bit_t, m_len) == mk_lang_offsetof(mk_lib_crypto_hash_block_sha2_base_32bit_portable_t, m_len));
		mk_lib_crypto_hash_block_sha2_base_32bit_portable_append_blocks(((mk_lib_crypto_hash_block_sha2_base_32bit_portable_pt)(sha2_base_32bit)), ((mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_pct)(pblocks)), nblocks);
	}
	else
	{
		#include "mk_lang_warning_clang_push_unreachable_code.h"
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_32bit_finish(mk_lib_crypto_hash_block_sha2_base_32bit_pt const sha2_base_32bit, mk_lib_crypto_hash_block_sha2_base_32bit_block_pt const block, mk_lang_types_sint_t const idx, mk_lib_crypto_hash_block_sha2_base_32bit_digest_pt const digest) mk_lang_noexcept
{
	...
	#include "mk_lang_warning_msvc_pop.h"
	{
		...
		mk_lang_static_assert(mk_lang_offsetof(mk_lib_crypto_hash_block_sha2_base_32bit_t, m_state) == mk_lang_offsetof(mk_lib_crypto_hash_block_sha2_base_32bit_portable_t, m_state));
		mk_lang_static_assert(mk_lang_offsetof(mk_lib_crypto_hash_block_sha2_base_32bit_t, m_len) == mk_lang_offsetof(mk_lib_crypto_hash_block_sha2_base_32bit_portable_t, m_len));
		mk_lib_crypto_hash_block_sha2_base_32bit_portable_finish(((mk_lib_crypto_hash_block_sha2_base_32bit_portable_pt)(sha2_base_32bit)), ((mk_lib_crypto_hash_block_sha2_base_32bit_portable_block_pt)(block)), idx, ((mk_lib_crypto_hash_block_sha2_base_32bit_portable_digest_pt)(digest)));
	}
	else
	{
		#include "mk_lang_warning_clang_push_unreachable_code.h"
