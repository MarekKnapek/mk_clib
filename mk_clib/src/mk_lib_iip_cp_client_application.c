...
mk_lang_constexpr_static_inline mk_lang_types_pchar_t const mk_lib_iip_cp_client_application_task_prrw_log_start_k_msg[] = "Start.";
mk_lang_constexpr_static_inline mk_lang_types_pchar_t const mk_lib_iip_cp_client_application_task_prrw_log_stop_k_msg[] = "Stop.";
#endif

mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_prrw_log_start(mk_lib_iip_cp_client_application_task_pt const task) mk_lang_noexcept
{
#if mk_lib_iip_cp_client_application_debug_print_have
	...
	msg_buf = &mk_lib_iip_cp_client_application_task_prrw_log_start_k_msg[0];
	msg_len = mk_lang_countstr(mk_lib_iip_cp_client_application_task_prrw_log_start_k_msg);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_prrw_log_stop(mk_lib_iip_cp_client_application_task_pt const task) mk_lang_noexcept
{
#if mk_lib_iip_cp_client_application_debug_print_have
	mk_lang_types_pchar_pct msg_buf;
	mk_lang_types_sint_t msg_len;
	...
	msg_buf = &mk_lib_iip_cp_client_application_task_prrw_log_stop_k_msg[0];
	msg_len = mk_lang_countstr(mk_lib_iip_cp_client_application_task_prrw_log_stop_k_msg);
	logger = &task->m_application.m_state.m_shared.m_logger;
	err = mk_lib_iip_logger_rw_begin_line(logger); mk_lang_check_rereturn(err);
	err = mk_lib_iip_logger_rw_append_current_time(logger); mk_lang_check_rereturn(err);
	err = mk_lib_iip_logger_rw_print(logger, msg_buf, msg_len); mk_lang_check_rereturn(err);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_prrw_construct(mk_lib_iip_cp_client_application_task_pt const task, mk_lib_iip_cp_client_application_settings_pct const settings) mk_lang_noexcept
{
	...
	err = mk_lib_iip_cp_client_application_task_prrw_log_start(task); mk_lang_check_rereturn(err);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_prrw_destroy(mk_lib_iip_cp_client_application_task_pt const task) mk_lang_noexcept
{
	...
	err = mk_lib_iip_cp_client_application_task_prrw_log_stop(task); mk_lang_check_rereturn(err);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_prrw_log(mk_lib_iip_cp_client_application_task_pt const task, mk_lang_types_pchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	mk_lib_iip_logger_pt logger;
	mk_lang_types_sint_t err;
	...
	err = mk_lib_iip_logger_rw_begin_line(logger); mk_lang_check_rereturn(err);
	err = mk_lib_iip_logger_rw_append_current_time(logger); mk_lang_check_rereturn(err);
	err = mk_lib_iip_logger_rw_print(logger, str_buf, str_len); mk_lang_check_rereturn(err);
	err = mk_lib_iip_logger_rw_end_line(logger); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_prrw_new_local(mk_lib_iip_cp_client_application_task_pt const task, mk_lib_iip_cp_client_local_listener_task_settings_pct const settings, mk_lib_iip_any_data_connection_ppt const local) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	err = mk_lib_iip_cp_client_iocp_task_rw_new_local_listener(&task->m_application.m_state.m_iocp, settings, local); mk_lang_check_rereturn(err);
	return 0;
}

mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_prrw_new_connection(mk_lib_iip_cp_client_application_task_pt const task, mk_lib_iip_cp_client_connection_task_settings_pct const settings, mk_lib_iip_any_data_connection_ppt const connection) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_rw_log(mk_lib_iip_cp_client_application_task_pt const task, mk_lang_types_pchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	return mk_lib_iip_cp_client_application_task_prrw_log(task, str_buf, str_len);
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_rw_new_local_listener(mk_lib_iip_cp_client_application_task_pt const task, mk_lib_iip_cp_client_local_listener_task_settings_pct const settings, mk_lib_iip_any_data_connection_ppt const local) mk_lang_noexcept
{
	return mk_lib_iip_cp_client_application_task_prrw_new_local(task, settings, local);
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_rw_new_connection(mk_lib_iip_cp_client_application_task_pt const task, mk_lib_iip_cp_client_connection_task_settings_pct const settings, mk_lib_iip_any_data_connection_ppt const connection) mk_lang_noexcept
{
