...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_prrw_new_local(mk_lib_iip_cp_client_application_task_pt const task, mk_lib_iip_cp_client_local_listener_task_settings_pct const settings, mk_lib_net_connection_any2_ppt const local) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_prrw_new_connection(mk_lib_iip_cp_client_application_task_pt const task, mk_lib_iip_cp_client_connection_task_settings_pct const settings, mk_lib_net_connection_any2_ppt const connection) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_rw_new_local_listener(mk_lib_iip_cp_client_application_task_pt const task, mk_lib_iip_cp_client_local_listener_task_settings_pct const settings, mk_lib_net_connection_any2_ppt const local) mk_lang_noexcept
{
	return mk_lib_iip_cp_client_application_task_prrw_new_local(task, settings, local);
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_rw_new_connection(mk_lib_iip_cp_client_application_task_pt const task, mk_lib_iip_cp_client_connection_task_settings_pct const settings, mk_lib_net_connection_any2_ppt const connection) mk_lang_noexcept
{
