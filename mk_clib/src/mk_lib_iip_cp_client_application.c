...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_prrw_new_local(mk_lib_iip_cp_client_application_task_pt const task, mk_lib_iip_cp_client_local_task_settings_pct const settings, mk_lib_net_connection_any2_ppt const local) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	err = mk_lib_iip_cp_client_iocp_task_rw_new_local(&task->m_application.m_state.m_iocp, settings, local); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_iip_cp_client_application_task_rw_new_local(mk_lib_iip_cp_client_application_task_pt const task, mk_lib_iip_cp_client_local_task_settings_pct const settings, mk_lib_net_connection_any2_ppt const local) mk_lang_noexcept
{
