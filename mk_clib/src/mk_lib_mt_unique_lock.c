...
#define mk_lib_mt_unique_lock_exclusive_impl_construct mk_lib_mt_unique_lock_exclusive_windows_woa_construct
#define mk_lib_mt_unique_lock_exclusive_impl_destruct  mk_lib_mt_unique_lock_exclusive_windows_woa_destruct
#define mk_lib_mt_unique_lock_shared_impl_construct    mk_lib_mt_unique_lock_shared_windows_woa_construct
#define mk_lib_mt_unique_lock_shared_impl_destruct     mk_lib_mt_unique_lock_shared_windows_woa_destruct
