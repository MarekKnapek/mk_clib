...
enum class mk_sl_fixed_vector_inl_defd_capacity_e : mk_lang_types_usize_t { mk_sl_fixed_vector_inl_defd_capacity_v = mk_sl_fixed_vector_inl_defd_capacity }; typedef enum mk_sl_fixed_vector_inl_defd_capacity_e mk_sl_fixed_vector_inl_defd_capacity_t;
#elif mk_lang_version_at_least_c_23
enum mk_sl_fixed_vector_inl_defd_capacity_e : mk_lang_types_usize_t { mk_sl_fixed_vector_inl_defd_capacity_v = mk_sl_fixed_vector_inl_defd_capacity }; typedef enum mk_sl_fixed_vector_inl_defd_capacity_e mk_sl_fixed_vector_inl_defd_capacity_t;
#else
#include "mk_lang_warning_msvc_push_c4309.h"
enum mk_sl_fixed_vector_inl_defd_capacity_e { mk_sl_fixed_vector_inl_defd_capacity_v = mk_sl_fixed_vector_inl_defd_capacity }; typedef enum mk_sl_fixed_vector_inl_defd_capacity_e mk_sl_fixed_vector_inl_defd_capacity_t;
