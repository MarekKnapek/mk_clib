...
mk_lang_extern_c mk_win_base_dll_import mk_win_base_sintptr_t mk_win_base_stdcall DialogBoxIndirectParamA(mk_win_base_instance_t, mk_win_user_dialog_dlg_template_lpct, mk_win_user_window_t, mk_win_user_dialog_dlgproc_t, mk_win_user_window_lparam_t) mk_lang_noexcept;
...
mk_lang_extern_c mk_win_base_dll_import mk_win_base_sintptr_t mk_win_base_stdcall DialogBoxIndirectParamW(mk_win_base_instance_t, mk_win_user_dialog_dlg_template_lpct, mk_win_user_window_t, mk_win_user_dialog_dlgproc_t, mk_win_user_window_lparam_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import int mk_win_base_stdcall MessageBoxW(mk_win_user_window_t, mk_win_base_wchar_lpct, mk_win_base_wchar_lpct, mk_win_base_uint_t) mk_lang_noexcept;

mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall EndDialog(mk_win_user_window_t, mk_win_base_sintptr_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_user_window_t mk_win_base_stdcall GetDlgItem(mk_win_user_window_t, int) mk_lang_noexcept;
