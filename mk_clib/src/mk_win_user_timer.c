...
mk_lang_extern_c mk_win_base_dll_import mk_win_base_uintptr_t mk_win_base_stdcall SetTimer(mk_win_user_window_t, mk_win_base_uintptr_t, mk_win_base_uint_t, mk_win_user_timer_proc_t) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall KillTimer(mk_win_user_window_t, mk_win_base_uintptr_t) mk_lang_noexcept;
