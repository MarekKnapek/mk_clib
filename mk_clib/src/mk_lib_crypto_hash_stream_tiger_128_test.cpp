#ifndef mk_include_guard_mk_lib_crypto_hash_stream_tiger_128_test_cpp
#define mk_include_guard_mk_lib_crypto_hash_stream_tiger_128_test_cpp
...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_hash_stream_tiger_128_test_compute_from_str_lit(mk_lang_types_pchar_t const(&str_lit)[str_lit_len]) mk_lang_noexcept
{
	...
	mk_lib_crypto_hash_stream_tiger_128_digest_t digest mk_lang_constexpr_init;
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, mk_lib_crypto_hash_stream_tiger_128_digest_len_v> ret mk_lang_constexpr_init;
	...
	mk_lib_crypto_hash_stream_tiger_128_append_u8s(&tiger_128, msg.data(), msg.size());
...
mk_lang_extern_force_c mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_stream_tiger_128_test(mk_lang_types_void_t) mk_lang_noexcept
{
	#define message_1 ""
	...
	for(i = 0; i != n; ++i)
	{
		...
		mk_lib_crypto_hash_stream_tiger_128_init(&tiger_128);
		mk_lib_crypto_hash_stream_tiger_128_append_u8s(&tiger_128, ((mk_sl_cui_uint8_pct)(messages[i])), ((mk_lang_types_usize_t)(message_lens[i])));
		mk_lib_crypto_hash_stream_tiger_128_finish(&tiger_128, &digest);
		for(j = 0; j != mk_lib_crypto_hash_stream_tiger_128_digest_len_v; ++j)
		{
