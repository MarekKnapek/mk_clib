#ifndef mk_include_guard_mk_lib_crypto_alg_aes_portable_base_h
#define mk_include_guard_mk_lib_crypto_alg_aes_portable_base_h
...
#define mk_lib_crypto_alg_aes_portable_base_msg_words_d (mk_lib_crypto_alg_aes_portable_base_msg_bits / mk_lib_crypto_alg_aes_portable_base_word_bits)
#define mk_lib_crypto_alg_aes_portable_base_msg_len_d (mk_lib_crypto_alg_aes_portable_base_msg_bits / mk_lang_charbit)
enum mk_lib_crypto_alg_aes_portable_base_msg_len_e{ mk_lib_crypto_alg_aes_portable_base_msg_len_v = mk_lib_crypto_alg_aes_portable_base_msg_len_d };
enum mk_lib_crypto_alg_aes_portable_base_msg_words_e{ mk_lib_crypto_alg_aes_portable_base_msg_words_v = mk_lib_crypto_alg_aes_portable_base_msg_words_d }; typedef enum mk_lib_crypto_alg_aes_portable_base_msg_words_e mk_lib_crypto_alg_aes_portable_base_msg_words_t;
...
mk_lang_typedef(mk_lib_crypto_alg_aes_portable_base_msg);

union mk_lib_crypto_alg_aes_portable_base_word_data_u
{
	mk_lang_alignas(mk_lib_crypto_alg_aes_portable_base_word_bytes) mk_sl_cui_uint8_t m_uint8s[mk_lib_crypto_alg_aes_portable_base_word_bytes];
...
mk_lang_typedef(mk_lib_crypto_alg_aes_portable_base_word);
