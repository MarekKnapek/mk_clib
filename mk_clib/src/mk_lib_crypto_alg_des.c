...
union mk_lib_crypto_alg_des_table_32_data_u
{
	mk_sl_cui_uint8_t m_uint8s[32];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_alg_des_table_32_data_u mk_lib_crypto_alg_des_table_32_data_t;

struct mk_lib_crypto_alg_des_table_32_s
{
	mk_lib_crypto_alg_des_table_32_data_t m_data;
};
typedef struct mk_lib_crypto_alg_des_table_32_s mk_lib_crypto_alg_des_table_32_t;
typedef mk_lib_crypto_alg_des_table_32_t const* mk_lib_crypto_alg_des_table_32_pct;


union mk_lib_crypto_alg_des_table_48_data_u
{
	mk_sl_cui_uint8_t m_uint8s[48];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_alg_des_table_48_data_u mk_lib_crypto_alg_des_table_48_data_t;

struct mk_lib_crypto_alg_des_table_48_s
{
	mk_lib_crypto_alg_des_table_48_data_t m_data;
};
typedef struct mk_lib_crypto_alg_des_table_48_s mk_lib_crypto_alg_des_table_48_t;
typedef mk_lib_crypto_alg_des_table_48_t const* mk_lib_crypto_alg_des_table_48_pct;


union mk_lib_crypto_alg_des_table_56_data_u
{
	mk_sl_cui_uint8_t m_uint8s[56];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_alg_des_table_56_data_u mk_lib_crypto_alg_des_table_56_data_t;

struct mk_lib_crypto_alg_des_table_56_s
{
	mk_lib_crypto_alg_des_table_56_data_t m_data;
};
typedef struct mk_lib_crypto_alg_des_table_56_s mk_lib_crypto_alg_des_table_56_t;
typedef mk_lib_crypto_alg_des_table_56_t const* mk_lib_crypto_alg_des_table_56_pct;


union mk_lib_crypto_alg_des_table_64_data_u
{
	mk_sl_cui_uint8_t m_uint8s[64];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_alg_des_table_64_data_u mk_lib_crypto_alg_des_table_64_data_t;

struct mk_lib_crypto_alg_des_table_64_s
{
	mk_lib_crypto_alg_des_table_64_data_t m_data;
};
typedef struct mk_lib_crypto_alg_des_table_64_s mk_lib_crypto_alg_des_table_64_t;
typedef mk_lib_crypto_alg_des_table_64_t const* mk_lib_crypto_alg_des_table_64_pct;


mk_lang_constexpr_static_inline mk_lib_crypto_alg_des_table_56_t const s_mk_lib_crypto_alg_des_pc1 =
{{{
...
mk_lang_constexpr_static_inline mk_lib_crypto_alg_des_table_48_t const s_mk_lib_crypto_alg_des_pc2 =
{{{
...
mk_lang_constexpr_static_inline mk_lib_crypto_alg_des_table_64_t const s_mk_lib_crypto_alg_des_ip =
{{{
...
mk_lang_constexpr_static_inline mk_lib_crypto_alg_des_table_64_t const s_mk_lib_crypto_alg_des_pi =
{{{
...
mk_lang_constexpr_static_inline mk_lib_crypto_alg_des_table_48_t const s_mk_lib_crypto_alg_des_e =
{{{
...
mk_lang_constexpr_static_inline mk_lib_crypto_alg_des_table_32_t const s_mk_lib_crypto_alg_des_p =
{{{
...
mk_lang_constexpr_static_inline mk_lib_crypto_alg_des_table_64_t const s_mk_lib_crypto_alg_des_ss[8] =
{
	{{{
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_bool_t mk_lib_crypto_alg_des_is_28_bit(mk_sl_cui_uint32_pct const x) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_bool_t mk_lib_crypto_alg_des_is_48_bit(mk_sl_cui_uint64_pct const x) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_bool_t mk_lib_crypto_alg_des_is_56_bit(mk_sl_cui_uint64_pct const x) mk_lang_noexcept
{
	mk_sl_cui_uint64_t ta mk_lang_constexpr_init;
	mk_lang_types_bool_t ret mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_u64_to_u32(mk_sl_cui_uint64_pct const u64, mk_sl_cui_uint32_pt const u32) mk_lang_noexcept
{
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_u32_to_u64(mk_sl_cui_uint32_pct const u32, mk_sl_cui_uint64_pt const u64) mk_lang_noexcept
{
	mk_lang_types_ulong_t tul mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_perm_32_to_32(mk_lib_crypto_alg_des_table_32_pct const table, mk_sl_cui_uint32_pct const a, mk_sl_cui_uint32_pt const b) mk_lang_noexcept
{
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_perm_32_to_48(mk_lib_crypto_alg_des_table_48_pct const table, mk_sl_cui_uint32_pct const a, mk_sl_cui_uint64_pt const b) mk_lang_noexcept
{
	mk_sl_cui_uint32_t one mk_lang_constexpr_init;
	mk_sl_cui_uint32_t aa mk_lang_constexpr_init;
	mk_lang_types_sint_t idx mk_lang_constexpr_init;
	...
	mk_sl_cui_uint32_shr3(&aa, bit, &ta);
	mk_sl_cui_uint32_and2(&ta, &one);
	mk_lib_crypto_alg_des_u32_to_u64(&ta, &bb);
	for(i = 1; i != 48; ++i)
	{
		...
		mk_sl_cui_uint32_shr3(&aa, bit, &ta);
		mk_sl_cui_uint32_and2(&ta, &one);
		mk_lib_crypto_alg_des_u32_to_u64(&ta, &tb);
		mk_sl_cui_uint64_or2(&bb, &tb);
	}
	mk_lang_assert(mk_lib_crypto_alg_des_is_48_bit(&bb));
	*b = bb;
}

mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_perm_56_to_48(mk_lib_crypto_alg_des_table_48_pct const table, mk_sl_cui_uint64_pct const a, mk_sl_cui_uint64_pt const b) mk_lang_noexcept
{
	...
	mk_lang_assert(a);
	mk_lang_assert(b);
	mk_lang_assert(mk_lib_crypto_alg_des_is_56_bit(a));
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_perm_64_to_56(mk_lib_crypto_alg_des_table_56_pct const table, mk_sl_cui_uint64_pct const a, mk_sl_cui_uint64_pt const b) mk_lang_noexcept
{
	mk_sl_cui_uint64_t one mk_lang_constexpr_init;
	mk_sl_cui_uint64_t aa mk_lang_constexpr_init;
	mk_lang_types_sint_t idx mk_lang_constexpr_init;
	...
	mk_lang_assert(mk_lib_crypto_alg_des_is_56_bit(&bb));
	*b = bb;
}

mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_perm_64_to_64(mk_lib_crypto_alg_des_table_64_pct const table, mk_sl_cui_uint64_pct const a, mk_sl_cui_uint64_pt const b) mk_lang_noexcept
{
	mk_sl_cui_uint64_t one mk_lang_constexpr_init;
	mk_sl_cui_uint64_t aa mk_lang_constexpr_init;
	mk_lang_types_sint_t idx mk_lang_constexpr_init;
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_pc1(mk_sl_cui_uint64_pct const a, mk_sl_cui_uint64_pt const b) mk_lang_noexcept
{
	mk_lang_static_assert(mk_lang_countof(s_mk_lib_crypto_alg_des_pc1.m_data.m_uint8s) == 56);

	mk_lang_assert(a);
	mk_lang_assert(b);

	mk_lib_crypto_alg_des_perm_64_to_56(&s_mk_lib_crypto_alg_des_pc1, a, b);
}

mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_pc2(mk_sl_cui_uint64_pct const a, mk_sl_cui_uint64_pt const b) mk_lang_noexcept
{
	mk_lang_static_assert(mk_lang_countof(s_mk_lib_crypto_alg_des_pc2.m_data.m_uint8s) == 48);

	mk_lang_assert(a);
	mk_lang_assert(b);

	mk_lib_crypto_alg_des_perm_56_to_48(&s_mk_lib_crypto_alg_des_pc2, a, b);
}

mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_ip(mk_sl_cui_uint64_pct const a, mk_sl_cui_uint64_pt const b) mk_lang_noexcept
{
	mk_lang_static_assert(mk_lang_countof(s_mk_lib_crypto_alg_des_ip.m_data.m_uint8s) == 64);

	mk_lang_assert(a);
	mk_lang_assert(b);

	mk_lib_crypto_alg_des_perm_64_to_64(&s_mk_lib_crypto_alg_des_ip, a, b);
}

mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_pi(mk_sl_cui_uint64_pct const a, mk_sl_cui_uint64_pt const b) mk_lang_noexcept
{
	mk_lang_static_assert(mk_lang_countof(s_mk_lib_crypto_alg_des_pi.m_data.m_uint8s) == 64);

	mk_lang_assert(a);
	mk_lang_assert(b);

	mk_lib_crypto_alg_des_perm_64_to_64(&s_mk_lib_crypto_alg_des_pi, a, b);
}

mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_e(mk_sl_cui_uint32_pct const a, mk_sl_cui_uint64_pt const b) mk_lang_noexcept
{
	mk_lang_static_assert(mk_lang_countof(s_mk_lib_crypto_alg_des_e.m_data.m_uint8s) == 48);

	mk_lang_assert(a);
	mk_lang_assert(b);

	mk_lib_crypto_alg_des_perm_32_to_48(&s_mk_lib_crypto_alg_des_e, a, b);
}

mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_p(mk_sl_cui_uint32_pct const a, mk_sl_cui_uint32_pt const b) mk_lang_noexcept
{
	mk_lang_assert(a);
	mk_lang_assert(a);

	mk_lang_static_assert(mk_lang_countof(s_mk_lib_crypto_alg_des_p.m_data.m_uint8s) == 32);

	mk_lib_crypto_alg_des_perm_32_to_32(&s_mk_lib_crypto_alg_des_p, a, b);
}

mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_get_lr(mk_sl_cui_uint64_pct const lr, mk_sl_cui_uint32_prt const l, mk_sl_cui_uint32_prt const r) mk_lang_noexcept
{
	...
	rr = lrlr;
	mk_lib_crypto_alg_des_u64_to_u32(&ll, &lll);
	mk_lib_crypto_alg_des_u64_to_u32(&rr, &rrr);
	*l = lll;
	*r = rrr;
}

mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_set_lr(mk_sl_cui_uint64_pt const lr, mk_sl_cui_uint32_prct const l, mk_sl_cui_uint32_prct const r) mk_lang_noexcept
{
	mk_sl_cui_uint64_t ll mk_lang_constexpr_init;
	mk_sl_cui_uint64_t rr mk_lang_constexpr_init;
	...
	mk_lib_crypto_alg_des_u32_to_u64(l, &ll);
	mk_lib_crypto_alg_des_u32_to_u64(r, &rr);
	mk_sl_cui_uint64_shl2(&ll, 32);
	mk_sl_cui_uint64_or3(&ll, &rr, lr);
}

mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_get_cd(mk_sl_cui_uint64_pct const key, mk_sl_cui_uint32_prt const c, mk_sl_cui_uint32_prt const d) mk_lang_noexcept
{
	...
	dd = k;
	mk_lib_crypto_alg_des_u64_to_u32(&cc, &ccc);
	mk_lib_crypto_alg_des_u64_to_u32(&dd, &ddd);
	mk_sl_cui_uint32_set_mask(&mask, 28);
	mk_sl_cui_uint32_and2(&ccc, &mask);
	mk_sl_cui_uint32_and2(&ddd, &mask);
	mk_lang_assert(mk_lib_crypto_alg_des_is_28_bit(&ccc));
	mk_lang_assert(mk_lib_crypto_alg_des_is_28_bit(&ddd));
	*c = ccc;
	*d = ddd;
}

mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_set_cd(mk_sl_cui_uint64_pt const key, mk_sl_cui_uint32_prct const c, mk_sl_cui_uint32_prct const d) mk_lang_noexcept
{
	mk_sl_cui_uint64_t cc mk_lang_constexpr_init;
	mk_sl_cui_uint64_t dd mk_lang_constexpr_init;
	...
	mk_lang_assert(d);
	mk_lang_assert(c != d);
	mk_lang_assert(mk_lib_crypto_alg_des_is_28_bit(c));
	mk_lang_assert(mk_lib_crypto_alg_des_is_28_bit(d));

	mk_lib_crypto_alg_des_u32_to_u64(c, &cc);
	mk_lib_crypto_alg_des_u32_to_u64(d, &dd);
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_rot_28_impl(mk_sl_cui_uint32_pct const a, mk_lang_types_bool_t const b, mk_sl_cui_uint32_pt const c) mk_lang_noexcept
{
	...
	mk_lang_assert(c);
	mk_lang_assert(mk_lib_crypto_alg_des_is_28_bit(a));
	...
	mk_lang_assert(mk_lib_crypto_alg_des_is_28_bit(&ta));
	*c = ta;
}
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_s_one(mk_lang_types_sint_t const s_idx, mk_sl_cui_uint32_pct const a, mk_sl_cui_uint32_pt const b) mk_lang_noexcept
{
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_alg_des_s_all(mk_sl_cui_uint64_pct const a, mk_sl_cui_uint32_pt const b) mk_lang_noexcept
{
	mk_sl_cui_uint64_t aa mk_lang_constexpr_init;
	mk_sl_cui_uint32_t mask mk_lang_constexpr_init;
	mk_sl_cui_uint32_t bb mk_lang_constexpr_init;
	...
	mk_lang_static_assert(mk_lang_countof(s_mk_lib_crypto_alg_des_ss) == 8);

	mk_lang_assert(a);
	mk_lang_assert(b);
	mk_lang_assert(mk_lib_crypto_alg_des_is_48_bit(a));
	...
	for(i = 0; i != 8; ++i)
	{
		...
		mk_lib_crypto_alg_des_u64_to_u32(&ta, &tb);
		mk_sl_cui_uint32_and2(&tb, &mask);
		mk_lib_crypto_alg_des_s_one((8 - 1) - i, &tb, &tb);
...
{
	mk_lib_crypto_alg_des_schedule_t schedule mk_lang_constexpr_init;

	mk_lang_assert(key);
	mk_lang_assert(input);
	mk_lang_assert(output);

	mk_lib_crypto_alg_des_expand_enc(key, &schedule);
	mk_lib_crypto_alg_des_schedule_encrypt(&schedule, input, output, 1);
}
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_alg_des_decrypt(mk_lib_crypto_alg_des_key_pct const key, mk_lib_crypto_alg_des_msg_pct const input, mk_lib_crypto_alg_des_msg_pt const output) mk_lang_noexcept
{
	...
	mk_lib_crypto_alg_des_expand_dec(key, &schedule);
	mk_lib_crypto_alg_des_schedule_decrypt(&schedule, input, output, 1);
}
