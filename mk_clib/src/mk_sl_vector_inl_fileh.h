...
enum mk_sl_vector_inl_defd_max_capacity_e { mk_sl_vector_inl_defd_max_capacity_v = mk_sl_vector_inl_defd_max_capacity_d }; typedef enum mk_sl_vector_inl_defd_max_capacity_e mk_sl_vector_inl_defd_max_capacity_t;
...
struct mk_sl_vector_inl_defd_s
{
	...
	mk_sl_vector_inl_defd_mallocator_pt m_mallocator;
	#endif
};
