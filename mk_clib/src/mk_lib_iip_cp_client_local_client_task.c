...
mk_lang_nodiscard static mk_lang_inline mk_lib_iip_any_data_connection_pt mk_lib_iip_cp_client_local_client_task_prrw_to_any(mk_lib_iip_cp_client_local_client_task_pt const task) mk_lang_noexcept
{
	mk_lib_iip_cp_client_local_client_task_settings_pt settings;
	mk_lib_iip_cp_client_local_client_pt local_listener;
	mk_lib_iip_any_data_connection_pt any;
...
mk_lang_nodiscard static mk_lang_inline mk_lib_iip_cp_client_local_client_task_pt mk_lib_iip_cp_client_local_client_task_any_prrw_to_self(mk_lib_iip_any_data_connection_pt const connection) mk_lang_noexcept
{
	mk_lib_iip_cp_client_local_client_task_settings_pt settings;
	mk_lib_iip_cp_client_local_client_pt local_listener;
	...
	/* for natvis purposes */
	mk_lang_assert(mk_lang_offsetof(mk_lib_iip_cp_client_local_client_task_settings_t, m_type) == 0);
	mk_lang_assert(mk_lang_offsetof(mk_lib_iip_cp_client_local_client_t, m_settings) == 0);
	mk_lang_assert(mk_lang_offsetof(mk_lib_iip_cp_client_local_client_task_t, m_local) == sizeof(mk_lang_types_void_pt));
	/* for natvis purposes */
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_local_client_task_any_prrw_allocate(mk_lib_iip_any_data_connection_ppt const connection) mk_lang_noexcept
{
	...
	self->m_local.m_settings.m_type.m_data.m_id = mk_lib_iip_any_data_connection_type_e_mk_lib_iip_cp_client_local_client_task;
	*connection = &self->m_local.m_settings.m_type;
	mk_lang_assert(mk_lib_iip_cp_client_local_client_task_any_prrw_to_self(*connection) == self);
	return 0;
}
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_local_client_task_any_prrw_deallocate(mk_lib_iip_any_data_connection_pt const connection) mk_lang_noexcept
{
	...
	self = mk_lib_iip_cp_client_local_client_task_any_prrw_to_self(connection); mk_lang_assert(self);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_local_client_task_any_prrw_construct(mk_lib_iip_any_data_connection_pt const connection, mk_lang_types_void_pt const settings) mk_lang_noexcept
{
	...
	self = mk_lib_iip_cp_client_local_client_task_any_prrw_to_self(connection); mk_lang_assert(self);
	err = mk_lib_iip_cp_client_local_client_task_prrw_construct(self, ((mk_lib_iip_cp_client_local_client_task_settings_pct)(settings))); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_client_local_client_task_any_prrw_step(mk_lib_iip_any_data_connection_pt const connection, mk_lang_types_bool_t const allow_to_block, mk_lang_types_sint_t const tm, mk_lib_iip_any_data_connection_result_pt const step_result) mk_lang_noexcept
{
	...
	self = mk_lib_iip_cp_client_local_client_task_any_prrw_to_self(connection); mk_lang_assert(self);
	err = mk_lib_iip_cp_client_local_client_task_prrw_step(self, allow_to_block, tm, ((mk_lib_iip_cp_client_local_client_task_result_pt)(step_result))); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lib_iip_any_data_connection_pt mk_lib_iip_cp_client_local_client_task_rw_to_any(mk_lib_iip_cp_client_local_client_task_pt const task) mk_lang_noexcept
{
	return mk_lib_iip_cp_client_local_client_task_prrw_to_any(task);
}

mk_lang_nodiscard mk_lang_jumbo mk_lib_iip_cp_client_local_client_task_pt mk_lib_iip_cp_client_local_client_task_any_rw_to_self(mk_lib_iip_any_data_connection_pt const connection) mk_lang_noexcept
{
	return mk_lib_iip_cp_client_local_client_task_any_prrw_to_self(connection);
}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_bool_t mk_lib_iip_cp_client_local_client_task_ptr_ro_eq(mk_lib_iip_cp_client_local_client_task_pcpt const a, mk_lib_iip_cp_client_local_client_task_pcpt const b) mk_lang_noexcept
{
...
#define mk_sl_vector_t_element_eq mk_lib_iip_cp_client_local_client_task_ptr_ro_eq
