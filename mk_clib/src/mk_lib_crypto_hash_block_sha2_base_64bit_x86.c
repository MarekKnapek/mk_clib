#ifndef mk_include_guard_mk_lib_crypto_hash_block_sha2_base_64bit_x86_c
#define mk_include_guard_mk_lib_crypto_hash_block_sha2_base_64bit_x86_c
...
union mk_lib_crypto_hash_block_sha2_base_64bit_x86_block2_data_u
{
	mk_lang_alignas(mk_lib_crypto_hash_block_sha2_base_64bit_x86_block_len_v) mk_sl_cui_uint64_t m_uint64s[16];
	mk_lib_crypto_hash_block_sha2_base_64bit_x86_block_t m_align;
};
typedef union mk_lib_crypto_hash_block_sha2_base_64bit_x86_block2_data_u mk_lib_crypto_hash_block_sha2_base_64bit_x86_block2_data_t;
struct mk_lib_crypto_hash_block_sha2_base_64bit_x86_block2_s
{
	mk_lib_crypto_hash_block_sha2_base_64bit_x86_block2_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_sha2_base_64bit_x86_block2_s mk_lib_crypto_hash_block_sha2_base_64bit_x86_block2_t;
...
{
	mk_lang_alignas(128) mk_lib_crypto_hash_block_sha2_base_64bit_x86_table_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_sha2_base_64bit_x86_table_s mk_lib_crypto_hash_block_sha2_base_64bit_x86_table_t;


mk_lang_constexpr_static_inline mk_lib_crypto_hash_block_sha2_base_64bit_x86_table_t const mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table =
{{{
...
mk_lang_jumbo mk_lang_types_void_t mk_lang_attribute_target("sse2,avx,avx2,sha512") mk_lib_crypto_hash_block_sha2_base_64bit_x86_init(mk_lib_crypto_hash_block_sha2_base_64bit_x86_pt const sha2_base_64bit_x86, mk_lang_static_param(mk_sl_cui_uint64_ct, iv, 8)) mk_lang_noexcept
{
	...
	mk_lang_static_assert(mk_lang_alignof(mk_sl_cui_uint64_t) == 8);
	mk_lang_static_assert(mk_sl_cui_uint64_size_bits_v == 64);

	mk_lang_assert(sha2_base_64bit_x86);
	mk_lang_assert(iv);
	mk_lang_assert((((mk_lang_types_uintptr_t)(&sha2_base_64bit_x86->m_data.m_state[0])) & 0x1f) == 0);
	mk_lang_assert((((mk_lang_types_uintptr_t)(&iv[0])) & 0x1f) == 0);
	...
	mk_lib_crypto_bitops_bulk_uint64_8_memcpy(&sha2_base_64bit_x86->m_data.m_state[0], &iv[0]);
	mk_sl_cui_uint128_set_zero(&sha2_base_64bit_x86->m_data.m_len);
}
...
mk_lang_jumbo mk_lang_types_void_t mk_lang_attribute_target("sse2,avx,avx2,sha512") mk_lib_crypto_hash_block_sha2_base_64bit_x86_append_blocks(mk_lib_crypto_hash_block_sha2_base_64bit_x86_pt const sha2_base_64bit_x86, mk_lib_crypto_hash_block_sha2_base_64bit_x86_block_pct const pblocks, mk_lang_types_usize_t const nblocks) mk_lang_noexcept
{
	...
	#define mk_mm256_blend_epi64(a, b, c) _mm256_blend_epi32((a), (b), mk_lib_crypto_hash_block_sha2_base_64bit_x86_blend_epi32_c((((c) >> 3) & 0x1), (((c) >> 3) & 0x1), (((c) >> 2) & 0x1), (((c) >> 2) & 0x1), (((c) >> 1) & 0x1), (((c) >> 1) & 0x1), (((c) >> 0) & 0x1), (((c) >> 0) & 0x1)))
	#define any 0
	...
	mk_lang_assert(nblocks <= mk_lang_limits_usize_max / mk_lib_crypto_hash_block_sha2_base_64bit_x86_block_len_v);
	mk_lang_assert((((mk_lang_types_uintptr_t)(&sha2_base_64bit_x86->m_data.m_state[0])) & 0x1f) == 0);
	mk_lang_assert((((mk_lang_types_uintptr_t)(pblocks)) & 0x1f) == 0);
	mk_lang_assert((((mk_lang_types_uintptr_t)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[0])) & 0x1f) == 0);
	mk_lang_assert(mk_lang_cpuid_has_sse2());
	mk_lang_assert(mk_lang_cpuid_has_avx());
	mk_lang_assert(mk_lang_cpuid_has_avx2());
	mk_lang_assert(mk_lang_cpuid_has_sha512());
	...
	if(nblocks != 0)
	{
		...
		mk_lang_assert(!mk_sl_cui_uint128_would_overflow_add_cc(&sha2_base_64bit_x86->m_data.m_len, &ta));
		mk_sl_cui_uint128_add2_wrap_cid_cod(&sha2_base_64bit_x86->m_data.m_len, &ta);
		...
		state_a = _mm256_load_si256(((__m256i const*)(&sha2_base_64bit_x86->m_data.m_state[0])));
		state_b = _mm256_load_si256(((__m256i const*)(&sha2_base_64bit_x86->m_data.m_state[4])));
		...
		state_a = mk_mm256_blend_epi64(tmp_a, tmp_b, mk_lib_crypto_hash_block_sha2_base_64bit_x86_blend_epi64_c(0x1, 0x1, 0x0, 0x0));
		state_b = mk_mm256_blend_epi64(tmp_c, tmp_d, mk_lib_crypto_hash_block_sha2_base_64bit_x86_blend_epi64_c(0x1, 0x1, 0x0, 0x0));
		for(iblock = 0, ptr = &pblocks->m_data.m_uint8s[0]; iblock != nblocks; ++iblock, ptr += mk_lib_crypto_hash_block_sha2_base_64bit_x86_block_len_v)
		{
			#include "mk_lang_warning_clang_push_cast_align.h"
			old_a = state_a;
			old_b = state_b;
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[0 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			msg_a = _mm256_load_si256(((__m256i const*)(&ptr[0 * (256 / mk_lang_charbit)])));
			...
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[1 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			msg_b = _mm256_load_si256(((__m256i const*)(&ptr[1 * (256 / mk_lang_charbit)])));
			msg_b = _mm256_shuffle_epi8(msg_b, reverse);
			tmp_a = _mm256_add_epi64(tmp_a, msg_b);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[2 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			msg_c = _mm256_load_si256(((__m256i const*)(&ptr[2 * (256 / mk_lang_charbit)])));
			msg_c = _mm256_shuffle_epi8(msg_c, reverse);
			tmp_a = _mm256_add_epi64(tmp_a, msg_c);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[3 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			msg_d = _mm256_load_si256(((__m256i const*)(&ptr[3 * (256 / mk_lang_charbit)])));
			...
			tmp_a = mk_mm256_blend_epi64(tmp_a, tmp_b, mk_lib_crypto_hash_block_sha2_base_64bit_x86_blend_epi64_c(0x1, 0x0, 0x0, 0x0));
			tmp_a = _mm256_add_epi64(tmp_a, msg_a);
			msg_a = _mm256_sha512msg2_epi64(tmp_a, msg_d);
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[4 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_a);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[5 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_b);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[6 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_c);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[7 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_d);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_add_epi64(tmp_a, msg_a);
			msg_a = _mm256_sha512msg2_epi64(tmp_a, msg_d);
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[8 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_a);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_add_epi64(tmp_a, msg_b);
			msg_b = _mm256_sha512msg2_epi64(tmp_a, msg_a);
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[9 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_b);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_add_epi64(tmp_a, msg_c);
			msg_c = _mm256_sha512msg2_epi64(tmp_a, msg_b);
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[10 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_c);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_add_epi64(tmp_a, msg_d);
			msg_d = _mm256_sha512msg2_epi64(tmp_a, msg_c);
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[11 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_d);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_add_epi64(tmp_a, msg_a);
			msg_a = _mm256_sha512msg2_epi64(tmp_a, msg_d);
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[12 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_a);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_add_epi64(tmp_a, msg_b);
			msg_b = _mm256_sha512msg2_epi64(tmp_a, msg_a);
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[13 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_b);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_add_epi64(tmp_a, msg_c);
			msg_c = _mm256_sha512msg2_epi64(tmp_a, msg_b);
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[14 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_c);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_add_epi64(tmp_a, msg_d);
			msg_d = _mm256_sha512msg2_epi64(tmp_a, msg_c);
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[15 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_d);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_add_epi64(tmp_a, msg_a);
			msg_a = _mm256_sha512msg2_epi64(tmp_a, msg_d);
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[16 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_a);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_add_epi64(tmp_a, msg_b);
			msg_b = _mm256_sha512msg2_epi64(tmp_a, msg_a);
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[17 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_b);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_add_epi64(tmp_a, msg_c);
			msg_c = _mm256_sha512msg2_epi64(tmp_a, msg_b);
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[18 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_c);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
			...
			tmp_a = _mm256_add_epi64(tmp_a, msg_d);
			msg_d = _mm256_sha512msg2_epi64(tmp_a, msg_c);
			tmp_a = _mm256_load_si256(((__m256i const*)(&mk_lib_crypto_hash_block_sha2_base_64bit_x86_k_table.m_data.m_uint64s[19 * (256 / mk_sl_cui_uint64_size_bits_v)])));
			tmp_a = _mm256_add_epi64(tmp_a, msg_d);
			state_a = _mm256_sha512rnds2_epi64(state_a, state_b, _mm256_castsi256_si128(tmp_a));
			tmp_a = _mm256_permute4x64_epi64(tmp_a, mk_lib_crypto_hash_block_sha2_base_64bit_x86_permute_epi64_c(any, any, 0x3, 0x2));
			state_b = _mm256_sha512rnds2_epi64(state_b, state_a, _mm256_castsi256_si128(tmp_a));
		...
		state_b = mk_mm256_blend_epi64(tmp_c, tmp_d, mk_lib_crypto_hash_block_sha2_base_64bit_x86_blend_epi64_c(0x1, 0x1, 0x0, 0x0));
		#include "mk_lang_warning_clang_push_cast_align.h"
		_mm256_store_si256(((__m256i*)(&sha2_base_64bit_x86->m_data.m_state[0])), state_a);
		_mm256_store_si256(((__m256i*)(&sha2_base_64bit_x86->m_data.m_state[4])), state_b);
		#include "mk_lang_warning_clang_pop.h"
	}
...
mk_lang_jumbo mk_lang_types_void_t mk_lang_attribute_target("sse2,avx,avx2,sha512") mk_lib_crypto_hash_block_sha2_base_64bit_x86_finish(mk_lib_crypto_hash_block_sha2_base_64bit_x86_pt const sha2_base_64bit_x86, mk_lib_crypto_hash_block_sha2_base_64bit_x86_block_pt const block, mk_lang_types_sint_t const idx, mk_lib_crypto_hash_block_sha2_base_64bit_x86_digest_pt const digest) mk_lang_noexcept
{
	...
	mk_lang_assert(idx >= 0 && idx < mk_lib_crypto_hash_block_sha2_base_64bit_x86_block_len_v);
	mk_lang_assert(digest);
	mk_lang_assert((((mk_lang_types_uintptr_t)(&sha2_base_64bit_x86->m_data.m_state[0])) & 0x1f) == 0);
	mk_lang_assert((((mk_lang_types_uintptr_t)(&block->m_data.m_uint8s[0])) & 0x1f) == 0);
	mk_lang_assert((((mk_lang_types_uintptr_t)(&digest->m_data.m_uint8s[0])) & 0x1f) == 0);
	mk_lang_assert(mk_lang_cpuid_has_sse2());
	mk_lang_assert(mk_lang_cpuid_has_avx());
	mk_lang_assert(mk_lang_cpuid_has_avx2());
	mk_lang_assert(mk_lang_cpuid_has_sha512());

	ui = mk_lib_crypto_hash_block_sha2_base_64bit_x86_block_len_v; mk_sl_cui_uint128_from_bi_uint(&ta, &ui);
	mk_lang_assert(!mk_sl_cui_uint128_would_overflow_mul(&sha2_base_64bit_x86->m_data.m_len, &ta));
	mk_sl_cui_uint128_shl3(&sha2_base_64bit_x86->m_data.m_len, 7, &ta);
	...
	ui = 8; mk_sl_cui_uint128_from_bi_uint(&tb, &ui);
	...
	rest = mk_lib_crypto_hash_block_sha2_base_64bit_x86_block_len_v - idx - 1;
	mk_lang_assert(rest >= 0 && rest <= mk_lib_crypto_hash_block_sha2_base_64bit_x86_block_len_v - 1);
	if(rest >= mk_sl_cui_uint128_size_bytes_v)
	{
		mk_sl_cui_uint8_memclr_fn(&block->m_data.m_uint8s[idx + 1], ((mk_lang_types_usize_t)(rest - mk_sl_cui_uint128_size_bytes_v)));
	}
	else
	{
		...
		mk_sl_cui_uint8_memclr_fn(&block->m_data.m_uint8s[0], ((mk_lang_types_sint_t)(mk_lib_crypto_hash_block_sha2_base_64bit_x86_block_len_v)) - ((mk_lang_types_sint_t)(mk_sl_cui_uint128_size_bytes_v)));
	}

	mk_sl_uint_convert_128_8_be_to_sml(&ta, &block->m_data.m_uint8s[((mk_lang_types_sint_t)(mk_lib_crypto_hash_block_sha2_base_64bit_x86_block_len_v)) - ((mk_lang_types_sint_t)(mk_sl_cui_uint128_size_bytes_v))]);
	mk_lib_crypto_hash_block_sha2_base_64bit_x86_append_blocks(sha2_base_64bit_x86, block, 1);
	for(i = 0; i != mk_lang_countof(sha2_base_64bit_x86->m_data.m_state); ++i)
	{
		mk_sl_uint_convert_64_8_be_to_sml(&sha2_base_64bit_x86->m_data.m_state[i], &digest->m_data.m_uint8s[i * mk_sl_cui_uint64_size_bytes_v]);
	}
}
