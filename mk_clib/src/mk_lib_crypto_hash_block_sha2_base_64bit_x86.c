...
mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_64bit_x86_init(mk_lib_crypto_hash_block_sha2_base_64bit_x86_pt const sha2_base_64bit_x86, mk_lang_static_param(mk_sl_cui_uint64_ct, iv, 8)) mk_lang_noexcept
{
	...
	mk_lang_assert(iv);
	mk_lang_assert((((mk_lang_types_uintptr_t)(&sha2_base_64bit_x86->m_state[0])) & 0x1f) == 0);
	...
	mk_lib_crypto_bitops_bulk_uint64_8_memcpy(&sha2_base_64bit_x86->m_state[0], &iv[0]);
...
mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_64bit_x86_append_blocks(mk_lib_crypto_hash_block_sha2_base_64bit_x86_pt const sha2_base_64bit_x86, mk_lib_crypto_hash_block_sha2_base_64bit_x86_block_pct const pblocks, mk_lang_types_usize_t const nblocks) mk_lang_noexcept
{
	...
	if(nblocks != 0)
	{
		...
		state_a = _mm256_load_si256(((__m256i const*)(&sha2_base_64bit_x86->m_state[0])));
		state_b = _mm256_load_si256(((__m256i const*)(&sha2_base_64bit_x86->m_state[4])));
		...
		state_a = mk_mm256_blend_epi64(tmp_a, tmp_b, mk_lib_crypto_hash_block_sha2_base_64bit_x86_blend_epi64_c(0x1, 0x1, 0x0, 0x0));
		state_b = mk_mm256_blend_epi64(tmp_c, tmp_d, mk_lib_crypto_hash_block_sha2_base_64bit_x86_blend_epi64_c(0x1, 0x1, 0x0, 0x0));
		_mm256_store_si256(((__m256i*)(&sha2_base_64bit_x86->m_state[0])), state_a);
		_mm256_store_si256(((__m256i*)(&sha2_base_64bit_x86->m_state[4])), state_b);
	}
...
mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha2_base_64bit_x86_finish(mk_lib_crypto_hash_block_sha2_base_64bit_x86_pt const sha2_base_64bit_x86, mk_lib_crypto_hash_block_sha2_base_64bit_x86_block_pt const block, mk_lang_types_sint_t const idx, mk_lib_crypto_hash_block_sha2_base_64bit_x86_digest_pt const digest) mk_lang_noexcept
{
	...
	mk_lib_crypto_hash_block_sha2_base_64bit_x86_append_blocks(sha2_base_64bit_x86, block, 1);
	for(i = 0; i != mk_lang_countof(sha2_base_64bit_x86->m_state); ++i)
	{
		mk_sl_uint_convert_64_8_be_to_sml(&sha2_base_64bit_x86->m_state[i], &digest->m_data.m_uint8s[i * mk_sl_cui_uint64_size_bytes_v]);
	}
}
#include "mk_lang_warning_msvc_pop.h"
