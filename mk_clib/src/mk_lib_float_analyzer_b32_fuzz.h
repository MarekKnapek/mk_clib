#ifndef mk_include_guard_mk_lib_float_analyzer_b32_fuzz_h
#define mk_include_guard_mk_lib_float_analyzer_b32_fuzz_h
...
#include "mk_lib_float_analyzer_b32_fuzz.c"
#endif
#endif
