...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lang_stdout_windows_no_redirect_print_n(mk_lang_types_pchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	if(mk_lang_stdout_windows_g.m_type != mk_lang_stdout_windows_type_e_redirected)
	{
		err = mk_lang_stdout_windows_print_n(str_buf, str_len); mk_lang_check_rereturn(err);
	}
	return 0;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lang_stdout_windows_no_redirect_print_w(mk_lang_types_wchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lang_stdout_windows_no_redirect_print_t(mk_lang_tchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lang_stdout_windows_no_redirect_println_n(mk_lang_types_pchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lang_stdout_windows_no_redirect_println_w(mk_lang_types_wchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lang_stdout_windows_no_redirect_println_t(mk_lang_tchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lang_stdout_windows_no_redirect_print_color_n(mk_lang_stdout_windows_color_text_t const color, mk_lang_types_pchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	if(mk_lang_stdout_windows_g.m_type != mk_lang_stdout_windows_type_e_redirected)
	{
		err = mk_lang_stdout_windows_print_color_n(color, str_buf, str_len); mk_lang_check_rereturn(err);
	}
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lang_stdout_windows_no_redirect_print_color_w(mk_lang_stdout_windows_color_text_t const color, mk_lang_types_wchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	if(mk_lang_stdout_windows_g.m_type != mk_lang_stdout_windows_type_e_redirected)
	{
		err = mk_lang_stdout_windows_print_color_w(color, str_buf, str_len); mk_lang_check_rereturn(err);
	}
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lang_stdout_windows_no_redirect_print_color_t(mk_lang_stdout_windows_color_text_t const color, mk_lang_tchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	if(mk_lang_stdout_windows_g.m_type != mk_lang_stdout_windows_type_e_redirected)
	{
		err = mk_lang_stdout_windows_print_color_t(color, str_buf, str_len); mk_lang_check_rereturn(err);
	}
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lang_stdout_windows_no_redirect_println_color_n(mk_lang_stdout_windows_color_text_t const color, mk_lang_types_pchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	if(mk_lang_stdout_windows_g.m_type != mk_lang_stdout_windows_type_e_redirected)
	{
		err = mk_lang_stdout_windows_println_color_n(color, str_buf, str_len); mk_lang_check_rereturn(err);
	}
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lang_stdout_windows_no_redirect_println_color_w(mk_lang_stdout_windows_color_text_t const color, mk_lang_types_wchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	if(mk_lang_stdout_windows_g.m_type != mk_lang_stdout_windows_type_e_redirected)
	{
		err = mk_lang_stdout_windows_println_color_w(color, str_buf, str_len); mk_lang_check_rereturn(err);
	}
	return 0;
}

mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lang_stdout_windows_no_redirect_println_color_t(mk_lang_stdout_windows_color_text_t const color, mk_lang_tchar_pct const str_buf, mk_lang_types_sint_t const str_len) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	if(mk_lang_stdout_windows_g.m_type != mk_lang_stdout_windows_type_e_redirected)
	{
		err = mk_lang_stdout_windows_println_color_t(color, str_buf, str_len); mk_lang_check_rereturn(err);
	}
	return 0;
}
