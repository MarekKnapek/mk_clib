...
#if defined mk_sl_mallocatorg_statistics_want && (mk_sl_mallocatorg_statistics_want) == 1
#define mk_sl_mallocatorg_statistics_have 1
#elif defined mk_sl_mallocatorg_statistics_want && (mk_sl_mallocatorg_statistics_want) == 0
#define mk_sl_mallocatorg_statistics_have 0
#elif !defined mk_sl_mallocatorg_statistics_have
#if defined NDEBUG
#define mk_sl_mallocatorg_statistics_have 0
#else
#define mk_sl_mallocatorg_statistics_have 1
