...
mk_lang_forward(mk_lib_iip_cp_client_connection_any2);
...
enum mk_lib_iip_cp_client_local_client_task_socket_state_e
{
	mk_lib_iip_cp_client_local_client_task_socket_state_e_not_connected_yet,
	mk_lib_iip_cp_client_local_client_task_socket_state_e_connected_no_data_yet,
	mk_lib_iip_cp_client_local_client_task_socket_state_e_connected_data_sent,
	mk_lib_iip_cp_client_local_client_task_socket_state_e_dummy_end
};
typedef enum mk_lib_iip_cp_client_local_client_task_socket_state_e mk_lib_iip_cp_client_local_client_task_socket_state_t;
mk_lang_typedef(mk_lib_iip_cp_client_local_client_task_socket_state);
...
struct mk_lib_iip_cp_client_local_client_state_s
{
	...
	mk_lang_types_ulllong_t m_ioctl_request_guid[128 / 8 / sizeof(mk_lang_types_ulllong_t)];
	...
	mk_lib_iip_cp_client_local_client_task_socket_state_t m_is_connected;
...
{
	mk_lib_iip_cp_client_local_client_task_step_e_want_associate_socket,
	mk_lib_iip_cp_client_local_client_task_step_e_rqst_accept_ex,
	mk_lib_iip_cp_client_local_client_task_step_e_wait_accept_ex,
	mk_lib_iip_cp_client_local_client_task_step_e_rqst_get_accept_ex_sock_addrs,
	mk_lib_iip_cp_client_local_client_task_step_e_wait_get_accept_ex_sock_addrs,
	mk_lib_iip_cp_client_local_client_task_step_e_accept_client,
	mk_lib_iip_cp_client_local_client_task_step_e_idle,
	mk_lib_iip_cp_client_local_client_task_step_e_wait_failed_accept,
	mk_lib_iip_cp_client_local_client_task_step_e_want_die,
