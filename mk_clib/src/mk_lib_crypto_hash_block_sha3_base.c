...
#define mk_lib_crypto_hash_block_sha3_base_round5(x) (((x) + 5) % 5)
#define mk_lib_crypto_hash_block_sha3_base_get5(sha3_base, x) ((sha3_base)[mk_lib_crypto_hash_block_sha3_base_round5((x))])
#define mk_lib_crypto_hash_block_sha3_base_get25(sha3_base, x, y) ((sha3_base)[(mk_lib_crypto_hash_block_sha3_base_round5((y)) * 5) + mk_lib_crypto_hash_block_sha3_base_round5((x))])
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha3_base_chi(mk_lib_crypto_hash_block_sha3_base_prct const input, mk_lib_crypto_hash_block_sha3_base_prt const output) mk_lang_noexcept
{
	...
	for(y = 0; y != 5; ++y)
	{
		for(x = 0; x != 5; ++x)
		{
			mk_sl_cui_uint64_not2(&mk_lib_crypto_hash_block_sha3_base_get25(input->m_data.m_uint64s, x + 1, y), &ta);
			mk_sl_cui_uint64_and2(&ta, &mk_lib_crypto_hash_block_sha3_base_get25(input->m_data.m_uint64s, x + 2, y));
			mk_sl_cui_uint64_xor3(&ta, &mk_lib_crypto_hash_block_sha3_base_get25(input->m_data.m_uint64s, x, y), &mk_lib_crypto_hash_block_sha3_base_get25(output->m_data.m_uint64s, x, y));
		}
	}
}
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha3_base_theta(mk_lib_crypto_hash_block_sha3_base_prct const input, mk_lib_crypto_hash_block_sha3_base_prt const output) mk_lang_noexcept
{
	...
	for(x = 0; x != 5; ++x)
	{
		mk_lib_crypto_hash_block_sha3_base_get5(c, x) = mk_lib_crypto_hash_block_sha3_base_get25(input->m_data.m_uint64s, x, 0);
		for(y = 1; y != 5; ++y)
		{
			mk_sl_cui_uint64_xor2(&mk_lib_crypto_hash_block_sha3_base_get5(c, x), &mk_lib_crypto_hash_block_sha3_base_get25(input->m_data.m_uint64s, x, y));
		}
	}
	for(x = 0; x != 5; ++x)
	{
		mk_sl_cui_uint64_rotl3(&mk_lib_crypto_hash_block_sha3_base_get5(c, x + 1), 1, &ta);
		mk_sl_cui_uint64_xor3(&ta, &mk_lib_crypto_hash_block_sha3_base_get5(c, x - 1), &mk_lib_crypto_hash_block_sha3_base_get5(d, x));
		for(y = 0; y != 5; ++y)
		{
			mk_sl_cui_uint64_xor3(&mk_lib_crypto_hash_block_sha3_base_get25(input->m_data.m_uint64s, x, y), &mk_lib_crypto_hash_block_sha3_base_get5(d, x), &mk_lib_crypto_hash_block_sha3_base_get25(output->m_data.m_uint64s, x, y));
		}
	}
}
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha3_base_pi(mk_lib_crypto_hash_block_sha3_base_prct const input, mk_lib_crypto_hash_block_sha3_base_prt const output) mk_lang_noexcept
{
	...
	for(x = 0; x != 5; ++x)
	{
		for(y = 0; y != 5; ++y)
		{
			xx = (0 * x + 1 * y) % 5;
			yy = (2 * x + 3 * y) % 5;
			mk_lib_crypto_hash_block_sha3_base_get25(output->m_data.m_uint64s, xx, yy) = mk_lib_crypto_hash_block_sha3_base_get25(input->m_data.m_uint64s, x, y);
		}
	}
}
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha3_base_rho(mk_lib_crypto_hash_block_sha3_base_prct const input, mk_lib_crypto_hash_block_sha3_base_prt const output) mk_lang_noexcept
{
	...
	mk_lib_crypto_hash_block_sha3_base_get25(output->m_data.m_uint64s, 0, 0) = mk_lib_crypto_hash_block_sha3_base_get25(input->m_data.m_uint64s, 0, 0);
	x = 1;
	y = 0;
	for(t = 0; t != 24; ++t)
	{
		r = (((t + 1) * (t + 2)) / 2) % 64;
		mk_sl_cui_uint64_rotl3(&mk_lib_crypto_hash_block_sha3_base_get25(input->m_data.m_uint64s, x, y), r, &mk_lib_crypto_hash_block_sha3_base_get25(output->m_data.m_uint64s, x, y));
		xx = (0 * x + 1 * y) % 5;
		yy = (2 * x + 3 * y) % 5;
		x = xx;
		y = yy;
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_lib_crypto_hash_block_sha3_base_iota(mk_lib_crypto_hash_block_sha3_base_pt const sha3_base, mk_lang_types_sint_t const rcidx) mk_lang_noexcept
{
	...
	mk_sl_cui_uint64_xor2(&mk_lib_crypto_hash_block_sha3_base_get25(sha3_base->m_data.m_uint64s, 0, 0), &mk_lib_crypto_hash_block_sha3_base_k_rc_nums.m_data.m_uint64s[rcidx]);
}
