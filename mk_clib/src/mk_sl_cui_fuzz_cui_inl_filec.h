...
#define mk_sl_cui_t_base_size_bits_d mk_sl_cui_fuzz_cui_inl_defd_cui_a_base_size_bits_d
...
#define mk_sl_cui_t_base_size_bits_d mk_sl_cui_fuzz_cui_inl_defd_cui_b_base_size_bits_d
...
mk_lang_constexpr static mk_lang_inline mk_lang_types_void_t mk_sl_cui_fuzz_cui_inl_defd_pr_to_str_hexf_many_n(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	...
	for(i = 0; i != n; ++i)
	{
		mk_sl_cui_fuzz_cui_inl_defd_cui_a_from_buis_uchar_le(&cui_aa[0], &d[i * mk_sl_cui_fuzz_cui_inl_defd_cui_a_size_bytes_v]);
		mk_sl_cui_fuzz_cui_inl_defd_cui_b_from_buis_uchar_le(&cui_ba[0], &d[i * mk_sl_cui_fuzz_cui_inl_defd_cui_b_size_bytes_v]);
	}
	d += n * mk_sl_cui_fuzz_cui_inl_defd_cui_a_size_bytes_v;
	s -= n * mk_sl_cui_fuzz_cui_inl_defd_cui_a_size_bytes_v;
	if(!(s >= mk_lang_sizeof_bi_ulong_t))
	{
		return;
	}
