...
#if defined mk_sl_mallocg_tracer_statistics_want && (mk_sl_mallocg_tracer_statistics_want) == 1
#define mk_sl_mallocg_tracer_statistics_have 1
#elif defined mk_sl_mallocg_tracer_statistics_want && (mk_sl_mallocg_tracer_statistics_want) == 0
