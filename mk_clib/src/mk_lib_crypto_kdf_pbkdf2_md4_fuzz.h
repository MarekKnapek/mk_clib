#ifndef mk_include_guard_mk_lib_crypto_kdf_pbkdf2_md4_fuzz_h
#define mk_include_guard_mk_lib_crypto_kdf_pbkdf2_md4_fuzz_h
...
#include "mk_lib_crypto_kdf_pbkdf2_md4_fuzz.c"
#endif
#endif
