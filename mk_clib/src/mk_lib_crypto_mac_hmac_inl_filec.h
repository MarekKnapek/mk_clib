...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_mac_hmac_inl_defd_init(mk_lib_crypto_mac_hmac_inl_defd_pt const hmac, mk_sl_cui_uint8_pct const key_buf, mk_lang_types_usize_t const key_len) mk_lang_noexcept
{
	...
	mk_lang_types_usize_t k_len mk_lang_constexpr_init;
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_mac_hmac_inl_defd_append(mk_lib_crypto_mac_hmac_inl_defd_pt const hmac, mk_sl_cui_uint8_pct const data_buf, mk_lang_types_usize_t const data_len) mk_lang_noexcept
{
	#include "mk_lang_warning_msvc_push_c4296.h"
	#include "mk_lang_warning_gcc_push_type_limits.h"
	mk_lang_assert(hmac);
	...
	mk_lib_crypto_mac_hmac_inl_defd_base_append_u8s(&hmac->m_base, data_buf, data_len);
}
