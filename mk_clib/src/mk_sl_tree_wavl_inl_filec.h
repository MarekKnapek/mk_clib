...
typedef mk_lang_types_void_pt mk_sl_tree_wavl_inl_defd_visitor_context_pt;
...
#else
typedef mk_lang_types_sint_t(*mk_sl_tree_wavl_inl_defd_visitor_callback_t)(mk_sl_tree_wavl_inl_defd_visitor_context_pt const context, mk_sl_tree_wavl_inl_defd_pct const tree, mk_sl_tree_wavl_inl_defd_node_pct const node);
#endif
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_sl_tree_wavl_inl_defd_mallocatorg_allocate(mk_sl_tree_wavl_inl_defd_pt const tree, mk_lang_types_usize_t const size, mk_lang_types_void_ppt const mem) mk_lang_noexcept
{
	mk_lang_types_sint_t err;

	mk_lang_assert(tree);
	mk_lang_assert(size >= 1);
	mk_lang_assert(mem);

	((mk_lang_types_void_t)(tree));
	err = mk_sl_tree_wavl_inl_defd_base_mallocatorg_allocate(size, mem); mk_lang_check_rereturn(err);
	return 0;
}

mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_sl_tree_wavl_inl_defd_mallocatorg_deallocate(mk_sl_tree_wavl_inl_defd_pt const tree, mk_lang_types_void_pt const mem, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	((mk_lang_types_void_t)(tree));
	err = mk_sl_tree_wavl_inl_defd_base_mallocatorg_deallocate(mem, size); mk_lang_check_rereturn(err);
	return 0;
}
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_sl_tree_wavl_inl_defd_prrw_node_init(mk_sl_tree_wavl_inl_defd_pt const tree, mk_sl_tree_wavl_inl_defd_node_pt const node, mk_sl_tree_wavl_inl_defd_node_pt const parent) mk_lang_noexcept
{
	mk_lang_assert(tree);
	mk_lang_assert(node);
	mk_lang_assert(parent || !parent);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_sl_tree_wavl_inl_defd_prrw_node_alloc(mk_sl_tree_wavl_inl_defd_pt const tree, mk_sl_tree_wavl_inl_defd_node_ppt const node, mk_sl_tree_wavl_inl_defd_node_pt const parent, mk_sl_tree_wavl_inl_defd_element_pct const element) mk_lang_noexcept
{
	mk_lang_types_sint_t err;
	...
	err = mk_sl_tree_wavl_inl_defd_mallocatorg_allocate(tree, sizeof(*target), ((mk_lang_types_void_ppt)(&target))); mk_lang_check_rereturn(err); mk_lang_assert(target);
	err = mk_sl_tree_wavl_inl_defd_prrw_node_init(tree, target, parent); mk_lang_check_rereturn(err);
...
mk_lang_nodiscard mk_lang_jumbo mk_sl_tree_wavl_inl_defd_node_pt mk_sl_tree_wavl_inl_defd_prrw_find_smallest(mk_sl_tree_wavl_inl_defd_pt const tree, mk_sl_tree_wavl_inl_defd_node_pt const node) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_sl_tree_wavl_inl_defd_prrw_rebalance_insert(mk_sl_tree_wavl_inl_defd_pt const tree, mk_sl_tree_wavl_inl_defd_node_pt const node) mk_lang_noexcept
{
	mk_sl_tree_wavl_inl_defd_node_pt z;
	mk_sl_tree_wavl_inl_defd_node_pt y;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_sl_tree_wavl_inl_defd_rw_insert_node(mk_sl_tree_wavl_inl_defd_pt const tree, mk_sl_tree_wavl_inl_defd_node_pct const node) mk_lang_noexcept
{
	...
	if(!curr)
	{
		curr = ((mk_sl_tree_wavl_inl_defd_node_pt)(node));
		err = mk_sl_tree_wavl_inl_defd_prrw_node_init(tree, curr, mk_lang_null); mk_lang_check_rereturn(err);
		++tree->m_nodes;
		++tree->m_elements;
		tree->m_root = curr;
	}
	else
	{
		...
		if(insert)
		{
			...
			*target = ((mk_sl_tree_wavl_inl_defd_node_pt)(node));
			err = mk_sl_tree_wavl_inl_defd_prrw_node_init(tree, *target, curr); mk_lang_check_rereturn(err);
			++tree->m_nodes;
			++tree->m_elements;
			mk_lang_assert
			(
			...
			if(rebalance)
			{
				...
				if(curr->m_parent && mk_sl_tree_wavl_inl_defd_prro_node_is_ichild(tree, curr, 0))
				{
					...
					err = mk_sl_tree_wavl_inl_defd_prrw_rebalance_insert(tree, curr); mk_lang_check_rereturn(err);
				}
			}
		}
	}
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_sl_tree_wavl_inl_defd_rw_remove_node(mk_sl_tree_wavl_inl_defd_pt const tree, mk_sl_tree_wavl_inl_defd_node_pct const node) mk_lang_noexcept
{
	...
	{
		y = ((mk_sl_tree_wavl_inl_defd_node_pt)(node));
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_sl_tree_wavl_inl_defd_rw_insert_element(mk_sl_tree_wavl_inl_defd_pt const tree, mk_sl_tree_wavl_inl_defd_element_pct const element, mk_sl_tree_wavl_inl_defd_node_ppct const node) mk_lang_noexcept
{
	...
	if(!curr)
	{
		err = mk_sl_tree_wavl_inl_defd_prrw_node_alloc(tree, &curr, mk_lang_null, element); mk_lang_check_rereturn(err); mk_lang_assert(curr);
		++tree->m_nodes;
		++tree->m_elements;
		tree->m_root = curr;
		*node = curr;
	...
	else
	{
		...
		if(insert)
		{
			...
			err = mk_sl_tree_wavl_inl_defd_prrw_node_alloc(tree, target, curr, element); mk_lang_check_rereturn(err); mk_lang_assert(*target);
			++tree->m_nodes;
			++tree->m_elements;
			*node = *target;
			mk_lang_assert
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_sl_tree_wavl_inl_defd_ro_find(mk_sl_tree_wavl_inl_defd_pct const tree, mk_sl_tree_wavl_inl_defd_element_pct const element, mk_sl_tree_wavl_inl_defd_node_ppct const node) mk_lang_noexcept
{
	mk_sl_tree_wavl_inl_defd_node_pt curr;
	mk_lang_types_sint_t err;
	mk_lang_types_sint_t cmp;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_sl_tree_wavl_inl_defd_rw_decrement_node(mk_sl_tree_wavl_inl_defd_pt const tree, mk_sl_tree_wavl_inl_defd_node_pct const node) mk_lang_noexcept
{
	...
	{
		++tree->m_elements;
		mk_sl_tree_wavl_inl_defd_rw_remove_node(tree, x);
