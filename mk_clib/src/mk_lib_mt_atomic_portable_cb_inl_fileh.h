...
typedef mk_lib_mt_atomic_portable_cb_inl_defd_type mk_lib_mt_atomic_portable_cb_inl_defd_type_t;
typedef mk_lib_mt_atomic_portable_cb_inl_defd_type_t const mk_lib_mt_atomic_portable_cb_inl_defd_type_ct;
typedef mk_lib_mt_atomic_portable_cb_inl_defd_type_t* mk_lib_mt_atomic_portable_cb_inl_defd_type_pt;
typedef mk_lib_mt_atomic_portable_cb_inl_defd_type_t const* mk_lib_mt_atomic_portable_cb_inl_defd_type_pct;


struct mk_lib_mt_atomic_portable_cb_inl_defd_s
{
	mk_lib_mt_mutex_portable_c_t m_mtx;
	mk_lib_mt_atomic_portable_cb_inl_defd_type_t m_atomyc;
};
typedef struct mk_lib_mt_atomic_portable_cb_inl_defd_s mk_lib_mt_atomic_portable_cb_inl_defd_t;
typedef mk_lib_mt_atomic_portable_cb_inl_defd_t const mk_lib_mt_atomic_portable_cb_inl_defd_ct;
typedef mk_lib_mt_atomic_portable_cb_inl_defd_t* mk_lib_mt_atomic_portable_cb_inl_defd_pt;
typedef mk_lib_mt_atomic_portable_cb_inl_defd_t const* mk_lib_mt_atomic_portable_cb_inl_defd_pct;
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_mt_atomic_portable_cb_inl_defd_exchange(mk_lib_mt_atomic_portable_cb_inl_defd_pt const atomyc) mk_lang_noexcept;
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_mt_atomic_portable_cb_inl_defd_compare_exchange_weak(mk_lib_mt_atomic_portable_cb_inl_defd_pt const atomyc) mk_lang_noexcept;
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_mt_atomic_portable_cb_inl_defd_compare_exchange_strong(mk_lib_mt_atomic_portable_cb_inl_defd_pt const atomyc) mk_lang_noexcept;
