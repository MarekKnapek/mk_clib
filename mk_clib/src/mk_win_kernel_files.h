...
struct mk_win_kernel_files_w_stream_data_s
{
	mk_win_base_large_integer_t m_len;
	mk_win_base_wchar_t m_name[s_mk_win_kernel_files_max_path + 36];
};
typedef struct mk_win_kernel_files_w_stream_data_s mk_win_kernel_files_w_stream_data_t;
typedef mk_win_kernel_files_w_stream_data_t const mk_win_kernel_files_w_stream_data_ct;
typedef mk_win_kernel_files_w_stream_data_t* mk_win_kernel_files_w_stream_data_pt;
typedef mk_win_kernel_files_w_stream_data_t const* mk_win_kernel_files_w_stream_data_pct;
typedef mk_win_kernel_files_w_stream_data_t mk_win_base_far* mk_win_kernel_files_w_stream_data_lpt;
typedef mk_win_kernel_files_w_stream_data_t mk_win_base_far const* mk_win_kernel_files_w_stream_data_lpct;
typedef mk_win_kernel_files_w_stream_data_t mk_win_base_near* mk_win_kernel_files_w_stream_data_npt;
typedef mk_win_kernel_files_w_stream_data_t mk_win_base_near const* mk_win_kernel_files_w_stream_data_npct;
...
struct mk_win_kernel_files_info_by_handle_s
{
	mk_win_base_dword_t m_attributes;
	mk_win_kernel_time_file_time_t m_time_created;
	mk_win_kernel_time_file_time_t m_time_accessed;
	mk_win_kernel_time_file_time_t m_time_written;
...
typedef struct mk_win_kernel_files_info_by_handle_s mk_win_kernel_files_info_by_handle_t;
typedef mk_win_kernel_files_info_by_handle_t const mk_win_kernel_files_info_by_handle_ct;
typedef mk_win_kernel_files_info_by_handle_t* mk_win_kernel_files_info_by_handle_pt;
typedef mk_win_kernel_files_info_by_handle_t const* mk_win_kernel_files_info_by_handle_pct;
typedef mk_win_kernel_files_info_by_handle_t mk_win_base_far* mk_win_kernel_files_info_by_handle_lpt;
typedef mk_win_kernel_files_info_by_handle_t mk_win_base_far const* mk_win_kernel_files_info_by_handle_lpct;
typedef mk_win_kernel_files_info_by_handle_t mk_win_base_near* mk_win_kernel_files_info_by_handle_npt;
typedef mk_win_kernel_files_info_by_handle_t mk_win_base_near const* mk_win_kernel_files_info_by_handle_npct;
...
mk_lang_nodiscard mk_lang_jumbo mk_win_base_bool_t mk_win_kernel_files_get_file_information_by_handle(mk_win_base_handle_t const handle, mk_win_kernel_files_info_by_handle_lpt const info) mk_lang_noexcept;
