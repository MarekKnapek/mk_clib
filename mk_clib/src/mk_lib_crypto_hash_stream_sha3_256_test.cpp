#ifndef mk_include_guard_mk_lib_crypto_hash_stream_sha3_256_test_cpp
#define mk_include_guard_mk_lib_crypto_hash_stream_sha3_256_test_cpp
...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_hash_stream_sha3_256_test_compute_from_str_lit(mk_lang_types_pchar_t const(&str_lit)[str_lit_len]) mk_lang_noexcept
{
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, str_lit_len - 1> msg mk_lang_constexpr_init;
	mk_lib_crypto_hash_stream_sha3_256_t sha3_256 mk_lang_constexpr_init;
	mk_lib_crypto_hash_stream_sha3_256_digest_t digest mk_lang_constexpr_init;
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, mk_lib_crypto_hash_stream_sha3_256_digest_len_v> ret mk_lang_constexpr_init;

	mk_lang_static_assert(str_lit_len >= 1);

	msg = mk_lib_cpp_constexpr_array_u8_from_pchar_lit(str_lit);
	mk_lib_crypto_hash_stream_sha3_256_init(&sha3_256);
	mk_lib_crypto_hash_stream_sha3_256_append_u8s(&sha3_256, msg.data(), msg.size());
	mk_lib_crypto_hash_stream_sha3_256_finish(&sha3_256, &digest);
...
mk_lang_extern_force_c mk_lang_types_void_t mk_lib_crypto_hash_stream_sha3_256_test(mk_lang_types_void_t) mk_lang_noexcept
{
	#define message_1 ""
	#define message_2 "a"
	...
	#define digest_1 "a7ffc6f8bf1ed76651c14756a061d662f580ff4de43b49fa82d80a4b80f8434a"
	#define digest_2 "80084bf2fba02475726feb2cab2d8215eab14bc6bdd8bfb2c8151257032ecd8b"
	#define digest_3 "3a985da74fe225b2045c172d6bd390bd855f086e3e9d525b46bfe24511431532"
	#define digest_4 "edcdb2069366e75243860c18c3a11465eca34bce6143d30c8665cefcfd32bffd"
	#define digest_5 "7cab2dc765e21b241dbc1c255ce620b29f527c6d5e7f5f843e56288f0d707521"
	#define digest_6 "a79d6a9da47f04a3b9a9323ec9991f2105d4c78a7bc7beeb103855a7a11dfb9f"
	#define digest_7 "293e5ce4ce54ee71990ab06e511b7ccd62722b1beb414f5ff65c8274e0f5be1d"
	#define digest_8 "8a5720b2ca0cae7b89ad399c5daab22c29f5c72bcf30ab81e807d9bda95b4580"

	#if mk_lang_version_at_least_cpp_14 || mk_lang_version_at_least_msvc_cpp_14

	mk_lang_constexpr_static auto const s_digest_computed_1 = mk_lib_crypto_hash_stream_sha3_256_test_compute_from_str_lit(message_1);
	mk_lang_constexpr_static auto const s_digest_computed_2 = mk_lib_crypto_hash_stream_sha3_256_test_compute_from_str_lit(message_2);
	mk_lang_constexpr_static auto const s_digest_computed_3 = mk_lib_crypto_hash_stream_sha3_256_test_compute_from_str_lit(message_3);
	mk_lang_constexpr_static auto const s_digest_computed_4 = mk_lib_crypto_hash_stream_sha3_256_test_compute_from_str_lit(message_4);
	mk_lang_constexpr_static auto const s_digest_computed_5 = mk_lib_crypto_hash_stream_sha3_256_test_compute_from_str_lit(message_5);
	mk_lang_constexpr_static auto const s_digest_computed_6 = mk_lib_crypto_hash_stream_sha3_256_test_compute_from_str_lit(message_6);
	mk_lang_constexpr_static auto const s_digest_computed_7 = mk_lib_crypto_hash_stream_sha3_256_test_compute_from_str_lit(message_7);
	mk_lang_constexpr_static auto const s_digest_computed_8 = mk_lib_crypto_hash_stream_sha3_256_test_compute_from_str_lit(message_8);
	...
	for(i = 0; i != n; ++i)
	{
		...
		mk_lib_crypto_hash_stream_sha3_256_init(&sha3_256);
		mk_lib_crypto_hash_stream_sha3_256_append_u8s(&sha3_256, ((mk_sl_cui_uint8_pct)(messages[i])), ((mk_lang_types_usize_t)(message_lens[i])));
		mk_lib_crypto_hash_stream_sha3_256_finish(&sha3_256, &digest);
		for(j = 0; j != mk_lib_crypto_hash_stream_sha3_256_digest_len_v; ++j)
		{
