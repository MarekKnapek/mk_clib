...
#define mk_lib_iip_cp_message_serialize_destination_blob_capacity ((mk_lib_iip_cp_message_serialize_destination_blob_enc_pub_max) + (mk_lib_iip_cp_message_serialize_destination_blob_sgn_pub_max))
#define mk_lib_iip_cp_message_serialize_destination_blob_padding_len_max ((mk_lib_iip_cp_message_serialize_destination_blob_capacity) - ((mk_lib_iip_cp_message_serialize_destination_blob_enc_pub_max) + (mk_lib_iip_cp_message_serialize_destination_blob_sgn_pub_max)))
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_message_serialize_elgamal_key_pri(mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lib_iip_cp_message_serialize_error_code_pt const error_code, mk_lang_types_sint_pt const consumed, mk_lib_iip_crypt_elgamal_key_pri_pct const obj) mk_lang_noexcept
{
	...
	mk_sl_cui_uint8_pt ptr;
	mk_lang_types_sint_t rem;
	mk_lib_iip_cp_message_serialize_elgamal_key_pri_t storage;
	mk_lang_types_sint_t err;
	mk_lang_types_sint_t tlen;
	...
	ptr = data_buf;
	rem = data_len;
	mk_lib_iip_integer_elgamal_pri_single_to_buis_uchar_be(&obj->m_data.m_val, &storage.m_data.m_uchars[0]);
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_message_serialize_elgamal_key_pub(mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lib_iip_cp_message_serialize_error_code_pt const error_code, mk_lang_types_sint_pt const consumed, mk_lib_iip_crypt_elgamal_key_pub_pct const obj) mk_lang_noexcept
{
	union mk_lib_iip_cp_message_serialize_elgamal_key_pub_data_u
	{
		...
		mk_lib_iip_crypt_elgamal_key_pub_t m_elgamal_key_pub;
	};
	...
	mk_sl_cui_uint8_pt ptr;
	mk_lang_types_sint_t rem;
	mk_lib_iip_cp_message_serialize_elgamal_key_pub_t storage;
	mk_lang_types_sint_t err;
	mk_lang_types_sint_t tlen;
	...
	ptr = data_buf;
	rem = data_len;
	mk_lib_iip_integer_elgamal_pub_single_to_buis_uchar_be(&obj->m_data.m_val, &storage.m_data.m_uchars[0]);
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_message_serialize_dsa_sha1_key_pri(mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lib_iip_cp_message_serialize_error_code_pt const error_code, mk_lang_types_sint_pt const consumed, mk_lib_iip_crypt_dsa_sha1_key_pri_pct const obj) mk_lang_noexcept
{
	...
	mk_sl_cui_uint8_pt ptr;
	mk_lang_types_sint_t rem;
	mk_lib_iip_cp_message_serialize_dsa_sha1_key_pri_t storage;
	mk_lang_types_sint_t err;
	mk_lang_types_sint_t tlen;
	...
	ptr = data_buf;
	rem = data_len;
	mk_lib_iip_integer_dsa_sha1_pri_single_to_buis_uchar_be(&obj->m_data.m_val, &storage.m_data.m_uchars[0]);
	err = mk_lib_iip_cp_message_serialize_uchars(ptr, rem, error_code, &tlen, &storage.m_data.m_uchars[0], mk_lang_countof(storage.m_data.m_uchars)); mk_lang_check_rereturn(err); if(*error_code != mk_lib_iip_cp_message_serialize_error_code_e_ok){ return 0; } mk_lang_assert(tlen >= 0); mk_lang_assert(tlen <= rem); ptr += tlen; rem -= tlen;
	tlen = data_len - rem;
	*consumed = tlen;
	return 0;
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_message_serialize_dsa_sha1_key_pub(mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lib_iip_cp_message_serialize_error_code_pt const error_code, mk_lang_types_sint_pt const consumed, mk_lib_iip_crypt_dsa_sha1_key_pub_pct const obj) mk_lang_noexcept
{
	union mk_lib_iip_cp_message_serialize_dsa_sha1_key_pub_data_u
	{
		...
		mk_lib_iip_crypt_dsa_sha1_key_pub_t m_dsa_sha1_key_pub;
	};
	...
	mk_sl_cui_uint8_pt ptr;
	mk_lang_types_sint_t rem;
	mk_lib_iip_cp_message_serialize_dsa_sha1_key_pub_t storage;
	mk_lang_types_sint_t err;
	mk_lang_types_sint_t tlen;
	...
	ptr = data_buf;
	rem = data_len;
	mk_lib_iip_integer_dsa_sha1_pub_single_to_buis_uchar_be(&obj->m_data.m_val, &storage.m_data.m_uchars[0]);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_message_serialize_dsa_sha1_signature(mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lib_iip_cp_message_serialize_error_code_pt const error_code, mk_lang_types_sint_pt const consumed, mk_lib_iip_crypt_dsa_sha1_signature_pct const obj) mk_lang_noexcept
{
	union mk_lib_iip_cp_message_serialize_dsa_sha1_signature_data_u
	{
		mk_lang_types_uchar_t m_uchars[mk_lib_iip_crypt_dsa_sha1_signature_len_v];
		mk_lib_iip_crypt_dsa_sha1_signature_t m_dsa_signature;
	};
	...
	mk_sl_cui_uint8_pt ptr;
	mk_lang_types_sint_t rem;
	mk_lib_iip_cp_message_serialize_dsa_sha1_signature_t storage;
	mk_lang_types_sint_t err;
	mk_lang_types_sint_t tlen;
	...
	ptr = data_buf;
	rem = data_len;
	mk_lib_iip_integer_dsa_sha1_pri_single_to_buis_uchar_be(&obj->m_r, &storage.m_data.m_uchars[0 * mk_lib_iip_integer_dsa_sha1_pri_single_size_bytes_v]);
	mk_lib_iip_integer_dsa_sha1_pri_single_to_buis_uchar_be(&obj->m_s, &storage.m_data.m_uchars[1 * mk_lib_iip_integer_dsa_sha1_pri_single_size_bytes_v]);
	err = mk_lib_iip_cp_message_serialize_uchars(ptr, rem, error_code, &tlen, &storage.m_data.m_uchars[0], mk_lang_countof(storage.m_data.m_uchars)); mk_lang_check_rereturn(err); if(*error_code != mk_lib_iip_cp_message_serialize_error_code_e_ok){ return 0; } mk_lang_assert(tlen >= 0); mk_lang_assert(tlen <= rem); ptr += tlen; rem -= tlen;
	tlen = data_len - rem;
	*consumed = tlen;
	return 0;
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_message_serialize_certificate_empty(mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lib_iip_cp_message_serialize_error_code_pt const error_code, mk_lang_types_sint_pt const consumed) mk_lang_noexcept
{
	mk_sl_cui_uint8_pt ptr;
	mk_lang_types_sint_t rem;
	mk_lib_iip_cp_message_certificate_type_id_t certificate_type_id;
	mk_lang_types_sint_t certificate_data_len;
	mk_lang_types_sint_t err;
	mk_lang_types_sint_t tlen;
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_message_serialize_type_destination_elgamal_dsa_sha1(mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lib_iip_cp_message_serialize_error_code_pt const error_code, mk_lang_types_sint_pt const consumed, mk_lib_iip_cp_types_destination_elgamal_dsa_sha1_pct const obj) mk_lang_noexcept
{
	...
	mk_sl_cui_uint8_t padding_buf[mk_lang_max(1, mk_lib_iip_cp_message_serialize_destination_blob_padding_len_max)];
	mk_lang_types_sint_t err;
	mk_lang_types_sint_t tlen;
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_message_serialize_type_strpair(mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lib_iip_cp_message_serialize_error_code_pt const error_code, mk_lang_types_sint_pt const consumed, mk_lib_iip_cp_types_strpair_pct const obj) mk_lang_noexcept
{
	mk_sl_cui_uint8_pt ptr;
	mk_lang_types_sint_t rem;
	mk_lang_types_pchar_t sep_key_val;
	mk_lang_types_pchar_t sep_pairs;
	mk_lang_types_sint_t err;
	mk_lang_types_sint_t tlen;
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_message_serialize_type_mapping(mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lib_iip_cp_message_serialize_error_code_pt const error_code, mk_lang_types_sint_pt const consumed, mk_lib_iip_cp_types_mapping_pct const obj) mk_lang_noexcept
{
	mk_sl_cui_uint8_pt ptr;
	mk_lang_types_sint_t rem;
	mk_sl_cui_uint8_pt ptb;
	mk_lang_types_sint_t reb;
	mk_lang_types_sint_t unknown_len;
	mk_lang_types_sint_t err;
	mk_lang_types_sint_t tlen;
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_message_serialize_type_leases_buf(mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lib_iip_cp_message_serialize_error_code_pt const error_code, mk_lang_types_sint_pt const consumed, mk_lib_iip_cp_types_leases_pct const obj) mk_lang_noexcept
{
	...
	mk_lang_types_usize_t n;
	mk_lang_types_usize_t i;
	mk_lib_iip_cp_types_lease_pct lease;
	mk_lang_types_sint_t err;
	mk_lang_types_sint_t tlen;
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_message_serialize_type_leaseset(mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lib_iip_cp_message_serialize_error_code_pt const error_code, mk_lang_types_sint_pt const consumed, mk_lib_iip_cp_types_leaseset_pct const obj) mk_lang_noexcept
{
	...
	mk_lib_iip_crypt_dsa_sha1_signature_t signature;
	...
	err = mk_lib_iip_crypt_dsa_sha1_key_pri_sign_data(&obj->m_destination.m_key_dsa_sha1_pri, snapshot_ptr, to_sign_len, &signature); mk_lang_check_rereturn(err);
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_message_serialize_msg_send_message(mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lib_iip_cp_message_serialize_error_code_pt const error_code, mk_lang_types_sint_pt const consumed, mk_lib_iip_cp_message_send_message_pct const obj) mk_lang_noexcept
{
	...
	rem = data_len;
	err = mk_lib_iip_cp_message_serialize_type_sessionid(ptr, rem, error_code, &tlen, &obj->m_session_id ); mk_lang_check_rereturn(err); if(*error_code != mk_lib_iip_cp_message_serialize_error_code_e_ok){ return 0; } mk_lang_assert(tlen >= 0); mk_lang_assert(tlen <= rem); ptr += tlen; rem -= tlen;
	err = mk_lib_iip_cp_message_serialize_type_buffer   (ptr, rem, error_code, &tlen, &obj->m_destination); mk_lang_check_rereturn(err); if(*error_code != mk_lib_iip_cp_message_serialize_error_code_e_ok){ return 0; } mk_lang_assert(tlen >= 0); mk_lang_assert(tlen <= rem); ptr += tlen; rem -= tlen;
