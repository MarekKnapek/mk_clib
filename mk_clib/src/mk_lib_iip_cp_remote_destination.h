...
struct mk_lib_iip_cp_local_destination_basic_buffer_s
{
	mk_lib_iip_cp_bytes_256_t m_enc_pri_key;
	mk_lib_iip_cp_bytes_20_t m_sgn_pri_key;
};
typedef struct mk_lib_iip_cp_local_destination_basic_buffer_s mk_lib_iip_cp_local_destination_basic_buffer_t;
mk_lang_typedef(mk_lib_iip_cp_local_destination_basic_buffer);

struct mk_lib_iip_cp_local_destination_s
{
	mk_lib_iip_cp_remote_destination_t m_remote_destination;
	mk_lib_iip_cp_local_destination_basic_buffer_t m_basic_buffer;
};
typedef struct mk_lib_iip_cp_local_destination_s mk_lib_iip_cp_local_destination_t;
mk_lang_typedef(mk_lib_iip_cp_local_destination);
...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo mk_lang_types_sint_t mk_lib_iip_cp_local_destination_rw_from_bytes(mk_lib_iip_cp_local_destination_pt const remote_destination, mk_sl_cui_uint8_pct const data_buf, mk_lang_types_sint_t const data_len, mk_lang_types_bool_pt const succeeded, mk_lang_types_sint_pt const consumed) mk_lang_noexcept;
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo mk_lang_types_sint_t mk_lib_iip_cp_local_destination_rw_to_bytes(mk_lib_iip_cp_local_destination_pct const remote_destination, mk_sl_cui_uint8_pt const data_buf, mk_lang_types_sint_t const data_len, mk_lang_types_bool_pt const succeeded, mk_lang_types_sint_pt const consumed) mk_lang_noexcept;
