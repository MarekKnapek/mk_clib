...
mk_lang_extern_c mk_win_base_dll_import mk_win_gdi_object_t mk_win_base_stdcall GetStockObject(int) mk_lang_noexcept;
mk_lang_extern_c mk_win_base_dll_import mk_win_base_bool_t mk_win_base_stdcall DeleteObject(mk_win_gdi_object_t) mk_lang_noexcept;
