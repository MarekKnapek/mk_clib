#ifndef mk_include_guard_mk_sl_io_writer_file_linux_h
#define mk_include_guard_mk_sl_io_writer_file_linux_h
...
mk_lang_typedef(mk_sl_io_writer_file_linux);
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_sl_io_writer_file_linux_read(mk_sl_io_writer_file_linux_pt const writer, mk_sl_cui_uint8_pt const buf, mk_lang_types_sint_t const len, mk_lang_types_sint_pt const read) mk_lang_noexcept;
