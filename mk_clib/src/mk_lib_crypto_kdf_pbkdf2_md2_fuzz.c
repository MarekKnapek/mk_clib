#ifndef mk_include_guard_mk_lib_crypto_kdf_pbkdf2_md2_fuzz_c
#define mk_include_guard_mk_lib_crypto_kdf_pbkdf2_md2_fuzz_c
...
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_crypto_kdf_pbkdf2_md2_fuzz_compute_my(mk_sl_cui_uint8_pct const password_buf, mk_lang_types_sint_t const password_len, mk_sl_cui_uint8_pct const salt_buf, mk_lang_types_sint_t const salt_len, mk_lang_types_ulong_t const cost, mk_lang_types_sint_t const key_len, mk_sl_cui_uint8_pt const key_buf) mk_lang_noexcept
{
	...
	mk_lib_crypto_kdf_pbkdf2_md2_fn(password_buf, password_len, salt_buf, salt_len, cost, key_len, key_buf);
	return 0;
}

#if mk_lang_platform_is_windows_at_least_any
mk_lang_nodiscard static mk_lang_inline mk_lang_types_sint_t mk_lib_crypto_kdf_pbkdf2_md2_fuzz_compute_win(mk_sl_cui_uint8_pct const password_buf, mk_lang_types_sint_t const password_len, mk_sl_cui_uint8_pct const salt_buf, mk_lang_types_sint_t const salt_len, mk_lang_types_ulong_t const cost, mk_lang_types_sint_t const key_len, mk_sl_cui_uint8_pt const key_buf) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_sint_t mk_lib_crypto_kdf_pbkdf2_md2_fuzz(mk_lang_types_uchar_pct const data, mk_lang_types_usize_t const size) mk_lang_noexcept
{
	...
	d += salt_len;
	s -= salt_len;
	err = mk_lib_crypto_kdf_pbkdf2_md2_fuzz_compute_my(&password_buf[0], ((mk_lang_types_sint_t)(password_len)), &salt_buf[0], ((mk_lang_types_sint_t)(salt_len)), cost, ((mk_lang_types_sint_t)(key_len)), &key_buf_my[0]); mk_lang_check_rereturn(err);
	#if mk_lang_platform_is_windows_at_least_any
	err = mk_lib_crypto_kdf_pbkdf2_md2_fuzz_compute_win(&password_buf[0], ((mk_lang_types_sint_t)(password_len)), &salt_buf[0], ((mk_lang_types_sint_t)(salt_len)), cost, ((mk_lang_types_sint_t)(key_len)), &key_buf_win[0]); mk_lang_check_rereturn(err);
