...
struct mk_lib_iip_cp_client_session_u32_and_socket_s
{
	mk_sl_cui_uint32_t m_u32;
	mk_lib_iip_cp_client_socket_task_pt m_socket;
};
typedef struct mk_lib_iip_cp_client_session_u32_and_socket_s mk_lib_iip_cp_client_session_u32_and_socket_t;
mk_lang_typedef(mk_lib_iip_cp_client_session_u32_and_socket);
...
struct mk_lib_iip_cp_client_session_state_s
{
	...
	mk_lib_iip_cp_client_session_u32_and_socket_map_t m_nonce_mapping;
	mk_lib_iip_cp_client_session_u32_and_socket_map_t m_stream_id_mapping;
};
