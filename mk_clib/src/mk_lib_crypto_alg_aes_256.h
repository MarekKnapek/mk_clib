...
{
	mk_lang_types_uchar_t m_uchars[mk_lib_crypto_alg_aes_256_key_len_v];
	mk_lang_types_ulllong_t m_ulllong;
};
typedef union mk_lib_crypto_alg_aes_256_aligned_key_u mk_lib_crypto_alg_aes_256_aligned_key_t;
typedef mk_lib_crypto_alg_aes_256_aligned_key_t const mk_lib_crypto_alg_aes_256_aligned_key_ct;
typedef mk_lib_crypto_alg_aes_256_aligned_key_t* mk_lib_crypto_alg_aes_256_aligned_key_pt;
typedef mk_lib_crypto_alg_aes_256_aligned_key_t const* mk_lib_crypto_alg_aes_256_aligned_key_pct;

union mk_lib_crypto_alg_aes_256_aligned_msg_u
{
	mk_lang_types_uchar_t m_uchars[mk_lib_crypto_alg_aes_256_msg_len_v];
	mk_lang_types_ulllong_t m_ulllong;
};
typedef union mk_lib_crypto_alg_aes_256_aligned_msg_u mk_lib_crypto_alg_aes_256_aligned_msg_t;
typedef mk_lib_crypto_alg_aes_256_aligned_msg_t const mk_lib_crypto_alg_aes_256_aligned_msg_ct;
typedef mk_lib_crypto_alg_aes_256_aligned_msg_t* mk_lib_crypto_alg_aes_256_aligned_msg_pt;
typedef mk_lib_crypto_alg_aes_256_aligned_msg_t const* mk_lib_crypto_alg_aes_256_aligned_msg_pct;
