#ifndef mk_include_guard_mk_iip_cp_sessioncmd_tcp_impl_h
#define mk_include_guard_mk_iip_cp_sessioncmd_tcp_impl_h
...
mk_lang_struct_forward(mk_iip_cp_sessioncmd_tcp_intr);
mk_lang_struct_forward(mk_iip_cp_socket_tcp_intr);
mk_lang_struct_forward(mk_iip_cp_type_sessionid);


enum mk_iip_cp_sessioncmd_tcp_impl_state_e
{
	mk_iip_cp_sessioncmd_tcp_impl_state_e_listening,
	mk_iip_cp_sessioncmd_tcp_impl_state_e_submit_message_end,
	mk_iip_cp_sessioncmd_tcp_impl_state_e_ready,
	mk_iip_cp_sessioncmd_tcp_impl_state_e_dummy_end
};
typedef enum mk_iip_cp_sessioncmd_tcp_impl_state_e mk_iip_cp_sessioncmd_tcp_impl_state_t;

struct mk_iip_cp_sessioncmd_tcp_impl_s
{
	mk_iip_cp_sessioncmd_tcp_intr_pt m_sessioncmd_tcp_intr;
	mk_iip_cp_type_sessionid_pct m_session_id;
	mk_lang_types_bool_t m_did_something;
	mk_iip_cp_sessioncmd_tcp_impl_state_t m_state;
	...
	mk_iip_cp_sessioncmd_tcp_impl_vec_t m_data_rcv;
	mk_iip_cp_sessioncmd_tcp_impl_vec_t m_data_snd;
	mk_iip_cp_socket_tcp_intr_pt m_socket;
	mk_iip_cp_client_data_response_accept_pt m_response;
};
typedef struct mk_iip_cp_sessioncmd_tcp_impl_s mk_iip_cp_sessioncmd_tcp_impl_t;
mk_lang_struct_typedef(mk_iip_cp_sessioncmd_tcp_impl);
...
#include "mk_iip_cp_sessioncmd_tcp_impl.c"
#endif
#endif
