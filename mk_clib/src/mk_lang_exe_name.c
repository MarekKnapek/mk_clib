#ifndef mk_include_guard_mk_lang_exe_name_c
#define mk_include_guard_mk_lang_exe_name_c
...
{
	mk_lang_tchar_pct last mk_lang_constexpr_init;

	mk_lang_assert(arg);
	mk_lang_assert(arg[0] != mk_lang_tchar_c('\0'));

	last = mk_lang_tchar_dispatch(mk_lang_exe_name_get_)(arg);
	return last;
}
