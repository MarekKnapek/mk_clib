#ifndef mk_include_guard_mk_lib_crypto_mode_cfb_8_aes_256
#define mk_include_guard_mk_lib_crypto_mode_cfb_8_aes_256
...
#include "mk_lib_crypto_mode_cfb_8_aes_256.c"
#endif
#endif
