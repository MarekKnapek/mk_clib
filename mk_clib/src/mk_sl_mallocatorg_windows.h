#ifndef mk_include_guard_mk_sl_mallocatorg_windows
#define mk_include_guard_mk_sl_mallocatorg_windows
...
#if defined mk_sl_mallocatorg_windows_statistics_want && (mk_sl_mallocatorg_windows_statistics_want) == 1
#define mk_sl_mallocatorg_windows_statistics_have 1
#elif defined mk_sl_mallocatorg_windows_statistics_want && (mk_sl_mallocatorg_windows_statistics_want) == 0
#define mk_sl_mallocatorg_windows_statistics_have 0
#elif !defined mk_sl_mallocatorg_windows_statistics_have
#if defined NDEBUG
#define mk_sl_mallocatorg_windows_statistics_have 0
#else
#define mk_sl_mallocatorg_windows_statistics_have 1
...
#include "mk_sl_mallocatorg_windows.c"
#endif
#endif
