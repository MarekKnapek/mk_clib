...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_remote_destination_get_key_additional_len_sgn(mk_lib_iip_cp_remote_destination_sgn_key_type_t const key_type) mk_lang_noexcept
{
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_remote_destination_get_key_additional_len_enc(mk_lib_iip_cp_remote_destination_enc_key_type_t const key_type) mk_lang_noexcept
{
	mk_lang_types_sint_t res mk_lang_constexpr_init;
...
mk_lang_nodiscard mk_lang_constexpr static mk_lang_inline mk_lang_types_sint_t mk_lib_iip_cp_remote_destination_prrw_from_bytes(mk_lib_iip_cp_remote_destination_pt const remote_destination, mk_sl_cui_uint8_pct const data_buf, mk_lang_types_sint_t const data_len, mk_lang_types_bool_pt const succeeded, mk_lang_types_sint_pt const consumed) mk_lang_noexcept
{
	...
	mk_sl_cui_uint8_memcpy_fn(&remote_destination->m_basic_buffer.m_enc_pub_key[0], ptr, mk_lang_countof(remote_destination->m_basic_buffer.m_enc_pub_key));
	ptr += tlen;
	rem -= tlen;
	...
	mk_sl_cui_uint8_memcpy_fn(&remote_destination->m_basic_buffer.m_sgn_pub_key[0], ptr, mk_lang_countof(remote_destination->m_basic_buffer.m_sgn_pub_key));
	ptr += tlen;
	rem -= tlen;
