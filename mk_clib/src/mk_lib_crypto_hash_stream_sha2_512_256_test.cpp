...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_hash_stream_sha2_512_256_test_compute_from_str_lit(char const(&str_lit)[str_lit_len]) mk_lang_noexcept
{
	...
	mk_lib_crypto_hash_block_sha2_512_256_digest_t digest mk_lang_constexpr_init;
	mk_lang_types_usize_t i mk_lang_constexpr_init;
	mk_lib_cpp_constexpr_array_t<mk_sl_cui_uint8_t, mk_lib_crypto_hash_block_sha2_512_256_digest_len> ret mk_lang_constexpr_init;
	...
	mk_lib_crypto_hash_stream_sha2_512_256_append_u8(&sha2_512_256, msg.data(), msg.size());
	mk_lib_crypto_hash_stream_sha2_512_256_finish(&sha2_512_256, &digest);
	for(i = 0; i != mk_lib_crypto_hash_block_sha2_512_256_digest_len; ++i){ ret[i] = digest.m_uint8s[i]; }
	return ret;
}
...
mk_lang_extern_c void mk_lib_crypto_hash_stream_sha2_512_256_test(void) mk_lang_noexcept
{
	#define message_1 ""
	#define message_2 "a"
	...
	int n;
	int i;
	mk_lib_crypto_hash_stream_sha2_512_256_t sha2_512_256;
	...
	for(i = 0; i != n; ++i)
	{
		...
		mk_lib_crypto_hash_stream_sha2_512_256_init(&sha2_512_256);
		mk_lib_crypto_hash_stream_sha2_512_256_append(&sha2_512_256, ((mk_lang_types_uchar_pct)(s_messages[i])), s_message_lens[i]);
		mk_lib_crypto_hash_stream_sha2_512_256_finish(&sha2_512_256, &digest);
		for(j = 0; j != mk_lib_crypto_hash_block_sha2_512_256_digest_len; ++j)
		{
