...
mk_lang_nodiscard mk_lang_constexpr mk_lang_jumbo auto mk_lib_crypto_hash_stream_sha2_512_256_test_compute_from_str_lit(char const(&str_lit)[str_lit_len]) mk_lang_noexcept
{
	...
	mk_lib_cpp_constexpr_array_t<mk_lang_types_uchar_t, mk_lib_crypto_hash_block_sha2_512_256_digest_len> ret mk_lang_constexpr_init;
	...
	for(i = 0; i  != s_len; ++i)
	{
		...
		mk_lib_crypto_hash_stream_sha2_512_256_append(&sha2_512_256, &uch, 1);
	}
...
mk_lang_extern_c void mk_lib_crypto_hash_stream_sha2_512_256_test(void) mk_lang_noexcept
{
	...
	#define digest_8 "19b1e37317d7fd3d7651f397005e31f154ef4912d1345743d2d5889aaca28996"
