#ifndef mk_include_guard_mk_iip_cp_sm_tcp_intr_h
#define mk_include_guard_mk_iip_cp_sm_tcp_intr_h
...
mk_lang_struct_forward(mk_iip_cp_sm_tcp_impl);
mk_lang_struct_forward(mk_iip_cp_type_destination_elgamal_dsa);
mk_lang_struct_forward(mk_iip_cp_type_sessionid);
mk_lang_struct_forward(mk_sl_cui_uint16);


struct mk_iip_cp_sm_tcp_intr_s
{
	mk_iip_cp_sm_tcp_impl_pt m_sessioncmd_tcp_impl;
};
typedef struct mk_iip_cp_sm_tcp_intr_s mk_iip_cp_sm_tcp_intr_t;
mk_lang_struct_typedef(mk_iip_cp_sm_tcp_intr);
...
#include "mk_iip_cp_sm_tcp_intr.c"
#endif
#endif
