...
mk_lang_nodiscard mk_lang_jumbo mk_lang_types_uintptr_t mk_lib_wasm_hasher_get_digest_len(mk_lib_wasm_hasher_pt const hasher) mk_lang_noexcept
{
	mk_lang_types_uintptr_t len;
	...
	{
		len = mk_lib_crypto_hash_stream_any1_get_digest_len(hasher->m_worker.m_data.m_hasher.m_data.m_id);
	}
	else
	{
		len = 0;
