#ifndef mk_include_guard_mk_lib_crypto_hash_block_whirlpool_c
#define mk_include_guard_mk_lib_crypto_hash_block_whirlpool_c
...
enum mk_lib_crypto_hash_block_whirlpool_k_nrounds_e{ mk_lib_crypto_hash_block_whirlpool_k_nrounds_v = 10 }; typedef enum mk_lib_crypto_hash_block_whirlpool_k_nrounds_e mk_lib_crypto_hash_block_whirlpool_k_nrounds_t;

#include "mk_lang_warning_msvc_push_c4820.h"
union mk_lib_crypto_hash_block_whirlpool_rcs_data_u
{
	mk_sl_cui_uint64_t m_uint64s[mk_lib_crypto_hash_block_whirlpool_k_nrounds_v];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_whirlpool_rcs_data_u mk_lib_crypto_hash_block_whirlpool_rcs_data_t;
struct mk_lib_crypto_hash_block_whirlpool_rcs_s
{
	mk_lang_alignas(64) mk_lib_crypto_hash_block_whirlpool_rcs_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_whirlpool_rcs_s mk_lib_crypto_hash_block_whirlpool_rcs_t;
#include "mk_lang_warning_msvc_pop.h"

union mk_lib_crypto_hash_block_whirlpool_table_data_u
{
	mk_sl_cui_uint64_t m_uint64s[0xff + 1];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_whirlpool_table_data_u mk_lib_crypto_hash_block_whirlpool_table_data_t;
struct mk_lib_crypto_hash_block_whirlpool_table_s
{
	mk_lang_alignas(sizeof(mk_lib_crypto_hash_block_whirlpool_table_data_t)) mk_lib_crypto_hash_block_whirlpool_table_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_whirlpool_table_s mk_lib_crypto_hash_block_whirlpool_table_t;

union mk_lib_crypto_hash_block_whirlpool_tables_data_u
{
	mk_lib_crypto_hash_block_whirlpool_table_t m_tables[8];
	mk_lang_types_ulllong_t m_align;
};
typedef union mk_lib_crypto_hash_block_whirlpool_tables_data_u mk_lib_crypto_hash_block_whirlpool_tables_data_t;
struct mk_lib_crypto_hash_block_whirlpool_tables_s
{
	mk_lang_alignas(sizeof(mk_lib_crypto_hash_block_whirlpool_tables_data_t)) mk_lib_crypto_hash_block_whirlpool_tables_data_t m_data;
};
typedef struct mk_lib_crypto_hash_block_whirlpool_tables_s mk_lib_crypto_hash_block_whirlpool_tables_t;


mk_lang_constexpr_static_inline mk_lib_crypto_hash_block_whirlpool_rcs_t const mk_lib_crypto_hash_block_whirlpool_k_rcs =
{{{
...
mk_lang_constexpr_static_inline mk_lib_crypto_hash_block_whirlpool_tables_t const mk_lib_crypto_hash_block_whirlpool_k_tables =
{{{
	{{{
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_whirlpool_init(mk_lib_crypto_hash_block_whirlpool_pt const whirlpool) mk_lang_noexcept
{
	...
	mk_lib_crypto_bitops_bulk_uint64_8_memclr(&whirlpool->m_state.m_data.m_uint64s[0]);
	mk_sl_cui_uint256_set_zero(&whirlpool->m_len);
}
...
{
	mk_sl_cui_uint256_t tsize mk_lang_constexpr_init;
	...
	mk_lang_assert(nblocks <= mk_lang_limits_usize_max / mk_lib_crypto_hash_block_whirlpool_block_len_v);
	#include "mk_lang_warning_gcc_pop.h"
	#include "mk_lang_warning_msvc_pop.h"

	if(nblocks != 0)
	{
		mk_sl_cui_uint256_from_bi_usize(&tsize, &nblocks);
		mk_lang_assert(!mk_sl_cui_uint256_would_overflow_add_cc(&whirlpool->m_len, &tsize));
		mk_sl_cui_uint256_add2_wrap_cid_cod(&whirlpool->m_len, &tsize);
		for(iblock = 0; iblock != nblocks; ++iblock)
		{
			...
			for(i = 0; i != 8; ++i)
			{
				mk_sl_uint_convert_64_8_le_to_big(&ta, &pblocks[iblock].m_data.m_uint8s[i * mk_sl_cui_uint64_size_bytes_v]);
				mk_sl_cui_uint64_xor3(&whirlpool->m_state.m_data.m_uint64s[i], &ta, &ptr2->m_data.m_uint64s[i]);
			}
			for(ir = 0; ir != mk_lib_crypto_hash_block_whirlpool_k_nrounds_v; ++ir)
			{
				ptr3 = pfree[--nfree];
				for(i = 0; i != 8; ++i)
				{
					...
					mk_sl_cui_uint64_xor3(&mk_lib_crypto_hash_block_whirlpool_k_tables.m_data.m_tables[0].m_data.m_uint64s[idxs[0]], &mk_lib_crypto_hash_block_whirlpool_k_tables.m_data.m_tables[1].m_data.m_uint64s[idxs[1]], &ta);
					mk_sl_cui_uint64_xor3(&mk_lib_crypto_hash_block_whirlpool_k_tables.m_data.m_tables[2].m_data.m_uint64s[idxs[2]], &mk_lib_crypto_hash_block_whirlpool_k_tables.m_data.m_tables[3].m_data.m_uint64s[idxs[3]], &tb);
					mk_sl_cui_uint64_xor3(&mk_lib_crypto_hash_block_whirlpool_k_tables.m_data.m_tables[4].m_data.m_uint64s[idxs[4]], &mk_lib_crypto_hash_block_whirlpool_k_tables.m_data.m_tables[5].m_data.m_uint64s[idxs[5]], &tc);
					mk_sl_cui_uint64_xor3(&mk_lib_crypto_hash_block_whirlpool_k_tables.m_data.m_tables[6].m_data.m_uint64s[idxs[6]], &mk_lib_crypto_hash_block_whirlpool_k_tables.m_data.m_tables[7].m_data.m_uint64s[idxs[7]], &td);
					mk_sl_cui_uint64_xor2(&ta, &tb);
					mk_sl_cui_uint64_xor2(&tc, &td);
					mk_sl_cui_uint64_xor3(&ta, &tc, &ptr3->m_data.m_uint64s[i]);
				}
				mk_sl_cui_uint64_xor2(&ptr3->m_data.m_uint64s[0], &mk_lib_crypto_hash_block_whirlpool_k_rcs.m_data.m_uint64s[ir]);
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_whirlpool_finish(mk_lib_crypto_hash_block_whirlpool_pt const whirlpool, mk_lib_crypto_hash_block_whirlpool_block_pt const block, mk_lang_types_sint_t const idx, mk_lib_crypto_hash_block_whirlpool_digest_pt const digest) mk_lang_noexcept
{
	...
	mk_sl_cui_uint256_t ta mk_lang_constexpr_init;
	mk_sl_cui_uint256_t tb mk_lang_constexpr_init;
	mk_lang_types_sint_t rest mk_lang_constexpr_init;
	mk_lang_types_sint_t i mk_lang_constexpr_init;

	mk_lang_assert(whirlpool);
	mk_lang_assert(block);
	mk_lang_assert(idx >= 0 && idx < mk_lib_crypto_hash_block_whirlpool_block_len_v);
	mk_lang_assert(digest);

	ui = mk_lib_crypto_hash_block_whirlpool_block_len_v; mk_sl_cui_uint256_from_bi_uint(&ta, &ui);
	mk_lang_assert(!mk_sl_cui_uint256_would_overflow_mul(&whirlpool->m_len, &ta));
	mk_sl_cui_uint256_shl3(&whirlpool->m_len, 6, &ta);
	mk_sl_cui_uint256_from_bi_sint(&tb, &idx);
	mk_lang_assert(!mk_sl_cui_uint256_would_overflow_add_cc(&ta, &tb));
	mk_sl_cui_uint256_add2_wrap_cid_cod(&ta, &tb);
	ui = 8; mk_sl_cui_uint256_from_bi_uint(&tb, &ui);
	mk_lang_assert(!mk_sl_cui_uint256_would_overflow_mul(&ta, &tb));
	mk_sl_cui_uint256_shl2(&ta, 3);

	ui = 0x80; mk_sl_cui_uint8_from_bi_uint(&block->m_data.m_uint8s[idx], &ui);
	rest = mk_lib_crypto_hash_block_whirlpool_block_len_v - idx - 1;
	mk_lang_assert(rest >= 0 && rest <= mk_lib_crypto_hash_block_whirlpool_block_len_v - 1);
	if(rest >= mk_sl_cui_uint256_size_bytes_v)
	{
		mk_sl_cui_uint8_memclr_fn(&block->m_data.m_uint8s[idx + 1], ((mk_lang_types_usize_t)(rest - mk_sl_cui_uint256_size_bytes_v)));
	}
	else
	{
		...
		mk_sl_cui_uint8_memclr_fn(&block->m_data.m_uint8s[0], ((mk_lang_types_sint_t)(mk_lib_crypto_hash_block_whirlpool_block_len_v)) - ((mk_lang_types_sint_t)(mk_sl_cui_uint256_size_bytes_v)));
	}

	mk_sl_uint_convert_256_8_be_to_sml(&ta, &block->m_data.m_uint8s[((mk_lang_types_sint_t)(mk_lib_crypto_hash_block_whirlpool_block_len_v)) - ((mk_lang_types_sint_t)(mk_sl_cui_uint256_size_bytes_v))]);
	mk_lib_crypto_hash_block_whirlpool_append_blocks(whirlpool, block, 1);

	for(i = 0; i != mk_lang_countof(whirlpool->m_state.m_data.m_uint64s); ++i)
	{
		mk_sl_uint_convert_64_8_le_to_sml(&whirlpool->m_state.m_data.m_uint64s[i], &digest->m_data.m_uint8s[i * mk_sl_cui_uint64_size_bytes_v]);
	}
}
#include "mk_lang_warning_msvc_pop.h"
