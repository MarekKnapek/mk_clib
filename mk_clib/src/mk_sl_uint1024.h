...
#define mk_sl_cui_uint1024_base_helper_sizebits_d (mk_lang_sizeof_bi_ulllong_t * mk_lang_charbit)
...
#define mk_sl_cui_uint1024_sizebits_d 1024
...
#undef mk_lang_bui_t_name
#undef mk_lang_bui_t_base
#define mk_sl_cui_uint1024_base_helper_sizebits_d (mk_lang_sizeof_bi_ulong_t * mk_lang_charbit)
...
#undef mk_lang_bui_t_name
#undef mk_lang_bui_t_base
#define mk_sl_cui_uint1024_base_helper_sizebits_d (mk_lang_sizeof_bi_ullong_t * mk_lang_charbit)
...
#undef mk_lang_bui_t_name
#undef mk_lang_bui_t_base
#define mk_sl_cui_uint1024_base_helper_sizebits_d (mk_lang_sizeof_bi_uint_t * mk_lang_charbit)
