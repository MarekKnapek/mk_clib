...
mk_lang_constexpr_static_inline mk_sl_cui_uint32_t const mk_lib_crypto_hash_block_sha1_portable_s_init[5] =
{
...
mk_lang_constexpr_static_inline mk_sl_cui_uint32_t const mk_lib_crypto_hash_block_sha1_portable_s_table[4] =
{
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha1_portable_init(mk_lib_crypto_hash_block_sha1_portable_pt const sha1_portable) mk_lang_noexcept
{
	...
	sha1_portable->m_state[0] = mk_lib_crypto_hash_block_sha1_portable_s_init[0];
	sha1_portable->m_state[1] = mk_lib_crypto_hash_block_sha1_portable_s_init[1];
	sha1_portable->m_state[2] = mk_lib_crypto_hash_block_sha1_portable_s_init[2];
	sha1_portable->m_state[3] = mk_lib_crypto_hash_block_sha1_portable_s_init[3];
	sha1_portable->m_state[4] = mk_lib_crypto_hash_block_sha1_portable_s_init[4];
...
mk_lang_constexpr mk_lang_jumbo mk_lang_types_void_t mk_lib_crypto_hash_block_sha1_portable_append_blocks(mk_lib_crypto_hash_block_sha1_portable_pt const sha1_portable, mk_lib_crypto_hash_block_sha1_portable_block_pct const pblocks, mk_lang_types_usize_t const nblocks) mk_lang_noexcept
{
	...
	oldh[0] = sha1_portable->m_state[0];
	oldh[1] = sha1_portable->m_state[1];
	oldh[2] = sha1_portable->m_state[2];
	oldh[3] = sha1_portable->m_state[3];
	oldh[4] = sha1_portable->m_state[4];
	a = &h[0];
	b = &h[1];
	c = &h[2];
	d = &h[3];
	...
	for(iblock = 0; iblock != nblocks; ++iblock)
	{
		...
		for(i = 0; i != 80; ++i)
		{
			...
			mk_lib_crypto_hash_block_sha1_portable_f(i, b, c, d, &tb);
			mk_sl_cui_uint32_add2_wrap_cid_cod(&ta, &tb);
			mk_sl_cui_uint32_add3_wrap_cid_cod(e, &w.m_data.m_u32s[(i - 0) % 16], &tb);
			mk_sl_cui_uint32_add2_wrap_cid_cod(&tb, &mk_lib_crypto_hash_block_sha1_portable_s_table[i / 20]);
	...
	sha1_portable->m_state[0] = oldh[0];
	sha1_portable->m_state[1] = oldh[1];
	sha1_portable->m_state[2] = oldh[2];
	sha1_portable->m_state[3] = oldh[3];
	sha1_portable->m_state[4] = oldh[4];
}
#include "mk_lang_warning_msvc_pop.h"
