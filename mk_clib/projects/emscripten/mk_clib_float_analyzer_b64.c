...
#include "../../src/mk_lib_wasm_float_analyzer_b64.h"


static mk_lib_float_analyzer_b64_t mk_lib_float_analyzer_b64_g;
...
{
	return mk_lib_wasm_float_analyzer_b64_main(&mk_lib_float_analyzer_b64_g, fnc, arg);
}
