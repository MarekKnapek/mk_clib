...
#include "../../src/mk_lib_wasm_float_analyzer_b128.h"


static mk_lib_float_analyzer_b128_t mk_lib_float_analyzer_b128_g;
...
{
	return mk_lib_wasm_float_analyzer_b128_main(&mk_lib_float_analyzer_b128_g, fnc, arg);
}
