...
#include "../../src/mk_lib_flt_analyzer_half.h"
#include "../../src/mk_sl_uint16.h"


static mk_lib_flt_analyzer_half_t g_half_analyzer;


mk_lang_extern_c mk_lang_emscripten_keepalive mk_lib_flt_analyzer_half_pct half_analyzer_analyze(mk_lang_types_uint_t const a, mk_lang_types_uint_t const b) mk_lang_noexcept
{
