...
#include "../../src/mk_lib_wasm_float_analyzer_b32.h"


static mk_lib_float_analyzer_b32_t mk_lib_float_analyzer_b32_g;
...
{
	return mk_lib_wasm_float_analyzer_b32_main(&mk_lib_float_analyzer_b32_g, fnc, arg);
}
