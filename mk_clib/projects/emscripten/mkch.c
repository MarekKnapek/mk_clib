...
#include "../../src/mk_lib_crypto_xof_stream_blake3.h"
...
#define alg_name_dn_xof_blake3        "blake3xof"
...
#define alg_name_dl_xof_blake3        ((int)(sizeof(alg_name_dn_xof_blake3       ) / sizeof(alg_name_dn_xof_blake3       [0]) - 1))
...
mk_lang_constexpr_static_inline mk_lang_types_uchar_t const s_alg_name_lens[] =
{
	...
	((mk_lang_types_uchar_t)(alg_name_dl_xof_blake3       )),
...
mk_lang_constexpr_static_inline char const s_alg_pretty_names[] =
	...
	mk_lang_stringify(mk_lib_crypto_xof_block_blake3_name_def)
...
mk_lang_constexpr_static_inline mk_lang_types_uchar_t const s_alg_pretty_name_lens[] =
{
	...
	((mk_lang_types_uchar_t)(((int)(sizeof(mk_lang_stringify(mk_lib_crypto_xof_block_blake3_name_def       )) - 1)))),
...
mk_lang_constexpr_static_inline mk_lang_types_uchar_t const s_alg_order[] =
{
	...
	((mk_lang_types_uchar_t)(alg_id_e_xof_blake3       )),
...
union alg_u
{
	...
	mk_lib_crypto_xof_stream_blake3_t        m_blake3xof   ;
...
static mk_lang_inline void init(alg_pt const alg, alg_id_t const id) mk_lang_noexcept
{
	switch(id)
	{
		...
		case alg_id_e_xof_blake3       : mk_lib_crypto_xof_stream_blake3_init       (&alg->m_blake3xof   ); break;
...
static mk_lang_inline void append(alg_pt const alg, alg_id_t const id, mk_lang_types_uchar_pct const msg, mk_lang_types_usize_t const msg_len) mk_lang_noexcept
{
	switch(id)
	{
		...
		case alg_id_e_xof_blake3       : mk_lib_crypto_xof_stream_blake3_append       (&alg->m_blake3xof   , msg, msg_len); break;
...
static mk_lang_inline int finish(alg_pt const alg, alg_id_t const id, int const xof_len, aligned16k_pt const digest) mk_lang_noexcept
{
	switch(id)
	{
		...
		case alg_id_e_xof_blake3       : mk_lib_crypto_xof_stream_blake3_finish       (&alg->m_blake3xof); mk_lib_crypto_xof_stream_blake3_squeeze   (&alg->m_blake3xof, xof_len, &digest->m_uint8s[0]); return xof_len; break;
